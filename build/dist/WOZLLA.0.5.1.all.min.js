(function(d,g){function c(){b.READY||(q.determineEventTypes(),t.each(b.gestures,function(a){w.register(a)}),q.onTouch(b.DOCUMENT,l,w.detect),q.onTouch(b.DOCUMENT,p,w.detect),b.READY=!0)}var b=function y(a,e){return new y.Instance(a,e||{})};b.VERSION="1.1.3";b.defaults={behavior:{userSelect:"none",touchAction:"pan-y",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};b.DOCUMENT=document;b.HAS_POINTEREVENTS=navigator.pointerEnabled||navigator.msPointerEnabled;
b.HAS_TOUCHEVENTS="ontouchstart"in d;b.IS_MOBILE=/mobile|tablet|ip(ad|hone|od)|android|silk/i.test(navigator.userAgent);b.NO_MOUSEEVENTS=b.HAS_TOUCHEVENTS&&b.IS_MOBILE||b.HAS_POINTEREVENTS;b.CALCULATE_INTERVAL=25;var a={},e=b.DIRECTION_DOWN="down",f=b.DIRECTION_LEFT="left",h=b.DIRECTION_UP="up",r=b.DIRECTION_RIGHT="right",n=b.POINTER_MOUSE="mouse",s=b.POINTER_TOUCH="touch",k=b.POINTER_PEN="pen",m=b.EVENT_START="start",l=b.EVENT_MOVE="move",p=b.EVENT_END="end",u=b.EVENT_RELEASE="release",v=b.EVENT_TOUCH=
...
b.clientX?f:r:0<a.clientY-b.clientY?h:e},getDistance:function(a,e){var b=e.clientX-a.clientX,f=e.clientY-a.clientY;return Math.sqrt(b*b+f*f)},getScale:function(a,e){return 2<=a.length&&2<=e.length?this.getDistance(e[0],e[1])/this.getDistance(a[0],a[1]):1},getRotation:function(a,e){return 2<=a.length&&2<=e.length?this.getAngle(e[1],e[0])-this.getAngle(a[1],a[0]):0},isVertical:function(a){return a==h||a==e},setPrefixedCss:function(a,e,b,f){var h=["","Webkit","Moz","O","ms"];e=t.toCamelCase(e);for(var c=
0;c<h.length;c++){var d=e;h[c]&&(d=h[c]+d.slice(0,1).toUpperCase()+d.slice(1));if(d in a.style){a.style[d]=(null==f||f)&&b||"";break}}},toggleBehavior:function(a,e,b){if(e&&a&&a.style){t.each(e,function(e,f){t.setPrefixedCss(a,f,e,b)});var f=b&&function(){return!1};"none"==e.userSelect&&(a.onselectstart=f);"none"==e.userDrag&&(a.ondragstart=f)}},toCamelCase:function(a){return a.replace(/[_-]([a-z])/g,function(a){return a[1].toUpperCase()})}},q=b.event={preventMouseEvents:!1,started:!1,shouldDetect:!1,
on:function(a,e,b,f){e=e.split(" ");t.each(e,function(e){t.on(a,e,b);f&&f(e)})},off:function(a,e,b,f){e=e.split(" ");t.each(e,function(e){t.off(a,e,b);f&&f(e)})},onTouch:function(e,f,h){var c=this,d=function(a){var d=a.type.toLowerCase(),r=b.HAS_POINTEREVENTS,d=t.inStr(d,"mouse"),n;d&&c.preventMouseEvents||(d&&f==m&&0===a.button?(c.preventMouseEvents=!1,c.shouldDetect=!0):r&&f==m?c.shouldDetect=1===a.buttons||x.matchType(s,a):d||f!=m||(c.preventMouseEvents=!0,c.shouldDetect=!0),r&&f!=p&&x.updatePointer(f,
a),c.shouldDetect&&(n=c.doDetect.call(c,a,f,e,h)),n==p&&(c.preventMouseEvents=!1,c.shouldDetect=!1,x.reset()),r&&f==p&&x.updatePointer(f,a))};this.on(e,a[f],d);return d},doDetect:function(a,e,b,f){var h=this.getTouchList(a,e),c=e,d=h.trigger,r=h.length;e==m?d=v:e==p&&(d=u,r=h.length-(a.changedTouches?a.changedTouches.length:1));0<r&&this.started&&(c=l);this.started=!0;a=this.collectEventData(b,c,h,a);e!=p&&f.call(w,a);d&&(a.changedLength=r,a.eventType=d,f.call(w,a),a.eventType=c,delete a.changedLength);
c==p&&(f.call(w,a),this.started=!1);return c},determineEventTypes:function(){var e;e=b.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:b.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];a[m]=e[0];a[l]=e[1];a[p]=e[2];return a},getTouchList:function(a,e){if(b.HAS_POINTEREVENTS)return x.getTouchList();
if(a.touches){if(e==l)return a.touches;var f=[],h=[].concat(t.toArray(a.touches),t.toArray(a.changedTouches)),c=[];t.each(h,function(a){!1===t.inArray(f,a.identifier)&&c.push(a);f.push(a.identifier)});return c}a.identifier=1;return[a]},collectEventData:function(a,e,b,f){a=s;t.inStr(f.type,"mouse")||x.matchType(n,f)?a=n:x.matchType(k,f)&&(a=k);return{center:t.getCenter(b),timeStamp:Date.now(),target:f.target,touches:b,eventType:e,pointerType:a,srcEvent:f,preventDefault:function(){var a=this.srcEvent;
...
f={};f[n]=b===(e.MSPOINTER_TYPE_MOUSE||n);f[s]=b===(e.MSPOINTER_TYPE_TOUCH||s);f[k]=b===(e.MSPOINTER_TYPE_PEN||k);return f[a]},reset:function(){this.pointers={}}},w=b.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(a,e){this.current||(this.stopped=!1,this.current={inst:a,startEvent:t.extend({},e),lastEvent:!1,lastCalcEvent:!1,futureCalcEvent:!1,lastCalcData:{},name:""},this.detect(e))},detect:function(a){if(this.current&&!this.stopped){a=this.extendEventData(a);var e=
this.current.inst,b=e.options;t.each(this.gestures,function(f){!this.stopped&&e.enabled&&b[f.name]&&f.handler.call(f,a,e)},this);this.current&&(this.current.lastEvent=a);a.eventType==p&&this.stopDetect();return a}},stopDetect:function(){this.previous=t.extend({},this.current);this.current=null;this.stopped=!0},getCalculatedData:function(a,e,f,h,c){var d=this.current,r=!1,n=d.lastCalcEvent,g=d.lastCalcData;n&&a.timeStamp-n.timeStamp>b.CALCULATE_INTERVAL&&(e=n.center,f=a.timeStamp-n.timeStamp,h=a.center.clientX-
n.center.clientX,c=a.center.clientY-n.center.clientY,r=!0);if(a.eventType==v||a.eventType==u)d.futureCalcEvent=a;if(!d.lastCalcEvent||r)g.velocity=t.getVelocity(f,h,c),g.angle=t.getAngle(e,a.center),g.direction=t.getDirection(e,a.center),d.lastCalcEvent=d.futureCalcEvent||a,d.futureCalcEvent=a;a.velocityX=g.velocity.x;a.velocityY=g.velocity.y;a.interimAngle=g.angle;a.interimDirection=g.direction},extendEventData:function(a){var e=this.current,b=e.startEvent,e=e.lastEvent||b;if(a.eventType==v||a.eventType==
...
!0);this.eventStartHandler=q.onTouch(a,m,function(a){f.enabled&&a.eventType==m?w.startDetect(f,a):a.eventType==v&&w.detect(a)});this.eventHandlers=[]};b.Instance.prototype={on:function(a,e){var b=this;q.on(b.element,a,e,function(a){b.eventHandlers.push({gesture:a,handler:e})});return b},off:function(a,e){var b=this;q.off(b.element,a,e,function(a){a=t.inArray({gesture:a,handler:e});!1!==a&&b.eventHandlers.splice(a,1)});return b},trigger:function(a,e){e||(e={});var f=b.DOCUMENT.createEvent("Event");
f.initEvent(a,!0,!0);f.gesture=e;var h=this.element;t.hasParent(e.target,h)&&(h=e.target);navigator.isCocoonJS?this.eventHandlers.forEach(function(e){a===e.gesture&&e.handler(f)}):h.dispatchEvent(f);return this},enable:function(a){this.enabled=a;return this},dispose:function(){var e,b;t.toggleBehavior(this.element,this.options.behavior,!1);for(e=-1;b=this.eventHandlers[++e];)t.off(this.element,b.gesture,b.handler);this.eventHandlers=[];q.off(this.element,a[m],this.eventStartHandler);return null}};
(function(a){var c=!1;b.gestures.Drag={name:a,index:50,handler:function(b,d){var n=w.current;if(!(0<d.options.dragMaxTouches&&b.touches.length>d.options.dragMaxTouches))switch(b.eventType){case m:c=!1;break;case l:if(b.distance<d.options.dragMinDistance&&n.name!=a)break;var g=n.startEvent.center;if(n.name!=a&&(n.name=a,d.options.dragDistanceCorrection&&0<b.distance)){var s=Math.abs(d.options.dragMinDistance/b.distance);g.pageX+=b.deltaX*s;g.pageY+=b.deltaY*s;g.clientX+=b.deltaX*s;g.clientY+=b.deltaY*
s;b=w.extendEventData(b)}if(n.lastEvent.dragLockToAxis||d.options.dragLockToAxis&&d.options.dragLockMinDistance<=b.distance)b.dragLockToAxis=!0;n=n.lastEvent.direction;b.dragLockToAxis&&n!==b.direction&&(t.isVertical(n)?b.direction=0>b.deltaY?h:e:b.direction=0>b.deltaX?f:r);c||(d.trigger(a+"start",b),c=!0);d.trigger(a,b);d.trigger(a+b.direction,b);n=t.isVertical(b.direction);(d.options.dragBlockVertical&&n||d.options.dragBlockHorizontal&&!n)&&b.preventDefault();break;case u:c&&b.changedLength<=d.options.dragMaxTouches&&
(d.trigger(a+"end",b),c=!1);break;case p:c=!1}},defaults:{dragMinDistance:10,dragDistanceCorrection:!0,dragMaxTouches:1,dragBlockHorizontal:!1,dragBlockVertical:!1,dragLockToAxis:!1,dragLockMinDistance:25}}})("drag");b.gestures.Gesture={name:"gesture",index:1337,handler:function(a,e){e.trigger(this.name,a)}};(function(a){var e;b.gestures.Hold={name:a,index:10,defaults:{holdTimeout:500,holdThreshold:2},handler:function(b,f){var h=f.options,c=w.current;switch(b.eventType){case m:clearTimeout(e);c.name=
...
b>f.swipeMaxTouches||!(a.velocityX>f.swipeVelocityX||a.velocityY>f.swipeVelocityY)||(e.trigger(this.name,a),e.trigger(this.name+a.direction,a))}}};(function(a){var e=!1;b.gestures.Tap={name:a,index:100,handler:function(b,f){var h=f.options,c=w.current,d=w.previous,r,n;switch(b.eventType){case m:e=!1;break;case l:e=e||b.distance>h.tapMaxDistance;break;case p:!t.inStr(b.srcEvent.type,"cancel")&&b.deltaTime<h.tapMaxTime&&!e&&(r=d&&d.lastEvent&&b.timeStamp-d.lastEvent.timeStamp,n=!1,d&&d.name==a&&r&&
r<h.doubleTapInterval&&b.distance<h.doubleTapDistance&&(f.trigger("doubletap",b),n=!0),!n||h.tapAlways)&&(c.name=a,f.trigger(c.name,b))}},defaults:{tapMaxTime:250,tapMaxDistance:10,tapAlways:!0,doubleTapDistance:20,doubleTapInterval:300}}})("tap");b.gestures.Touch={name:"touch",index:-Infinity,defaults:{preventDefault:!1,preventMouse:!1},handler:function(a,e){e.options.preventMouse&&a.pointerType==n?a.stopDetect():(e.options.preventDefault&&a.preventDefault(),a.eventType==v&&e.trigger("touch",a))}};
(function(a){var e=!1;b.gestures.Transform={name:a,index:45,defaults:{transformMinScale:.01,transformMinRotation:1},handler:function(b,f){switch(b.eventType){case m:e=!1;break;case l:if(2>b.touches.length)break;var h=Math.abs(1-b.scale),c=Math.abs(b.rotation);if(h<f.options.transformMinScale&&c<f.options.transformMinRotation)break;w.current.name=a;e||(f.trigger(a+"start",b),e=!0);f.trigger(a,b);c>f.options.transformMinRotation&&f.trigger("rotate",b);h>f.options.transformMinScale&&(f.trigger("pinch",
...
null}};c.prototype.gotoAndPlay=function(b,a,e,f,h,r,n,g,k){void 0===a&&(a=-1);void 0===e&&(e=-1);void 0===f&&(f=NaN);void 0===h&&(h=0);void 0===r&&(r=null);void 0===n&&(n=c.SAME_LAYER_AND_GROUP);void 0===g&&(g=!0);void 0===k&&(k=!0);if(!this._animationDataList)return null;for(var m=this._animationDataList.length,l;m--;)if(this._animationDataList[m].name==b){l=this._animationDataList[m];break}if(!l)return null;this._isFading=this._isPlaying=!0;a=0>a?0>l.fadeTime?.3:l.fadeTime:a;e=0>e?0>l.scale?1:l.scale:
1E3*e/l.duration;f=isNaN(f)?l.playTimes:f;switch(n){case c.NONE:break;case c.SAME_LAYER:for(m=this._animationStateList.length;m--;)n=this._animationStateList[m],n.layer==h&&n.fadeOut(a,g);break;case c.SAME_GROUP:for(m=this._animationStateList.length;m--;)n=this._animationStateList[m],n.group==r&&n.fadeOut(a,g);break;case c.ALL:for(m=this._animationStateList.length;m--;)n=this._animationStateList[m],n.fadeOut(a,g);break;default:for(m=this._animationStateList.length;m--;)n=this._animationStateList[m],
n.layer==h&&n.group==r&&n.fadeOut(a,g)}this._lastAnimationState=d.AnimationState._borrowObject();this._lastAnimationState._layer=h;this._lastAnimationState._group=r;this._lastAnimationState.autoTween=this.tweenEnabled;this._lastAnimationState._fadeIn(this._armature,l,a,1/e,f,k);this.addState(this._lastAnimationState);f=this._armature.getSlots(!1);for(m=f.length;m--;)h=f[m],h.childArmature&&h.childArmature.animation.gotoAndPlay(b,a);return this._lastAnimationState};c.prototype.gotoAndStop=function(b,
a,e,f,h,d,n,g){void 0===e&&(e=-1);void 0===f&&(f=0);void 0===h&&(h=-1);void 0===d&&(d=0);void 0===n&&(n=null);void 0===g&&(g=c.ALL);var k=this.getState(b,d);k||(k=this.gotoAndPlay(b,f,h,NaN,d,n,g));0<=e?k.setCurrentTime(k.totalTime*e):k.setCurrentTime(a);k.stop();return k};c.prototype.play=function(){this._animationDataList&&0!=this._animationDataList.length&&(this._lastAnimationState?this._isPlaying?this.gotoAndPlay(this._lastAnimationState.name):this._isPlaying=!0:this.gotoAndPlay(this._animationDataList[0].name))};
...
h?(c=h,f=!0):c<=-h?(c=-h,f=!0):f=!1,0>c&&(c+=h),h=Math.ceil(c/this._totalTime)||1,c=0<=c?c-Math.floor(c/this._totalTime)*this._totalTime:c-Math.ceil(c/this._totalTime)*this._totalTime,f&&(c=this._totalTime));this._isComplete=f;var n=1E3*this._time/this._totalTime,g;for(g in this._timelineStateList){var k=this._timelineStateList[g];k._update(n);this._isComplete=k._isComplete&&this._isComplete}this._currentTime!=c&&(this._currentPlayTimes!=h&&(0<this._currentPlayTimes&&1<h&&(e=!0),this._currentPlayTimes=
h),0>this._currentTime&&(a=!0),this._isComplete&&(b=!0),this._currentTime=c,this.updateMainTimeline(f));a&&this._armature.hasEventListener(d.AnimationEvent.START)&&(g=new d.AnimationEvent(d.AnimationEvent.START),g.animationState=this,this._armature._eventList.push(g));b?(this._armature.hasEventListener(d.AnimationEvent.COMPLETE)&&(g=new d.AnimationEvent(d.AnimationEvent.COMPLETE),g.animationState=this,this._armature._eventList.push(g)),this.autoFadeOut&&this.fadeOut(this.fadeOutTime,!0)):e&&this._armature.hasEventListener(d.AnimationEvent.LOOP_COMPLETE)&&
(g=new d.AnimationEvent(d.AnimationEvent.LOOP_COMPLETE),g.animationState=this,this._armature._eventList.push(g))};c.prototype.updateMainTimeline=function(b){var a=this._clip.frameList;if(0<a.length){for(var e,f,h=0,c=this._clip.frameList.length;h<c;++h){if(0>this._currentFrameIndex)this._currentFrameIndex=0;else if(this._currentTime<this._currentFramePosition||this._currentTime>=this._currentFramePosition+this._currentFrameDuration){if(this._currentFrameIndex++,this._currentFrameIndex>=a.length)if(b){this._currentFrameIndex--;
...
function(){var a,e,b,h=this._timelineStateList.length;if(1==h)a=this._timelineStateList[0],b=a._animationState.weight*a._animationState.fadeWeight,a._weight=b,e=a._transform,a=a._pivot,this._tween.x=e.x*b,this._tween.y=e.y*b,this._tween.skewX=e.skewX*b,this._tween.skewY=e.skewY*b,this._tween.scaleX=1+(e.scaleX-1)*b,this._tween.scaleY=1+(e.scaleY-1)*b,this._tweenPivot.x=a.x*b,this._tweenPivot.y=a.y*b;else if(1<h){var c=0,d=0,g=0,k=0,m=0,l=0,p=0,u=0,v=1,t=0,q=this._timelineStateList[h-1]._animationState.layer;
for(e=0;h--;){a=this._timelineStateList[h];e=a._animationState.layer;if(q!=e)if(t>=v){a._weight=0;break}else v-=t;q=e;b=a._animationState.weight*a._animationState.fadeWeight*v;(a._weight=b)&&a._blendEnabled&&(e=a._transform,a=a._pivot,c+=e.x*b,d+=e.y*b,g+=e.skewX*b,k+=e.skewY*b,m+=(e.scaleX-1)*b,l+=(e.scaleY-1)*b,p+=a.x*b,u+=a.y*b,t+=b)}this._tween.x=c;this._tween.y=d;this._tween.skewX=g;this._tween.skewY=k;this._tween.scaleX=m;this._tween.scaleY=l;this._tweenPivot.x=p;this._tweenPivot.y=u}};b.prototype.sortState=
...
};b.prototype._updateDisplayColor=function(a,e,b,h,c,d,g,k){this._colorTransform.alphaOffset=a;this._colorTransform.redOffset=e;this._colorTransform.greenOffset=b;this._colorTransform.blueOffset=h;this._colorTransform.alphaMultiplier=c;this._colorTransform.redMultiplier=d;this._colorTransform.greenMultiplier=g;this._colorTransform.blueMultiplier=k};b.prototype._updateDisplayBlendMode=function(a){throw Error("Abstract method needs to be implemented in subclass!");};return b}(d.DBObject);d.Slot=g})(dragonBones||
...
(function(d){var g=function(c){function b(a,e){c.call(this,a)}__extends(b,c);Object.defineProperty(b,"MOVEMENT_CHANGE",{get:function(){return b.FADE_IN},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"movementID",{get:function(){return this.animationName},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"armature",{get:function(){return this.target},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"animationName",{get:function(){return this.animationState.name},
...
(function(d){var g=function(c){function b(a,e){c.call(this,a)}__extends(b,c);Object.defineProperty(b,"MOVEMENT_FRAME_EVENT",{get:function(){return b.ANIMATION_FRAME_EVENT},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"armature",{get:function(){return this.target},enumerable:!0,configurable:!0});b.ANIMATION_FRAME_EVENT="animationFrameEvent";b.BONE_FRAME_EVENT="boneFrameEvent";return b}(d.Event);d.FrameEvent=g})(dragonBones||(dragonBones={}));
...
null==a.armatureData.getBoneData(f)&&(f=null),a.addBone(h,f,!0);a._updateAnimationAfterBoneListChanged()};b.prototype._buildSlots=function(a,b,f){var h=a.armatureData.getSkinData(b);if(h)for(var c=[],h=h.slotDataList,n,g,k,m=0;m<h.length;m++)if(n=h[m],k=a.getBone(n.parent)){g=this._generateSlot();g.initWithSlotData(n);k.addSlot(g);for(k=n.displayDataList.length;k--;){var l=n.displayDataList[k];switch(l.type){case d.DisplayData.ARMATURE:l=this.buildArmatureUsingArmatureDataFromTextureAtlas(a.__dragonBonesData,
a.__dragonBonesData.getArmatureDataByName(l.name),f,b);c[k]=l;break;default:c[k]=this._generateDisplay(f,l.name,l.pivot.x,l.pivot.y)}}for(var p in c)if(n=c[p],n instanceof d.Armature&&(n=n.display),n.hasOwnProperty("name"))try{n.name=g.name}catch(u){}g.displayList=c;g._changeDisplay(0)}};b.prototype._generateArmature=function(){return null};b.prototype._generateSlot=function(){return null};b.prototype._generateDisplay=function(a,b,f,h){return null};b._helpMatrix=new d.Matrix;return b}(d.EventDispatcher);
...
(function(d){var g=function(){function c(){}c.parseTextureAtlasData=function(b,a){void 0===a&&(a=1);var e={},f,h=b[d.ConstValues.SUB_TEXTURE],r;for(r in h){var n=h[r],g=n[d.ConstValues.A_NAME],k=new d.Rectangle;k.x=c.getNumber(n,d.ConstValues.A_X,0)/a;k.y=c.getNumber(n,d.ConstValues.A_Y,0)/a;k.width=c.getNumber(n,d.ConstValues.A_WIDTH,0)/a;k.height=c.getNumber(n,d.ConstValues.A_HEIGHT,0)/a;var m="true"==n[d.ConstValues.A_ROTATED],l=c.getNumber(n,d.ConstValues.A_FRAME_WIDTH,0)/a,p=c.getNumber(n,d.ConstValues.A_FRAME_HEIGHT,
0)/a;0<l&&0<p?(f=new d.Rectangle,f.x=c.getNumber(n,d.ConstValues.A_FRAME_X,0)/a,f.y=c.getNumber(n,d.ConstValues.A_FRAME_Y,0)/a,f.width=l,f.height=p):f=null;e[g]=new d.TextureData(k,f,m)}return e};c.parseDragonBonesData=function(b){if(!b)throw Error();var a=b[d.ConstValues.A_VERSION],a=a.toString();if(a.toString()!=d.DragonBones.DATA_VERSION&&a.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var a=c.getNumber(b,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
...
d.DBDataUtil.transformArmatureData(e);e.sortBoneDataList();f=b[d.ConstValues.ANIMATION];for(h in f){var r=c.parseAnimationData(f[h],a);d.DBDataUtil.addHideTimeline(r,e);d.DBDataUtil.transformAnimationData(r,e,c.tempDragonBonesData.isGlobal);e.addAnimationData(r)}return e};c.parseBoneData=function(b){var a=new d.BoneData;a.name=b[d.ConstValues.A_NAME];a.parent=b[d.ConstValues.A_PARENT];a.length=Number(b[d.ConstValues.A_LENGTH])||0;a.inheritRotation=c.getBoolean(b,d.ConstValues.A_INHERIT_ROTATION,!0);
...
e=a.boneDataList;var h;f&&(h=f.slotDataList);for(f=0;f<e.length;f++){var r=e[f],g=b.getTimeline(r.name);if(g){var s=null;if(h)for(var k in h)if(s=h[k],s.parent==r.name)break;for(var m=g.frameList,l=null,p=null,u=null,v=m.length,t=0;t<v;t++){var q=m[t];c.setFrameTransform(b,a,r,q);q.transform.x-=r.transform.x;q.transform.y-=r.transform.y;q.transform.skewX-=r.transform.skewX;q.transform.skewY-=r.transform.skewY;q.transform.scaleX/=r.transform.scaleX;q.transform.scaleY/=r.transform.scaleY;!g.transformed&&
s&&(q.zOrder-=s.zOrder);l||(l=g.originTransform,l.copy(q.transform),l.skewX=d.TransformUtil.formatRadian(l.skewX),l.skewY=d.TransformUtil.formatRadian(l.skewY),p=g.originPivot,p.x=q.pivot.x,p.y=q.pivot.y);q.transform.x-=l.x;q.transform.y-=l.y;q.transform.skewX=d.TransformUtil.formatRadian(q.transform.skewX-l.skewX);q.transform.skewY=d.TransformUtil.formatRadian(q.transform.skewY-l.skewY);q.transform.scaleX/=l.scaleX;q.transform.scaleY/=l.scaleY;g.transformed||(q.pivot.x-=p.x,q.pivot.y-=p.y);if(u){var x=
q.transform.skewX-u.transform.skewX;u.tweenRotate?0<u.tweenRotate?(0>x&&(q.transform.skewX+=2*Math.PI,q.transform.skewY+=2*Math.PI),1<u.tweenRotate&&(q.transform.skewX+=2*Math.PI*(u.tweenRotate-1),q.transform.skewY+=2*Math.PI*(u.tweenRotate-1))):(0<x&&(q.transform.skewX-=2*Math.PI,q.transform.skewY-=2*Math.PI),1>u.tweenRotate&&(q.transform.skewX+=2*Math.PI*(u.tweenRotate+1),q.transform.skewY+=2*Math.PI*(u.tweenRotate+1))):(q.transform.skewX=u.transform.skewX+d.TransformUtil.formatRadian(q.transform.skewX-
u.transform.skewX),q.transform.skewY=u.transform.skewY+d.TransformUtil.formatRadian(q.transform.skewY-u.transform.skewY))}u=q}g.transformed=!0}}}else c.transformRelativeAnimationData(b,a)};c.setFrameTransform=function(b,a,e,f){f.transform.copy(f.global);if(e=a.getBoneData(e.parent)){var h=b.getTimeline(e.name);if(h){for(var r=[],g=[];h;)r.push(h),g.push(e),h=(e=a.getBoneData(e.parent))?b.getTimeline(e.name):null;b=r.length;var s;a=new d.Matrix;for(var k=new d.DBTransform,m=new d.Matrix;b--;)h=r[b],
e=g[b],c.getTimelineTransform(h,f.position,k,!s),s?(k.x+=h.originTransform.x+e.transform.x,k.y+=h.originTransform.y+e.transform.y,k.skewX+=h.originTransform.skewX+e.transform.skewX,k.skewY+=h.originTransform.skewY+e.transform.skewY,k.scaleX=k.scaleX*h.originTransform.scaleX*e.transform.scaleX,k.scaleY=k.scaleY*h.originTransform.scaleY*e.transform.scaleY,d.TransformUtil.transformToMatrix(k,m,!0),m.concat(a),d.TransformUtil.matrixToTransform(m,s,0<=k.scaleX*s.scaleX,0<=k.scaleY*s.scaleY)):(s=new d.DBTransform,
s.copy(k)),d.TransformUtil.transformToMatrix(s,a,!0);d.TransformUtil.globalToLocal(f.transform,s)}}};c.getTimelineTransform=function(b,a,e,f){for(var h=b.frameList,c=h.length;c--;)if(b=h[c],b.position<=a&&b.position+b.duration>a){if(c==h.length-1||a==b.position)e.copy(f?b.global:b.transform);else{var g=b.tweenEasing;a=(a-b.position)/b.duration;g&&10!=g&&(a=d.MathUtil.getEaseValue(a,g));h=h[c+1];b=f?b.global:b.transform;f=f?h.global:h.transform;e.x=b.x+(f.x-b.x)*a;e.y=b.y+(f.y-b.y)*a;e.skewX=d.TransformUtil.formatRadian(b.skewX+
...
h/g;this.values[1]=-b/g;this.values[3]=-f/g;this.values[4]=a/g;this.values[6]=(f*d-h*c)/g;this.values[7]=-(a*d-b*c)/g};b.prototype.prepend=function(a,b,f,h,c,d){var g,k,m,l,p=this.values,u=p[6],v=p[7];if(1!=a||0!=b||0!=f||1!=h)g=p[0],k=p[1],m=p[3],l=p[4],p[0]=g*a+k*f,p[1]=g*b+k*h,p[3]=m*a+l*f,p[4]=m*b+l*h;p[6]=u*a+v*f+c;p[7]=u*b+v*h+d};b.prototype.append=function(a,b,f,h,c,d){var g,k,m,l,p=this.values;g=p[0];k=p[1];m=p[3];l=p[4];p[0]=a*g+b*m;p[1]=a*k+b*l;p[3]=f*g+h*m;p[4]=f*k+h*l;p[6]=c*g+d*m+p[6];
p[7]=c*k+d*l+p[7]};b.prototype.prependTransform=function(a,e,f,h,c,d,g,k,m){if(c%360){var l=c*b.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=1,l=0;if(k||m)this.values[6]-=k,this.values[7]-=m;d||g?(d*=b.DEG_TO_RAD,g*=b.DEG_TO_RAD,this.prepend(c*f,l*f,-l*h,c*h,0,0),this.prepend(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),a,e)):this.prepend(c*f,l*f,-l*h,c*h,a,e);return this};b.prototype.appendTransform=function(a,e,f,h,c,d,g,k,m){if(c%360){var l=c*b.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=
1,l=0;d||g?(d*=b.DEG_TO_RAD,g*=b.DEG_TO_RAD,this.append(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),a,e),this.append(c*f,l*f,-l*h,c*h,0,0)):this.append(c*f,l*f,-l*h,c*h,a,e);if(k||m)this.values[6]-=k*this.values[0]+m*this.values[3],this.values[7]-=k*this.values[1]+m*this.values[4];return this};b.DEG_TO_RAD=Math.PI/180;return b}();d.Matrix=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
f){void 0===f&&(f=1);this.enabled=!0;this.canvasOffset=this.canvas=null;this.channelMap={};var c=this,r=window.navigator;c.canvas=b;c.canvasOffset=g(b);c.touchScale=f;Hammer(r.isCocoonJS?document:b,{transform:!1,doubletap:!1,hold:!1,rotate:!1,pinch:!1}).on(a.enabledGestures||"touch release tap swipe drag dragstart dragend",function(a){("release"===a.type||c.enabled)&&d.Scheduler.getInstance().scheduleFrame(function(){c.onGestureEvent(a)})})}a.setEanbledGestures=function(a){this.enabledGestures=a};
a.prototype.onGestureEvent=function(a){var b,c,g,n,s,k,m,l,p=a.type,u=d.Director.getInstance().stage,v=this.touchScale||1;if(m=a.gesture.srcEvent.changedTouches)for(n=m.length,g=0;g<n;g++)c=m[g],s=parseInt(c.identifier),b=c.pageX-this.canvasOffset.x,c=c.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&(l=u.getUnderPoint(b,c,!0))&&(this.channelMap[s]=this.createDispatchChanel(l),delete this.channelMap[s-10]),(k=this.channelMap[s])&&k.onGestureEvent(a,l,b,c,s);else s=1,b=a.gesture.srcEvent.pageX-this.canvasOffset.x,
c=a.gesture.srcEvent.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&((l=u.getUnderPoint(b,c,!0))?this.channelMap[s]=this.createDispatchChanel(l):delete this.channelMap[s]),(k=this.channelMap[s])&&k.onGestureEvent(a,l,b,c,s)};a.prototype.createDispatchChanel=function(a){var b=!0;return{onGestureEvent:function(h,g,n,s,k){var m=h.type,l=d.Director.getInstance().stage;switch(m){case "drag":if(!b){g=a;break}case "tap":case "release":g=l.getUnderPoint(n,s,!0)}if("tap"!==m||a===g)h=new c({x:n,y:s,type:m,
...
(function(d){(function(d){var c=function(){function b(){}b.getGLContext=function(a,b){var c,d=b||{},g={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},n;for(n in g)"undefined"===typeof d[n]&&(d[n]=g[n]);b=d;try{c=a.getContext("experimental-webgl",b)}catch(s){try{c=a.getContext("webgl",b)}catch(k){}}return c};b.compileShader=function(a,b,c){b=a.createShader(b);a.shaderSource(b,c);a.compileShader(b);return a.getShaderParameter(b,a.COMPILE_STATUS)?b:(console.log(a.getShaderInfoLog(b)),null)};
b.compileProgram=function(a,e,c){e=b.compileShader(a,a.VERTEX_SHADER,e);c=b.compileShader(a,a.FRAGMENT_SHADER,c);var d=a.createProgram();a.attachShader(d,e);a.attachShader(d,c);a.linkProgram(d);a.getProgramParameter(d,a.LINK_STATUS)||console.log("Could not initialise program");return{program:d,vertexShader:e,fragmentShader:c}};return b}();d.WebGLUtils=c})(d.renderer||(d.renderer={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){function c(a){return 0===(a&a-1)}var b=function(){function a(a){this._gl=a;this._textureMap={}}a.prototype.getTexture=function(a){return this._textureMap[a]};a.prototype.generateTexture=function(a,b){var h,r;h=this._gl;var n=b||h.createTexture();h.bindTexture(h.TEXTURE_2D,n);h.pixelStorei(h.UNPACK_PREMULTIPLY_ALPHA_WEBGL,1);h.texParameteri(h.TEXTURE_2D,h.TEXTURE_MAG_FILTER,h.LINEAR);h.texParameteri(h.TEXTURE_2D,h.TEXTURE_MIN_FILTER,h.LINEAR);c(a.width)&&c(a.height)?(h.texParameteri(h.TEXTURE_2D,
h.TEXTURE_WRAP_S,h.REPEAT),h.texParameteri(h.TEXTURE_2D,h.TEXTURE_WRAP_T,h.REPEAT)):(h.texParameteri(h.TEXTURE_2D,h.TEXTURE_WRAP_S,h.CLAMP_TO_EDGE),h.texParameteri(h.TEXTURE_2D,h.TEXTURE_WRAP_T,h.CLAMP_TO_EDGE));switch(a.textureFormat){case 0:case 1:h.texImage2D(h.TEXTURE_2D,0,h.RGBA,h.RGBA,h.UNSIGNED_BYTE,a.source);break;case 2:switch(a.pixelFormat){case 5:r=d.WebGLExtension.getExtension(h,d.WebGLExtension.PVRTC);r=r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG;break;case 4:r=d.WebGLExtension.getExtension(h,
d.WebGLExtension.PVRTC);r=r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;break;default:throw Error("Unsupported pixel format: "+a.pixelFormat);}h.compressedTexImage2D(h.TEXTURE_2D,0,r,a.width,a.height,0,a.source);break;default:throw Error("Unsupported texture format: "+a.textureFormat);}h=new d.Texture(n,a);return this._textureMap[n]=h};a.prototype.updateTexture=function(a){this.generateTexture(a.descriptor,a.id)};a.prototype.deleteTexture=function(a){this._gl.deleteTexture(a.id);delete this._textureMap[a.id]};
...
function(a,b){this._renderOffset=a;this._renderCount=b};a.prototype.setVertices=function(a,b,c,d,g,s,k,m,l){void 0===l&&(l=0);var p=this._type.strade;l=this._type.size*l+this._type.vertexIndex;this._storage[0+l]=a;this._storage[1+l]=b;this._storage[0+l+1*p]=c;this._storage[1+l+1*p]=d;this._storage[0+l+2*p]=g;this._storage[1+l+2*p]=s;this._storage[0+l+3*p]=k;this._storage[1+l+3*p]=m};a.prototype.setTexCoords=function(a,b,c,d,g,s,k,m,l){void 0===l&&(l=0);var p=this._type.strade;l=this._type.size*l+
this._type.texCoordIndex;this._storage[0+l]=a;this._storage[1+l]=b;this._storage[0+l+1*p]=c;this._storage[1+l+1*p]=d;this._storage[0+l+2*p]=g;this._storage[1+l+2*p]=s;this._storage[0+l+3*p]=k;this._storage[1+l+3*p]=m};a.prototype.setAlpha=function(a,b){void 0===b&&(b=0);var c=this._type.strade,d=this._type.size*b+this._type.alphaIndex;this._storage[d]=a;this._storage[d+1*c]=a;this._storage[d+2*c]=a;this._storage[d+3*c]=a};a.prototype.setColor=function(a,b){void 0===b&&(b=0);var c=this._type.strade,
...
this._updateQuadVerticesByArgs(b,e,c,this._gameObject.transform.worldMatrix,a);this._quadVertexDirty=!1};b.prototype._updateQuadVerticesByArgs=function(a,b,e,c,d){void 0===d&&(d=0);var g=c.values[0],m=c.values[1],l=c.values[3],p=c.values[4],u=c.values[6];c=c.values[7];var v=-e.x*b.width,t=v+b.width;e=-e.y*b.height;b=e+b.height;this._quad.setVertices(g*v+l*e+u,p*e+m*v+c,g*t+l*e+u,p*e+m*t+c,g*t+l*b+u,p*b+m*t+c,g*v+l*b+u,p*b+m*v+c,d);this._quad.setTexCoords(a.x0,a.y0,a.x1,a.y1,a.x2,a.y2,a.x3,a.y3,d)};
...
this._maskQuadRenderer=new d.component.QuadRenderer;this._maskQuadRenderer.setTexture(a);this._helperGameObject.addComponent(this._maskQuadRenderer);this._helperGameObject.init()};return a}(d.Mask);g.RectMask=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
...
a.prototype.generateCanvasTexture=function(a){this._glTexture?a.textureManager.updateTexture(this._glTexture):this._glTexture=a.textureManager.generateTexture(new d.assets.HTMLImageDescriptor(this._canvas));this.setTexture(this._glTexture)};return a}(g.QuadRenderer);g.CanvasRenderer=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(g){var c=function(){function b(){}b.array2rect=function(a){return new d.math.Rectangle(a[0],a[1],a[2],a[3])};return b}();g.PropertyConverter=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
...
width:b.width-g.right,height:b.height-g.bottom},pos:{x:k.right,y:k.bottom},size:{width:1,height:1}}],g=0;9>g;g++)if(k=b[g],0<k.frame.width&&0<k.frame.height){e=k.frame;var m=this._texture,l=m.descriptor.width,m=m.descriptor.height,p={};p.x0=e.x/l;p.y0=e.y/m;p.x1=(e.x+e.width)/l;p.y1=e.y/m;p.x2=(e.x+e.width)/l;p.y2=(e.y+e.height)/m;p.x3=e.x/l;p.y3=(e.y+e.height)/m;e=p;a.set(this.gameObject.transform);a.x+=k.pos.x;a.y+=k.pos.y;a.setScale(k.size.width,k.size.height);a.updateWorldMatrix();this._updateQuadVerticesByArgs(e,
...
success:function(c){b.data=c;a&&a()},error:function(c){b.err=c;a&&a()}}):a&&a()};a.prototype._newGameObjectTree=function(a){var b=this;this._newGameObject(this.data.root,function(c){b.root=c;a&&a()})};a.prototype._newGameObject=function(a,b){var c=this,g=new d.GameObject(a.rect);g.id=a.id;g.name=a.name;g.active=a.active;g.visible=a.visible;g.touchable=a.touchable;g.transform.set(a.transform);var n=a.components;n&&0<n.length&&n.forEach(function(a){g.addComponent(c._newComponent(a))});var s=0,k=a.children;
k&&0!==k.length?k.forEach(function(a){a.reference?c._newReferenceObject(a,function(a){a&&g.addChild(a);s++;s===k.length&&b(g)}):c._newGameObject(a,function(a){g.addChild(a);s++;s===k.length&&b(g)})}):b(g)};a.prototype._newReferenceObject=function(b,c){var d=this;(new a).instantiateWithSrc(b.reference).build(function(a,g){a?d.err=a:g&&(g.name=b.name,g.id=b.id,g.active=b.active,g.visible=b.visible,g.touchable=b.touchable,g.transform.set(b.transform));c(g)})};a.prototype._newComponent=function(a){var b=
...
(function(d){(function(d){(function(c){c.rectIntersect=function(b,a){return b.x<a.x+a.width&&a.x<b.x+b.width&&b.y<a.y+a.height&&a.y<b.y+b.height};c.rectIntersect2=function(b,a,c,d,g,r,n,s){return b<=g+n&&g<=b+c&&a<=r+s&&r<=a+d}})(d.MathUtils||(d.MathUtils={}))})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
function(c){var e=this,g,s;d.Assert.isNotUndefined(this._stateConfig[c]);g=this._currentState;s=this._stateConfig[c][c]||a.getInstance();this._currentTransition&&this._currentTransition.cancel();s.reset();s.execute(g,c,function(){e._currentTransition=null;e._currentState=c;e.dispatchEvent(new d.event.Event(f.CHANGE,!1,new b(e._currentState)))});this._currentTransition=s};f.INIT="state.init";f.CHANGE="state.change";return f}(d.event.EventDispatcher);g.StateMachine=c;var b=function(){return function(a){this.state=
