...
on:function(a,e,b,g){e=e.split(" ");t.each(e,function(e){t.on(a,e,b);g&&g(e)})},off:function(a,e,b,g){e=e.split(" ");t.each(e,function(e){t.off(a,e,b);g&&g(e)})},onTouch:function(e,g,h){var d=this,c=function(a){var c=a.type.toLowerCase(),s=b.HAS_POINTEREVENTS,c=t.inStr(c,"mouse"),k;c&&d.preventMouseEvents||(c&&g==n&&0===a.button?(d.preventMouseEvents=!1,d.shouldDetect=!0):s&&g==n?d.shouldDetect=1===a.buttons||x.matchType(p,a):c||g!=n||(d.preventMouseEvents=!0,d.shouldDetect=!0),s&&g!=q&&x.updatePointer(g,
a),d.shouldDetect&&(k=d.doDetect.call(d,a,g,e,h)),k==q&&(d.preventMouseEvents=!1,d.shouldDetect=!1,x.reset()),s&&g==q&&x.updatePointer(g,a))};this.on(e,a[g],c);return c},doDetect:function(a,e,b,g){var h=this.getTouchList(a,e),d=e,c=h.trigger,s=h.length;e==n?c=v:e==q&&(c=u,s=h.length-(a.changedTouches?a.changedTouches.length:1));0<s&&this.started&&(d=m);this.started=!0;a=this.collectEventData(b,d,h,a);e!=q&&g.call(w,a);c&&(a.changedLength=s,a.eventType=c,g.call(w,a),a.eventType=d,delete a.changedLength);
d==q&&(g.call(w,a),this.started=!1);return d},determineEventTypes:function(){var e;e=b.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:b.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];a[n]=e[0];a[m]=e[1];a[q]=e[2];return a},getTouchList:function(a,e){if(b.HAS_POINTEREVENTS)return x.getTouchList();
...
(function(a){var d=!1;b.gestures.Drag={name:a,index:50,handler:function(b,c){var k=w.current;if(!(0<c.options.dragMaxTouches&&b.touches.length>c.options.dragMaxTouches))switch(b.eventType){case n:d=!1;break;case m:if(b.distance<c.options.dragMinDistance&&k.name!=a)break;var p=k.startEvent.center;if(k.name!=a&&(k.name=a,c.options.dragDistanceCorrection&&0<b.distance)){var f=Math.abs(c.options.dragMinDistance/b.distance);p.pageX+=b.deltaX*f;p.pageY+=b.deltaY*f;p.clientX+=b.deltaX*f;p.clientY+=b.deltaY*
f;b=w.extendEventData(b)}if(k.lastEvent.dragLockToAxis||c.options.dragLockToAxis&&c.options.dragLockMinDistance<=b.distance)b.dragLockToAxis=!0;k=k.lastEvent.direction;b.dragLockToAxis&&k!==b.direction&&(t.isVertical(k)?b.direction=0>b.deltaY?h:e:b.direction=0>b.deltaX?g:s);d||(c.trigger(a+"start",b),d=!0);c.trigger(a,b);c.trigger(a+b.direction,b);k=t.isVertical(b.direction);(c.options.dragBlockVertical&&k||c.options.dragBlockHorizontal&&!k)&&b.preventDefault();break;case u:d&&b.changedLength<=c.options.dragMaxTouches&&
(c.trigger(a+"end",b),d=!1);break;case q:d=!1}},defaults:{dragMinDistance:10,dragDistanceCorrection:!0,dragMaxTouches:1,dragBlockHorizontal:!1,dragBlockVertical:!1,dragLockToAxis:!1,dragLockMinDistance:25}}})("drag");b.gestures.Gesture={name:"gesture",index:1337,handler:function(a,e){e.trigger(this.name,a)}};(function(a){var e;b.gestures.Hold={name:a,index:10,defaults:{holdTimeout:500,holdThreshold:2},handler:function(b,g){var h=g.options,d=w.current;switch(b.eventType){case n:clearTimeout(e);d.name=
...
b>g.swipeMaxTouches||!(a.velocityX>g.swipeVelocityX||a.velocityY>g.swipeVelocityY)||(e.trigger(this.name,a),e.trigger(this.name+a.direction,a))}}};(function(a){var e=!1;b.gestures.Tap={name:a,index:100,handler:function(b,g){var h=g.options,d=w.current,c=w.previous,s,k;switch(b.eventType){case n:e=!1;break;case m:e=e||b.distance>h.tapMaxDistance;break;case q:!t.inStr(b.srcEvent.type,"cancel")&&b.deltaTime<h.tapMaxTime&&!e&&(s=c&&c.lastEvent&&b.timeStamp-c.lastEvent.timeStamp,k=!1,c&&c.name==a&&s&&
...
null}};c.prototype.gotoAndPlay=function(b,a,e,g,h,s,k,p,f){void 0===a&&(a=-1);void 0===e&&(e=-1);void 0===g&&(g=NaN);void 0===h&&(h=0);void 0===s&&(s=null);void 0===k&&(k=c.SAME_LAYER_AND_GROUP);void 0===p&&(p=!0);void 0===f&&(f=!0);if(!this._animationDataList)return null;for(var n=this._animationDataList.length,m;n--;)if(this._animationDataList[n].name==b){m=this._animationDataList[n];break}if(!m)return null;this._isFading=this._isPlaying=!0;a=0>a?0>m.fadeTime?.3:m.fadeTime:a;e=0>e?0>m.scale?1:m.scale:
...
a.__dragonBonesData.getArmatureDataByName(m.name),b,e);c[l]=m;break;default:c[l]=this._generateDisplay(b,m.name,m.pivot.x,m.pivot.y)}}for(var q in c)if(k=c[q],k instanceof d.Armature&&(k=k.display),k.hasOwnProperty("name"))try{k.name=f.name}catch(u){}f.displayList=c;f._changeDisplay(0)}};b.prototype._generateArmature=function(){return null};b.prototype._generateSlot=function(){return null};b.prototype._generateDisplay=function(a,e,b,h){return null};b._helpMatrix=new d.Matrix;return b}(d.EventDispatcher);
...
(function(d){var f=function(){function c(){}c.parseTextureAtlasData=function(b,a){void 0===a&&(a=1);var e={},g,h=b[d.ConstValues.SUB_TEXTURE],s;for(s in h){var k=h[s],f=k[d.ConstValues.A_NAME],l=new d.Rectangle;l.x=c.getNumber(k,d.ConstValues.A_X,0)/a;l.y=c.getNumber(k,d.ConstValues.A_Y,0)/a;l.width=c.getNumber(k,d.ConstValues.A_WIDTH,0)/a;l.height=c.getNumber(k,d.ConstValues.A_HEIGHT,0)/a;var n="true"==k[d.ConstValues.A_ROTATED],m=c.getNumber(k,d.ConstValues.A_FRAME_WIDTH,0)/a,q=c.getNumber(k,d.ConstValues.A_FRAME_HEIGHT,
0)/a;0<m&&0<q?(g=new d.Rectangle,g.x=c.getNumber(k,d.ConstValues.A_FRAME_X,0)/a,g.y=c.getNumber(k,d.ConstValues.A_FRAME_Y,0)/a,g.width=m,g.height=q):g=null;e[f]=new d.TextureData(l,g,n)}return e};c.parseDragonBonesData=function(b){if(!b)throw Error();var a=b[d.ConstValues.A_VERSION],a=a.toString();if(a.toString()!=d.DragonBones.DATA_VERSION&&a.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var a=c.getNumber(b,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
...
e=a.boneDataList;var h;g&&(h=g.slotDataList);for(g=0;g<e.length;g++){var s=e[g],k=b.getTimeline(s.name);if(k){var f=null;if(h)for(var l in h)if(f=h[l],f.parent==s.name)break;for(var n=k.frameList,m=null,q=null,u=null,v=n.length,t=0;t<v;t++){var r=n[t];c.setFrameTransform(b,a,s,r);r.transform.x-=s.transform.x;r.transform.y-=s.transform.y;r.transform.skewX-=s.transform.skewX;r.transform.skewY-=s.transform.skewY;r.transform.scaleX/=s.transform.scaleX;r.transform.scaleY/=s.transform.scaleY;!k.transformed&&
f&&(r.zOrder-=f.zOrder);m||(m=k.originTransform,m.copy(r.transform),m.skewX=d.TransformUtil.formatRadian(m.skewX),m.skewY=d.TransformUtil.formatRadian(m.skewY),q=k.originPivot,q.x=r.pivot.x,q.y=r.pivot.y);r.transform.x-=m.x;r.transform.y-=m.y;r.transform.skewX=d.TransformUtil.formatRadian(r.transform.skewX-m.skewX);r.transform.skewY=d.TransformUtil.formatRadian(r.transform.skewY-m.skewY);r.transform.scaleX/=m.scaleX;r.transform.scaleY/=m.scaleY;k.transformed||(r.pivot.x-=q.x,r.pivot.y-=q.y);if(u){var x=
...
if(!this._loadingAssets)if(c=this._components.length+this._children.length,0===c)a&&a();else{b=0;for(e=this._components.length;b<e;b++)d=this._components[b],d.loadAssets(function(){0===--c&&a&&a()});b=0;for(e=this._children.length;b<e;b++)this._children[b].loadAssets(function(){0===--c&&a&&a()})}};b.prototype.query=function(a,c){var f,k,p,l,n;f=-1!==a.indexOf("[")&&-1!==a.indexOf("]");(p=-1!==a.indexOf(":"))&&f?(f=b.QUERY_FULL_REGEX.exec(a),k=f[1],p=f[2],l=f[3],n=f[4]):p&&!f?(f=b.QUERY_COMP_REGEX.exec(a),
k=f[1],p=f[2],l=f[3]):!p&&f?(f=b.QUERY_OBJ_ATTR_REGEX.exec(a),p=f[1],n=f[2]):p=a;c&&(c.compExpr=k,c.objExpr=p,c.compName=l,c.attrName=n);if(p){f=this;k=p.split("/");p=0;for(var m=k.length;p<m&&k[p]&&(f=f.getChild(k[p]),f);p++);}else f=this;f&&l&&(f=f.getComponent(d.Component.getType(l)));f&&c&&(c.target=f);f&&n&&(f=f[n]);return f};b.prototype.checkComponentDependency=function(a,b){void 0===b&&(b=!1);var e,c=a.listRequiredComponents();if(c&&0!==c.length)for(var f=0,l=c.length;f<l;f++)if(e=c[f],!this.hasComponent(e)){if(b)throw Error("Can NOT remove: Component["+
...
a.prototype.onGestureEvent=function(a){var b,c,f,k,p,l,n,m,q=a.type,u=d.Director.getInstance().stage,v=this.touchScale||1;if(n=a.gesture.srcEvent.changedTouches)for(k=n.length,f=0;f<k;f++)c=n[f],p=parseInt(c.identifier),b=c.pageX-this.canvasOffset.x,c=c.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===q&&(m=u.getUnderPoint(b,c,!0))&&(this.channelMap[p]=this.createDispatchChanel(m),delete this.channelMap[p-10]),(l=this.channelMap[p])&&l.onGestureEvent(a,m,b,c,p);else p=1,b=a.gesture.srcEvent.pageX-this.canvasOffset.x,
c=a.gesture.srcEvent.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===q&&((m=u.getUnderPoint(b,c,!0))?this.channelMap[p]=this.createDispatchChanel(m):delete this.channelMap[p]),(l=this.channelMap[p])&&l.onGestureEvent(a,m,b,c,p)};a.prototype.createDispatchChanel=function(a){var b=!0;return{onGestureEvent:function(h,f,k,p,l){var n=h.type,m=d.Director.getInstance().stage;switch(n){case "drag":if(!b){f=a;break}case "tap":case "release":f=m.getUnderPoint(k,p,!0)}if("tap"!==n||a===f)h=new c({x:k,y:p,type:n,
...
(function(d){(function(d){var c=function(){function b(){}b.getGLContext=function(a,b){var c,d=b||{},f={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},k;for(k in f)"undefined"===typeof d[k]&&(d[k]=f[k]);b=d;try{c=a.getContext("experimental-webgl",b)}catch(p){try{c=a.getContext("webgl",b)}catch(l){}}return c};b.compileShader=function(a,b,c){b=a.createShader(b);a.shaderSource(b,c);a.compileShader(b);return a.getShaderParameter(b,a.COMPILE_STATUS)?b:(console.log(a.getShaderInfoLog(b)),null)};
...
function(a,b){this._renderOffset=a;this._renderCount=b};a.prototype.setVertices=function(a,b,c,d,f,p,l,n,m){void 0===m&&(m=0);var q=this._type.strade;m=this._type.size*m+this._type.vertexIndex;this._storage[0+m]=a;this._storage[1+m]=b;this._storage[0+m+1*q]=c;this._storage[1+m+1*q]=d;this._storage[0+m+2*q]=f;this._storage[1+m+2*q]=p;this._storage[0+m+3*q]=l;this._storage[1+m+3*q]=n};a.prototype.setTexCoords=function(a,b,c,d,f,p,l,n,m){void 0===m&&(m=0);var q=this._type.strade;m=this._type.size*m+
this._type.texCoordIndex;this._storage[0+m]=a;this._storage[1+m]=b;this._storage[0+m+1*q]=c;this._storage[1+m+1*q]=d;this._storage[0+m+2*q]=f;this._storage[1+m+2*q]=p;this._storage[0+m+3*q]=l;this._storage[1+m+3*q]=n};a.prototype.setAlpha=function(a,b){void 0===b&&(b=0);var c=this._type.strade,d=this._type.size*b+this._type.alphaIndex;this._storage[d]=a;this._storage[d+1*c]=a;this._storage[d+2*c]=a;this._storage[d+3*c]=a};a.prototype.setColor=function(a,b){void 0===b&&(b=0);var c=this._type.strade,
...
y:b.y+f.bottom,width:b.width-f.right,height:b.height-f.bottom},pos:{x:l.right,y:l.bottom},size:{width:1,height:1}}],f=0;9>f;f++)if(l=b[f],0<l.frame.width&&0<l.frame.height){e=l.frame;var n=this._texture,m=n.descriptor.width,n=n.descriptor.height,q={};q.x0=e.x/m;q.y0=e.y/n;q.x1=(e.x+e.width)/m;q.y1=e.y/n;q.x2=(e.x+e.width)/m;q.y2=(e.y+e.height)/n;q.x3=e.x/m;q.y3=(e.y+e.height)/n;e=q;a.set(this.gameObject.transform);a.x+=l.pos.x;a.y+=l.pos.y;a.setScale(l.size.width,l.size.height);a.updateWorldMatrix();
...
(function(d){(function(f){var c=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.init=function(){b.prototype.init.call(this);this.gameObject.addListenerScope("childadd",this.onChildAdd,this);this.gameObject.addListenerScope("childremove",this.onChildRemove,this);this.requestLayout()};a.prototype.destroy=function(){this.gameObject.removeListenerScope("childadd",this.onChildAdd,this);this.gameObject.removeListenerScope("childremove",this.onChildRemove,this);b.prototype.destroy.call(this)};
a.prototype.doLayout=function(){};a.prototype.requestLayout=function(){var a=this;this._layoutSchedule||(this._layoutSchedule=d.Director.getInstance().scheduler.scheduleFrame(function(){a.doLayout();a._layoutSchedule=null}))};a.prototype.cancelLayout=function(){this._layoutSchedule&&d.Director.getInstance().scheduler.removeSchedule(this._layoutSchedule);this._layoutSchedule=null};a.prototype.onChildAdd=function(a){this.requestLayout()};a.prototype.onChildRemove=function(a){alert("remove");this.requestLayout()};
return a}(d.Component);f.LayoutBase=c})(d.layout||(d.layout={}))})(WOZLLA||(WOZLLA={}));(function(d){(function(d){var c=function(){function b(a,b){this.width=a;this.height=b}b.prototype.toString=function(){return"Size["+this.width+","+this.height+"]"};return b}();d.Size=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
this._itemMargin.equals(a)||(this._itemMargin=a,this.requestLayout())},enumerable:!0,configurable:!0});b.prototype.doLayout=function(){for(var a=this._padding,b=this._itemMargin,e=this.gameObject.rawChildren,d=0,f=0,l=0,n=a.left,m=a.top,q,u=this.gameObject.rectTransform,v=0,t=e.length;v<t;v++)q=e[v],this.measureChildSize(q,v,c),n+=b.left,m+=b.top,n+c.width+b.right+a.right>u.width&&(f++,d=0,m+=b.bottom,m+=c.height,n=a.left+b.left),q.rectTransform?(q.rectTransform.px=n,q.rectTransform.py=m):(q.transform.x=
n,q.transform.y=m),c.height>l&&(l=c.height),n+=b.right+c.width,d++};b.prototype.measureChildSize=function(a,b,e){(a=a.rectTransform)?(e.width=a.width,e.height=a.height):e.height=e.width=0};return b}(f.LayoutBase);f.Grid=b;d.Component.register(b,{name:"Grid",properties:[{name:"padding",type:"Padding",convert:d.component.PropertyConverter.array2Padding,defaultValue:[0,0,0,0]},{name:"itemMargin",type:"Margin",convert:d.component.PropertyConverter.array2Margin,defaultValue:[0,0,0,0]}]})})(d.layout||(d.layout=
