(function(d,f){function c(){b.READY||(s.determineEventTypes(),t.each(b.gestures,function(a){w.register(a)}),s.onTouch(b.DOCUMENT,m,w.detect),s.onTouch(b.DOCUMENT,p,w.detect),b.READY=!0)}var b=function y(a,e){return new y.Instance(a,e||{})};b.VERSION="1.1.3";b.defaults={behavior:{userSelect:"none",touchAction:"pan-y",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};b.DOCUMENT=document;b.HAS_POINTEREVENTS=navigator.pointerEnabled||navigator.msPointerEnabled;
b.HAS_TOUCHEVENTS="ontouchstart"in d;b.IS_MOBILE=/mobile|tablet|ip(ad|hone|od)|android|silk/i.test(navigator.userAgent);b.NO_MOUSEEVENTS=b.HAS_TOUCHEVENTS&&b.IS_MOBILE||b.HAS_POINTEREVENTS;b.CALCULATE_INTERVAL=25;var a={},e=b.DIRECTION_DOWN="down",g=b.DIRECTION_LEFT="left",h=b.DIRECTION_UP="up",r=b.DIRECTION_RIGHT="right",k=b.POINTER_MOUSE="mouse",q=b.POINTER_TOUCH="touch",l=b.POINTER_PEN="pen",n=b.EVENT_START="start",m=b.EVENT_MOVE="move",p=b.EVENT_END="end",u=b.EVENT_RELEASE="release",v=b.EVENT_TOUCH=
...
a.indexOf(e)},inArray:function(a,e){if(a.indexOf){var b=a.indexOf(e);return-1===b?!1:b}for(var b=0,g=a.length;b<g;b++)if(a[b]===e)return b;return!1},toArray:function(a){return Array.prototype.slice.call(a,0)},hasParent:function(a,e){for(;a;){if(a==e)return!0;a=a.parentNode}return!1},getCenter:function(a){var e=[],b=[],g=[],h=[],d=Math.min,c=Math.max;if(1===a.length)return{pageX:a[0].pageX,pageY:a[0].pageY,clientX:a[0].clientX,clientY:a[0].clientY};t.each(a,function(a){e.push(a.pageX);b.push(a.pageY);
g.push(a.clientX);h.push(a.clientY)});return{pageX:(d.apply(Math,e)+c.apply(Math,e))/2,pageY:(d.apply(Math,b)+c.apply(Math,b))/2,clientX:(d.apply(Math,g)+c.apply(Math,g))/2,clientY:(d.apply(Math,h)+c.apply(Math,h))/2}},getVelocity:function(a,e,b){return{x:Math.abs(e/a)||0,y:Math.abs(b/a)||0}},getAngle:function(a,e){return 180*Math.atan2(e.clientY-a.clientY,e.clientX-a.clientX)/Math.PI},getDirection:function(a,b){var d=Math.abs(a.clientX-b.clientX),c=Math.abs(a.clientY-b.clientY);return d>=c?0<a.clientX-
b.clientX?g:r:0<a.clientY-b.clientY?h:e},getDistance:function(a,e){var b=e.clientX-a.clientX,g=e.clientY-a.clientY;return Math.sqrt(b*b+g*g)},getScale:function(a,e){return 2<=a.length&&2<=e.length?this.getDistance(e[0],e[1])/this.getDistance(a[0],a[1]):1},getRotation:function(a,e){return 2<=a.length&&2<=e.length?this.getAngle(e[1],e[0])-this.getAngle(a[1],a[0]):0},isVertical:function(a){return a==h||a==e},setPrefixedCss:function(a,e,b,g){var h=["","Webkit","Moz","O","ms"];e=t.toCamelCase(e);for(var d=
0;d<h.length;d++){var c=e;h[d]&&(c=h[d]+c.slice(0,1).toUpperCase()+c.slice(1));if(c in a.style){a.style[c]=(null==g||g)&&b||"";break}}},toggleBehavior:function(a,e,b){if(e&&a&&a.style){t.each(e,function(e,g){t.setPrefixedCss(a,g,e,b)});var g=b&&function(){return!1};"none"==e.userSelect&&(a.onselectstart=g);"none"==e.userDrag&&(a.ondragstart=g)}},toCamelCase:function(a){return a.replace(/[_-]([a-z])/g,function(a){return a[1].toUpperCase()})}},s=b.event={preventMouseEvents:!1,started:!1,shouldDetect:!1,
on:function(a,e,b,g){e=e.split(" ");t.each(e,function(e){t.on(a,e,b);g&&g(e)})},off:function(a,e,b,g){e=e.split(" ");t.each(e,function(e){t.off(a,e,b);g&&g(e)})},onTouch:function(e,g,h){var d=this,c=function(a){var c=a.type.toLowerCase(),r=b.HAS_POINTEREVENTS,c=t.inStr(c,"mouse"),k;c&&d.preventMouseEvents||(c&&g==n&&0===a.button?(d.preventMouseEvents=!1,d.shouldDetect=!0):r&&g==n?d.shouldDetect=1===a.buttons||x.matchType(q,a):c||g!=n||(d.preventMouseEvents=!0,d.shouldDetect=!0),r&&g!=p&&x.updatePointer(g,
a),d.shouldDetect&&(k=d.doDetect.call(d,a,g,e,h)),k==p&&(d.preventMouseEvents=!1,d.shouldDetect=!1,x.reset()),r&&g==p&&x.updatePointer(g,a))};this.on(e,a[g],c);return c},doDetect:function(a,e,b,g){var h=this.getTouchList(a,e),d=e,c=h.trigger,r=h.length;e==n?c=v:e==p&&(c=u,r=h.length-(a.changedTouches?a.changedTouches.length:1));0<r&&this.started&&(d=m);this.started=!0;a=this.collectEventData(b,d,h,a);e!=p&&g.call(w,a);c&&(a.changedLength=r,a.eventType=c,g.call(w,a),a.eventType=d,delete a.changedLength);
d==p&&(g.call(w,a),this.started=!1);return d},determineEventTypes:function(){var e;e=b.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:b.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];a[n]=e[0];a[m]=e[1];a[p]=e[2];return a},getTouchList:function(a,e){if(b.HAS_POINTEREVENTS)return x.getTouchList();
if(a.touches){if(e==m)return a.touches;var g=[],h=[].concat(t.toArray(a.touches),t.toArray(a.changedTouches)),d=[];t.each(h,function(a){!1===t.inArray(g,a.identifier)&&d.push(a);g.push(a.identifier)});return d}a.identifier=1;return[a]},collectEventData:function(a,e,b,g){a=q;t.inStr(g.type,"mouse")||x.matchType(k,g)?a=k:x.matchType(l,g)&&(a=l);return{center:t.getCenter(b),timeStamp:Date.now(),target:g.target,touches:b,eventType:e,pointerType:a,srcEvent:g,preventDefault:function(){var a=this.srcEvent;
...
g={};g[k]=b===(e.MSPOINTER_TYPE_MOUSE||k);g[q]=b===(e.MSPOINTER_TYPE_TOUCH||q);g[l]=b===(e.MSPOINTER_TYPE_PEN||l);return g[a]},reset:function(){this.pointers={}}},w=b.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(a,e){this.current||(this.stopped=!1,this.current={inst:a,startEvent:t.extend({},e),lastEvent:!1,lastCalcEvent:!1,futureCalcEvent:!1,lastCalcData:{},name:""},this.detect(e))},detect:function(a){if(this.current&&!this.stopped){a=this.extendEventData(a);var e=
this.current.inst,b=e.options;t.each(this.gestures,function(g){!this.stopped&&e.enabled&&b[g.name]&&g.handler.call(g,a,e)},this);this.current&&(this.current.lastEvent=a);a.eventType==p&&this.stopDetect();return a}},stopDetect:function(){this.previous=t.extend({},this.current);this.current=null;this.stopped=!0},getCalculatedData:function(a,e,g,h,d){var c=this.current,r=!1,k=c.lastCalcEvent,q=c.lastCalcData;k&&a.timeStamp-k.timeStamp>b.CALCULATE_INTERVAL&&(e=k.center,g=a.timeStamp-k.timeStamp,h=a.center.clientX-
k.center.clientX,d=a.center.clientY-k.center.clientY,r=!0);if(a.eventType==v||a.eventType==u)c.futureCalcEvent=a;if(!c.lastCalcEvent||r)q.velocity=t.getVelocity(g,h,d),q.angle=t.getAngle(e,a.center),q.direction=t.getDirection(e,a.center),c.lastCalcEvent=c.futureCalcEvent||a,c.futureCalcEvent=a;a.velocityX=q.velocity.x;a.velocityY=q.velocity.y;a.interimAngle=q.angle;a.interimDirection=q.direction},extendEventData:function(a){var e=this.current,b=e.startEvent,e=e.lastEvent||b;if(a.eventType==v||a.eventType==
u)b.touches=[],t.each(a.touches,function(a){b.touches.push({clientX:a.clientX,clientY:a.clientY})});var g=a.timeStamp-b.timeStamp,h=a.center.clientX-b.center.clientX,d=a.center.clientY-b.center.clientY;this.getCalculatedData(a,e.center,g,h,d);t.extend(a,{startEvent:b,deltaTime:g,deltaX:h,deltaY:d,distance:t.getDistance(b.center,a.center),angle:t.getAngle(b.center,a.center),direction:t.getDirection(b.center,a.center),scale:t.getScale(b.touches,a.touches),rotation:t.getRotation(b.touches,a.touches)});
...
!0);this.eventStartHandler=s.onTouch(a,n,function(a){g.enabled&&a.eventType==n?w.startDetect(g,a):a.eventType==v&&w.detect(a)});this.eventHandlers=[]};b.Instance.prototype={on:function(a,e){var b=this;s.on(b.element,a,e,function(a){b.eventHandlers.push({gesture:a,handler:e})});return b},off:function(a,e){var b=this;s.off(b.element,a,e,function(a){a=t.inArray({gesture:a,handler:e});!1!==a&&b.eventHandlers.splice(a,1)});return b},trigger:function(a,e){e||(e={});var g=b.DOCUMENT.createEvent("Event");
g.initEvent(a,!0,!0);g.gesture=e;var h=this.element;t.hasParent(e.target,h)&&(h=e.target);navigator.isCocoonJS?this.eventHandlers.forEach(function(e){a===e.gesture&&e.handler(g)}):h.dispatchEvent(g);return this},enable:function(a){this.enabled=a;return this},dispose:function(){var e,b;t.toggleBehavior(this.element,this.options.behavior,!1);for(e=-1;b=this.eventHandlers[++e];)t.off(this.element,b.gesture,b.handler);this.eventHandlers=[];s.off(this.element,a[n],this.eventStartHandler);return null}};
(function(a){var d=!1;b.gestures.Drag={name:a,index:50,handler:function(b,c){var k=w.current;if(!(0<c.options.dragMaxTouches&&b.touches.length>c.options.dragMaxTouches))switch(b.eventType){case n:d=!1;break;case m:if(b.distance<c.options.dragMinDistance&&k.name!=a)break;var q=k.startEvent.center;if(k.name!=a&&(k.name=a,c.options.dragDistanceCorrection&&0<b.distance)){var f=Math.abs(c.options.dragMinDistance/b.distance);q.pageX+=b.deltaX*f;q.pageY+=b.deltaY*f;q.clientX+=b.deltaX*f;q.clientY+=b.deltaY*
f;b=w.extendEventData(b)}if(k.lastEvent.dragLockToAxis||c.options.dragLockToAxis&&c.options.dragLockMinDistance<=b.distance)b.dragLockToAxis=!0;k=k.lastEvent.direction;b.dragLockToAxis&&k!==b.direction&&(t.isVertical(k)?b.direction=0>b.deltaY?h:e:b.direction=0>b.deltaX?g:r);d||(c.trigger(a+"start",b),d=!0);c.trigger(a,b);c.trigger(a+b.direction,b);k=t.isVertical(b.direction);(c.options.dragBlockVertical&&k||c.options.dragBlockHorizontal&&!k)&&b.preventDefault();break;case u:d&&b.changedLength<=c.options.dragMaxTouches&&
(c.trigger(a+"end",b),d=!1);break;case p:d=!1}},defaults:{dragMinDistance:10,dragDistanceCorrection:!0,dragMaxTouches:1,dragBlockHorizontal:!1,dragBlockVertical:!1,dragLockToAxis:!1,dragLockMinDistance:25}}})("drag");b.gestures.Gesture={name:"gesture",index:1337,handler:function(a,e){e.trigger(this.name,a)}};(function(a){var e;b.gestures.Hold={name:a,index:10,defaults:{holdTimeout:500,holdThreshold:2},handler:function(b,g){var h=g.options,d=w.current;switch(b.eventType){case n:clearTimeout(e);d.name=
a;e=setTimeout(function(){d&&d.name==a&&g.trigger(a,b)},h.holdTimeout);break;case m:b.distance>h.holdThreshold&&clearTimeout(e);break;case u:clearTimeout(e)}}}})("hold");b.gestures.Release={name:"release",index:Infinity,handler:function(a,e){a.eventType==u&&e.trigger(this.name,a)}};b.gestures.Swipe={name:"swipe",index:40,defaults:{swipeMinTouches:1,swipeMaxTouches:1,swipeVelocityX:.6,swipeVelocityY:.6},handler:function(a,e){if(a.eventType==u){var b=a.touches.length,g=e.options;b<g.swipeMinTouches||
b>g.swipeMaxTouches||!(a.velocityX>g.swipeVelocityX||a.velocityY>g.swipeVelocityY)||(e.trigger(this.name,a),e.trigger(this.name+a.direction,a))}}};(function(a){var e=!1;b.gestures.Tap={name:a,index:100,handler:function(b,g){var h=g.options,d=w.current,c=w.previous,r,k;switch(b.eventType){case n:e=!1;break;case m:e=e||b.distance>h.tapMaxDistance;break;case p:!t.inStr(b.srcEvent.type,"cancel")&&b.deltaTime<h.tapMaxTime&&!e&&(r=c&&c.lastEvent&&b.timeStamp-c.lastEvent.timeStamp,k=!1,c&&c.name==a&&r&&
r<h.doubleTapInterval&&b.distance<h.doubleTapDistance&&(g.trigger("doubletap",b),k=!0),!k||h.tapAlways)&&(d.name=a,g.trigger(d.name,b))}},defaults:{tapMaxTime:250,tapMaxDistance:10,tapAlways:!0,doubleTapDistance:20,doubleTapInterval:300}}})("tap");b.gestures.Touch={name:"touch",index:-Infinity,defaults:{preventDefault:!1,preventMouse:!1},handler:function(a,e){e.options.preventMouse&&a.pointerType==k?a.stopDetect():(e.options.preventDefault&&a.preventDefault(),a.eventType==v&&e.trigger("touch",a))}};
(function(a){var e=!1;b.gestures.Transform={name:a,index:45,defaults:{transformMinScale:.01,transformMinRotation:1},handler:function(b,g){switch(b.eventType){case n:e=!1;break;case m:if(2>b.touches.length)break;var h=Math.abs(1-b.scale),d=Math.abs(b.rotation);if(h<g.options.transformMinScale&&d<g.options.transformMinRotation)break;w.current.name=a;e||(g.trigger(a+"start",b),e=!0);g.trigger(a,b);d>g.options.transformMinRotation&&g.trigger("rotate",b);h>g.options.transformMinScale&&(g.trigger("pinch",
...
null}};c.prototype.gotoAndPlay=function(b,a,e,g,h,r,k,q,f){void 0===a&&(a=-1);void 0===e&&(e=-1);void 0===g&&(g=NaN);void 0===h&&(h=0);void 0===r&&(r=null);void 0===k&&(k=c.SAME_LAYER_AND_GROUP);void 0===q&&(q=!0);void 0===f&&(f=!0);if(!this._animationDataList)return null;for(var n=this._animationDataList.length,m;n--;)if(this._animationDataList[n].name==b){m=this._animationDataList[n];break}if(!m)return null;this._isFading=this._isPlaying=!0;a=0>a?0>m.fadeTime?.3:m.fadeTime:a;e=0>e?0>m.scale?1:m.scale:
1E3*e/m.duration;g=isNaN(g)?m.playTimes:g;switch(k){case c.NONE:break;case c.SAME_LAYER:for(n=this._animationStateList.length;n--;)k=this._animationStateList[n],k.layer==h&&k.fadeOut(a,q);break;case c.SAME_GROUP:for(n=this._animationStateList.length;n--;)k=this._animationStateList[n],k.group==r&&k.fadeOut(a,q);break;case c.ALL:for(n=this._animationStateList.length;n--;)k=this._animationStateList[n],k.fadeOut(a,q);break;default:for(n=this._animationStateList.length;n--;)k=this._animationStateList[n],
k.layer==h&&k.group==r&&k.fadeOut(a,q)}this._lastAnimationState=d.AnimationState._borrowObject();this._lastAnimationState._layer=h;this._lastAnimationState._group=r;this._lastAnimationState.autoTween=this.tweenEnabled;this._lastAnimationState._fadeIn(this._armature,m,a,1/e,g,f);this.addState(this._lastAnimationState);g=this._armature.getSlots(!1);for(n=g.length;n--;)h=g[n],h.childArmature&&h.childArmature.animation.gotoAndPlay(b,a);return this._lastAnimationState};c.prototype.gotoAndStop=function(b,
a,e,g,h,d,k,q){void 0===e&&(e=-1);void 0===g&&(g=0);void 0===h&&(h=-1);void 0===d&&(d=0);void 0===k&&(k=null);void 0===q&&(q=c.ALL);var f=this.getState(b,d);f||(f=this.gotoAndPlay(b,g,h,NaN,d,k,q));0<=e?f.setCurrentTime(f.totalTime*e):f.setCurrentTime(a);f.stop();return f};c.prototype.play=function(){this._animationDataList&&0!=this._animationDataList.length&&(this._lastAnimationState?this._isPlaying?this.gotoAndPlay(this._lastAnimationState.name):this._isPlaying=!0:this.gotoAndPlay(this._animationDataList[0].name))};
...
h?(c=h,g=!0):c<=-h?(c=-h,g=!0):g=!1,0>c&&(c+=h),h=Math.ceil(c/this._totalTime)||1,c=0<=c?c-Math.floor(c/this._totalTime)*this._totalTime:c-Math.ceil(c/this._totalTime)*this._totalTime,g&&(c=this._totalTime));this._isComplete=g;var k=1E3*this._time/this._totalTime,q;for(q in this._timelineStateList){var f=this._timelineStateList[q];f._update(k);this._isComplete=f._isComplete&&this._isComplete}this._currentTime!=c&&(this._currentPlayTimes!=h&&(0<this._currentPlayTimes&&1<h&&(e=!0),this._currentPlayTimes=
h),0>this._currentTime&&(a=!0),this._isComplete&&(b=!0),this._currentTime=c,this.updateMainTimeline(g));a&&this._armature.hasEventListener(d.AnimationEvent.START)&&(q=new d.AnimationEvent(d.AnimationEvent.START),q.animationState=this,this._armature._eventList.push(q));b?(this._armature.hasEventListener(d.AnimationEvent.COMPLETE)&&(q=new d.AnimationEvent(d.AnimationEvent.COMPLETE),q.animationState=this,this._armature._eventList.push(q)),this.autoFadeOut&&this.fadeOut(this.fadeOutTime,!0)):e&&this._armature.hasEventListener(d.AnimationEvent.LOOP_COMPLETE)&&
...
function(){var a,e,b,h=this._timelineStateList.length;if(1==h)a=this._timelineStateList[0],b=a._animationState.weight*a._animationState.fadeWeight,a._weight=b,e=a._transform,a=a._pivot,this._tween.x=e.x*b,this._tween.y=e.y*b,this._tween.skewX=e.skewX*b,this._tween.skewY=e.skewY*b,this._tween.scaleX=1+(e.scaleX-1)*b,this._tween.scaleY=1+(e.scaleY-1)*b,this._tweenPivot.x=a.x*b,this._tweenPivot.y=a.y*b;else if(1<h){var c=0,d=0,q=0,f=0,n=0,m=0,p=0,u=0,v=1,t=0,s=this._timelineStateList[h-1]._animationState.layer;
for(e=0;h--;){a=this._timelineStateList[h];e=a._animationState.layer;if(s!=e)if(t>=v){a._weight=0;break}else v-=t;s=e;b=a._animationState.weight*a._animationState.fadeWeight*v;(a._weight=b)&&a._blendEnabled&&(e=a._transform,a=a._pivot,c+=e.x*b,d+=e.y*b,q+=e.skewX*b,f+=e.skewY*b,n+=(e.scaleX-1)*b,m+=(e.scaleY-1)*b,p+=a.x*b,u+=a.y*b,t+=b)}this._tween.x=c;this._tween.y=d;this._tween.skewX=q;this._tween.skewY=f;this._tween.scaleX=n;this._tween.scaleY=m;this._tweenPivot.x=p;this._tweenPivot.y=u}};b.prototype.sortState=
...
};b.prototype._updateDisplayColor=function(a,e,b,h,c,d,q,f){this._colorTransform.alphaOffset=a;this._colorTransform.redOffset=e;this._colorTransform.greenOffset=b;this._colorTransform.blueOffset=h;this._colorTransform.alphaMultiplier=c;this._colorTransform.redMultiplier=d;this._colorTransform.greenMultiplier=q;this._colorTransform.blueMultiplier=f};b.prototype._updateDisplayBlendMode=function(a){throw Error("Abstract method needs to be implemented in subclass!");};return b}(d.DBObject);d.Slot=f})(dragonBones||
...
null==a.armatureData.getBoneData(b)&&(b=null),a.addBone(h,b,!0);a._updateAnimationAfterBoneListChanged()};b.prototype._buildSlots=function(a,e,b){var h=a.armatureData.getSkinData(e);if(h)for(var c=[],h=h.slotDataList,k,f,l,n=0;n<h.length;n++)if(k=h[n],l=a.getBone(k.parent)){f=this._generateSlot();f.initWithSlotData(k);l.addSlot(f);for(l=k.displayDataList.length;l--;){var m=k.displayDataList[l];switch(m.type){case d.DisplayData.ARMATURE:m=this.buildArmatureUsingArmatureDataFromTextureAtlas(a.__dragonBonesData,
a.__dragonBonesData.getArmatureDataByName(m.name),b,e);c[l]=m;break;default:c[l]=this._generateDisplay(b,m.name,m.pivot.x,m.pivot.y)}}for(var p in c)if(k=c[p],k instanceof d.Armature&&(k=k.display),k.hasOwnProperty("name"))try{k.name=f.name}catch(u){}f.displayList=c;f._changeDisplay(0)}};b.prototype._generateArmature=function(){return null};b.prototype._generateSlot=function(){return null};b.prototype._generateDisplay=function(a,e,b,h){return null};b._helpMatrix=new d.Matrix;return b}(d.EventDispatcher);
...
(function(d){var f=function(){function c(){}c.parseTextureAtlasData=function(b,a){void 0===a&&(a=1);var e={},g,h=b[d.ConstValues.SUB_TEXTURE],r;for(r in h){var k=h[r],f=k[d.ConstValues.A_NAME],l=new d.Rectangle;l.x=c.getNumber(k,d.ConstValues.A_X,0)/a;l.y=c.getNumber(k,d.ConstValues.A_Y,0)/a;l.width=c.getNumber(k,d.ConstValues.A_WIDTH,0)/a;l.height=c.getNumber(k,d.ConstValues.A_HEIGHT,0)/a;var n="true"==k[d.ConstValues.A_ROTATED],m=c.getNumber(k,d.ConstValues.A_FRAME_WIDTH,0)/a,p=c.getNumber(k,d.ConstValues.A_FRAME_HEIGHT,
0)/a;0<m&&0<p?(g=new d.Rectangle,g.x=c.getNumber(k,d.ConstValues.A_FRAME_X,0)/a,g.y=c.getNumber(k,d.ConstValues.A_FRAME_Y,0)/a,g.width=m,g.height=p):g=null;e[f]=new d.TextureData(l,g,n)}return e};c.parseDragonBonesData=function(b){if(!b)throw Error();var a=b[d.ConstValues.A_VERSION],a=a.toString();if(a.toString()!=d.DragonBones.DATA_VERSION&&a.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var a=c.getNumber(b,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
...
e=a.boneDataList;var h;g&&(h=g.slotDataList);for(g=0;g<e.length;g++){var r=e[g],k=b.getTimeline(r.name);if(k){var f=null;if(h)for(var l in h)if(f=h[l],f.parent==r.name)break;for(var n=k.frameList,m=null,p=null,u=null,v=n.length,t=0;t<v;t++){var s=n[t];c.setFrameTransform(b,a,r,s);s.transform.x-=r.transform.x;s.transform.y-=r.transform.y;s.transform.skewX-=r.transform.skewX;s.transform.skewY-=r.transform.skewY;s.transform.scaleX/=r.transform.scaleX;s.transform.scaleY/=r.transform.scaleY;!k.transformed&&
f&&(s.zOrder-=f.zOrder);m||(m=k.originTransform,m.copy(s.transform),m.skewX=d.TransformUtil.formatRadian(m.skewX),m.skewY=d.TransformUtil.formatRadian(m.skewY),p=k.originPivot,p.x=s.pivot.x,p.y=s.pivot.y);s.transform.x-=m.x;s.transform.y-=m.y;s.transform.skewX=d.TransformUtil.formatRadian(s.transform.skewX-m.skewX);s.transform.skewY=d.TransformUtil.formatRadian(s.transform.skewY-m.skewY);s.transform.scaleX/=m.scaleX;s.transform.scaleY/=m.scaleY;k.transformed||(s.pivot.x-=p.x,s.pivot.y-=p.y);if(u){var x=
s.transform.skewX-u.transform.skewX;u.tweenRotate?0<u.tweenRotate?(0>x&&(s.transform.skewX+=2*Math.PI,s.transform.skewY+=2*Math.PI),1<u.tweenRotate&&(s.transform.skewX+=2*Math.PI*(u.tweenRotate-1),s.transform.skewY+=2*Math.PI*(u.tweenRotate-1))):(0<x&&(s.transform.skewX-=2*Math.PI,s.transform.skewY-=2*Math.PI),1>u.tweenRotate&&(s.transform.skewX+=2*Math.PI*(u.tweenRotate+1),s.transform.skewY+=2*Math.PI*(u.tweenRotate+1))):(s.transform.skewX=u.transform.skewX+d.TransformUtil.formatRadian(s.transform.skewX-
u.transform.skewX),s.transform.skewY=u.transform.skewY+d.TransformUtil.formatRadian(s.transform.skewY-u.transform.skewY))}u=s}k.transformed=!0}}}else c.transformRelativeAnimationData(b,a)};c.setFrameTransform=function(b,a,e,g){g.transform.copy(g.global);if(e=a.getBoneData(e.parent)){var h=b.getTimeline(e.name);if(h){for(var r=[],k=[];h;)r.push(h),k.push(e),h=(e=a.getBoneData(e.parent))?b.getTimeline(e.name):null;b=r.length;var f;a=new d.Matrix;for(var l=new d.DBTransform,n=new d.Matrix;b--;)h=r[b],
e=k[b],c.getTimelineTransform(h,g.position,l,!f),f?(l.x+=h.originTransform.x+e.transform.x,l.y+=h.originTransform.y+e.transform.y,l.skewX+=h.originTransform.skewX+e.transform.skewX,l.skewY+=h.originTransform.skewY+e.transform.skewY,l.scaleX=l.scaleX*h.originTransform.scaleX*e.transform.scaleX,l.scaleY=l.scaleY*h.originTransform.scaleY*e.transform.scaleY,d.TransformUtil.transformToMatrix(l,n,!0),n.concat(a),d.TransformUtil.matrixToTransform(n,f,0<=l.scaleX*f.scaleX,0<=l.scaleY*f.scaleY)):(f=new d.DBTransform,
f.copy(l)),d.TransformUtil.transformToMatrix(f,a,!0);d.TransformUtil.globalToLocal(g.transform,f)}}};c.getTimelineTransform=function(b,a,e,g){for(var h=b.frameList,c=h.length;c--;)if(b=h[c],b.position<=a&&b.position+b.duration>a){if(c==h.length-1||a==b.position)e.copy(g?b.global:b.transform);else{var k=b.tweenEasing;a=(a-b.position)/b.duration;k&&10!=k&&(a=d.MathUtil.getEaseValue(a,k));h=h[c+1];b=g?b.global:b.transform;g=g?h.global:h.transform;e.x=b.x+(g.x-b.x)*a;e.y=b.y+(g.y-b.y)*a;e.skewX=d.TransformUtil.formatRadian(b.skewX+
...
(function(d){(function(f){var c=function(b){function a(a,g){void 0===g&&(g="");b.call(this);this._refCount=0;this._src=a;this._baseDir=g}__extends(a,b);Object.defineProperty(a.prototype,"src",{get:function(){return this._src},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"fullPath",{get:function(){return this._baseDir+this._src},enumerable:!0,configurable:!0});a.prototype.retain=function(){this._refCount++};a.prototype.release=function(a){void 0===a&&(a=!0);a&&0<this._refCount&&
this._refCount--;0===this._refCount&&this.unload()};a.prototype.load=function(a,b){a()};a.prototype.unload=function(){var b=new d.event.Event(a.EVENT_UNLOAD,!1);b.target=b.currentTarget=this;this.dispatchEvent(b)};a.EVENT_UNLOAD="unload";return a}(d.event.EventDispatcher);f.Asset=c})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function a(){this._loadedAssets={};this._loadingUnits={};this._baseDir=""}a.getInstance=function(){a.instance||(a.instance=new a);return a.instance};a.prototype.getBaseDir=function(){return this._baseDir};a.prototype.setBaseDir=function(a){this._baseDir=a};a.prototype.getAsset=function(a){return this._loadedAssets[a]};a.prototype.addAsset=function(a){var b=this;this._loadedAssets[a.src]=a;a.addListener(d.Asset.EVENT_UNLOAD,function(h){h.removeCurrentListener();
b.removeAsset(a)})};a.prototype.removeAsset=function(a){delete this._loadedAssets[a.src]};a.prototype.loadAll=function(a){var b,h,c;h=0;for(c=a.length;h<c;h++)b=a[h],this.load(b.src,b.AssetClass,b.callback)};a.prototype.load=function(a,g,h){var c=this,d,f;(d=this._loadedAssets[a])?h&&h():(f=this._loadingUnits[a])?f.addCallback(h,h):(d=new g(a,this._baseDir?this._baseDir+"/":""),f=new b(a),f.addCallback(h,h),this._loadingUnits[a]=f,d.load(function(){delete c._loadingUnits[a];c.addAsset(d);f.complete(null,
d)},function(b){console.log(b);delete c._loadingUnits[a];f.complete(b)}))};return a}();d.AssetLoader=c;var b=function(){function a(a){this.callbacks=[];this.src=a}a.prototype.addCallback=function(a,b){this.callbacks.push({onSuccess:a,onError:b})};a.prototype.complete=function(a,b){this.callbacks.forEach(function(h){a?h.onError&&h.onError(a):h.onSuccess&&h.onSuccess(b)})};return a}()})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
(function(d){d=d.renderer||(d.renderer={});(d.ITexture||(d.ITexture={})).DOC="DOC"})(WOZLLA||(WOZLLA={}));(function(d){d=d.renderer||(d.renderer={});(d.IRenderer||(d.IRenderer={})).DOC="DOC"})(WOZLLA||(WOZLLA={}));
...
h/f;this.values[1]=-b/f;this.values[3]=-g/f;this.values[4]=a/f;this.values[6]=(g*d-h*c)/f;this.values[7]=-(a*d-b*c)/f};b.prototype.prepend=function(a,b,g,h,c,d){var f,l,n,m,p=this.values,u=p[6],v=p[7];if(1!=a||0!=b||0!=g||1!=h)f=p[0],l=p[1],n=p[3],m=p[4],p[0]=f*a+l*g,p[1]=f*b+l*h,p[3]=n*a+m*g,p[4]=n*b+m*h;p[6]=u*a+v*g+c;p[7]=u*b+v*h+d};b.prototype.append=function(a,b,g,h,c,d){var f,l,n,m,p=this.values;f=p[0];l=p[1];n=p[3];m=p[4];p[0]=a*f+b*n;p[1]=a*l+b*m;p[3]=g*f+h*n;p[4]=g*l+h*m;p[6]=c*f+d*n+p[6];
p[7]=c*l+d*m+p[7]};b.prototype.prependTransform=function(a,e,g,h,c,d,f,l,n){if(c%360){var m=c*b.DEG_TO_RAD;c=Math.cos(m);m=Math.sin(m)}else c=1,m=0;if(l||n)this.values[6]-=l,this.values[7]-=n;d||f?(d*=b.DEG_TO_RAD,f*=b.DEG_TO_RAD,this.prepend(c*g,m*g,-m*h,c*h,0,0),this.prepend(Math.cos(f),Math.sin(f),-Math.sin(d),Math.cos(d),a,e)):this.prepend(c*g,m*g,-m*h,c*h,a,e);return this};b.prototype.appendTransform=function(a,e,g,h,c,d,f,l,n){if(c%360){var m=c*b.DEG_TO_RAD;c=Math.cos(m);m=Math.sin(m)}else c=
1,m=0;d||f?(d*=b.DEG_TO_RAD,f*=b.DEG_TO_RAD,this.append(Math.cos(f),Math.sin(f),-Math.sin(d),Math.cos(d),a,e),this.append(c*g,m*g,-m*h,c*h,0,0)):this.append(c*g,m*g,-m*h,c*h,a,e);if(l||n)this.values[6]-=l*this.values[0]+n*this.values[3],this.values[7]-=l*this.values[1]+n*this.values[4];return this};b.DEG_TO_RAD=Math.PI/180;return b}();d.Matrix=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
typeof a.skewX&&(this._values[7]=a.skewX);"number"===typeof a.skewY&&(this._values[8]=a.skewY);"undefined"!==typeof a.relative&&(this._relative=a.relative);this._dirty=!0};b.prototype.transform=function(a){void 0===a&&(a=null);var e,g,h=this.worldMatrix;g=this._values[0];var c=this._values[1];e=this._values[4];var d=this._values[5],f=this._values[6],l=this._values[7],n=this._values[8];this.useGLCoords&&(l+=180);a&&this._relative?h.applyMatrix(a.worldMatrix):this===a?h.identity():h.applyMatrix(a.worldMatrix);
this.__local_matrix?(g=this.__local_matrix,h.append(g.a,g.b,g.c,g.d,g.tx,g.ty)):(e%360?(e*=b.DEG_TO_RAD,a=Math.cos(e),e=Math.sin(e)):(a=1,e=0),l||n?(l*=b.DEG_TO_RAD,n*=b.DEG_TO_RAD,h.append(Math.cos(n),Math.sin(n),-Math.sin(l),Math.cos(l),g,c),h.append(a*d,e*d,-e*f,a*f,0,0)):h.append(a*d,e*d,-e*f,a*f,g,c));this._dirty=!1};b.prototype.updateWorldMatrix=function(){if(this._dirty){var a=this.worldMatrix;a?a.identity():a=new d.math.Matrix;for(var b=this;null!=b;)a.prependTransform(b.x,b.y,b.scaleX,b.scaleY,
...
(function(d){var f=function(c){function b(){c.apply(this,arguments);this._py=this._px=this._bottom=this._right=this._left=this._top=this._height=this._width=0;this._anchorMode=b.ANCHOR_CENTER|b.ANCHOR_MIDDLE}__extends(b,c);b.getMode=function(a){a=a.split("_");var e=0;switch(a[0]){case "Left":e|=b.ANCHOR_LEFT;break;case "Right":e|=b.ANCHOR_RIGHT;break;case "HStrength":e|=b.ANCHOR_HORIZONTAL_STRENGTH;break;default:e|=b.ANCHOR_CENTER}switch(a[1]){case "Top":e|=b.ANCHOR_TOP;break;case "Bottom":e|=b.ANCHOR_BOTTOM;
break;case "VStrength":e|=b.ANCHOR_VERTICAL_STRENGTH;break;default:e|=b.ANCHOR_MIDDLE}return e};Object.defineProperty(b.prototype,"width",{get:function(){return this._width},set:function(a){this._width!==a&&(this._width=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"height",{get:function(){return this._height},set:function(a){this._height!==a&&(this._height=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"top",{get:function(){return this._top},
set:function(a){this._top!==a&&(this._top=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"left",{get:function(){return this._left},set:function(a){this._left!==a&&(this._left=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"right",{get:function(){return this._right},set:function(a){this._right!==a&&(this._right=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"bottom",{get:function(){return this._bottom},
set:function(a){this._bottom!==a&&(this._bottom=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"px",{get:function(){return this._px},set:function(a){this._px!==a&&(this._px=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"py",{get:function(){return this._py},set:function(a){this._py!==a&&(this._py=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"anchorMode",{get:function(){return this._anchorMode},
set:function(a){this._anchorMode!==a&&(this._anchorMode=a,this.dirty=!0)},enumerable:!0,configurable:!0});b.prototype.set=function(a){var e=a.anchorMode;"string"===typeof e&&(e=b.getMode(e));this._anchorMode=e;this._width=a.width||0;this._height=a.height||0;this._top=a.top||0;this._left=a.left||0;this._right=a.right||0;this._bottom=a.bottom||0;this._px=a.px||0;this._px=a.py||0;this.dirty=!0};b.prototype.transform=function(a){void 0===a&&(a=null);var e,g;g=a&&this._relative&&a instanceof b?a:d.Director.getInstance().viewRectTransform;
e=this._anchorMode;(e&b.ANCHOR_LEFT)===b.ANCHOR_LEFT?this.x=this._px:(e&b.ANCHOR_RIGHT)===b.ANCHOR_RIGHT?this.x=g._width+this._px:(e&b.ANCHOR_HORIZONTAL_STRENGTH)===b.ANCHOR_HORIZONTAL_STRENGTH?(this.x=this._left,this._width=g._width-this._left-this._right):this.x=g._width/2+this._px;(e&b.ANCHOR_TOP)===b.ANCHOR_TOP?this.y=this._py:(e&b.ANCHOR_BOTTOM)===b.ANCHOR_BOTTOM?this.y=g._height+this._py:(e&b.ANCHOR_VERTICAL_STRENGTH)===b.ANCHOR_VERTICAL_STRENGTH?(this.y=this._top,this._height=g._height-this._top-
this._bottom):this.y=g._height/2+this._py;c.prototype.transform.call(this,a)};b.ANCHOR_TOP=1;b.ANCHOR_MIDDLE=16;b.ANCHOR_BOTTOM=256;b.ANCHOR_VERTICAL_STRENGTH=4096;b.ANCHOR_LEFT=65536;b.ANCHOR_CENTER=1048576;b.ANCHOR_RIGHT=16777216;b.ANCHOR_HORIZONTAL_STRENGTH=268435456;return b}(d.Transform);d.RectTransform=f})(WOZLLA||(WOZLLA={}));
...
a=b.ctorMap[a];d.Assert.isFunction(a);return new a};b.getConfig=function(a){d.Assert.isNotUndefined(a);"function"===typeof a&&(a=b.getName(a));a=b.configMap[a];d.Assert.isNotUndefined(a);return a};b.extendConfig=function(a){a=b.getName(a);return{group:a,properties:b.getConfig(a).properties}};b.ctorMap={};b.configMap={};return b}(d.event.EventDispatcher);d.Component=f})(WOZLLA||(WOZLLA={}));
...
"parent",{get:function(){return this._parent},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"children",{get:function(){return this._children.slice(0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"rawChildren",{get:function(){return this._children},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"childCount",{get:function(){return this._children.length},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"z",{get:function(){return this._z},
set:function(a){this.setZ(a,!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"active",{get:function(){return this._active},set:function(a){var b=this._active;this._active=a;!b&&a&&(this._transform.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"visible",{get:function(){return this._visible},set:function(a){this._visible=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"initialized",{get:function(){return this._initialized},enumerable:!0,
configurable:!0});Object.defineProperty(b.prototype,"destroyed",{get:function(){return this._destroyed},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"touchable",{get:function(){return this._touchable},set:function(a){this._touchable=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"renderer",{get:function(){return this._renderer},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"collider",{get:function(){return this._collider},enumerable:!0,
configurable:!0});Object.defineProperty(b.prototype,"behaviours",{get:function(){return this._behaviours.slice(0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"mask",{get:function(){return this._mask},enumerable:!0,configurable:!0});b.prototype.setZ=function(a,b){void 0===b&&(b=!0);this._z!==a&&(this._z=a,b&&this._children.sort(f))};b.prototype.addChild=function(a,b){void 0===b&&(b=!0);if(-1!==this._children.indexOf(a))return!1;a._parent&&a.removeMe();a.dispatchEvent(new d.CoreEvent("beforeadd",
!1,{parent:this}));this._children.push(a);b&&this._children.sort(f);a._parent=this;a._transform.dirty=!0;a.dispatchEvent(new d.CoreEvent("add",!1));this.dispatchEvent(new d.CoreEvent("childadd",!1,{child:a}));return!0};b.prototype.removeChild=function(a){var b=this._children.indexOf(a);return-1!==b?(a.dispatchEvent(new d.CoreEvent("beforeremove",!1)),this._children.splice(b,1),a._parent=null,a.dispatchEvent(new d.CoreEvent("remove",!1,{parent:this})),this.dispatchEvent(new d.CoreEvent("childremove",
!1,{child:a})),!0):!1};b.prototype.getChild=function(a){var b,e,c;e=0;for(c=this._children.length;e<c;e++)if(b=this._children[e],b._name===a)return b;return null};b.prototype.getChildren=function(a){var b,e,c,d=[];e=0;for(c=this._children.length;e<c;e++)b=this._children[e],b._name===a&&d.push(b);return d};b.prototype.removeMe=function(){var a=this._parent;return a&&a.removeChild(this)};b.prototype.eachChild=function(a){this._children.forEach(a)};b.prototype.sortChildren=function(){this._children.sort(f)};
b.prototype.getPath=function(a){void 0===a&&(a="/");for(var b=[],e=this;e;)b.unshift(e.name),e=e.parent;return b.join(a)};b.prototype.contains=function(a){if(a===this)return!0;for(;a=a.parent;)if(a===this)return!0;return!1};b.prototype.getComponent=function(a){var b,e,c;if(0>=this._components.length)return null;e=0;for(c=this._components.length;e<c;e++)if(b=this._components[e],b instanceof a)return b;return null};b.prototype.hasComponent=function(a){var b,e,c;if(a===d.RectTransform)return!!this._rectTransform;
if(0>=this._components.length)return!1;e=0;for(c=this._components.length;e<c;e++)if(b=this._components[e],b instanceof a)return!0;return!1};b.prototype.getComponents=function(a){var b,e,c,d=[];if(0>=this._components.length)return d;e=0;for(c=this._components.length;e<c;e++)b=this._components[e],b instanceof a&&d.push(b);return d};b.prototype.addComponent=function(a){if(-1!==this._components.indexOf(a))return!1;this.checkComponentDependency(a);a._gameObject&&a._gameObject.removeComponent(a);this._components.push(a);
a._gameObject=this;a instanceof d.Behaviour?this._behaviours.push(a):a instanceof d.Renderer?this._renderer=a:a instanceof d.Collider?this._collider=a:a instanceof d.Mask&&(this._mask=a);return!0};b.prototype.removeComponent=function(a){var b,e,c,f=this._components.indexOf(a);if(-1!==f){b=0;for(e=this._components.length;b<e;b++)c=this._components[b],c!==a&&this.checkComponentDependency(c,!0);this._components.splice(f,1);a instanceof d.Behaviour?this._behaviours.splice(this._behaviours.indexOf(a),
1):a instanceof d.Renderer?this._renderer=null:a instanceof d.Collider?this._collider=null:a instanceof d.Mask&&(this._mask=null);a._gameObject=null;return!0}return!1};b.prototype.init=function(){var a,b;if(!this._initialized&&!this._destroyed){a=0;for(b=this._components.length;a<b;a++)this._components[a].init();a=0;for(b=this._children.length;a<b;a++)this._children[a].init();this._initialized=!0}};b.prototype.destroy=function(){var a,b;if(!this._destroyed&&this._initialized){a=0;for(b=this._components.length;a<
b;a++)this._components[a].destroy();a=0;for(b=this._children.length;a<b;a++)this._children[a].destroy();this._id&&delete c[this._id];this.clearAllListeners();this._destroyed=!0}};b.prototype.update=function(){var a,b,e;if(this._active){if(0<this._behaviours.length)for(a=0,b=this._behaviours.length;a<b;a++)e=this._behaviours[a],e.enabled&&e.update();if(0<this._children.length)for(a=0,b=this._children.length;a<b;a++)this._children[a].update()}};b.prototype.visit=function(a,h,c){var d;if(this._active&&
this._initialized&&!this._destroyed){this._transform.dirty&&(c|=b.MASK_TRANSFORM_DIRTY);(c&b.MASK_TRANSFORM_DIRTY)==b.MASK_TRANSFORM_DIRTY&&this._transform.transform(h);this._visible||(c&=~b.MASK_VISIBLE);(c&b.MASK_VISIBLE)===b.MASK_VISIBLE&&this.render(a,c);h=0;for(d=this._children.length;h<d;h++)this._children[h].visit(a,this._transform,c);return c}(c&b.MASK_TRANSFORM_DIRTY)===b.MASK_TRANSFORM_DIRTY&&(this._transform.dirty=!0)};b.prototype.render=function(a,b){this._mask&&this._mask.render(a,b);
this._renderer&&this._renderer.render(a,b)};b.prototype.getUnderPoint=function(a,b,e){void 0===e&&(e=!1);var c,d;if(!this._active||!this._visible)return null;d=this._children;if(0<d.length)for(var f=d.length-1;0<=f;f--)if(c=d[f],c=c.getUnderPoint(a,b,e))return c;if(!e||this._touchable)if(a=this.transform.globalToLocal(a,b),this.testHit(a.x,a.y))return this;return null};b.prototype.testHit=function(a,b){var e=this._collider;return e&&e.collideXY(a,b)};b.prototype.loadAssets=function(a){var b,e,c,d;
if(!this._loadingAssets)if(c=this._components.length+this._children.length,0===c)a&&a();else{b=0;for(e=this._components.length;b<e;b++)d=this._components[b],d.loadAssets(function(){0===--c&&a&&a()});b=0;for(e=this._children.length;b<e;b++)this._children[b].loadAssets(function(){0===--c&&a&&a()})}};b.prototype.query=function(a,c){var f,k,q,l,n;f=-1!==a.indexOf("[")&&-1!==a.indexOf("]");(q=-1!==a.indexOf(":"))&&f?(f=b.QUERY_FULL_REGEX.exec(a),k=f[1],q=f[2],l=f[3],n=f[4]):q&&!f?(f=b.QUERY_COMP_REGEX.exec(a),
k=f[1],q=f[2],l=f[3]):!q&&f?(f=b.QUERY_OBJ_ATTR_REGEX.exec(a),q=f[1],n=f[2]):q=a;c&&(c.compExpr=k,c.objExpr=q,c.compName=l,c.attrName=n);if(q){f=this;k=q.split("/");q=0;for(var m=k.length;q<m&&k[q]&&(f=f.getChild(k[q]),f);q++);}else f=this;f&&l&&(f=f.getComponent(d.Component.getType(l)));f&&c&&(c.target=f);f&&n&&(f=f[n]);return f};b.prototype.checkComponentDependency=function(a,b){void 0===b&&(b=!1);var e,c=a.listRequiredComponents();if(c&&0!==c.length)for(var f=0,l=c.length;f<l;f++)if(e=c[f],!this.hasComponent(e)){if(b)throw Error("Can NOT remove: Component["+
d.Component.getName(a.constructor)+"] depend on it");e=e===d.RectTransform?"RectTransform":d.Component.getName(e);throw Error("Can NOT add: Component["+e+"] required");}};b.MASK_TRANSFORM_DIRTY=1;b.MASK_VISIBLE=16;b.QUERY_FULL_REGEX=/((.*?):(.*?))\[(.*?)\]$/;b.QUERY_COMP_REGEX=/((.*?):(.*?))$/;b.QUERY_OBJ_ATTR_REGEX=/(.*?)\[(.*?)\]$/;return b}(d.event.EventDispatcher);d.GameObject=b;b=function(){return function(){this.target=this.attrName=this.compName=this.objExpr=this.compExpr=null}}();d.QueryRecord=
b})(WOZLLA||(WOZLLA={}));
(function(d){var f=function(c){function b(){c.call(this);this.name=this.id=b.ID;this._rootTransform=new d.Transform;this._viewRectTransform=new d.RectTransform;this._viewRectTransform.anchorMode=d.RectTransform.ANCHOR_TOP|d.RectTransform.ANCHOR_LEFT;this._viewRectTransform.width=d.Director.getInstance().renderer.viewport.width;this._viewRectTransform.height=d.Director.getInstance().renderer.viewport.height;this._viewRectTransform.px=0;this._viewRectTransform.py=0;this.init()}__extends(b,c);Object.defineProperty(b.prototype,
"viewRectTransform",{get:function(){return this._viewRectTransform},enumerable:!0,configurable:!0});b.prototype.visitStage=function(a){c.prototype.visit.call(this,a,this._rootTransform,d.GameObject.MASK_VISIBLE)};b.ID="WOZLLAStage";return b}(d.GameObject);d.Stage=f})(WOZLLA||(WOZLLA={}));
...
(function(d){var f=function(){function c(){this._scheduleCount=0;this._schedules={}}c.getInstance=function(){c.instance||(c.instance=new c);return c.instance};c.prototype.runSchedule=function(){var b,a,e,g=this._scheduleCount;if(this._lastSchedules)for(b in this._schedules)this._lastSchedules[b]=this._schedules[b];else this._lastSchedules=this._schedules;this._schedules={};e=this._lastSchedules;for(b in e)a=e[b],a.isFrame&&!a.paused?(a.frame--,0>a.frame&&(delete e[b],a.task.apply(a,a.args))):a.isTime&&
!a.paused?(a.time-=d.Time.delta,0>a.time&&(delete e[b],a.task.apply(a,a.args))):a.isInterval&&!a.paused?(a.time-=d.Time.delta,0>a.time&&(a.task.apply(a,a.args),a.time+=a.intervalTime)):a.isLoop&&!a.paused&&a.task.apply(a,a.args);g<this._scheduleCount&&this.runSchedule()};c.prototype.removeSchedule=function(b){delete this._schedules[b]};c.prototype.scheduleLoop=function(b,a){var e="Schedule_"+this._scheduleCount++;this._schedules[e]={task:b,args:a,isLoop:!0};return e};c.prototype.scheduleFrame=function(b,
a,e){void 0===a&&(a=0);var g="Schedule_"+this._scheduleCount++;this._schedules[g]={task:b,frame:a,args:e,isFrame:!0};return g};c.prototype.scheduleInterval=function(b,a,e){void 0===a&&(a=0);var g="Schedule_"+this._scheduleCount++;this._schedules[g]={task:b,intervalTime:a,time:a,args:e,isInterval:!0};return g};c.prototype.scheduleTime=function(b,a,e){void 0===a&&(a=0);var g="Schedule_"+this._scheduleCount++;this._schedules[g]={task:b,time:a||0,args:e,isTime:!0};return g};c.prototype.resumeSchedule=
function(b){this._schedules[b].paused=!1};c.prototype.pauseSchedule=function(b){this._schedules[b].paused=!0};return c}();d.Scheduler=f})(WOZLLA||(WOZLLA={}));
...
g){void 0===g&&(g=1);this.enabled=!0;this.canvasOffset=this.canvas=null;this.channelMap={};var c=this,r=window.navigator;c.canvas=b;c.canvasOffset=f(b);c.touchScale=g;Hammer(r.isCocoonJS?document:b,{transform:!1,doubletap:!1,hold:!1,rotate:!1,pinch:!1}).on(a.enabledGestures||"touch release tap swipe drag dragstart dragend",function(a){("release"===a.type||c.enabled)&&d.Scheduler.getInstance().scheduleFrame(function(){c.onGestureEvent(a)})})}a.setEanbledGestures=function(a){this.enabledGestures=a};
a.prototype.onGestureEvent=function(a){var b,c,f,k,q,l,n,m,p=a.type,u=d.Director.getInstance().stage,v=this.touchScale||1;if(n=a.gesture.srcEvent.changedTouches)for(k=n.length,f=0;f<k;f++)c=n[f],q=parseInt(c.identifier),b=c.pageX-this.canvasOffset.x,c=c.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&(m=u.getUnderPoint(b,c,!0))&&(this.channelMap[q]=this.createDispatchChanel(m),delete this.channelMap[q-10]),(l=this.channelMap[q])&&l.onGestureEvent(a,m,b,c,q);else q=1,b=a.gesture.srcEvent.pageX-this.canvasOffset.x,
c=a.gesture.srcEvent.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&((m=u.getUnderPoint(b,c,!0))?this.channelMap[q]=this.createDispatchChanel(m):delete this.channelMap[q]),(l=this.channelMap[q])&&l.onGestureEvent(a,m,b,c,q)};a.prototype.createDispatchChanel=function(a){var b=!0;return{onGestureEvent:function(h,f,k,q,l){var n=h.type,m=d.Director.getInstance().stage;switch(n){case "drag":if(!b){f=a;break}case "tap":case "release":f=m.getUnderPoint(k,q,!0)}if("tap"!==n||a===f)h=new c({x:k,y:q,type:n,
bubbles:!0,touch:f,gesture:h.gesture,identifier:l,touchMoveDetection:!1}),a.dispatchEvent(h),b=h.touchMoveDetection}}};return a}();d.Touch=b})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function b(){}b.getGLContext=function(a,b){var c,h=b||{},d={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},f;for(f in d)"undefined"===typeof h[f]&&(h[f]=d[f]);b=h;try{c=a.getContext("experimental-webgl",b)}catch(q){try{c=a.getContext("webgl",b)}catch(l){}}return c};b.compileShader=function(a,b,c){b=a.createShader(b);a.shaderSource(b,c);a.compileShader(b);return a.getShaderParameter(b,a.COMPILE_STATUS)?b:(console.log(a.getShaderInfoLog(b)),null)};
...
this._usingTexture&&this._usingTexture.bind(a),this._quadBatch.flush(a))};b.prototype._clearCommands=function(){var a=this._commandQueueMap,b;for(b in a)a[b].clear()};b.prototype._eachCommand=function(a){var b,e,c,g,d,f,p,u=this._commandQueueMap,v=this._layerManager._getSortedLayers();b=0;for(e=v.length;b<e;b++)if(c=v[b],d=u[c]){f=d.negativeZQueue;if(0<f.length)for(c=0,g=f.length;c<g;c++)p=f[c],a(p);f=d.zeroZQueue;if(0<f.length)for(c=0,g=f.length;c<g;c++)p=f[c],a(p);f=d.positiveZQueue;if(0<f.length)for(c=
0,g=f.length;c<g;c++)p=f[c],a(p)}};b.MAX_QUAD_SIZE=500;return b}();d.Renderer=b;var a=function(){function a(b){this._addIndex=0;this.negativeZQueue=[];this.zeroZQueue=[];this.positiveZQueue=[];this.layer=b}a.prototype.add=function(a){a._addIndex=this._addIndex++;0===a.globalZ?this.zeroZQueue.push(a):0<a.globalZ?this.positiveZQueue.push(a):this.negativeZQueue.push(a)};a.prototype.clear=function(){var a,b,e;a=0;for(b=this.negativeZQueue.length;a<b;a++)e=this.negativeZQueue[a],e.isPoolable&&e.release();
...
(function(d){(function(f){var c=function(a){function e(){a.apply(this,arguments)}__extends(e,a);Object.defineProperty(e.prototype,"glTexture",{get:function(){return this._glTexture},enumerable:!0,configurable:!0});e.prototype._generateTexture=function(a){var e=d.Director.getInstance().renderer;if(!e)throw Error("Director not initialized");this._glTexture=e.textureManager.generateTexture(new b(a))};e.prototype._generatePVRTexture=function(a){throw Error("Unsupported now");};return e}(f.Asset);f.GLTextureAsset=
...
(function(d){(function(d){function c(a,b){for(var e in b)"undefined"===typeof a[e]&&(a[e]=b[e]);return a}var b={json:function(a){return JSON.parse(a.responseText)},arraybuffer:function(a){return a.response}},a=function(){},e=function(){function e(){}e.request=function(d){void 0===d&&(d={});var f,k;d=c(d,{url:"",async:!0,method:"GET",dataType:"text",responseType:"text/plain",timeout:3E4,success:a,error:a,withCredentials:!1});f=new XMLHttpRequest;f.responseType=d.responseType;f.onreadystatechange=function(){var e;
4===f.readyState&&(f.onreadystatechange=a,clearTimeout(k),e=b[d.dataType]||function(){return f.responseText},d.success(e(f)))};f.open(d.method,d.url,d.async);f.withCredentials=d.withCredentials;k=setTimeout(function(){f.onreadystatechange=a;f.abort();d.error({code:e.ERROR_TIMEOUT,message:"request timeout"})},d.timeout);f.send()};e.ERROR_TIMEOUT=1;e.ERROR_SERVER=2;return e}();d.Ajax=e})(d.utils||(d.utils={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(f){function c(a){var b=a,d;if(a&&"object"===typeof a)for(d in b="[object Array]"===Object.prototype.toString.call(a)?[]:{},a)b[d]=c(a[d]);return b}var b=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype.cloneData=function(){return this._data?c(this._data):this._data};b.prototype.load=function(a,b){var e=this;d.utils.Ajax.request({url:this.fullPath,dataType:"json",success:function(b){e._data=b;a()},error:function(a){b(a)}})};b.prototype.unload=function(){this._data=
null;a.prototype.unload.call(this)};return b}(f.Asset);f.JSONAsset=b})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){(function(c){var b=function(){function a(a){this.loading=!1;this.proxyTarget=a}a.prototype.setAssetSrc=function(a){this.newAssetSrc=a};a.prototype.loadAsset=function(a){var b=this;this.checkDirty()?this.loading?a&&a():(this.loading=!0,this.asset&&this.asset.release(),this.asset=null,this.doLoad(function(c){c?c.src!==b.newAssetSrc?(c.retain(),c.release(),b.asset=null):(b.asset=c,b.asset.retain()):(b.asset=null,a&&a());b.loading=!1;b.proxyTarget.onAssetLoaded(c);a&&a()})):
a&&a()};a.prototype.onDestroy=function(){this.asset&&this.asset.release();this.asset=null};a.prototype.checkDirty=function(){return this.asset?this.newAssetSrc!==this.asset.src:!!this.newAssetSrc};a.prototype.doLoad=function(a){a(null)};return a}();c.AssetProxy=b})(d.proxy||(d.proxy={}))})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
...
(WOZLLA={}));
(function(d){(function(f){function c(a){var b=a.lastIndexOf("/");return-1!==b?a.substr(b+1,a.length):a}var b=/(\.png|\.jpg)$/i,a=function(a){function g(){a.apply(this,arguments);this._spriteCache={}}__extends(g,a);Object.defineProperty(g.prototype,"imageSrc",{get:function(){return this._imageSrc},enumerable:!0,configurable:!0});Object.defineProperty(g.prototype,"metaSrc",{get:function(){return this._metaSrc},enumerable:!0,configurable:!0});Object.defineProperty(g.prototype,"sourceImage",{get:function(){return this._sourceImage},
enumerable:!0,configurable:!0});Object.defineProperty(g.prototype,"spriteData",{get:function(){return this._spriteData},enumerable:!0,configurable:!0});g.prototype.getFrameLength=function(){var a;if(!this._spriteData)return 1;a=this._spriteData.frames;if("[object Array]"===Object.prototype.toString.call(a))return a.length;if(void 0==this._frameLengthCache){this._frameLengthCache=0;for(var b in a)this._frameLengthCache++}return this._frameLengthCache};g.prototype.getSprite=function(a){var b;return void 0==
a?this._entireSprite:(b=this._spriteCache[a])?b:this._spriteData?(b=this._spriteData.frames[a])?("undefined"===typeof b.frame.width&&(b.frame.width=b.frame.w,b.frame.height=b.frame.h),b=new f.Sprite(this,{x:b.frame.x,y:b.frame.y,width:b.frame.width,height:b.frame.height,offsetX:Math.ceil(b.spriteSourceSize?b.spriteSourceSize.x||0:0),offsetY:Math.ceil(b.spriteSourceSize?b.spriteSourceSize.y||0:0)},a),this._spriteCache[a]=b):null:null};g.prototype.load=function(a,e){var c=this;b.test(this.fullPath)?
(this._imageSrc=this.fullPath,this._loadImage(function(b,d){b?e&&e(b):(c._generateTexture(d),c._sourceImage=d,c._entireSprite=new f.Sprite(c,{x:0,y:0,width:d.width,height:d.height}),a&&a())})):(this._metaSrc=this.fullPath,this._loadSpriteAtlas(function(b,d,g){b?e&&e(b):(c._sourceImage=d,c._generateTexture(d),c._entireSprite=new f.Sprite(c,{x:0,y:0,width:d.width,height:d.height}),c._spriteData=g,a&&a())}))};g.prototype._loadImage=function(a){var b=this,e=new Image;e.src=this._imageSrc;e.onload=function(){a&&
a(null,e)};e.onerror=function(){a("Fail to load image: "+b._imageSrc)}};g.prototype._loadSpriteAtlas=function(a){var b=this;d.utils.Ajax.request({url:b._metaSrc,dataType:"json",success:function(e){var d=e.meta.image,g=c(b._metaSrc);b._imageSrc=b._metaSrc.replace(new RegExp(g+"$"),d);b._loadImage(function(b,c){b?a&&a(b):a&&a(null,c,e)})},error:function(b){a("Fail to load sprite: "+this._metaSrc+", "+b.code+":"+b.message)}})};return g}(f.GLTextureAsset);f.SpriteAtlas=a})(d.assets||(d.assets={}))})(WOZLLA||
(WOZLLA={}));
(function(d){(function(d){var c=function(){function b(a,b,c,d){this.x=a;this.y=b;this.width=c;this.height=d}Object.defineProperty(b.prototype,"left",{get:function(){return this.x},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"right",{get:function(){return this.x+this.width},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"top",{get:function(){return this.y},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"bottom",{get:function(){return this.y+this.height},
enumerable:!0,configurable:!0});b.prototype.containsXY=function(a,b){return this.x<=a&&this.right>a&&this.y<=b&&this.bottom>b};b.prototype.toString=function(){return"Rectangle["+this.x+","+this.y+","+this.width+","+this.height+"]"};return b}();d.Rectangle=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
function(a,b){this._renderOffset=a;this._renderCount=b};a.prototype.setVertices=function(a,b,c,d,f,q,l,n,m){void 0===m&&(m=0);var p=this._type.strade;m=this._type.size*m+this._type.vertexIndex;this._storage[0+m]=a;this._storage[1+m]=b;this._storage[0+m+1*p]=c;this._storage[1+m+1*p]=d;this._storage[0+m+2*p]=f;this._storage[1+m+2*p]=q;this._storage[0+m+3*p]=l;this._storage[1+m+3*p]=n};a.prototype.setTexCoords=function(a,b,c,d,f,q,l,n,m){void 0===m&&(m=0);var p=this._type.strade;m=this._type.size*m+
this._type.texCoordIndex;this._storage[0+m]=a;this._storage[1+m]=b;this._storage[0+m+1*p]=c;this._storage[1+m+1*p]=d;this._storage[0+m+2*p]=f;this._storage[1+m+2*p]=q;this._storage[0+m+3*p]=l;this._storage[1+m+3*p]=n};a.prototype.setAlpha=function(a,b){void 0===b&&(b=0);var c=this._type.strade,d=this._type.size*b+this._type.alphaIndex;this._storage[d]=a;this._storage[d+1*c]=a;this._storage[d+2*c]=a;this._storage[d+3*c]=a};a.prototype.setColor=function(a,b){void 0===b&&(b=0);var c=this._type.strade,
...
(function(d){(function(f){var c,b=function(a){function b(e,c){a.call(this,e,c);this.isPoolable=!0}__extends(b,a);b.init=function(a,b,e,d,f){var l=c.retain();l.initWith(a,b,e,d,f);return l};Object.defineProperty(b.prototype,"texture",{get:function(){return this._texture},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"materialId",{get:function(){return this._materialId},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"quad",{get:function(){return this._quad},enumerable:!0,
...
(function(d){(function(f){var c=function(){function b(){}b.array2rect=function(a){return new d.math.Rectangle(a[0],a[1],a[2],a[3])};b.array2circle=function(a){return new d.math.Circle(a[0],a[1],a[2])};b.json2TextStyle=function(a){var b=new f.TextStyle,c;for(c in a)b[c]=a[c];return b};b.array2Padding=function(a){return new d.layout.Padding(a[0],a[1],a[2],a[3])};b.array2Margin=function(a){return new d.layout.Margin(a[0],a[1],a[2],a[3])};return b}();f.PropertyConverter=c})(d.component||(d.component=
{}))})(WOZLLA||(WOZLLA={}));
...
type:"string"},{name:"style",type:"object",convert:f.PropertyConverter.json2TextStyle,editor:"textStyle"}]})})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));(function(d){var f=function(c){function b(){c.apply(this,arguments);this.enabled=!0}__extends(b,c);b.prototype.update=function(){};return b}(d.Component);d.Behaviour=f})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(f){function c(a,b){b()}var b=function(){function a(){this.doInit=this.doLoad=!1;this.async=!0;this.uuidMap={}}a.create=function(){return a.Factory?new a.Factory:new a};a.prototype.getByUUID=function(a){return this.uuidMap[a]};a.prototype.setSync=function(){this.async=!1};a.prototype.instantiateWithSrc=function(a,b){void 0===b&&(b=c);this.src=a;this.newCallback=b;return this};a.prototype.instantiateWithJSON=function(a,b){void 0===b&&(b=c);this.data=a;this.newCallback=b;return this};
a.prototype.load=function(a){void 0===a&&(a=c);this.doLoad=!0;this.loadCallback=a;return this};a.prototype.init=function(){this.doLoad?this.doInit=!0:this.err="JSONXBuilder: init must after load";return this};a.prototype.build=function(a){var b=this;this._loadJSONData(function(){b._checkError(a)||b._newGameObjectTree(function(){b._checkError(a)||(b.doLoad?b.newCallback(b.root,function(){b._loadAssets(function(){b._checkError(a)||(b.doInit&&b._init(),a(b.err,b.root))})}):a(b.err,b.root))})})};a.prototype._checkError=
function(a){return this.err?(a(this.err,null),!0):!1};a.prototype._loadJSONData=function(a){var b=this;this.src&&!this.data?d.utils.Ajax.request({url:d.Director.getInstance().assetLoader.getBaseDir()+"/"+this.src,dataType:"json",async:this.async,withCredentials:!0,success:function(c){b.data=c;a&&a()},error:function(c){b.err=c;a&&a()}}):a&&a()};a.prototype._newGameObjectTree=function(a){var b=this;this._newGameObject(this.data.root,function(c){b.root=c;a&&a()})};a.prototype._newGameObject=function(a,
b){var c=this,f=new d.GameObject(a.rect);f._uuid=a.uuid;this.uuidMap[a.uuid]=f;f.id=a.id;f.name=a.name;f.active=a.active;f.visible=a.visible;f.touchable=a.touchable;f.transform.set(a.transform);var k=a.components;k&&0<k.length&&k.forEach(function(a){f.addComponent(c._newComponent(a,f))});var q=0,l=a.children;l&&0!==l.length?l.forEach(function(a){a.reference?c._newReferenceObject(a,function(a){a&&f.addChild(a);q++;q===l.length&&b(f)}):c._newGameObject(a,function(a){f.addChild(a);q++;q===l.length&&
b(f)})}):b(f)};a.prototype._newReferenceObject=function(b,c){var d=this;(new a).instantiateWithSrc(b.reference).build(function(a,f){a?d.err=a:f&&(f._uuid=b.uuid,d.uuidMap[b.uuid]=f,f.name=b.name,f.id=b.id,f.active=b.active,f.visible=b.visible,f.touchable=b.touchable,f.transform.set(b.transform));c(f)})};a.prototype._newComponent=function(a,b){var c=d.Component.create(a.name),f=d.Component.getConfig(a.name);c._uuid=a.uuid;this.uuidMap[a.uuid]=c;c.gameObject=b;this._applyComponentProperties(c,f.properties,
a);return c};a.prototype._applyComponentProperties=function(a,b,c){var f=this;b&&0<b.length&&b.forEach(function(b){if(b.group)f._applyComponentProperties(a,b.properties,c);else if(b.extend)(b=d.Component.getConfig(b.extend))&&f._applyComponentProperties(a,b.properties,c);else{var g=c.properties[b.name],g=void 0==g?b.defaultValue:g;b.convert&&g&&(g=b.convert(g));a[b.name]=g}})};a.prototype._loadAssets=function(a){this.root.loadAssets(a)};a.prototype._init=function(){this.root.init()};return a}();f.JSONXBuilder=
b})(d.jsonx||(d.jsonx={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(f){var c=function(b){function a(){b.apply(this,arguments);this._layoutRequired=!0}__extends(a,b);a.prototype.init=function(){b.prototype.init.call(this);this.gameObject.addListenerScope("childadd",this.onChildAdd,this);this.gameObject.addListenerScope("childremove",this.onChildRemove,this);this.requestLayout()};a.prototype.destroy=function(){this.gameObject.removeListenerScope("childadd",this.onChildAdd,this);this.gameObject.removeListenerScope("childremove",this.onChildRemove,
this);b.prototype.destroy.call(this)};a.prototype.doLayout=function(){};a.prototype.requestLayout=function(){this._layoutRequired=!0};a.prototype.update=function(){this._layoutRequired&&(this._layoutRequired=!1,this.doLayout())};a.prototype.onChildAdd=function(a){this.requestLayout()};a.prototype.onChildRemove=function(a){alert("remove");this.requestLayout()};return a}(d.Behaviour);f.LayoutBase=c})(d.layout||(d.layout={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function b(a,b){this.width=a;this.height=b}b.prototype.toString=function(){return"Size["+this.width+","+this.height+"]"};return b}();d.Size=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(f){var c=new d.math.Size(0,0),b=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype.listRequiredComponents=function(){return[d.RectTransform]};Object.defineProperty(b.prototype,"padding",{get:function(){return this._padding},set:function(a){this._padding&&this._padding.equals(a)||(this._padding=a,this.requestLayout())},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"itemMargin",{get:function(){return this._itemMargin},set:function(a){this._itemMargin&&
this._itemMargin.equals(a)||(this._itemMargin=a,this.requestLayout())},enumerable:!0,configurable:!0});b.prototype.doLayout=function(){for(var a=this._padding,b=this._itemMargin,e=this.gameObject.rawChildren,d=0,f=0,l=0,n=a.left,m=a.top,p,u=this.gameObject.rectTransform,v=0,t=e.length;v<t;v++)p=e[v],this.measureChildSize(p,v,c),n+=b.left,m+=b.top,n+c.width+b.right+a.right>u.width&&(f++,d=0,m+=b.bottom,m+=c.height,n=a.left+b.left),p.rectTransform?(p.rectTransform.px=n,p.rectTransform.py=m):(p.transform.x=
n,p.transform.y=m),c.height>l&&(l=c.height),n+=b.right+c.width,d++};b.prototype.measureChildSize=function(a,b,e){(a=a.rectTransform)?(e.width=a.width,e.height=a.height):e.height=e.width=0};return b}(f.LayoutBase);f.Grid=b;d.Component.register(b,{name:"Grid",properties:[{name:"padding",type:"Padding",convert:d.component.PropertyConverter.array2Padding,defaultValue:[0,0,0,0]},{name:"itemMargin",type:"Margin",convert:d.component.PropertyConverter.array2Margin,defaultValue:[0,0,0,0]}]})})(d.layout||(d.layout=
{}))})(WOZLLA||(WOZLLA={}));(function(d){(function(d){var c=function(){function b(a,b,c,d){this.top=a;this.left=b;this.bottom=c;this.right=d}b.prototype.equals=function(a){return this.top===a.top&&this.bottom===a.bottom&&this.right===a.right&&this.left===a.left};return b}();d.Margin=c})(d.layout||(d.layout={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function b(a,b,c,d){this.top=a;this.left=b;this.bottom=c;this.right=d}b.prototype.equals=function(a){return this.top===a.top&&this.bottom===a.bottom&&this.right===a.right&&this.left===a.left};return b}();d.Padding=c})(d.layout||(d.layout={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(f){var c=function(b){function a(){b.apply(this,arguments)}__extends(a,b);Object.defineProperty(a.prototype,"padding",{get:function(){return this._padding},set:function(a){this._padding&&this._padding.equals(a)||(this._padding=a,this.requestLayout())},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"itemMargin",{get:function(){return this._itemMargin},set:function(a){this._itemMargin!==a&&(this._itemMargin=a,this.requestLayout())},enumerable:!0,configurable:!0});
a.prototype.doLayout=function(){var a=this,b=this._padding,c=b.top;this.gameObject.eachChild(function(f,k){var q=f.rectTransform;q?(q.anchorMode=d.RectTransform.ANCHOR_LEFT|d.RectTransform.ANCHOR_TOP,q.px=b.left,q.py=c):(f.transform.x=b.left,f.transform.y=c);c+=a._itemMargin+a.measureChildHeight(f,k)})};a.prototype.measureChildHeight=function(a,b){var c=a.rectTransform;return c?c.height:0};return a}(f.LayoutBase);f.VBox=c;d.Component.register(c,{name:"VBox",properties:[{name:"padding",type:"Padding",
convert:d.component.PropertyConverter.array2Padding,defaultValue:[0,0,0,0]},{name:"itemMargin",type:"int",defaultValue:0}]})})(d.layout||(d.layout={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){(function(c){c.rectIntersect=function(b,a){return b.x<a.x+a.width&&a.x<b.x+b.width&&b.y<a.y+a.height&&a.y<b.y+b.height};c.rectIntersect2=function(b,a,e,c,d,f,k,q){return b<=d+k&&d<=b+e&&a<=f+q&&f<=a+c}})(d.MathUtils||(d.MathUtils={}))})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));(function(d){d=d.renderer||(d.renderer={});(d.IMaterialManager||(d.IMaterialManager={})).DOC="DOC"})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){var c=function(){function b(){}b.getExtension=function(a,e,c){void 0===c&&(c=!0);a=a.getExtension(e)||a.getExtension(a,b.VENDOR_WEBKIT+e);if(null!=a)return a;if(c)throw Error("Unsupported extension: "+e);};b.VENDOR_WEBKIT="WEBKIT_";b.PVRTC="WEBGL_compressed_texture_pvrtc";b.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG=35842;b.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG=35843;return b}();d.WebGLExtension=c})(d.renderer||(d.renderer={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(f){var c=function(e){function c(){e.apply(this,arguments);this._stateConfig={}}__extends(c,e);c.prototype.defineState=function(a,b){void 0===b&&(b=!1);d.Assert.isUndefined(this._stateConfig[a],'state "'+a+'" has been defined');this._stateConfig[a]={data:{}};b&&(this._defaultState=a)};c.prototype.getStateData=function(a,b){d.Assert.isNotUndefined(this._stateConfig[a],'state "'+a+'" not defined');return this._stateConfig[a].data[b]};c.prototype.setStateData=function(a,b,c){d.Assert.isNotUndefined(this._stateConfig[a],
'state "'+a+'" not defined');this._stateConfig[a].data[b]=c};c.prototype.defineTransition=function(a,b,c){d.Assert.isNotUndefined(this._stateConfig[a],'state "'+a+'" not defined');d.Assert.isNotUndefined(this._stateConfig[b],'state "'+b+'" not defined');this._stateConfig[a][b]=c};c.prototype.init=function(){this._currentState=this._defaultState;this.dispatchEvent(new d.event.Event(c.INIT,!1,new b(this._currentState)))};c.prototype.getCurrentState=function(){return this._currentState};c.prototype.changeState=
function(e){var f=this,k,q;d.Assert.isNotUndefined(this._stateConfig[e]);k=this._currentState;q=this._stateConfig[e][e]||a.getInstance();this._currentTransition&&this._currentTransition.cancel();q.reset();q.execute(k,e,function(){f._currentTransition=null;f._currentState=e;f.dispatchEvent(new d.event.Event(c.CHANGE,!1,new b(f._currentState)))});this._currentTransition=q};c.INIT="state.init";c.CHANGE="state.change";return c}(d.event.EventDispatcher);f.StateMachine=c;var b=function(){return function(a){this.state=
...
(function(d){(function(f){function c(a,b,c){return a<b?b<c?b:a<c?c:a:b>c?b:a>c?c:a}var b=function(a){function b(){a.apply(this,arguments);this._direction=b.VERTICAL;this._momentumEnabled=this._bufferBackEnabled=this._enabled=!0;this._dragMovedInLastSession=!1;this._values={velocityX:0,velocityY:0,momentumX:0,momentumY:0,lastDragX:0,lastDragY:0,momentumXTween:void 0,momentumYTween:void 0,bufferXTween:void 0,bufferYTween:void 0}}__extends(b,a);Object.defineProperty(b.prototype,"direction",{get:function(){return this._direction},
set:function(a){this._direction=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"enabled",{get:function(){return this._enabled},set:function(a){this._enabled=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"content",{get:function(){return this._content},set:function(a){this._content=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"visibleWidth",{get:function(){return this.gameObject.rectTransform.width},enumerable:!0,configurable:!0});
Object.defineProperty(b.prototype,"visibleHeight",{get:function(){return this.gameObject.rectTransform.height},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"contentWidth",{get:function(){return this._contentGameObject.rectTransform.width},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"contentHeight",{get:function(){return this._contentGameObject.rectTransform.height},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"bufferBackEnabled",{get:function(){return this._bufferBackEnabled},
set:function(a){this._bufferBackEnabled=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"momentumEnabled",{get:function(){return this._momentumEnabled},set:function(a){this._momentumEnabled=a},enumerable:!0,configurable:!0});b.prototype.listRequiredComponents=function(){return[d.RectTransform]};b.prototype.init=function(){this._content&&(this._contentGameObject=this.gameObject.query(this._content));this.gameObject.addListenerScope("dragstart",this.onDragStart,this);this.gameObject.addListenerScope("drag",
this.onDrag,this);this.gameObject.addListenerScope("dragend",this.onDragEnd,this);a.prototype.init.call(this)};b.prototype.destroy=function(){this.gameObject.removeListenerScope("dragstart",this.onDragStart,this);this.gameObject.removeListenerScope("drag",this.onDrag,this);this.gameObject.removeListenerScope("dragend",this.onDragEnd,this);a.prototype.destroy.call(this)};b.prototype.update=function(){var a=this;if(this._contentGameObject&&(this._bufferBackEnabled||this._momentumEnabled)){var f=this._contentGameObject.rectTransform;
if(this._direction===b.BOTH||this._direction===b.HORIZONTAL){f.px+=(this._values.velocityX+this._values.momentumX)*d.Time.delta;var r=this.getMinScrollX();this._bufferBackEnabled||(f.px=c(f.px,r,0));var k=!1;0<f.px&&0!==this._values.velocityX?(f.px=0,this._values.momentumX=this._values.velocityX,k=!0):f.px<r&&0!==this._values.velocityX&&(f.px=r,this._values.momentumX=this._values.velocityX,k=!0);k&&(this._values.momentumXTween&&this._values.momentumXTween.setPaused(!0),this._values.momentumXTween=
d.utils.Tween.get(this._values).to({momentumX:0},100).call(function(){a.tryBufferBackX()}))}if(this._direction===b.BOTH||this._direction===b.VERTICAL)f.py+=(this._values.velocityY+this._values.momentumY)*d.Time.delta,r=this.getMinScrollY(),this._bufferBackEnabled||(f.py=c(f.py,r,0)),k=!1,0<f.py&&0!==this._values.velocityY?(f.py=0,this._values.momentumY=this._values.velocityY,k=!0):f.py<r&&0!==this._values.velocityY&&(f.py=r,this._values.momentumY=this._values.velocityY,k=!0),k&&(this._values.momentumYTween&&
this._values.momentumYTween.setPaused(!0),this._values.momentumYTween=d.utils.Tween.get(this._values).to({momentumY:0},100).call(function(){a.tryBufferBackY()}))}};b.prototype.isScrollable=function(){return this._contentGameObject&&b.globalScrollEnabled&&this._enabled};b.prototype.getMinScrollX=function(){return this.visibleWidth-this.contentWidth};b.prototype.getMinScrollY=function(){return this.visibleHeight-this.contentHeight};b.prototype.onDragStart=function(a){this.isScrollable()&&(this._dragMovedInLastSession=
!0,this._values.lastDragX=a.x,this._values.lastDragY=a.y,this._values.velocityX=0,this._values.velocityY=0,this._values.momentumX=0,this._values.momentumY=0,this._contentGameObject.rectTransform.clearTweens(),d.utils.Tween.removeTweens(this))};b.prototype.onDrag=function(a){if(this.isScrollable()){var d=this._contentGameObject.rectTransform;if(this._direction===b.BOTH||this._direction===b.HORIZONTAL){var f=a.x-this._values.lastDragX,k=this.getMinScrollX();if(0===k||0<=d.px&&0<f||d.px<=k&&0>f)f/=10;
d.px+=f;this._values.lastDragX+=f;this._bufferBackEnabled||(d.px=c(d.px,k,0))}if(this._direction===b.BOTH||this._direction===b.VERTICAL){a=a.y-this._values.lastDragY;f=this.getMinScrollY();if(0===f||0<=d.py&&0<a||d.py<=f&&0>a)a/=10;d.py+=a;this._values.lastDragY+=a;this._bufferBackEnabled||(d.py=c(d.py,f,0))}}};b.prototype.onDragEnd=function(a){this.isScrollable()&&(this._direction!==b.BOTH&&this._direction!==b.HORIZONTAL||this.tryBufferBackX()||(this._momentumEnabled?(this._values.velocityX=a.gesture.velocityX*
(0<=a.gesture.deltaX?1:-1),this._values.momentumXTween&&this._values.momentumXTween.setPaused(!0),this._values.momentumXTween=d.utils.Tween.get(this._values).to({velocityX:0},1E3)):(this._values.velocityX=0,this._values.momentumY=0)),this._direction!==b.BOTH&&this._direction!==b.VERTICAL||this.tryBufferBackY()||(this._momentumEnabled?(this._values.velocityY=a.gesture.velocityY*(0<=a.gesture.deltaY?1:-1),this._values.momentumYTween&&this._values.momentumYTween.setPaused(!0),this._values.momentumYTween=
d.utils.Tween.get(this._values).to({velocityY:0},1E3)):(this._values.velocityY=0,this._values.momentumY=0)))};b.prototype.tryBufferBackX=function(){if(!this._bufferBackEnabled)return!1;var a=this.getMinScrollX(),b=this._contentGameObject.rectTransform;return 0<b.px?(this._values.bufferXTween&&this._values.bufferXTween.setPaused(!0),this._values.bufferXTween=b.tween(!1).to({px:0},100),!0):b.px<a?(this._values.bufferXTween&&this._values.bufferXTween.setPaused(!0),this._values.bufferXTween=b.tween(!1).to({px:a},
100),!0):!1};b.prototype.tryBufferBackY=function(){if(!this._bufferBackEnabled)return!1;var a=this.getMinScrollY(),b=this._contentGameObject.rectTransform;return 0<b.py?(this._values.bufferYTween&&this._values.bufferYTween.setPaused(!0),this._values.bufferYTween=b.tween(!1).to({py:0},100),!0):b.py<a?(this._values.bufferYTween&&this._values.bufferYTween.setPaused(!0),this._values.bufferYTween=b.tween(!1).to({py:a},100),!0):!1};b.globalScrollEnabled=!0;b.HORIZONTAL="Horizontal";b.VERTICAL="Vertical";
b.BOTH="both";return b}(d.Behaviour);f.ScrollRect=b;d.Component.register(b,{name:"UI.ScrollRect",properties:[{name:"enabeld",type:"boolean",defaultValue:!0},{name:"direction",type:"string",defaultValue:b.VERTICAL,editor:"combobox",data:[b.HORIZONTAL,b.VERTICAL,b.BOTH]},{name:"content",type:"string",defaultValue:""},{name:"bufferBackEnabled",type:"boolean",defaultValue:!0},{name:"momentumEnabled",type:"boolean",defaultValue:!0}]})})(d.ui||(d.ui={}))})(WOZLLA||(WOZLLA={}));
