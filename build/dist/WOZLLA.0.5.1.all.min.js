...
on:function(b,a,e,f){a=a.split(" ");t.each(a,function(a){t.on(b,a,e);f&&f(a)})},off:function(b,a,e,f){a=a.split(" ");t.each(a,function(a){t.off(b,a,e);f&&f(a)})},onTouch:function(e,f,h){var c=this,d=function(b){var d=b.type.toLowerCase(),s=a.HAS_POINTEREVENTS,d=t.inStr(d,"mouse"),l;d&&c.preventMouseEvents||(d&&f==p&&0===b.button?(c.preventMouseEvents=!1,c.shouldDetect=!0):s&&f==p?c.shouldDetect=1===b.buttons||x.matchType(k,b):d||f!=p||(c.preventMouseEvents=!0,c.shouldDetect=!0),s&&f!=q&&x.updatePointer(f,
b),c.shouldDetect&&(l=c.doDetect.call(c,b,f,e,h)),l==q&&(c.preventMouseEvents=!1,c.shouldDetect=!1,x.reset()),s&&f==q&&x.updatePointer(f,b))};this.on(e,b[f],d);return d},doDetect:function(b,a,e,f){var h=this.getTouchList(b,a),c=a,d=h.trigger,s=h.length;a==p?d=v:a==q&&(d=u,s=h.length-(b.changedTouches?b.changedTouches.length:1));0<s&&this.started&&(c=m);this.started=!0;b=this.collectEventData(e,c,h,b);a!=q&&f.call(w,b);d&&(b.changedLength=s,b.eventType=d,f.call(w,b),b.eventType=c,delete b.changedLength);
c==q&&(f.call(w,b),this.started=!1);return c},determineEventTypes:function(){var e;e=a.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:a.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];b[p]=e[0];b[m]=e[1];b[q]=e[2];return b},getTouchList:function(b,e){if(a.HAS_POINTEREVENTS)return x.getTouchList();
if(b.touches){if(e==m)return b.touches;var f=[],h=[].concat(t.toArray(b.touches),t.toArray(b.changedTouches)),c=[];t.each(h,function(b){!1===t.inArray(f,b.identifier)&&c.push(b);f.push(b.identifier)});return c}b.identifier=1;return[b]},collectEventData:function(b,a,e,f){b=k;t.inStr(f.type,"mouse")||x.matchType(l,f)?b=l:x.matchType(n,f)&&(b=n);return{center:t.getCenter(e),timeStamp:Date.now(),target:f.target,touches:e,eventType:a,pointerType:b,srcEvent:f,preventDefault:function(){var b=this.srcEvent;
...
f={};f[l]=e===(a.MSPOINTER_TYPE_MOUSE||l);f[k]=e===(a.MSPOINTER_TYPE_TOUCH||k);f[n]=e===(a.MSPOINTER_TYPE_PEN||n);return f[b]},reset:function(){this.pointers={}}},w=a.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(b,a){this.current||(this.stopped=!1,this.current={inst:b,startEvent:t.extend({},a),lastEvent:!1,lastCalcEvent:!1,futureCalcEvent:!1,lastCalcData:{},name:""},this.detect(a))},detect:function(b){if(this.current&&!this.stopped){b=this.extendEventData(b);var a=
this.current.inst,e=a.options;t.each(this.gestures,function(f){!this.stopped&&a.enabled&&e[f.name]&&f.handler.call(f,b,a)},this);this.current&&(this.current.lastEvent=b);b.eventType==q&&this.stopDetect();return b}},stopDetect:function(){this.previous=t.extend({},this.current);this.current=null;this.stopped=!0},getCalculatedData:function(b,e,f,h,c){var d=this.current,s=!1,l=d.lastCalcEvent,k=d.lastCalcData;l&&b.timeStamp-l.timeStamp>a.CALCULATE_INTERVAL&&(e=l.center,f=b.timeStamp-l.timeStamp,h=b.center.clientX-
l.center.clientX,c=b.center.clientY-l.center.clientY,s=!0);if(b.eventType==v||b.eventType==u)d.futureCalcEvent=b;if(!d.lastCalcEvent||s)k.velocity=t.getVelocity(f,h,c),k.angle=t.getAngle(e,b.center),k.direction=t.getDirection(e,b.center),d.lastCalcEvent=d.futureCalcEvent||b,d.futureCalcEvent=b;b.velocityX=k.velocity.x;b.velocityY=k.velocity.y;b.interimAngle=k.angle;b.interimDirection=k.direction},extendEventData:function(b){var a=this.current,e=a.startEvent,a=a.lastEvent||e;if(b.eventType==v||b.eventType==
...
!0);this.eventStartHandler=r.onTouch(b,p,function(b){f.enabled&&b.eventType==p?w.startDetect(f,b):b.eventType==v&&w.detect(b)});this.eventHandlers=[]};a.Instance.prototype={on:function(b,a){var e=this;r.on(e.element,b,a,function(b){e.eventHandlers.push({gesture:b,handler:a})});return e},off:function(b,a){var e=this;r.off(e.element,b,a,function(b){b=t.inArray({gesture:b,handler:a});!1!==b&&e.eventHandlers.splice(b,1)});return e},trigger:function(b,e){e||(e={});var f=a.DOCUMENT.createEvent("Event");
f.initEvent(b,!0,!0);f.gesture=e;var h=this.element;t.hasParent(e.target,h)&&(h=e.target);navigator.isCocoonJS?this.eventHandlers.forEach(function(a){b===a.gesture&&a.handler(f)}):h.dispatchEvent(f);return this},enable:function(b){this.enabled=b;return this},dispose:function(){var a,e;t.toggleBehavior(this.element,this.options.behavior,!1);for(a=-1;e=this.eventHandlers[++a];)t.off(this.element,e.gesture,e.handler);this.eventHandlers=[];r.off(this.element,b[p],this.eventStartHandler);return null}};
(function(b){var c=!1;a.gestures.Drag={name:b,index:50,handler:function(a,d){var l=w.current;if(!(0<d.options.dragMaxTouches&&a.touches.length>d.options.dragMaxTouches))switch(a.eventType){case p:c=!1;break;case m:if(a.distance<d.options.dragMinDistance&&l.name!=b)break;var k=l.startEvent.center;if(l.name!=b&&(l.name=b,d.options.dragDistanceCorrection&&0<a.distance)){var g=Math.abs(d.options.dragMinDistance/a.distance);k.pageX+=a.deltaX*g;k.pageY+=a.deltaY*g;k.clientX+=a.deltaX*g;k.clientY+=a.deltaY*
g;a=w.extendEventData(a)}if(l.lastEvent.dragLockToAxis||d.options.dragLockToAxis&&d.options.dragLockMinDistance<=a.distance)a.dragLockToAxis=!0;l=l.lastEvent.direction;a.dragLockToAxis&&l!==a.direction&&(t.isVertical(l)?a.direction=0>a.deltaY?h:e:a.direction=0>a.deltaX?f:s);c||(d.trigger(b+"start",a),c=!0);d.trigger(b,a);d.trigger(b+a.direction,a);l=t.isVertical(a.direction);(d.options.dragBlockVertical&&l||d.options.dragBlockHorizontal&&!l)&&a.preventDefault();break;case u:c&&a.changedLength<=d.options.dragMaxTouches&&
(d.trigger(b+"end",a),c=!1);break;case q:c=!1}},defaults:{dragMinDistance:10,dragDistanceCorrection:!0,dragMaxTouches:1,dragBlockHorizontal:!1,dragBlockVertical:!1,dragLockToAxis:!1,dragLockMinDistance:25}}})("drag");a.gestures.Gesture={name:"gesture",index:1337,handler:function(b,a){a.trigger(this.name,b)}};(function(b){var e;a.gestures.Hold={name:b,index:10,defaults:{holdTimeout:500,holdThreshold:2},handler:function(a,f){var h=f.options,c=w.current;switch(a.eventType){case p:clearTimeout(e);c.name=
b;e=setTimeout(function(){c&&c.name==b&&f.trigger(b,a)},h.holdTimeout);break;case m:a.distance>h.holdThreshold&&clearTimeout(e);break;case u:clearTimeout(e)}}}})("hold");a.gestures.Release={name:"release",index:Infinity,handler:function(b,a){b.eventType==u&&a.trigger(this.name,b)}};a.gestures.Swipe={name:"swipe",index:40,defaults:{swipeMinTouches:1,swipeMaxTouches:1,swipeVelocityX:.6,swipeVelocityY:.6},handler:function(b,a){if(b.eventType==u){var e=b.touches.length,f=a.options;e<f.swipeMinTouches||
e>f.swipeMaxTouches||!(b.velocityX>f.swipeVelocityX||b.velocityY>f.swipeVelocityY)||(a.trigger(this.name,b),a.trigger(this.name+b.direction,b))}}};(function(b){var e=!1;a.gestures.Tap={name:b,index:100,handler:function(a,f){var h=f.options,c=w.current,d=w.previous,s,l;switch(a.eventType){case p:e=!1;break;case m:e=e||a.distance>h.tapMaxDistance;break;case q:!t.inStr(a.srcEvent.type,"cancel")&&a.deltaTime<h.tapMaxTime&&!e&&(s=d&&d.lastEvent&&a.timeStamp-d.lastEvent.timeStamp,l=!1,d&&d.name==b&&s&&
s<h.doubleTapInterval&&a.distance<h.doubleTapDistance&&(f.trigger("doubletap",a),l=!0),!l||h.tapAlways)&&(c.name=b,f.trigger(c.name,a))}},defaults:{tapMaxTime:250,tapMaxDistance:10,tapAlways:!0,doubleTapDistance:20,doubleTapInterval:300}}})("tap");a.gestures.Touch={name:"touch",index:-Infinity,defaults:{preventDefault:!1,preventMouse:!1},handler:function(b,a){a.options.preventMouse&&b.pointerType==l?b.stopDetect():(a.options.preventDefault&&b.preventDefault(),b.eventType==v&&a.trigger("touch",b))}};
(function(b){var e=!1;a.gestures.Transform={name:b,index:45,defaults:{transformMinScale:.01,transformMinRotation:1},handler:function(a,f){switch(a.eventType){case p:e=!1;break;case m:if(2>a.touches.length)break;var h=Math.abs(1-a.scale),c=Math.abs(a.rotation);if(h<f.options.transformMinScale&&c<f.options.transformMinRotation)break;w.current.name=b;e||(f.trigger(b+"start",a),e=!0);f.trigger(b,a);c>f.options.transformMinRotation&&f.trigger("rotate",a);h>f.options.transformMinScale&&(f.trigger("pinch",
...
null}};c.prototype.gotoAndPlay=function(a,b,e,f,h,s,l,k,g){void 0===b&&(b=-1);void 0===e&&(e=-1);void 0===f&&(f=NaN);void 0===h&&(h=0);void 0===s&&(s=null);void 0===l&&(l=c.SAME_LAYER_AND_GROUP);void 0===k&&(k=!0);void 0===g&&(g=!0);if(!this._animationDataList)return null;for(var p=this._animationDataList.length,m;p--;)if(this._animationDataList[p].name==a){m=this._animationDataList[p];break}if(!m)return null;this._isFading=this._isPlaying=!0;b=0>b?0>m.fadeTime?.3:m.fadeTime:b;e=0>e?0>m.scale?1:m.scale:
1E3*e/m.duration;f=isNaN(f)?m.playTimes:f;switch(l){case c.NONE:break;case c.SAME_LAYER:for(p=this._animationStateList.length;p--;)l=this._animationStateList[p],l.layer==h&&l.fadeOut(b,k);break;case c.SAME_GROUP:for(p=this._animationStateList.length;p--;)l=this._animationStateList[p],l.group==s&&l.fadeOut(b,k);break;case c.ALL:for(p=this._animationStateList.length;p--;)l=this._animationStateList[p],l.fadeOut(b,k);break;default:for(p=this._animationStateList.length;p--;)l=this._animationStateList[p],
l.layer==h&&l.group==s&&l.fadeOut(b,k)}this._lastAnimationState=d.AnimationState._borrowObject();this._lastAnimationState._layer=h;this._lastAnimationState._group=s;this._lastAnimationState.autoTween=this.tweenEnabled;this._lastAnimationState._fadeIn(this._armature,m,b,1/e,f,g);this.addState(this._lastAnimationState);f=this._armature.getSlots(!1);for(p=f.length;p--;)h=f[p],h.childArmature&&h.childArmature.animation.gotoAndPlay(a,b);return this._lastAnimationState};c.prototype.gotoAndStop=function(a,
b,e,f,h,d,l,k){void 0===e&&(e=-1);void 0===f&&(f=0);void 0===h&&(h=-1);void 0===d&&(d=0);void 0===l&&(l=null);void 0===k&&(k=c.ALL);var g=this.getState(a,d);g||(g=this.gotoAndPlay(a,f,h,NaN,d,l,k));0<=e?g.setCurrentTime(g.totalTime*e):g.setCurrentTime(b);g.stop();return g};c.prototype.play=function(){this._animationDataList&&0!=this._animationDataList.length&&(this._lastAnimationState?this._isPlaying?this.gotoAndPlay(this._lastAnimationState.name):this._isPlaying=!0:this.gotoAndPlay(this._animationDataList[0].name))};
...
h?(c=h,f=!0):c<=-h?(c=-h,f=!0):f=!1,0>c&&(c+=h),h=Math.ceil(c/this._totalTime)||1,c=0<=c?c-Math.floor(c/this._totalTime)*this._totalTime:c-Math.ceil(c/this._totalTime)*this._totalTime,f&&(c=this._totalTime));this._isComplete=f;var l=1E3*this._time/this._totalTime,k;for(k in this._timelineStateList){var g=this._timelineStateList[k];g._update(l);this._isComplete=g._isComplete&&this._isComplete}this._currentTime!=c&&(this._currentPlayTimes!=h&&(0<this._currentPlayTimes&&1<h&&(e=!0),this._currentPlayTimes=
h),0>this._currentTime&&(b=!0),this._isComplete&&(a=!0),this._currentTime=c,this.updateMainTimeline(f));b&&this._armature.hasEventListener(d.AnimationEvent.START)&&(k=new d.AnimationEvent(d.AnimationEvent.START),k.animationState=this,this._armature._eventList.push(k));a?(this._armature.hasEventListener(d.AnimationEvent.COMPLETE)&&(k=new d.AnimationEvent(d.AnimationEvent.COMPLETE),k.animationState=this,this._armature._eventList.push(k)),this.autoFadeOut&&this.fadeOut(this.fadeOutTime,!0)):e&&this._armature.hasEventListener(d.AnimationEvent.LOOP_COMPLETE)&&
(k=new d.AnimationEvent(d.AnimationEvent.LOOP_COMPLETE),k.animationState=this,this._armature._eventList.push(k))};c.prototype.updateMainTimeline=function(a){var b=this._clip.frameList;if(0<b.length){for(var e,f,h=0,c=this._clip.frameList.length;h<c;++h){if(0>this._currentFrameIndex)this._currentFrameIndex=0;else if(this._currentTime<this._currentFramePosition||this._currentTime>=this._currentFramePosition+this._currentFrameDuration){if(this._currentFrameIndex++,this._currentFrameIndex>=b.length)if(a){this._currentFrameIndex--;
...
function(){var b,a,f,h=this._timelineStateList.length;if(1==h)b=this._timelineStateList[0],f=b._animationState.weight*b._animationState.fadeWeight,b._weight=f,a=b._transform,b=b._pivot,this._tween.x=a.x*f,this._tween.y=a.y*f,this._tween.skewX=a.skewX*f,this._tween.skewY=a.skewY*f,this._tween.scaleX=1+(a.scaleX-1)*f,this._tween.scaleY=1+(a.scaleY-1)*f,this._tweenPivot.x=b.x*f,this._tweenPivot.y=b.y*f;else if(1<h){var c=0,d=0,k=0,g=0,p=0,m=0,q=0,u=0,v=1,t=0,r=this._timelineStateList[h-1]._animationState.layer;
for(a=0;h--;){b=this._timelineStateList[h];a=b._animationState.layer;if(r!=a)if(t>=v){b._weight=0;break}else v-=t;r=a;f=b._animationState.weight*b._animationState.fadeWeight*v;(b._weight=f)&&b._blendEnabled&&(a=b._transform,b=b._pivot,c+=a.x*f,d+=a.y*f,k+=a.skewX*f,g+=a.skewY*f,p+=(a.scaleX-1)*f,m+=(a.scaleY-1)*f,q+=b.x*f,u+=b.y*f,t+=f)}this._tween.x=c;this._tween.y=d;this._tween.skewX=k;this._tween.skewY=g;this._tween.scaleX=p;this._tween.scaleY=m;this._tweenPivot.x=q;this._tweenPivot.y=u}};a.prototype.sortState=
...
};a.prototype._updateDisplayColor=function(b,a,f,h,c,d,k,g){this._colorTransform.alphaOffset=b;this._colorTransform.redOffset=a;this._colorTransform.greenOffset=f;this._colorTransform.blueOffset=h;this._colorTransform.alphaMultiplier=c;this._colorTransform.redMultiplier=d;this._colorTransform.greenMultiplier=k;this._colorTransform.blueMultiplier=g};a.prototype._updateDisplayBlendMode=function(b){throw Error("Abstract method needs to be implemented in subclass!");};return a}(d.DBObject);d.Slot=g})(dragonBones||
...
null==b.armatureData.getBoneData(f)&&(f=null),b.addBone(h,f,!0);b._updateAnimationAfterBoneListChanged()};a.prototype._buildSlots=function(b,a,f){var h=b.armatureData.getSkinData(a);if(h)for(var c=[],h=h.slotDataList,l,k,g,p=0;p<h.length;p++)if(l=h[p],g=b.getBone(l.parent)){k=this._generateSlot();k.initWithSlotData(l);g.addSlot(k);for(g=l.displayDataList.length;g--;){var m=l.displayDataList[g];switch(m.type){case d.DisplayData.ARMATURE:m=this.buildArmatureUsingArmatureDataFromTextureAtlas(b.__dragonBonesData,
b.__dragonBonesData.getArmatureDataByName(m.name),f,a);c[g]=m;break;default:c[g]=this._generateDisplay(f,m.name,m.pivot.x,m.pivot.y)}}for(var q in c)if(l=c[q],l instanceof d.Armature&&(l=l.display),l.hasOwnProperty("name"))try{l.name=k.name}catch(u){}k.displayList=c;k._changeDisplay(0)}};a.prototype._generateArmature=function(){return null};a.prototype._generateSlot=function(){return null};a.prototype._generateDisplay=function(b,a,f,h){return null};a._helpMatrix=new d.Matrix;return a}(d.EventDispatcher);
...
(function(d){var g=function(){function c(){}c.parseTextureAtlasData=function(a,b){void 0===b&&(b=1);var e={},f,h=a[d.ConstValues.SUB_TEXTURE],s;for(s in h){var l=h[s],g=l[d.ConstValues.A_NAME],n=new d.Rectangle;n.x=c.getNumber(l,d.ConstValues.A_X,0)/b;n.y=c.getNumber(l,d.ConstValues.A_Y,0)/b;n.width=c.getNumber(l,d.ConstValues.A_WIDTH,0)/b;n.height=c.getNumber(l,d.ConstValues.A_HEIGHT,0)/b;var p="true"==l[d.ConstValues.A_ROTATED],m=c.getNumber(l,d.ConstValues.A_FRAME_WIDTH,0)/b,q=c.getNumber(l,d.ConstValues.A_FRAME_HEIGHT,
0)/b;0<m&&0<q?(f=new d.Rectangle,f.x=c.getNumber(l,d.ConstValues.A_FRAME_X,0)/b,f.y=c.getNumber(l,d.ConstValues.A_FRAME_Y,0)/b,f.width=m,f.height=q):f=null;e[g]=new d.TextureData(n,f,p)}return e};c.parseDragonBonesData=function(a){if(!a)throw Error();var b=a[d.ConstValues.A_VERSION],b=b.toString();if(b.toString()!=d.DragonBones.DATA_VERSION&&b.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var b=c.getNumber(a,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
...
e=b.boneDataList;var h;f&&(h=f.slotDataList);for(f=0;f<e.length;f++){var s=e[f],l=a.getTimeline(s.name);if(l){var g=null;if(h)for(var n in h)if(g=h[n],g.parent==s.name)break;for(var p=l.frameList,m=null,q=null,u=null,v=p.length,t=0;t<v;t++){var r=p[t];c.setFrameTransform(a,b,s,r);r.transform.x-=s.transform.x;r.transform.y-=s.transform.y;r.transform.skewX-=s.transform.skewX;r.transform.skewY-=s.transform.skewY;r.transform.scaleX/=s.transform.scaleX;r.transform.scaleY/=s.transform.scaleY;!l.transformed&&
g&&(r.zOrder-=g.zOrder);m||(m=l.originTransform,m.copy(r.transform),m.skewX=d.TransformUtil.formatRadian(m.skewX),m.skewY=d.TransformUtil.formatRadian(m.skewY),q=l.originPivot,q.x=r.pivot.x,q.y=r.pivot.y);r.transform.x-=m.x;r.transform.y-=m.y;r.transform.skewX=d.TransformUtil.formatRadian(r.transform.skewX-m.skewX);r.transform.skewY=d.TransformUtil.formatRadian(r.transform.skewY-m.skewY);r.transform.scaleX/=m.scaleX;r.transform.scaleY/=m.scaleY;l.transformed||(r.pivot.x-=q.x,r.pivot.y-=q.y);if(u){var x=
...
u.transform.skewX),r.transform.skewY=u.transform.skewY+d.TransformUtil.formatRadian(r.transform.skewY-u.transform.skewY))}u=r}l.transformed=!0}}}else c.transformRelativeAnimationData(a,b)};c.setFrameTransform=function(a,b,e,f){f.transform.copy(f.global);if(e=b.getBoneData(e.parent)){var h=a.getTimeline(e.name);if(h){for(var s=[],l=[];h;)s.push(h),l.push(e),h=(e=b.getBoneData(e.parent))?a.getTimeline(e.name):null;a=s.length;var g;b=new d.Matrix;for(var n=new d.DBTransform,p=new d.Matrix;a--;)h=s[a],
e=l[a],c.getTimelineTransform(h,f.position,n,!g),g?(n.x+=h.originTransform.x+e.transform.x,n.y+=h.originTransform.y+e.transform.y,n.skewX+=h.originTransform.skewX+e.transform.skewX,n.skewY+=h.originTransform.skewY+e.transform.skewY,n.scaleX=n.scaleX*h.originTransform.scaleX*e.transform.scaleX,n.scaleY=n.scaleY*h.originTransform.scaleY*e.transform.scaleY,d.TransformUtil.transformToMatrix(n,p,!0),p.concat(b),d.TransformUtil.matrixToTransform(p,g,0<=n.scaleX*g.scaleX,0<=n.scaleY*g.scaleY)):(g=new d.DBTransform,
g.copy(n)),d.TransformUtil.transformToMatrix(g,b,!0);d.TransformUtil.globalToLocal(f.transform,g)}}};c.getTimelineTransform=function(a,b,e,f){for(var h=a.frameList,c=h.length;c--;)if(a=h[c],a.position<=b&&a.position+a.duration>b){if(c==h.length-1||b==a.position)e.copy(f?a.global:a.transform);else{var l=a.tweenEasing;b=(b-a.position)/a.duration;l&&10!=l&&(b=d.MathUtil.getEaseValue(b,l));h=h[c+1];a=f?a.global:a.transform;f=f?h.global:h.transform;e.x=a.x+(f.x-a.x)*b;e.y=a.y+(f.y-a.y)*b;e.skewX=d.TransformUtil.formatRadian(a.skewX+
...
h/g;this.values[1]=-a/g;this.values[3]=-f/g;this.values[4]=b/g;this.values[6]=(f*d-h*c)/g;this.values[7]=-(b*d-a*c)/g};a.prototype.prepend=function(b,a,f,h,c,d){var g,n,p,m,q=this.values,u=q[6],v=q[7];if(1!=b||0!=a||0!=f||1!=h)g=q[0],n=q[1],p=q[3],m=q[4],q[0]=g*b+n*f,q[1]=g*a+n*h,q[3]=p*b+m*f,q[4]=p*a+m*h;q[6]=u*b+v*f+c;q[7]=u*a+v*h+d};a.prototype.append=function(b,a,f,h,c,d){var g,n,p,m,q=this.values;g=q[0];n=q[1];p=q[3];m=q[4];q[0]=b*g+a*p;q[1]=b*n+a*m;q[3]=f*g+h*p;q[4]=f*n+h*m;q[6]=c*g+d*p+q[6];
q[7]=c*n+d*m+q[7]};a.prototype.prependTransform=function(b,e,f,h,c,d,g,n,p){if(c%360){var m=c*a.DEG_TO_RAD;c=Math.cos(m);m=Math.sin(m)}else c=1,m=0;if(n||p)this.values[6]-=n,this.values[7]-=p;d||g?(d*=a.DEG_TO_RAD,g*=a.DEG_TO_RAD,this.prepend(c*f,m*f,-m*h,c*h,0,0),this.prepend(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),b,e)):this.prepend(c*f,m*f,-m*h,c*h,b,e);return this};a.prototype.appendTransform=function(b,e,f,h,c,d,g,n,p){if(c%360){var m=c*a.DEG_TO_RAD;c=Math.cos(m);m=Math.sin(m)}else c=
1,m=0;d||g?(d*=a.DEG_TO_RAD,g*=a.DEG_TO_RAD,this.append(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),b,e),this.append(c*f,m*f,-m*h,c*h,0,0)):this.append(c*f,m*f,-m*h,c*h,b,e);if(n||p)this.values[6]-=n*this.values[0]+p*this.values[3],this.values[7]-=n*this.values[1]+p*this.values[4];return this};a.DEG_TO_RAD=Math.PI/180;return a}();d.Matrix=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
a._tweens,f=e.length-1;0<=f;f--)e[f]._target==b&&(e[f].paused=!0,e.splice(f,1));b.tween_count=0}};a.tick=function(b,e){void 0===e&&(e=!1);for(var f=a._tweens.concat(),h=f.length-1;0<=h;h--){var c=f[h];e&&!c.ignoreGlobalPause||c.paused||c.tick(c._useTicks?1:b)}};a._register=function(b,e){var f=b._target,c=a._tweens;if(e)f&&(f.tween_count=f.tween_count?f.tween_count+1:1),c.push(b);else for(f&&f.tween_count--,f=c.length;f--;)if(c[f]==b){c.splice(f,1);break}};a.removeAllTweens=function(){for(var b=a._tweens,
e=0,f=b.length;e<f;e++){var c=b[e];c.paused=!0;c._target.tweenjs_count=0}b.length=0};a.prototype.initialize=function(b,e,f){this._target=b;e&&(this._useTicks=e.useTicks,this.ignoreGlobalPause=e.ignoreGlobalPause,this.loop=e.loop,e.override&&a.removeTweens(b));this.pluginData=f||{};this._curQueueProps={};this._initQueueProps={};this._steps=[];this._actions=[];e&&e.paused?this.paused=!0:a._register(this,!0);e&&null!=e.position&&this.setPosition(e.position,a.NONE)};a.prototype.setPosition=function(b,
a){void 0===a&&(a=1);0>b&&(b=0);var f=b,c=!1;f>=this.duration&&(this.loop?f%=this.duration:(f=this.duration,c=!0));if(f==this._prevPos)return c;var d=this._prevPos;this.position=this._prevPos=f;this._prevPosition=b;if(this._target)if(c)this._updateTargetProps(null,1);else if(0<this._steps.length){for(var g=0,k=this._steps.length;g<k&&!(this._steps[g].t>f);g++);g=this._steps[g-1];this._updateTargetProps(g,(this._stepPosition=f-g.t)/g.d)}0!=a&&0<this._actions.length&&(this._useTicks?this._runActions(f,
f):1==a&&f<d?(d!=this.duration&&this._runActions(d,this.duration),this._runActions(0,f,!0)):this._runActions(d,f));c&&this.setPaused(!0);return c};a.prototype._runActions=function(b,a,f){void 0===f&&(f=!1);var c=b,d=a,g=-1,k=this._actions.length,n=1;b>a&&(c=a,d=b,g=k,k=n=-1);for(;(g+=n)!=k;){a=this._actions[g];var p=a.t;(p==d||p>c&&p<d||f&&p==b)&&a.f.apply(a.o,a.p)}};a.prototype._updateTargetProps=function(b,e){var f,c,d,g;if(b||1!=e){if(this.passive=!!b.v)return;b.e&&(e=b.e(e,0,1,1));f=b.p0;c=b.p1}else this.passive=
!1,f=c=this._curQueueProps;for(var k in this._initQueueProps){null==(d=f[k])&&(f[k]=d=this._initQueueProps[k]);null==(g=c[k])&&(c[k]=g=d);d=d==g||0==e||1==e||"number"!=typeof d?1==e?g:d:d+(g-d)*e;var n=!1;if(g=a._plugins[k])for(var p=0,m=g.length;p<m;p++){var q=g[p].tween(this,k,d,f,c,e,!!b&&f==c,!b);q==a.IGNORE?n=!0:d=q}n||(this._target[k]=d)}};a.prototype.setPaused=function(b){this.paused=b;a._register(this,!b);return this};a.prototype._cloneProps=function(b){var a={},f;for(f in b)a[f]=b[f];return a};
a.prototype._addStep=function(b){0<b.d&&(this._steps.push(b),b.t=this.duration,this.duration+=b.d);return this};a.prototype._appendQueueProps=function(b){var e,f,c,d,g,k;for(k in b)if(void 0===this._initQueueProps[k]){f=this._target[k];if(e=a._plugins[k])for(c=0,d=e.length;c<d;c++)f=e[c].init(this,k,f);this._initQueueProps[k]=this._curQueueProps[k]=void 0===f?null:f}for(k in b){f=this._curQueueProps[k];if(e=a._plugins[k])for(g=g||{},c=0,d=e.length;c<d;c++)e[c].step&&e[c].step(this,k,f,b[k],g);this._curQueueProps[k]=
b[k]}g&&this._appendQueueProps(g);return this._curQueueProps};a.prototype._addAction=function(b){b.t=this.duration;this._actions.push(b);return this};a.prototype._set=function(b,a){for(var f in b)a[f]=b[f]};a.prototype.wait=function(b,a){void 0===a&&(a=!1);if(null==b||0>=b)return this;var f=this._cloneProps(this._curQueueProps);return this._addStep({d:b,p0:f,p1:f,v:a})};a.prototype.to=function(b,a,f){void 0===f&&(f=void 0);if(isNaN(a)||0>a)a=0;return this._addStep({d:a||0,p0:this._cloneProps(this._curQueueProps),
...
(function(d){var g=function(){function c(){}Object.defineProperty(c.prototype,"gameObject",{get:function(){return this._gameObject},enumerable:!0,configurable:!0});Object.defineProperty(c.prototype,"transform",{get:function(){return this._gameObject.transform},enumerable:!0,configurable:!0});c.prototype.init=function(){};c.prototype.destroy=function(){};c.prototype.listRequiredComponents=function(){return[]};c.register=function(a,b){d.Assert.isObject(b);d.Assert.isString(b.name);d.Assert.isUndefined(c.configMap[b.name]);
c.configMap[b.name]=a};c.create=function(a){a=c.configMap[a];d.Assert.isFunction(a);return new a};c.configMap={};return c}();d.Component=g})(WOZLLA||(WOZLLA={}));(function(d){var g=function(c){function a(){c.apply(this,arguments)}__extends(a,c);a.prototype.collideXY=function(b,a){return!1};a.prototype.collide=function(b){return!1};return a}(d.Component);d.Collider=g})(WOZLLA||(WOZLLA={}));
(function(d){var g=function(b,a){return b.z-a.z},c={},a=function(a){function e(f){void 0===f&&(f=!1);a.call(this);this._visible=this._active=!0;this._touchable=this._destroyed=this._initialized=!1;this._name="GameObject";this._children=[];this._components=[];this._transform=f?new d.RectTransform:new d.Transform;this._rectTransform=f?this._transform:null;this._z=0;this._behaviours=[]}__extends(e,a);e.getById=function(a){return c[a]};Object.defineProperty(e.prototype,"id",{get:function(){return this._id},
set:function(a){var b=this._id;this._id=a;b&&delete c[b];c[a]=this},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"name",{get:function(){return this._name},set:function(a){this._name=a},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"transform",{get:function(){return this._transform},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"rectTransform",{get:function(){return this._rectTransform},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,
"parent",{get:function(){return this._parent},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"children",{get:function(){return this._children.slice(0)},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"childCount",{get:function(){return this._children.length},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"z",{get:function(){return this._z},set:function(a){this.setZ(a,!0)},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"active",
{get:function(){return this._active},set:function(a){var b=this._active;this._active=a;!b&&a&&(this._transform.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"visible",{get:function(){return this._visible},set:function(a){this._visible=a},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"initialized",{get:function(){return this._initialized},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"destroyed",{get:function(){return this._destroyed},
enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"touchable",{get:function(){return this._touchable},set:function(a){this._touchable=a},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"renderer",{get:function(){return this._renderer},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"collider",{get:function(){return this._collider},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"behaviours",{get:function(){return this._behaviours.slice(0)},
enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"mask",{get:function(){return this._mask},enumerable:!0,configurable:!0});e.prototype.setZ=function(a,b){void 0===b&&(b=!0);this._z!==a&&(this._z=a,b&&this._children.sort(g))};e.prototype.addChild=function(a,b){void 0===b&&(b=!0);if(-1!==this._children.indexOf(a))return!1;a._parent&&a.removeMe();a.dispatchEvent(new d.CoreEvent("beforeadd",!0));this._children.push(a);b&&this._children.sort(g);a._parent=this;a._transform.dirty=!0;a.dispatchEvent(new d.CoreEvent("add",
!0));return!0};e.prototype.removeChild=function(a){var b=this._children.indexOf(a);return-1!==b?(a.dispatchEvent(new d.CoreEvent("beforeremove",!0,null,!1)),this._children.splice(b,1),a._parent=null,a.dispatchEvent(new d.CoreEvent("remove",!0,null,!1)),!0):!1};e.prototype.getChild=function(a){var b,e,c;e=0;for(c=this._children.length;e<c;e++)if(b=this._children[e],b._name===a)return b;return null};e.prototype.getChildren=function(a){var b,e,c,d=[];e=0;for(c=this._children.length;e<c;e++)b=this._children[e],
b._name===a&&d.push(b);return d};e.prototype.removeMe=function(){var a=this._parent;return a&&a.removeChild(this)};e.prototype.eachChild=function(a){this._children.forEach(a)};e.prototype.sortChildren=function(){this._children.sort(g)};e.prototype.getPath=function(a){void 0===a&&(a="/");for(var b=[],e=this;e;)b.unshift(e.name),e=e.parent;return b.join(a)};e.prototype.contains=function(a){if(a===this)return!0;for(;a=a.parent;)if(a===this)return!0;return!1};e.prototype.getComponent=function(a){var b,
e,c;if(0>=this._components.length)return null;e=0;for(c=this._components.length;e<c;e++)if(b=this._components[e],b instanceof a)return b;return null};e.prototype.hasComponent=function(a){var b,e,c;if(0>=this._components.length)return!1;e=0;for(c=this._components.length;e<c;e++)if(b=this._components[e],b instanceof a)return!0;return!1};e.prototype.getComponents=function(a){var b,e,c,d=[];if(0>=this._components.length)return d;e=0;for(c=this._components.length;e<c;e++)b=this._components[e],b instanceof
a&&d.push(b);return d};e.prototype.addComponent=function(a){if(-1!==this._components.indexOf(a))return!1;if(!this.checkComponentDependency(a))throw Error("Can't not add, because of dependency");a._gameObject&&a._gameObject.removeComponent(a);this._components.push(a);a._gameObject=this;a instanceof d.Behaviour?this._behaviours.push(a):a instanceof d.Renderer?this._renderer=a:a instanceof d.Collider?this._collider=a:a instanceof d.Mask&&(this._mask=a);return!0};e.prototype.removeComponent=function(a){var b,
e,c,g=this._components.indexOf(a);if(-1!==g){b=0;for(e=this._components.length;b<e;b++)if(c=this._components[b],c!==a&&this.checkComponentDependency(c))throw Error("Can't not remove, because of dependency");this._components.splice(g,1);a instanceof d.Behaviour?this._behaviours.splice(this._behaviours.indexOf(a),1):a instanceof d.Renderer?this._renderer=null:a instanceof d.Collider?this._collider=null:a instanceof d.Mask&&(this._mask=null);a._gameObject=null;return!0}return!1};e.prototype.init=function(){var a,
b;if(!this._initialized&&!this._destroyed){a=0;for(b=this._components.length;a<b;a++)this._components[a].init();a=0;for(b=this._children.length;a<b;a++)this._children[a].init();this._initialized=!0}};e.prototype.destroy=function(){var a,b;if(!this._destroyed&&this._initialized){a=0;for(b=this._components.length;a<b;a++)this._components[a].destroy();a=0;for(b=this._children.length;a<b;a++)this._children[a].destroy();this._id&&delete c[this._id];this.clearAllListeners();this._destroyed=!0}};e.prototype.update=
function(){var a,b,e;if(this._active){if(0<this._behaviours.length)for(a=0,b=this._behaviours.length;a<b;a++)e=this._behaviours[a],e.enabled&&e.update();if(0<this._children.length)for(a=0,b=this._children.length;a<b;a++)this._children[a].update()}};e.prototype.visit=function(a,b,c){var d;if(this._active&&this._initialized&&!this._destroyed)for(this._transform.dirty&&(c|=e.MASK_TRANSFORM_DIRTY),(c&e.MASK_TRANSFORM_DIRTY)==e.MASK_TRANSFORM_DIRTY&&this._transform.transform(b),this._visible||(c&=~e.MASK_VISIBLE),
(c&e.MASK_VISIBLE)===e.MASK_VISIBLE&&this.render(a,c),b=0,d=this._children.length;b<d;b++)this._children[b].visit(a,this._transform,c);else(c&e.MASK_TRANSFORM_DIRTY)===e.MASK_TRANSFORM_DIRTY&&(this._transform.dirty=!0)};e.prototype.render=function(a,b){this._mask&&this._mask.render(a,b);this._renderer&&this._renderer.render(a,b)};e.prototype.getUnderPoint=function(a,b,e){void 0===e&&(e=!1);var c,d;if(!this._active||!this._visible)return null;d=this._children;if(0<d.length)for(var g=d.length-1;0<=
g;g--)if(c=d[g],c=c.getUnderPoint(a,b,e))return c;if(!e||this._touchable)if(a=this.transform.globalToLocal(a,b),this.testHit(a.x,a.y))return this;return null};e.prototype.testHit=function(a,b){var e=this._collider;return e&&e.collideXY(a,b)};e.prototype.checkComponentDependency=function(a){for(var b=a.listRequiredComponents(),e=!0,c=0,d=b.length;c<d;c++)a=b[c],e=e&&this.hasComponent(a);return e};e.MASK_TRANSFORM_DIRTY=1;e.MASK_VISIBLE=16;return e}(d.event.EventDispatcher);d.GameObject=a})(WOZLLA||
(WOZLLA={}));
...
a.prototype.onGestureEvent=function(a){var b,c,g,l,k,n,p,m,q=a.type,u=d.Director.getInstance().stage,v=this.touchScale||1;if(p=a.gesture.srcEvent.changedTouches)for(l=p.length,g=0;g<l;g++)c=p[g],k=parseInt(c.identifier),b=c.pageX-this.canvasOffset.x,c=c.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===q&&(m=u.getUnderPoint(b,c,!0))&&(this.channelMap[k]=this.createDispatchChanel(m),delete this.channelMap[k-10]),(n=this.channelMap[k])&&n.onGestureEvent(a,m,b,c,k);else k=1,b=a.gesture.srcEvent.pageX-this.canvasOffset.x,
c=a.gesture.srcEvent.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===q&&((m=u.getUnderPoint(b,c,!0))?this.channelMap[k]=this.createDispatchChanel(m):delete this.channelMap[k]),(n=this.channelMap[k])&&n.onGestureEvent(a,m,b,c,k)};a.prototype.createDispatchChanel=function(a){var b=!0;return{onGestureEvent:function(h,g,l,k,n){var p=h.type,m=d.Director.getInstance().stage;switch(p){case "drag":if(!b){g=a;break}case "tap":case "release":g=m.getUnderPoint(l,k,!0)}if("tap"!==p||a===g)h=new c({x:l,y:k,type:p,
bubbles:!0,touch:g,gesture:h.gesture,identifier:n,touchMoveDetection:!1}),a.dispatchEvent(h),b=h.touchMoveDetection}}};return a}();d.Touch=a})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function a(){}a.getGLContext=function(a,e){var c,d=e||{},g={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},l;for(l in g)"undefined"===typeof d[l]&&(d[l]=g[l]);e=d;try{c=a.getContext("experimental-webgl",e)}catch(k){try{c=a.getContext("webgl",e)}catch(n){}}return c};a.compileShader=function(a,e,c){e=a.createShader(e);a.shaderSource(e,c);a.compileShader(e);return a.getShaderParameter(e,a.COMPILE_STATUS)?e:(console.log(a.getShaderInfoLog(e)),null)};
...
function(a,b){this._renderOffset=a;this._renderCount=b};a.prototype.setVertices=function(a,b,c,d,g,k,n,p,m){void 0===m&&(m=0);var q=this._type.strade;m=this._type.size*m+this._type.vertexIndex;this._storage[0+m]=a;this._storage[1+m]=b;this._storage[0+m+1*q]=c;this._storage[1+m+1*q]=d;this._storage[0+m+2*q]=g;this._storage[1+m+2*q]=k;this._storage[0+m+3*q]=n;this._storage[1+m+3*q]=p};a.prototype.setTexCoords=function(a,b,c,d,g,k,n,p,m){void 0===m&&(m=0);var q=this._type.strade;m=this._type.size*m+
this._type.texCoordIndex;this._storage[0+m]=a;this._storage[1+m]=b;this._storage[0+m+1*q]=c;this._storage[1+m+1*q]=d;this._storage[0+m+2*q]=g;this._storage[1+m+2*q]=k;this._storage[0+m+3*q]=n;this._storage[1+m+3*q]=p};a.prototype.setAlpha=function(a,b){void 0===b&&(b=0);var c=this._type.strade,d=this._type.size*b+this._type.alphaIndex;this._storage[d]=a;this._storage[d+1*c]=a;this._storage[d+2*c]=a;this._storage[d+3*c]=a};a.prototype.setColor=function(a,b){void 0===b&&(b=0);var c=this._type.strade,
...
this._updateQuadVerticesByArgs(b,e,c,this._gameObject.transform.worldMatrix,a);this._quadVertexDirty=!1};e.prototype._updateQuadVerticesByArgs=function(a,b,e,c,d){void 0===d&&(d=0);var g=c.values[0],p=c.values[1],m=c.values[3],q=c.values[4],u=c.values[6];c=c.values[7];var v=-e.x*b.width,t=v+b.width;e=-e.y*b.height;b=e+b.height;this._quad.setVertices(g*v+m*e+u,q*e+p*v+c,g*t+m*e+u,q*e+p*t+c,g*t+m*b+u,q*b+p*t+c,g*v+m*b+u,q*b+p*v+c,d);this._quad.setTexCoords(a.x0,a.y0,a.x1,a.y1,a.x2,a.y2,a.x3,a.y3,d)};
...
e.prototype._updateNinePatchQuads=function(){this._updateNinePatchQuadVertices();this._updateNinePatchQuadAlpha();this._updateNinePatchQuadColor();this._textureUpdated=!1};e.prototype._updateNinePatchQuadVertices=function(){for(var a=new d.Transform,b=this._getTextureFrame(),c,e={x:0,y:0},g=this._patch||new d.math.Rectangle(0,0,b.width,b.height),n=this._renderRegion||g,b=[{frame:{x:b.x,y:b.y,width:g.left,height:g.top},pos:{x:n.x,y:n.y},size:{width:1,height:1}},{frame:{x:b.x+g.left,y:b.y,width:g.width,
height:g.top},pos:{x:n.x+g.left,y:n.y},size:{width:(n.width-(g.right-g.width))/g.width,height:1}},{frame:{x:b.x+g.right,y:b.y,width:b.width-g.right,height:g.top},pos:{x:n.right,y:n.y},size:{width:1,height:1}},{frame:{x:b.x,y:b.y+g.top,width:g.left,height:g.height},pos:{x:n.x,y:n.y+g.top},size:{width:1,height:(n.height-(g.bottom-g.height))/g.height}},{frame:{x:b.x+g.left,y:b.y+g.top,width:g.width,height:g.height},pos:{x:n.x+g.left,y:n.y+g.top},size:{width:(n.width-(g.right-g.width))/g.width,height:(n.height-
(g.bottom-g.height))/g.height}},{frame:{x:b.x+g.right,y:b.y+g.top,width:b.width-g.right,height:g.height},pos:{x:n.right,y:n.y+g.top},size:{width:1,height:(n.height-(g.bottom-g.height))/g.height}},{frame:{x:b.x,y:b.y+g.bottom,width:b.width-g.right,height:b.height-g.bottom},pos:{x:n.x,y:n.bottom},size:{width:1,height:1}},{frame:{x:b.x+g.left,y:b.y+g.bottom,width:g.width,height:b.height-g.bottom},pos:{x:n.x+g.left,y:n.bottom},size:{width:(n.width-(g.right-g.width))/g.width,height:1}},{frame:{x:b.x+g.right,
y:b.y+g.bottom,width:b.width-g.right,height:b.height-g.bottom},pos:{x:n.right,y:n.bottom},size:{width:1,height:1}}],g=0;9>g;g++)if(n=b[g],0<n.frame.width&&0<n.frame.height){c=n.frame;var p=this._texture,m=p.descriptor.width,p=p.descriptor.height,q={};q.x0=c.x/m;q.y0=c.y/p;q.x1=(c.x+c.width)/m;q.y1=c.y/p;q.x2=(c.x+c.width)/m;q.y2=(c.y+c.height)/p;q.x3=c.x/m;q.y3=(c.y+c.height)/p;c=q;a.set(this.gameObject.transform);a.x+=n.pos.x;a.y+=n.pos.y;a.setScale(n.size.width,n.size.height);a.updateWorldMatrix();
this._updateQuadVerticesByArgs(c,n.frame,e,a.worldMatrix,g)}else this._clearQuadVertices(g);this._quadVertexDirty=!1};e.prototype._updateNinePatchQuadAlpha=function(){for(var a=0;9>a;a++)this._updateQuadAlpha(a);this._quadAlphaDirty=!1};e.prototype._updateNinePatchQuadColor=function(){for(var a=0;9>a;a++)this._updateQuadColor(a);this._quadColorDirty=!1};e.prototype.render=function(a,b){this._texture&&((b&d.GameObject.MASK_TRANSFORM_DIRTY)===d.GameObject.MASK_TRANSFORM_DIRTY&&(this._quadVertexDirty=
...
success:function(c){b.data=c;a&&a()},error:function(c){b.err=c;a&&a()}}):a&&a()};a.prototype._newGameObjectTree=function(a){var b=this;this._newGameObject(this.data.root,function(c){b.root=c;a&&a()})};a.prototype._newGameObject=function(a,b){var c=this,g=new d.GameObject(a.rect);g.id=a.id;g.name=a.name;g.active=a.active;g.visible=a.visible;g.touchable=a.touchable;g.transform.set(a.transform);var l=a.components;l&&0<l.length&&l.forEach(function(a){a=d.Component.create(a.name);g.addComponent(a)});var k=
0,n=a.children;n&&0!==n.length?n.forEach(function(a){a.reference?c._newReferenceObject(a,function(a){a&&g.addChild(a);k++;k===n.length&&b(g)}):c._newGameObject(a,function(a){g.addChild(a);k++;k===n.length&&b(g)})}):b(g)};a.prototype._newReferenceObject=function(c,d){var g=this;(new a).instantiateWithSrc(c.reference).build(function(a,b){a?g.err=a:b&&(b.name=c.name,b.id=c.id,b.active=c.active,b.visible=c.visible,b.touchable=c.touchable,b.transform.set(c.transform));d(b)})};a.prototype._loadAssets=function(a){a&&
a()};a.prototype._init=function(){this.root.init()};return a}();g.JSONXBuilder=a})(d.jsonx||(d.jsonx={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){(function(c){c.rectIntersect=function(a,b){return a.x<b.x+b.width&&b.x<a.x+a.width&&a.y<b.y+b.height&&b.y<a.y+a.height};c.rectIntersect2=function(a,b,c,d,g,s,l,k){return a<=g+l&&g<=a+c&&b<=s+k&&s<=b+d}})(d.MathUtils||(d.MathUtils={}))})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
function(c){var e=this,g,k;d.Assert.isNotUndefined(this._stateConfig[c]);g=this._currentState;k=this._stateConfig[c][c]||b.getInstance();this._currentTransition&&this._currentTransition.cancel();k.reset();k.execute(g,c,function(){e._currentTransition=null;e._currentState=c;e.dispatchEvent(new d.event.Event(f.CHANGE,!1,new a(e._currentState)))});this._currentTransition=k};f.INIT="state.init";f.CHANGE="state.change";return f}(d.event.EventDispatcher);g.StateMachine=c;var a=function(){return function(a){this.state=
...
(function(d){(function(g){var c=d.utils.StateMachine,a=function(a){function e(){a.apply(this,arguments);this._stateMachine=new d.utils.StateMachine}__extends(e,a);Object.defineProperty(e.prototype,"spriteAtlas",{get:function(){return this._spriteAtlas},set:function(a){this._spriteAtlas=a},enumerable:!0,configurable:!0});e.prototype.listRequiredComponents=function(){return[d.component.SpriteRenderer]};e.prototype.init=function(){var e=this;this._stateMachine.addListener(c.INIT,function(a){return e.onStateChange(a)});
this._stateMachine.addListener(c.CHANGE,function(a){return e.onStateChange(a)});this._spriteRenderer=this.gameObject.renderer;a.prototype.init.call(this)};e.prototype.getStateSpriteName=function(a){return this._stateMachine.getStateData(a,"spriteName")};e.prototype.setStateSpriteName=function(a,b){this._stateMachine.setStateData(a,"spriteName",b)};e.prototype.onStateChange=function(a){this._spriteRenderer.sprite=this._spriteAtlas.getSprite(this.getStateSpriteName(a.data.state))};return e}(d.Component);
...
(function(d){(function(g){var c=function(a){function b(){a.call(this,this)}__extends(b,a);b.prototype._generateArmature=function(){var a=new d.GameObject;a.init();return new dragonBones.Armature(a)};b.prototype._generateSlot=function(){return new g.WSlot};b.prototype._generateDisplay=function(a,b,c,g){var l=new d.GameObject,k=new d.component.SpriteRenderer;k.sprite=a.getSprite(b);k.spriteOffset={x:c/k.sprite.frame.width,y:g/k.sprite.frame.height};l.addComponent(k);l.init();return l};return b}(dragonBones.BaseFactory);
