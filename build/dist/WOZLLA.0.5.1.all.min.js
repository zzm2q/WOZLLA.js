(function(d,f){function c(){b.READY||(q.determineEventTypes(),t.each(b.gestures,function(a){w.register(a)}),q.onTouch(b.DOCUMENT,l,w.detect),q.onTouch(b.DOCUMENT,n,w.detect),b.READY=!0)}var b=function y(a,e){return new y.Instance(a,e||{})};b.VERSION="1.1.3";b.defaults={behavior:{userSelect:"none",touchAction:"pan-y",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};b.DOCUMENT=document;b.HAS_POINTEREVENTS=navigator.pointerEnabled||navigator.msPointerEnabled;
b.HAS_TOUCHEVENTS="ontouchstart"in d;b.IS_MOBILE=/mobile|tablet|ip(ad|hone|od)|android|silk/i.test(navigator.userAgent);b.NO_MOUSEEVENTS=b.HAS_TOUCHEVENTS&&b.IS_MOBILE||b.HAS_POINTEREVENTS;b.CALCULATE_INTERVAL=25;var a={},e=b.DIRECTION_DOWN="down",g=b.DIRECTION_LEFT="left",h=b.DIRECTION_UP="up",r=b.DIRECTION_RIGHT="right",p=b.POINTER_MOUSE="mouse",s=b.POINTER_TOUCH="touch",k=b.POINTER_PEN="pen",m=b.EVENT_START="start",l=b.EVENT_MOVE="move",n=b.EVENT_END="end",u=b.EVENT_RELEASE="release",v=b.EVENT_TOUCH=
...
0;c<h.length;c++){var d=e;h[c]&&(d=h[c]+d.slice(0,1).toUpperCase()+d.slice(1));if(d in a.style){a.style[d]=(null==g||g)&&b||"";break}}},toggleBehavior:function(a,e,b){if(e&&a&&a.style){t.each(e,function(e,g){t.setPrefixedCss(a,g,e,b)});var g=b&&function(){return!1};"none"==e.userSelect&&(a.onselectstart=g);"none"==e.userDrag&&(a.ondragstart=g)}},toCamelCase:function(a){return a.replace(/[_-]([a-z])/g,function(a){return a[1].toUpperCase()})}},q=b.event={preventMouseEvents:!1,started:!1,shouldDetect:!1,
on:function(a,e,b,g){e=e.split(" ");t.each(e,function(e){t.on(a,e,b);g&&g(e)})},off:function(a,e,b,g){e=e.split(" ");t.each(e,function(e){t.off(a,e,b);g&&g(e)})},onTouch:function(e,g,h){var c=this,d=function(a){var d=a.type.toLowerCase(),r=b.HAS_POINTEREVENTS,d=t.inStr(d,"mouse"),p;d&&c.preventMouseEvents||(d&&g==m&&0===a.button?(c.preventMouseEvents=!1,c.shouldDetect=!0):r&&g==m?c.shouldDetect=1===a.buttons||x.matchType(s,a):d||g!=m||(c.preventMouseEvents=!0,c.shouldDetect=!0),r&&g!=n&&x.updatePointer(g,
a),c.shouldDetect&&(p=c.doDetect.call(c,a,g,e,h)),p==n&&(c.preventMouseEvents=!1,c.shouldDetect=!1,x.reset()),r&&g==n&&x.updatePointer(g,a))};this.on(e,a[g],d);return d},doDetect:function(a,e,b,g){var h=this.getTouchList(a,e),c=e,d=h.trigger,r=h.length;e==m?d=v:e==n&&(d=u,r=h.length-(a.changedTouches?a.changedTouches.length:1));0<r&&this.started&&(c=l);this.started=!0;a=this.collectEventData(b,c,h,a);e!=n&&g.call(w,a);d&&(a.changedLength=r,a.eventType=d,g.call(w,a),a.eventType=c,delete a.changedLength);
c==n&&(g.call(w,a),this.started=!1);return c},determineEventTypes:function(){var e;e=b.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:b.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];a[m]=e[0];a[l]=e[1];a[n]=e[2];return a},getTouchList:function(a,e){if(b.HAS_POINTEREVENTS)return x.getTouchList();
if(a.touches){if(e==l)return a.touches;var g=[],h=[].concat(t.toArray(a.touches),t.toArray(a.changedTouches)),c=[];t.each(h,function(a){!1===t.inArray(g,a.identifier)&&c.push(a);g.push(a.identifier)});return c}a.identifier=1;return[a]},collectEventData:function(a,e,b,g){a=s;t.inStr(g.type,"mouse")||x.matchType(p,g)?a=p:x.matchType(k,g)&&(a=k);return{center:t.getCenter(b),timeStamp:Date.now(),target:g.target,touches:b,eventType:e,pointerType:a,srcEvent:g,preventDefault:function(){var a=this.srcEvent;
a.preventManipulation&&a.preventManipulation();a.preventDefault&&a.preventDefault()},stopPropagation:function(){this.srcEvent.stopPropagation()},stopDetect:function(){return w.stopDetect()}}}},x=b.PointerEvent={pointers:{},getTouchList:function(){var a=[];t.each(this.pointers,function(e){a.push(e)});return a},updatePointer:function(a,e){a==n?delete this.pointers[e.pointerId]:(e.identifier=e.pointerId,this.pointers[e.pointerId]=e)},matchType:function(a,e){if(!e.pointerType)return!1;var b=e.pointerType,
g={};g[p]=b===(e.MSPOINTER_TYPE_MOUSE||p);g[s]=b===(e.MSPOINTER_TYPE_TOUCH||s);g[k]=b===(e.MSPOINTER_TYPE_PEN||k);return g[a]},reset:function(){this.pointers={}}},w=b.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(a,e){this.current||(this.stopped=!1,this.current={inst:a,startEvent:t.extend({},e),lastEvent:!1,lastCalcEvent:!1,futureCalcEvent:!1,lastCalcData:{},name:""},this.detect(e))},detect:function(a){if(this.current&&!this.stopped){a=this.extendEventData(a);var e=
this.current.inst,b=e.options;t.each(this.gestures,function(g){!this.stopped&&e.enabled&&b[g.name]&&g.handler.call(g,a,e)},this);this.current&&(this.current.lastEvent=a);a.eventType==n&&this.stopDetect();return a}},stopDetect:function(){this.previous=t.extend({},this.current);this.current=null;this.stopped=!0},getCalculatedData:function(a,e,g,h,c){var d=this.current,r=!1,p=d.lastCalcEvent,f=d.lastCalcData;p&&a.timeStamp-p.timeStamp>b.CALCULATE_INTERVAL&&(e=p.center,g=a.timeStamp-p.timeStamp,h=a.center.clientX-
p.center.clientX,c=a.center.clientY-p.center.clientY,r=!0);if(a.eventType==v||a.eventType==u)d.futureCalcEvent=a;if(!d.lastCalcEvent||r)f.velocity=t.getVelocity(g,h,c),f.angle=t.getAngle(e,a.center),f.direction=t.getDirection(e,a.center),d.lastCalcEvent=d.futureCalcEvent||a,d.futureCalcEvent=a;a.velocityX=f.velocity.x;a.velocityY=f.velocity.y;a.interimAngle=f.angle;a.interimDirection=f.direction},extendEventData:function(a){var e=this.current,b=e.startEvent,e=e.lastEvent||b;if(a.eventType==v||a.eventType==
...
(function(a){var c=!1;b.gestures.Drag={name:a,index:50,handler:function(b,d){var p=w.current;if(!(0<d.options.dragMaxTouches&&b.touches.length>d.options.dragMaxTouches))switch(b.eventType){case m:c=!1;break;case l:if(b.distance<d.options.dragMinDistance&&p.name!=a)break;var f=p.startEvent.center;if(p.name!=a&&(p.name=a,d.options.dragDistanceCorrection&&0<b.distance)){var s=Math.abs(d.options.dragMinDistance/b.distance);f.pageX+=b.deltaX*s;f.pageY+=b.deltaY*s;f.clientX+=b.deltaX*s;f.clientY+=b.deltaY*
s;b=w.extendEventData(b)}if(p.lastEvent.dragLockToAxis||d.options.dragLockToAxis&&d.options.dragLockMinDistance<=b.distance)b.dragLockToAxis=!0;p=p.lastEvent.direction;b.dragLockToAxis&&p!==b.direction&&(t.isVertical(p)?b.direction=0>b.deltaY?h:e:b.direction=0>b.deltaX?g:r);c||(d.trigger(a+"start",b),c=!0);d.trigger(a,b);d.trigger(a+b.direction,b);p=t.isVertical(b.direction);(d.options.dragBlockVertical&&p||d.options.dragBlockHorizontal&&!p)&&b.preventDefault();break;case u:c&&b.changedLength<=d.options.dragMaxTouches&&
(d.trigger(a+"end",b),c=!1);break;case n:c=!1}},defaults:{dragMinDistance:10,dragDistanceCorrection:!0,dragMaxTouches:1,dragBlockHorizontal:!1,dragBlockVertical:!1,dragLockToAxis:!1,dragLockMinDistance:25}}})("drag");b.gestures.Gesture={name:"gesture",index:1337,handler:function(a,e){e.trigger(this.name,a)}};(function(a){var e;b.gestures.Hold={name:a,index:10,defaults:{holdTimeout:500,holdThreshold:2},handler:function(b,g){var h=g.options,c=w.current;switch(b.eventType){case m:clearTimeout(e);c.name=
...
null}};c.prototype.gotoAndPlay=function(b,a,e,g,h,r,p,f,k){void 0===a&&(a=-1);void 0===e&&(e=-1);void 0===g&&(g=NaN);void 0===h&&(h=0);void 0===r&&(r=null);void 0===p&&(p=c.SAME_LAYER_AND_GROUP);void 0===f&&(f=!0);void 0===k&&(k=!0);if(!this._animationDataList)return null;for(var m=this._animationDataList.length,l;m--;)if(this._animationDataList[m].name==b){l=this._animationDataList[m];break}if(!l)return null;this._isFading=this._isPlaying=!0;a=0>a?0>l.fadeTime?.3:l.fadeTime:a;e=0>e?0>l.scale?1:l.scale:
1E3*e/l.duration;g=isNaN(g)?l.playTimes:g;switch(p){case c.NONE:break;case c.SAME_LAYER:for(m=this._animationStateList.length;m--;)p=this._animationStateList[m],p.layer==h&&p.fadeOut(a,f);break;case c.SAME_GROUP:for(m=this._animationStateList.length;m--;)p=this._animationStateList[m],p.group==r&&p.fadeOut(a,f);break;case c.ALL:for(m=this._animationStateList.length;m--;)p=this._animationStateList[m],p.fadeOut(a,f);break;default:for(m=this._animationStateList.length;m--;)p=this._animationStateList[m],
p.layer==h&&p.group==r&&p.fadeOut(a,f)}this._lastAnimationState=d.AnimationState._borrowObject();this._lastAnimationState._layer=h;this._lastAnimationState._group=r;this._lastAnimationState.autoTween=this.tweenEnabled;this._lastAnimationState._fadeIn(this._armature,l,a,1/e,g,k);this.addState(this._lastAnimationState);g=this._armature.getSlots(!1);for(m=g.length;m--;)h=g[m],h.childArmature&&h.childArmature.animation.gotoAndPlay(b,a);return this._lastAnimationState};c.prototype.gotoAndStop=function(b,
a,e,g,h,d,p,f){void 0===e&&(e=-1);void 0===g&&(g=0);void 0===h&&(h=-1);void 0===d&&(d=0);void 0===p&&(p=null);void 0===f&&(f=c.ALL);var k=this.getState(b,d);k||(k=this.gotoAndPlay(b,g,h,NaN,d,p,f));0<=e?k.setCurrentTime(k.totalTime*e):k.setCurrentTime(a);k.stop();return k};c.prototype.play=function(){this._animationDataList&&0!=this._animationDataList.length&&(this._lastAnimationState?this._isPlaying?this.gotoAndPlay(this._lastAnimationState.name):this._isPlaying=!0:this.gotoAndPlay(this._animationDataList[0].name))};
...
h?(c=h,g=!0):c<=-h?(c=-h,g=!0):g=!1,0>c&&(c+=h),h=Math.ceil(c/this._totalTime)||1,c=0<=c?c-Math.floor(c/this._totalTime)*this._totalTime:c-Math.ceil(c/this._totalTime)*this._totalTime,g&&(c=this._totalTime));this._isComplete=g;var p=1E3*this._time/this._totalTime,f;for(f in this._timelineStateList){var k=this._timelineStateList[f];k._update(p);this._isComplete=k._isComplete&&this._isComplete}this._currentTime!=c&&(this._currentPlayTimes!=h&&(0<this._currentPlayTimes&&1<h&&(e=!0),this._currentPlayTimes=
h),0>this._currentTime&&(a=!0),this._isComplete&&(b=!0),this._currentTime=c,this.updateMainTimeline(g));a&&this._armature.hasEventListener(d.AnimationEvent.START)&&(f=new d.AnimationEvent(d.AnimationEvent.START),f.animationState=this,this._armature._eventList.push(f));b?(this._armature.hasEventListener(d.AnimationEvent.COMPLETE)&&(f=new d.AnimationEvent(d.AnimationEvent.COMPLETE),f.animationState=this,this._armature._eventList.push(f)),this.autoFadeOut&&this.fadeOut(this.fadeOutTime,!0)):e&&this._armature.hasEventListener(d.AnimationEvent.LOOP_COMPLETE)&&
(f=new d.AnimationEvent(d.AnimationEvent.LOOP_COMPLETE),f.animationState=this,this._armature._eventList.push(f))};c.prototype.updateMainTimeline=function(b){var a=this._clip.frameList;if(0<a.length){for(var e,g,h=0,c=this._clip.frameList.length;h<c;++h){if(0>this._currentFrameIndex)this._currentFrameIndex=0;else if(this._currentTime<this._currentFramePosition||this._currentTime>=this._currentFramePosition+this._currentFrameDuration){if(this._currentFrameIndex++,this._currentFrameIndex>=a.length)if(b){this._currentFrameIndex--;
...
};b.prototype._updateDisplayColor=function(a,e,b,h,c,d,f,k){this._colorTransform.alphaOffset=a;this._colorTransform.redOffset=e;this._colorTransform.greenOffset=b;this._colorTransform.blueOffset=h;this._colorTransform.alphaMultiplier=c;this._colorTransform.redMultiplier=d;this._colorTransform.greenMultiplier=f;this._colorTransform.blueMultiplier=k};b.prototype._updateDisplayBlendMode=function(a){throw Error("Abstract method needs to be implemented in subclass!");};return b}(d.DBObject);d.Slot=f})(dragonBones||
...
null==a.armatureData.getBoneData(b)&&(b=null),a.addBone(h,b,!0);a._updateAnimationAfterBoneListChanged()};b.prototype._buildSlots=function(a,e,b){var h=a.armatureData.getSkinData(e);if(h)for(var c=[],h=h.slotDataList,p,f,k,m=0;m<h.length;m++)if(p=h[m],k=a.getBone(p.parent)){f=this._generateSlot();f.initWithSlotData(p);k.addSlot(f);for(k=p.displayDataList.length;k--;){var l=p.displayDataList[k];switch(l.type){case d.DisplayData.ARMATURE:l=this.buildArmatureUsingArmatureDataFromTextureAtlas(a.__dragonBonesData,
a.__dragonBonesData.getArmatureDataByName(l.name),b,e);c[k]=l;break;default:c[k]=this._generateDisplay(b,l.name,l.pivot.x,l.pivot.y)}}for(var n in c)if(p=c[n],p instanceof d.Armature&&(p=p.display),p.hasOwnProperty("name"))try{p.name=f.name}catch(u){}f.displayList=c;f._changeDisplay(0)}};b.prototype._generateArmature=function(){return null};b.prototype._generateSlot=function(){return null};b.prototype._generateDisplay=function(a,e,b,h){return null};b._helpMatrix=new d.Matrix;return b}(d.EventDispatcher);
...
(function(d){var f=function(){function c(){}c.parseTextureAtlasData=function(b,a){void 0===a&&(a=1);var e={},g,h=b[d.ConstValues.SUB_TEXTURE],r;for(r in h){var f=h[r],s=f[d.ConstValues.A_NAME],k=new d.Rectangle;k.x=c.getNumber(f,d.ConstValues.A_X,0)/a;k.y=c.getNumber(f,d.ConstValues.A_Y,0)/a;k.width=c.getNumber(f,d.ConstValues.A_WIDTH,0)/a;k.height=c.getNumber(f,d.ConstValues.A_HEIGHT,0)/a;var m="true"==f[d.ConstValues.A_ROTATED],l=c.getNumber(f,d.ConstValues.A_FRAME_WIDTH,0)/a,n=c.getNumber(f,d.ConstValues.A_FRAME_HEIGHT,
0)/a;0<l&&0<n?(g=new d.Rectangle,g.x=c.getNumber(f,d.ConstValues.A_FRAME_X,0)/a,g.y=c.getNumber(f,d.ConstValues.A_FRAME_Y,0)/a,g.width=l,g.height=n):g=null;e[s]=new d.TextureData(k,g,m)}return e};c.parseDragonBonesData=function(b){if(!b)throw Error();var a=b[d.ConstValues.A_VERSION],a=a.toString();if(a.toString()!=d.DragonBones.DATA_VERSION&&a.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var a=c.getNumber(b,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
...
a);e.addFrame(r)}c.parseTimeline(b,e);g=e.duration;r=b[d.ConstValues.TIMELINE];for(h in r){var f=r[h],s=c.parseTransformTimeline(f,e.duration,a),s=c.parseTransformTimeline(f,e.duration,a),g=Math.min(g,s.frameList[s.frameList.length-1].duration);e.addTimeline(s)}0<e.frameList.length&&(g=Math.min(g,e.frameList[e.frameList.length-1].duration));e.lastFrameDuration=g;return e};c.parseTransformTimeline=function(b,a,e){var g=new d.TransformTimeline;g.name=b[d.ConstValues.A_NAME];g.scale=c.getNumber(b,d.ConstValues.A_SCALE,
...
e=a.boneDataList;var h;g&&(h=g.slotDataList);for(g=0;g<e.length;g++){var r=e[g],f=b.getTimeline(r.name);if(f){var s=null;if(h)for(var k in h)if(s=h[k],s.parent==r.name)break;for(var m=f.frameList,l=null,n=null,u=null,v=m.length,t=0;t<v;t++){var q=m[t];c.setFrameTransform(b,a,r,q);q.transform.x-=r.transform.x;q.transform.y-=r.transform.y;q.transform.skewX-=r.transform.skewX;q.transform.skewY-=r.transform.skewY;q.transform.scaleX/=r.transform.scaleX;q.transform.scaleY/=r.transform.scaleY;!f.transformed&&
s&&(q.zOrder-=s.zOrder);l||(l=f.originTransform,l.copy(q.transform),l.skewX=d.TransformUtil.formatRadian(l.skewX),l.skewY=d.TransformUtil.formatRadian(l.skewY),n=f.originPivot,n.x=q.pivot.x,n.y=q.pivot.y);q.transform.x-=l.x;q.transform.y-=l.y;q.transform.skewX=d.TransformUtil.formatRadian(q.transform.skewX-l.skewX);q.transform.skewY=d.TransformUtil.formatRadian(q.transform.skewY-l.skewY);q.transform.scaleX/=l.scaleX;q.transform.scaleY/=l.scaleY;f.transformed||(q.pivot.x-=n.x,q.pivot.y-=n.y);if(u){var x=
...
u.transform.skewX),q.transform.skewY=u.transform.skewY+d.TransformUtil.formatRadian(q.transform.skewY-u.transform.skewY))}u=q}f.transformed=!0}}}else c.transformRelativeAnimationData(b,a)};c.setFrameTransform=function(b,a,e,g){g.transform.copy(g.global);if(e=a.getBoneData(e.parent)){var h=b.getTimeline(e.name);if(h){for(var r=[],f=[];h;)r.push(h),f.push(e),h=(e=a.getBoneData(e.parent))?b.getTimeline(e.name):null;b=r.length;var s;a=new d.Matrix;for(var k=new d.DBTransform,m=new d.Matrix;b--;)h=r[b],
e=f[b],c.getTimelineTransform(h,g.position,k,!s),s?(k.x+=h.originTransform.x+e.transform.x,k.y+=h.originTransform.y+e.transform.y,k.skewX+=h.originTransform.skewX+e.transform.skewX,k.skewY+=h.originTransform.skewY+e.transform.skewY,k.scaleX=k.scaleX*h.originTransform.scaleX*e.transform.scaleX,k.scaleY=k.scaleY*h.originTransform.scaleY*e.transform.scaleY,d.TransformUtil.transformToMatrix(k,m,!0),m.concat(a),d.TransformUtil.matrixToTransform(m,s,0<=k.scaleX*s.scaleX,0<=k.scaleY*s.scaleY)):(s=new d.DBTransform,
s.copy(k)),d.TransformUtil.transformToMatrix(s,a,!0);d.TransformUtil.globalToLocal(g.transform,s)}}};c.getTimelineTransform=function(b,a,e,g){for(var h=b.frameList,c=h.length;c--;)if(b=h[c],b.position<=a&&b.position+b.duration>a){if(c==h.length-1||a==b.position)e.copy(g?b.global:b.transform);else{var f=b.tweenEasing;a=(a-b.position)/b.duration;f&&10!=f&&(a=d.MathUtil.getEaseValue(a,f));h=h[c+1];b=g?b.global:b.transform;g=g?h.global:h.transform;e.x=b.x+(g.x-b.x)*a;e.y=b.y+(g.y-b.y)*a;e.skewX=d.TransformUtil.formatRadian(b.skewX+
...
b){var h,d=b?this._captureDict:this._bubbleDict;h=d[a];h||(h=new c,d[a]=h);return h};return a}();d.EventDispatcher=b})(d.event||(d.event={}))})(WOZLLA||(WOZLLA={}));__extends=this.__extends||function(d,f){function c(){this.constructor=d}for(var b in f)f.hasOwnProperty(b)&&(d[b]=f[b]);c.prototype=f.prototype;d.prototype=new c};
...
h/f;this.values[1]=-b/f;this.values[3]=-g/f;this.values[4]=a/f;this.values[6]=(g*d-h*c)/f;this.values[7]=-(a*d-b*c)/f};b.prototype.prepend=function(a,b,g,h,c,d){var f,k,m,l,n=this.values,u=n[6],v=n[7];if(1!=a||0!=b||0!=g||1!=h)f=n[0],k=n[1],m=n[3],l=n[4],n[0]=f*a+k*g,n[1]=f*b+k*h,n[3]=m*a+l*g,n[4]=m*b+l*h;n[6]=u*a+v*g+c;n[7]=u*b+v*h+d};b.prototype.append=function(a,b,g,h,c,d){var f,k,m,l,n=this.values;f=n[0];k=n[1];m=n[3];l=n[4];n[0]=a*f+b*m;n[1]=a*k+b*l;n[3]=g*f+h*m;n[4]=g*k+h*l;n[6]=c*f+d*m+n[6];
n[7]=c*k+d*l+n[7]};b.prototype.prependTransform=function(a,e,g,h,c,d,f,k,m){if(c%360){var l=c*b.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=1,l=0;if(k||m)this.values[6]-=k,this.values[7]-=m;d||f?(d*=b.DEG_TO_RAD,f*=b.DEG_TO_RAD,this.prepend(c*g,l*g,-l*h,c*h,0,0),this.prepend(Math.cos(f),Math.sin(f),-Math.sin(d),Math.cos(d),a,e)):this.prepend(c*g,l*g,-l*h,c*h,a,e);return this};b.prototype.appendTransform=function(a,e,g,h,c,d,f,k,m){if(c%360){var l=c*b.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=
1,l=0;d||f?(d*=b.DEG_TO_RAD,f*=b.DEG_TO_RAD,this.append(Math.cos(f),Math.sin(f),-Math.sin(d),Math.cos(d),a,e),this.append(c*g,l*g,-l*h,c*h,0,0)):this.append(c*g,l*g,-l*h,c*h,a,e);if(k||m)this.values[6]-=k*this.values[0]+m*this.values[3],this.values[7]-=k*this.values[1]+m*this.values[4];return this};b.DEG_TO_RAD=Math.PI/180;return b}();d.Matrix=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
typeof a.skewX&&(this._values[7]=a.skewX);"number"===typeof a.skewY&&(this._values[8]=a.skewY);"undefined"!==typeof a.relative&&(this._relative=a.relative);this._dirty=!0};b.prototype.transform=function(a){void 0===a&&(a=null);var e,g,h=this.worldMatrix;g=this._values[0];var c=this._values[1];e=this._values[4];var d=this._values[5],f=this._values[6],k=this._values[7],m=this._values[8];this.useGLCoords&&(k+=180);a&&this._relative?h.applyMatrix(a.worldMatrix):this===a?h.identity():h.applyMatrix(a.worldMatrix);
this.__local_matrix?(g=this.__local_matrix,h.append(g.a,g.b,g.c,g.d,g.tx,g.ty)):(e%360?(e*=b.DEG_TO_RAD,a=Math.cos(e),e=Math.sin(e)):(a=1,e=0),k||m?(k*=b.DEG_TO_RAD,m*=b.DEG_TO_RAD,h.append(Math.cos(m),Math.sin(m),-Math.sin(k),Math.cos(k),g,c),h.append(a*d,e*d,-e*f,a*f,0,0)):h.append(a*d,e*d,-e*f,a*f,g,c));this._dirty=!1};b.prototype.updateWorldMatrix=function(){if(this._dirty){var a=this.worldMatrix;a?a.identity():a=new d.math.Matrix;for(var b=this;null!=b;)a.prependTransform(b.x,b.y,b.scaleX,b.scaleY,
...
(function(d){var f=function(c){function b(){c.apply(this,arguments)}__extends(b,c);Object.defineProperty(b.prototype,"gameObject",{get:function(){return this._gameObject},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"transform",{get:function(){return this._gameObject.transform},enumerable:!0,configurable:!0});b.prototype.init=function(){};b.prototype.destroy=function(){};b.prototype.loadAssets=function(a){a&&a()};b.prototype.listRequiredComponents=function(){return[]};b.register=
...
d.Component=f})(WOZLLA||(WOZLLA={}));(function(d){var f=function(c){function b(){c.apply(this,arguments)}__extends(b,c);b.prototype.collideXY=function(a,b){return!1};b.prototype.collide=function(a){return!1};return b}(d.Component);d.Collider=f})(WOZLLA||(WOZLLA={}));
...
c){void 0===c&&(c=1);this.enabled=!0;this.canvasOffset=this.canvas=null;this.channelMap={};var h=this,r=window.navigator;h.canvas=b;h.canvasOffset=f(b);h.touchScale=c;Hammer(r.isCocoonJS?document:b,{transform:!1,doubletap:!1,hold:!1,rotate:!1,pinch:!1}).on(a.enabledGestures||"touch release tap swipe drag dragstart dragend",function(a){("release"===a.type||h.enabled)&&d.Scheduler.getInstance().scheduleFrame(function(){h.onGestureEvent(a)})})}a.setEanbledGestures=function(a){this.enabledGestures=a};
a.prototype.onGestureEvent=function(a){var b,c,f,p,s,k,m,l,n=a.type,u=d.Director.getInstance().stage,v=this.touchScale||1;if(m=a.gesture.srcEvent.changedTouches)for(p=m.length,f=0;f<p;f++)c=m[f],s=parseInt(c.identifier),b=c.pageX-this.canvasOffset.x,c=c.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===n&&(l=u.getUnderPoint(b,c,!0))&&(this.channelMap[s]=this.createDispatchChanel(l),delete this.channelMap[s-10]),(k=this.channelMap[s])&&k.onGestureEvent(a,l,b,c,s);else s=1,b=a.gesture.srcEvent.pageX-this.canvasOffset.x,
c=a.gesture.srcEvent.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===n&&((l=u.getUnderPoint(b,c,!0))?this.channelMap[s]=this.createDispatchChanel(l):delete this.channelMap[s]),(k=this.channelMap[s])&&k.onGestureEvent(a,l,b,c,s)};a.prototype.createDispatchChanel=function(a){var b=!0;return{onGestureEvent:function(h,f,p,s,k){var m=h.type,l=d.Director.getInstance().stage;switch(m){case "drag":if(!b){f=a;break}case "tap":case "release":f=l.getUnderPoint(p,s,!0)}if("tap"!==m||a===f)h=new c({x:p,y:s,type:m,
bubbles:!0,touch:f,gesture:h.gesture,identifier:k,touchMoveDetection:!1}),a.dispatchEvent(h),b=h.touchMoveDetection}}};return a}();d.Touch=b})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function b(){}b.getGLContext=function(a,b){var c,d=b||{},f={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},p;for(p in f)"undefined"===typeof d[p]&&(d[p]=f[p]);b=d;try{c=a.getContext("experimental-webgl",b)}catch(s){try{c=a.getContext("webgl",b)}catch(k){}}return c};b.compileShader=function(a,b,c){b=a.createShader(b);a.shaderSource(b,c);a.compileShader(b);return a.getShaderParameter(b,a.COMPILE_STATUS)?b:(console.log(a.getShaderInfoLog(b)),null)};
...
(function(d){(function(d){function c(a){return 0===(a&a-1)}var b=function(){function a(a){this._gl=a;this._textureMap={}}a.prototype.getTexture=function(a){return this._textureMap[a]};a.prototype.generateTexture=function(a,b){var h,r;h=this._gl;var p=b||h.createTexture();h.bindTexture(h.TEXTURE_2D,p);h.pixelStorei(h.UNPACK_PREMULTIPLY_ALPHA_WEBGL,1);h.texParameteri(h.TEXTURE_2D,h.TEXTURE_MAG_FILTER,h.LINEAR);h.texParameteri(h.TEXTURE_2D,h.TEXTURE_MIN_FILTER,h.LINEAR);c(a.width)&&c(a.height)?(h.texParameteri(h.TEXTURE_2D,
...
function(a,b){this._renderOffset=a;this._renderCount=b};a.prototype.setVertices=function(a,b,c,d,f,s,k,m,l){void 0===l&&(l=0);var n=this._type.strade;l=this._type.size*l+this._type.vertexIndex;this._storage[0+l]=a;this._storage[1+l]=b;this._storage[0+l+1*n]=c;this._storage[1+l+1*n]=d;this._storage[0+l+2*n]=f;this._storage[1+l+2*n]=s;this._storage[0+l+3*n]=k;this._storage[1+l+3*n]=m};a.prototype.setTexCoords=function(a,b,c,d,f,s,k,m,l){void 0===l&&(l=0);var n=this._type.strade;l=this._type.size*l+
this._type.texCoordIndex;this._storage[0+l]=a;this._storage[1+l]=b;this._storage[0+l+1*n]=c;this._storage[1+l+1*n]=d;this._storage[0+l+2*n]=f;this._storage[1+l+2*n]=s;this._storage[0+l+3*n]=k;this._storage[1+l+3*n]=m};a.prototype.setAlpha=function(a,b){void 0===b&&(b=0);var c=this._type.strade,d=this._type.size*b+this._type.alphaIndex;this._storage[d]=a;this._storage[d+1*c]=a;this._storage[d+2*c]=a;this._storage[d+3*c]=a};a.prototype.setColor=function(a,b){void 0===b&&(b=0);var c=this._type.strade,
...
(function(d){(function(f){var c,b=function(a){function b(e,c){a.call(this,e,c);this.isPoolable=!0}__extends(b,a);b.init=function(a,b,e,d,f){var k=c.retain();k.initWith(a,b,e,d,f);return k};Object.defineProperty(b.prototype,"texture",{get:function(){return this._texture},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"materialId",{get:function(){return this._materialId},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"quad",{get:function(){return this._quad},enumerable:!0,
...
this._updateQuadVerticesByArgs(b,e,c,this._gameObject.transform.worldMatrix,a);this._quadVertexDirty=!1};b.prototype._updateQuadVerticesByArgs=function(a,b,e,c,d){void 0===d&&(d=0);var f=c.values[0],m=c.values[1],l=c.values[3],n=c.values[4],u=c.values[6];c=c.values[7];var v=-e.x*b.width,t=v+b.width;e=-e.y*b.height;b=e+b.height;this._quad.setVertices(f*v+l*e+u,n*e+m*v+c,f*t+l*e+u,n*e+m*t+c,f*t+l*b+u,n*b+m*t+c,f*v+l*b+u,n*b+m*v+c,d);this._quad.setTexCoords(a.x0,a.y0,a.x1,a.y1,a.x2,a.y2,a.x3,a.y3,d)};
...
(function(d){(function(f){var c=function(){function b(){}b.array2rect=function(a){return new d.math.Rectangle(a[0],a[1],a[2],a[3])};b.array2circle=function(a){return new d.math.Circle(a[0],a[1],a[2])};return b}();f.PropertyConverter=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
...
{}));
(function(d){(function(f){var c=function(b){function a(){b.apply(this,arguments);this._autoOffset=this._frameNumDirty=!0;this._playMode=a.MODE_NONLOOP;this._playing=!1}__extends(a,b);Object.defineProperty(a.prototype,"autoOffset",{get:function(){return this._autoOffset},set:function(a){this._autoOffset=a},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"frameNum",{get:function(){return this._frameNum},set:function(a){a=Math.floor(a);this._frameNum!==a&&(this._frameNum=a,this._frameNumDirty=!0)},
enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"duration",{get:function(){return this._duration},set:function(a){this._duration=a},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"playMode",{get:function(){return this._playMode},set:function(a){this._playMode=a},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"frameLength",{get:function(){return this._spriteProxy.getFrameLength()},enumerable:!0,configurable:!0});a.prototype.play=function(a){void 0===
...
b.prototype._updateNinePatchQuads=function(){this._updateNinePatchQuadVertices();this._updateNinePatchQuadAlpha();this._updateNinePatchQuadColor();this._textureUpdated=!1};b.prototype._updateNinePatchQuadVertices=function(){for(var a=new d.Transform,b=this._getTextureFrame(),e,c={x:0,y:0},f=this._patch||new d.math.Rectangle(0,0,b.width,b.height),k=this._renderRegion||f,b=[{frame:{x:b.x,y:b.y,width:f.left,height:f.top},pos:{x:k.x,y:k.y},size:{width:1,height:1}},{frame:{x:b.x+f.left,y:b.y,width:f.width,
height:f.top},pos:{x:k.x+f.left,y:k.y},size:{width:(k.width-(f.right-f.width))/f.width,height:1}},{frame:{x:b.x+f.right,y:b.y,width:b.width-f.right,height:f.top},pos:{x:k.right,y:k.y},size:{width:1,height:1}},{frame:{x:b.x,y:b.y+f.top,width:f.left,height:f.height},pos:{x:k.x,y:k.y+f.top},size:{width:1,height:(k.height-(f.bottom-f.height))/f.height}},{frame:{x:b.x+f.left,y:b.y+f.top,width:f.width,height:f.height},pos:{x:k.x+f.left,y:k.y+f.top},size:{width:(k.width-(f.right-f.width))/f.width,height:(k.height-
(f.bottom-f.height))/f.height}},{frame:{x:b.x+f.right,y:b.y+f.top,width:b.width-f.right,height:f.height},pos:{x:k.right,y:k.y+f.top},size:{width:1,height:(k.height-(f.bottom-f.height))/f.height}},{frame:{x:b.x,y:b.y+f.bottom,width:b.width-f.right,height:b.height-f.bottom},pos:{x:k.x,y:k.bottom},size:{width:1,height:1}},{frame:{x:b.x+f.left,y:b.y+f.bottom,width:f.width,height:b.height-f.bottom},pos:{x:k.x+f.left,y:k.bottom},size:{width:(k.width-(f.right-f.width))/f.width,height:1}},{frame:{x:b.x+f.right,
y:b.y+f.bottom,width:b.width-f.right,height:b.height-f.bottom},pos:{x:k.right,y:k.bottom},size:{width:1,height:1}}],f=0;9>f;f++)if(k=b[f],0<k.frame.width&&0<k.frame.height){e=k.frame;var m=this._texture,l=m.descriptor.width,m=m.descriptor.height,n={};n.x0=e.x/l;n.y0=e.y/m;n.x1=(e.x+e.width)/l;n.y1=e.y/m;n.x2=(e.x+e.width)/l;n.y2=(e.y+e.height)/m;n.x3=e.x/l;n.y3=(e.y+e.height)/m;e=n;a.set(this.gameObject.transform);a.x+=k.pos.x;a.y+=k.pos.y;a.setScale(k.size.width,k.size.height);a.updateWorldMatrix();
this._updateQuadVerticesByArgs(e,k.frame,c,a.worldMatrix,f)}else this._clearQuadVertices(f);this._quadVertexDirty=!1};b.prototype._updateNinePatchQuadAlpha=function(){for(var a=0;9>a;a++)this._updateQuadAlpha(a);this._quadAlphaDirty=!1};b.prototype._updateNinePatchQuadColor=function(){for(var a=0;9>a;a++)this._updateQuadColor(a);this._quadColorDirty=!1};b.prototype.render=function(a,b){this._texture&&((b&d.GameObject.MASK_TRANSFORM_DIRTY)===d.GameObject.MASK_TRANSFORM_DIRTY&&(this._quadVertexDirty=
...
(function(d){var f=function(c){function b(){c.apply(this,arguments);this.enabled=!0}__extends(b,c);b.prototype.update=function(){};return b}(d.Component);d.Behaviour=f})(WOZLLA||(WOZLLA={}));(function(d){var f=function(c){function b(a,b,d,h){void 0===b&&(b=!1);void 0===d&&(d=null);void 0===h&&(h=!0);c.call(this,a,b,d,h)}__extends(b,c);return b}(d.event.Event);d.CoreEvent=f})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){(function(c){c.rectIntersect=function(b,a){return b.x<a.x+a.width&&a.x<b.x+b.width&&b.y<a.y+a.height&&a.y<b.y+b.height};c.rectIntersect2=function(b,a,c,d,f,r,p,s){return b<=f+p&&f<=b+c&&a<=r+s&&r<=a+d}})(d.MathUtils||(d.MathUtils={}))})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
function(c){var e=this,f,s;d.Assert.isNotUndefined(this._stateConfig[c]);f=this._currentState;s=this._stateConfig[c][c]||a.getInstance();this._currentTransition&&this._currentTransition.cancel();s.reset();s.execute(f,c,function(){e._currentTransition=null;e._currentState=c;e.dispatchEvent(new d.event.Event(g.CHANGE,!1,new b(e._currentState)))});this._currentTransition=s};g.INIT="state.init";g.CHANGE="state.change";return g}(d.event.EventDispatcher);f.StateMachine=c;var b=function(){return function(a){this.state=
