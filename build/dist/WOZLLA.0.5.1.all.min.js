...
on:function(b,a,e,f){a=a.split(" ");t.each(a,function(a){t.on(b,a,e);f&&f(a)})},off:function(b,a,e,f){a=a.split(" ");t.each(a,function(a){t.off(b,a,e);f&&f(a)})},onTouch:function(e,f,h){var c=this,d=function(b){var d=b.type.toLowerCase(),s=a.HAS_POINTEREVENTS,d=t.inStr(d,"mouse"),l;d&&c.preventMouseEvents||(d&&f==n&&0===b.button?(c.preventMouseEvents=!1,c.shouldDetect=!0):s&&f==n?c.shouldDetect=1===b.buttons||x.matchType(q,b):d||f!=n||(c.preventMouseEvents=!0,c.shouldDetect=!0),s&&f!=p&&x.updatePointer(f,
b),c.shouldDetect&&(l=c.doDetect.call(c,b,f,e,h)),l==p&&(c.preventMouseEvents=!1,c.shouldDetect=!1,x.reset()),s&&f==p&&x.updatePointer(f,b))};this.on(e,b[f],d);return d},doDetect:function(b,a,e,f){var h=this.getTouchList(b,a),c=a,d=h.trigger,s=h.length;a==n?d=v:a==p&&(d=u,s=h.length-(b.changedTouches?b.changedTouches.length:1));0<s&&this.started&&(c=k);this.started=!0;b=this.collectEventData(e,c,h,b);a!=p&&f.call(w,b);d&&(b.changedLength=s,b.eventType=d,f.call(w,b),b.eventType=c,delete b.changedLength);
c==p&&(f.call(w,b),this.started=!1);return c},determineEventTypes:function(){var e;e=a.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:a.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];b[n]=e[0];b[k]=e[1];b[p]=e[2];return b},getTouchList:function(b,e){if(a.HAS_POINTEREVENTS)return x.getTouchList();
if(b.touches){if(e==k)return b.touches;var f=[],h=[].concat(t.toArray(b.touches),t.toArray(b.changedTouches)),c=[];t.each(h,function(b){!1===t.inArray(f,b.identifier)&&c.push(b);f.push(b.identifier)});return c}b.identifier=1;return[b]},collectEventData:function(b,a,e,f){b=q;t.inStr(f.type,"mouse")||x.matchType(l,f)?b=l:x.matchType(m,f)&&(b=m);return{center:t.getCenter(e),timeStamp:Date.now(),target:f.target,touches:e,eventType:a,pointerType:b,srcEvent:f,preventDefault:function(){var b=this.srcEvent;
...
f={};f[l]=e===(a.MSPOINTER_TYPE_MOUSE||l);f[q]=e===(a.MSPOINTER_TYPE_TOUCH||q);f[m]=e===(a.MSPOINTER_TYPE_PEN||m);return f[b]},reset:function(){this.pointers={}}},w=a.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(b,a){this.current||(this.stopped=!1,this.current={inst:b,startEvent:t.extend({},a),lastEvent:!1,lastCalcEvent:!1,futureCalcEvent:!1,lastCalcData:{},name:""},this.detect(a))},detect:function(b){if(this.current&&!this.stopped){b=this.extendEventData(b);var a=
this.current.inst,e=a.options;t.each(this.gestures,function(f){!this.stopped&&a.enabled&&e[f.name]&&f.handler.call(f,b,a)},this);this.current&&(this.current.lastEvent=b);b.eventType==p&&this.stopDetect();return b}},stopDetect:function(){this.previous=t.extend({},this.current);this.current=null;this.stopped=!0},getCalculatedData:function(b,e,f,h,c){var d=this.current,s=!1,l=d.lastCalcEvent,q=d.lastCalcData;l&&b.timeStamp-l.timeStamp>a.CALCULATE_INTERVAL&&(e=l.center,f=b.timeStamp-l.timeStamp,h=b.center.clientX-
l.center.clientX,c=b.center.clientY-l.center.clientY,s=!0);if(b.eventType==v||b.eventType==u)d.futureCalcEvent=b;if(!d.lastCalcEvent||s)q.velocity=t.getVelocity(f,h,c),q.angle=t.getAngle(e,b.center),q.direction=t.getDirection(e,b.center),d.lastCalcEvent=d.futureCalcEvent||b,d.futureCalcEvent=b;b.velocityX=q.velocity.x;b.velocityY=q.velocity.y;b.interimAngle=q.angle;b.interimDirection=q.direction},extendEventData:function(b){var a=this.current,e=a.startEvent,a=a.lastEvent||e;if(b.eventType==v||b.eventType==
...
(function(b){var c=!1;a.gestures.Drag={name:b,index:50,handler:function(a,d){var l=w.current;if(!(0<d.options.dragMaxTouches&&a.touches.length>d.options.dragMaxTouches))switch(a.eventType){case n:c=!1;break;case k:if(a.distance<d.options.dragMinDistance&&l.name!=b)break;var q=l.startEvent.center;if(l.name!=b&&(l.name=b,d.options.dragDistanceCorrection&&0<a.distance)){var g=Math.abs(d.options.dragMinDistance/a.distance);q.pageX+=a.deltaX*g;q.pageY+=a.deltaY*g;q.clientX+=a.deltaX*g;q.clientY+=a.deltaY*
...
b;e=setTimeout(function(){c&&c.name==b&&f.trigger(b,a)},h.holdTimeout);break;case k:a.distance>h.holdThreshold&&clearTimeout(e);break;case u:clearTimeout(e)}}}})("hold");a.gestures.Release={name:"release",index:Infinity,handler:function(b,a){b.eventType==u&&a.trigger(this.name,b)}};a.gestures.Swipe={name:"swipe",index:40,defaults:{swipeMinTouches:1,swipeMaxTouches:1,swipeVelocityX:.6,swipeVelocityY:.6},handler:function(b,a){if(b.eventType==u){var e=b.touches.length,f=a.options;e<f.swipeMinTouches||
e>f.swipeMaxTouches||!(b.velocityX>f.swipeVelocityX||b.velocityY>f.swipeVelocityY)||(a.trigger(this.name,b),a.trigger(this.name+b.direction,b))}}};(function(b){var e=!1;a.gestures.Tap={name:b,index:100,handler:function(a,f){var h=f.options,c=w.current,d=w.previous,s,l;switch(a.eventType){case n:e=!1;break;case k:e=e||a.distance>h.tapMaxDistance;break;case p:!t.inStr(a.srcEvent.type,"cancel")&&a.deltaTime<h.tapMaxTime&&!e&&(s=d&&d.lastEvent&&a.timeStamp-d.lastEvent.timeStamp,l=!1,d&&d.name==b&&s&&
...
(function(b){var e=!1;a.gestures.Transform={name:b,index:45,defaults:{transformMinScale:.01,transformMinRotation:1},handler:function(a,f){switch(a.eventType){case n:e=!1;break;case k:if(2>a.touches.length)break;var h=Math.abs(1-a.scale),c=Math.abs(a.rotation);if(h<f.options.transformMinScale&&c<f.options.transformMinRotation)break;w.current.name=b;e||(f.trigger(b+"start",a),e=!0);f.trigger(b,a);c>f.options.transformMinRotation&&f.trigger("rotate",a);h>f.options.transformMinScale&&(f.trigger("pinch",
...
null}};c.prototype.gotoAndPlay=function(a,b,e,f,h,s,l,q,g){void 0===b&&(b=-1);void 0===e&&(e=-1);void 0===f&&(f=NaN);void 0===h&&(h=0);void 0===s&&(s=null);void 0===l&&(l=c.SAME_LAYER_AND_GROUP);void 0===q&&(q=!0);void 0===g&&(g=!0);if(!this._animationDataList)return null;for(var n=this._animationDataList.length,k;n--;)if(this._animationDataList[n].name==a){k=this._animationDataList[n];break}if(!k)return null;this._isFading=this._isPlaying=!0;b=0>b?0>k.fadeTime?.3:k.fadeTime:b;e=0>e?0>k.scale?1:k.scale:
1E3*e/k.duration;f=isNaN(f)?k.playTimes:f;switch(l){case c.NONE:break;case c.SAME_LAYER:for(n=this._animationStateList.length;n--;)l=this._animationStateList[n],l.layer==h&&l.fadeOut(b,q);break;case c.SAME_GROUP:for(n=this._animationStateList.length;n--;)l=this._animationStateList[n],l.group==s&&l.fadeOut(b,q);break;case c.ALL:for(n=this._animationStateList.length;n--;)l=this._animationStateList[n],l.fadeOut(b,q);break;default:for(n=this._animationStateList.length;n--;)l=this._animationStateList[n],
l.layer==h&&l.group==s&&l.fadeOut(b,q)}this._lastAnimationState=d.AnimationState._borrowObject();this._lastAnimationState._layer=h;this._lastAnimationState._group=s;this._lastAnimationState.autoTween=this.tweenEnabled;this._lastAnimationState._fadeIn(this._armature,k,b,1/e,f,g);this.addState(this._lastAnimationState);f=this._armature.getSlots(!1);for(n=f.length;n--;)h=f[n],h.childArmature&&h.childArmature.animation.gotoAndPlay(a,b);return this._lastAnimationState};c.prototype.gotoAndStop=function(a,
b,e,f,h,d,l,q){void 0===e&&(e=-1);void 0===f&&(f=0);void 0===h&&(h=-1);void 0===d&&(d=0);void 0===l&&(l=null);void 0===q&&(q=c.ALL);var g=this.getState(a,d);g||(g=this.gotoAndPlay(a,f,h,NaN,d,l,q));0<=e?g.setCurrentTime(g.totalTime*e):g.setCurrentTime(b);g.stop();return g};c.prototype.play=function(){this._animationDataList&&0!=this._animationDataList.length&&(this._lastAnimationState?this._isPlaying?this.gotoAndPlay(this._lastAnimationState.name):this._isPlaying=!0:this.gotoAndPlay(this._animationDataList[0].name))};
...
function(){var b,a,f,h=this._timelineStateList.length;if(1==h)b=this._timelineStateList[0],f=b._animationState.weight*b._animationState.fadeWeight,b._weight=f,a=b._transform,b=b._pivot,this._tween.x=a.x*f,this._tween.y=a.y*f,this._tween.skewX=a.skewX*f,this._tween.skewY=a.skewY*f,this._tween.scaleX=1+(a.scaleX-1)*f,this._tween.scaleY=1+(a.scaleY-1)*f,this._tweenPivot.x=b.x*f,this._tweenPivot.y=b.y*f;else if(1<h){var c=0,d=0,q=0,g=0,n=0,k=0,p=0,u=0,v=1,t=0,r=this._timelineStateList[h-1]._animationState.layer;
for(a=0;h--;){b=this._timelineStateList[h];a=b._animationState.layer;if(r!=a)if(t>=v){b._weight=0;break}else v-=t;r=a;f=b._animationState.weight*b._animationState.fadeWeight*v;(b._weight=f)&&b._blendEnabled&&(a=b._transform,b=b._pivot,c+=a.x*f,d+=a.y*f,q+=a.skewX*f,g+=a.skewY*f,n+=(a.scaleX-1)*f,k+=(a.scaleY-1)*f,p+=b.x*f,u+=b.y*f,t+=f)}this._tween.x=c;this._tween.y=d;this._tween.skewX=q;this._tween.skewY=g;this._tween.scaleX=n;this._tween.scaleY=k;this._tweenPivot.x=p;this._tweenPivot.y=u}};a.prototype.sortState=
...
};a.prototype._updateDisplayColor=function(b,a,f,h,c,d,q,g){this._colorTransform.alphaOffset=b;this._colorTransform.redOffset=a;this._colorTransform.greenOffset=f;this._colorTransform.blueOffset=h;this._colorTransform.alphaMultiplier=c;this._colorTransform.redMultiplier=d;this._colorTransform.greenMultiplier=q;this._colorTransform.blueMultiplier=g};a.prototype._updateDisplayBlendMode=function(b){throw Error("Abstract method needs to be implemented in subclass!");};return a}(d.DBObject);d.Slot=g})(dragonBones||
...
null==b.armatureData.getBoneData(f)&&(f=null),b.addBone(h,f,!0);b._updateAnimationAfterBoneListChanged()};a.prototype._buildSlots=function(b,a,f){var h=b.armatureData.getSkinData(a);if(h)for(var c=[],h=h.slotDataList,l,g,m,n=0;n<h.length;n++)if(l=h[n],m=b.getBone(l.parent)){g=this._generateSlot();g.initWithSlotData(l);m.addSlot(g);for(m=l.displayDataList.length;m--;){var k=l.displayDataList[m];switch(k.type){case d.DisplayData.ARMATURE:k=this.buildArmatureUsingArmatureDataFromTextureAtlas(b.__dragonBonesData,
b.__dragonBonesData.getArmatureDataByName(k.name),f,a);c[m]=k;break;default:c[m]=this._generateDisplay(f,k.name,k.pivot.x,k.pivot.y)}}for(var p in c)if(l=c[p],l instanceof d.Armature&&(l=l.display),l.hasOwnProperty("name"))try{l.name=g.name}catch(u){}g.displayList=c;g._changeDisplay(0)}};a.prototype._generateArmature=function(){return null};a.prototype._generateSlot=function(){return null};a.prototype._generateDisplay=function(b,a,f,h){return null};a._helpMatrix=new d.Matrix;return a}(d.EventDispatcher);
...
(function(d){var g=function(){function c(){}c.parseTextureAtlasData=function(a,b){void 0===b&&(b=1);var e={},f,h=a[d.ConstValues.SUB_TEXTURE],s;for(s in h){var l=h[s],g=l[d.ConstValues.A_NAME],m=new d.Rectangle;m.x=c.getNumber(l,d.ConstValues.A_X,0)/b;m.y=c.getNumber(l,d.ConstValues.A_Y,0)/b;m.width=c.getNumber(l,d.ConstValues.A_WIDTH,0)/b;m.height=c.getNumber(l,d.ConstValues.A_HEIGHT,0)/b;var n="true"==l[d.ConstValues.A_ROTATED],k=c.getNumber(l,d.ConstValues.A_FRAME_WIDTH,0)/b,p=c.getNumber(l,d.ConstValues.A_FRAME_HEIGHT,
0)/b;0<k&&0<p?(f=new d.Rectangle,f.x=c.getNumber(l,d.ConstValues.A_FRAME_X,0)/b,f.y=c.getNumber(l,d.ConstValues.A_FRAME_Y,0)/b,f.width=k,f.height=p):f=null;e[g]=new d.TextureData(m,f,n)}return e};c.parseDragonBonesData=function(a){if(!a)throw Error();var b=a[d.ConstValues.A_VERSION],b=b.toString();if(b.toString()!=d.DragonBones.DATA_VERSION&&b.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var b=c.getNumber(a,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
...
e=b.boneDataList;var h;f&&(h=f.slotDataList);for(f=0;f<e.length;f++){var s=e[f],l=a.getTimeline(s.name);if(l){var g=null;if(h)for(var m in h)if(g=h[m],g.parent==s.name)break;for(var n=l.frameList,k=null,p=null,u=null,v=n.length,t=0;t<v;t++){var r=n[t];c.setFrameTransform(a,b,s,r);r.transform.x-=s.transform.x;r.transform.y-=s.transform.y;r.transform.skewX-=s.transform.skewX;r.transform.skewY-=s.transform.skewY;r.transform.scaleX/=s.transform.scaleX;r.transform.scaleY/=s.transform.scaleY;!l.transformed&&
g&&(r.zOrder-=g.zOrder);k||(k=l.originTransform,k.copy(r.transform),k.skewX=d.TransformUtil.formatRadian(k.skewX),k.skewY=d.TransformUtil.formatRadian(k.skewY),p=l.originPivot,p.x=r.pivot.x,p.y=r.pivot.y);r.transform.x-=k.x;r.transform.y-=k.y;r.transform.skewX=d.TransformUtil.formatRadian(r.transform.skewX-k.skewX);r.transform.skewY=d.TransformUtil.formatRadian(r.transform.skewY-k.skewY);r.transform.scaleX/=k.scaleX;r.transform.scaleY/=k.scaleY;l.transformed||(r.pivot.x-=p.x,r.pivot.y-=p.y);if(u){var x=
...
h/g;this.values[1]=-a/g;this.values[3]=-f/g;this.values[4]=b/g;this.values[6]=(f*d-h*c)/g;this.values[7]=-(b*d-a*c)/g};a.prototype.prepend=function(b,a,f,h,c,d){var g,m,n,k,p=this.values,u=p[6],v=p[7];if(1!=b||0!=a||0!=f||1!=h)g=p[0],m=p[1],n=p[3],k=p[4],p[0]=g*b+m*f,p[1]=g*a+m*h,p[3]=n*b+k*f,p[4]=n*a+k*h;p[6]=u*b+v*f+c;p[7]=u*a+v*h+d};a.prototype.append=function(b,a,f,h,c,d){var g,m,n,k,p=this.values;g=p[0];m=p[1];n=p[3];k=p[4];p[0]=b*g+a*n;p[1]=b*m+a*k;p[3]=f*g+h*n;p[4]=f*m+h*k;p[6]=c*g+d*n+p[6];
p[7]=c*m+d*k+p[7]};a.prototype.prependTransform=function(b,e,f,h,c,d,g,m,n){if(c%360){var k=c*a.DEG_TO_RAD;c=Math.cos(k);k=Math.sin(k)}else c=1,k=0;if(m||n)this.values[6]-=m,this.values[7]-=n;d||g?(d*=a.DEG_TO_RAD,g*=a.DEG_TO_RAD,this.prepend(c*f,k*f,-k*h,c*h,0,0),this.prepend(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),b,e)):this.prepend(c*f,k*f,-k*h,c*h,b,e);return this};a.prototype.appendTransform=function(b,e,f,h,c,d,g,m,n){if(c%360){var k=c*a.DEG_TO_RAD;c=Math.cos(k);k=Math.sin(k)}else c=
1,k=0;d||g?(d*=a.DEG_TO_RAD,g*=a.DEG_TO_RAD,this.append(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),b,e),this.append(c*f,k*f,-k*h,c*h,0,0)):this.append(c*f,k*f,-k*h,c*h,b,e);if(m||n)this.values[6]-=m*this.values[0]+n*this.values[3],this.values[7]-=m*this.values[1]+n*this.values[4];return this};a.DEG_TO_RAD=Math.PI/180;return a}();d.Matrix=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
f):1==a&&f<c?(c!=this.duration&&this._runActions(c,this.duration),this._runActions(0,f,!0)):this._runActions(c,f));h&&this.setPaused(!0);return h};a.prototype._runActions=function(b,a,f){void 0===f&&(f=!1);var h=b,c=a,d=-1,g=this._actions.length,m=1;b>a&&(h=a,c=b,d=g,g=m=-1);for(;(d+=m)!=g;){a=this._actions[d];var n=a.t;(n==c||n>h&&n<c||f&&n==b)&&a.f.apply(a.o,a.p)}};a.prototype._updateTargetProps=function(b,e){var f,h,c,d;if(b||1!=e){if(this.passive=!!b.v)return;b.e&&(e=b.e(e,0,1,1));f=b.p0;h=b.p1}else this.passive=
!1,f=h=this._curQueueProps;for(var g in this._initQueueProps){null==(c=f[g])&&(f[g]=c=this._initQueueProps[g]);null==(d=h[g])&&(h[g]=d=c);c=c==d||0==e||1==e||"number"!=typeof c?1==e?d:c:c+(d-c)*e;var m=!1;if(d=a._plugins[g])for(var n=0,k=d.length;n<k;n++){var p=d[n].tween(this,g,c,f,h,e,!!b&&f==h,!b);p==a.IGNORE?m=!0:c=p}m||(this._target[g]=c)}};a.prototype.setPaused=function(b){this.paused=b;a._register(this,!b);return this};a.prototype._cloneProps=function(b){var a={},f;for(f in b)a[f]=b[f];return a};
...
a.prototype.onGestureEvent=function(a){var b,c,g,l,q,m,n,k,p=a.type,u=d.Director.getInstance().stage,v=this.touchScale||1;if(n=a.gesture.srcEvent.changedTouches)for(l=n.length,g=0;g<l;g++)c=n[g],q=parseInt(c.identifier),b=c.pageX-this.canvasOffset.x,c=c.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&(k=u.getUnderPoint(b,c,!0))&&(this.channelMap[q]=this.createDispatchChanel(k),delete this.channelMap[q-10]),(m=this.channelMap[q])&&m.onGestureEvent(a,k,b,c,q);else q=1,b=a.gesture.srcEvent.pageX-this.canvasOffset.x,
c=a.gesture.srcEvent.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&((k=u.getUnderPoint(b,c,!0))?this.channelMap[q]=this.createDispatchChanel(k):delete this.channelMap[q]),(m=this.channelMap[q])&&m.onGestureEvent(a,k,b,c,q)};a.prototype.createDispatchChanel=function(a){var b=!0;return{onGestureEvent:function(h,g,l,q,m){var n=h.type,k=d.Director.getInstance().stage;switch(n){case "drag":if(!b){g=a;break}case "tap":case "release":g=k.getUnderPoint(l,q,!0)}if("tap"!==n||a===g)h=new c({x:l,y:q,type:n,
bubbles:!0,touch:g,gesture:h.gesture,identifier:m,touchMoveDetection:!1}),a.dispatchEvent(h),b=h.touchMoveDetection}}};return a}();d.Touch=a})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function a(){}a.getGLContext=function(a,e){var f,c=e||{},d={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},g;for(g in d)"undefined"===typeof c[g]&&(c[g]=d[g]);e=c;try{f=a.getContext("experimental-webgl",e)}catch(q){try{f=a.getContext("webgl",e)}catch(m){}}return f};a.compileShader=function(a,e,f){e=a.createShader(e);a.shaderSource(e,f);a.compileShader(e);return a.getShaderParameter(e,a.COMPILE_STATUS)?e:(console.log(a.getShaderInfoLog(e)),null)};
...
function(a,b){this._renderOffset=a;this._renderCount=b};a.prototype.setVertices=function(a,b,c,d,g,q,m,n,k){void 0===k&&(k=0);var p=this._type.strade;k=this._type.size*k+this._type.vertexIndex;this._storage[0+k]=a;this._storage[1+k]=b;this._storage[0+k+1*p]=c;this._storage[1+k+1*p]=d;this._storage[0+k+2*p]=g;this._storage[1+k+2*p]=q;this._storage[0+k+3*p]=m;this._storage[1+k+3*p]=n};a.prototype.setTexCoords=function(a,b,c,d,g,q,m,n,k){void 0===k&&(k=0);var p=this._type.strade;k=this._type.size*k+
this._type.texCoordIndex;this._storage[0+k]=a;this._storage[1+k]=b;this._storage[0+k+1*p]=c;this._storage[1+k+1*p]=d;this._storage[0+k+2*p]=g;this._storage[1+k+2*p]=q;this._storage[0+k+3*p]=m;this._storage[1+k+3*p]=n};a.prototype.setAlpha=function(a,b){void 0===b&&(b=0);var c=this._type.strade,d=this._type.size*b+this._type.alphaIndex;this._storage[d]=a;this._storage[d+1*c]=a;this._storage[d+2*c]=a;this._storage[d+3*c]=a};a.prototype.setColor=function(a,b){void 0===b&&(b=0);var c=this._type.strade,
...
this._updateQuadVerticesByArgs(b,c,e,this._gameObject.transform.worldMatrix,a);this._quadVertexDirty=!1};e.prototype._updateQuadVerticesByArgs=function(a,b,c,e,d){void 0===d&&(d=0);var g=e.values[0],n=e.values[1],k=e.values[3],p=e.values[4],u=e.values[6];e=e.values[7];var v=-c.x*b.width,t=v+b.width;c=-c.y*b.height;b=c+b.height;this._quad.setVertices(g*v+k*c+u,p*c+n*v+e,g*t+k*c+u,p*c+n*t+e,g*t+k*b+u,p*b+n*t+e,g*v+k*b+u,p*b+n*v+e,d);this._quad.setTexCoords(a.x0,a.y0,a.x1,a.y1,a.x2,a.y2,a.x3,a.y3,d)};
...
e.prototype._updateNinePatchQuads=function(){this._updateNinePatchQuadVertices();this._updateNinePatchQuadAlpha();this._updateNinePatchQuadColor();this._textureUpdated=!1};e.prototype._updateNinePatchQuadVertices=function(){for(var a=new d.Transform,b=this._getTextureFrame(),c,e={x:0,y:0},g=this._patch||new d.math.Rectangle(0,0,b.width,b.height),m=this._renderRegion||g,b=[{frame:{x:b.x,y:b.y,width:g.left,height:g.top},pos:{x:m.x,y:m.y},size:{width:1,height:1}},{frame:{x:b.x+g.left,y:b.y,width:g.width,
height:g.top},pos:{x:m.x+g.left,y:m.y},size:{width:(m.width-(g.right-g.width))/g.width,height:1}},{frame:{x:b.x+g.right,y:b.y,width:b.width-g.right,height:g.top},pos:{x:m.right,y:m.y},size:{width:1,height:1}},{frame:{x:b.x,y:b.y+g.top,width:g.left,height:g.height},pos:{x:m.x,y:m.y+g.top},size:{width:1,height:(m.height-(g.bottom-g.height))/g.height}},{frame:{x:b.x+g.left,y:b.y+g.top,width:g.width,height:g.height},pos:{x:m.x+g.left,y:m.y+g.top},size:{width:(m.width-(g.right-g.width))/g.width,height:(m.height-
(g.bottom-g.height))/g.height}},{frame:{x:b.x+g.right,y:b.y+g.top,width:b.width-g.right,height:g.height},pos:{x:m.right,y:m.y+g.top},size:{width:1,height:(m.height-(g.bottom-g.height))/g.height}},{frame:{x:b.x,y:b.y+g.bottom,width:b.width-g.right,height:b.height-g.bottom},pos:{x:m.x,y:m.bottom},size:{width:1,height:1}},{frame:{x:b.x+g.left,y:b.y+g.bottom,width:g.width,height:b.height-g.bottom},pos:{x:m.x+g.left,y:m.bottom},size:{width:(m.width-(g.right-g.width))/g.width,height:1}},{frame:{x:b.x+g.right,
y:b.y+g.bottom,width:b.width-g.right,height:b.height-g.bottom},pos:{x:m.right,y:m.bottom},size:{width:1,height:1}}],g=0;9>g;g++)if(m=b[g],0<m.frame.width&&0<m.frame.height){c=m.frame;var n=this._texture,k=n.descriptor.width,n=n.descriptor.height,p={};p.x0=c.x/k;p.y0=c.y/n;p.x1=(c.x+c.width)/k;p.y1=c.y/n;p.x2=(c.x+c.width)/k;p.y2=(c.y+c.height)/n;p.x3=c.x/k;p.y3=(c.y+c.height)/n;c=p;a.set(this.gameObject.transform);a.x+=m.pos.x;a.y+=m.pos.y;a.setScale(m.size.width,m.size.height);a.updateWorldMatrix();
this._updateQuadVerticesByArgs(c,m.frame,e,a.worldMatrix,g)}else this._clearQuadVertices(g);this._quadVertexDirty=!1};e.prototype._updateNinePatchQuadAlpha=function(){for(var a=0;9>a;a++)this._updateQuadAlpha(a);this._quadAlphaDirty=!1};e.prototype._updateNinePatchQuadColor=function(){for(var a=0;9>a;a++)this._updateQuadColor(a);this._quadColorDirty=!1};e.prototype.render=function(a,b){this._texture&&((b&d.GameObject.MASK_TRANSFORM_DIRTY)===d.GameObject.MASK_TRANSFORM_DIRTY&&(this._quadVertexDirty=
...
(function(d){(function(d){(function(c){c.rectIntersect=function(a,b){return a.x<b.x+b.width&&b.x<a.x+a.width&&a.y<b.y+b.height&&b.y<a.y+a.height};c.rectIntersect2=function(a,b,c,d,h,g,l,q){return a<=h+l&&h<=a+c&&b<=g+q&&g<=b+d}})(d.MathUtils||(d.MathUtils={}))})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(g){var c=d.utils.StateMachine,a=function(a){function e(){a.call(this);this._stateMachine=new d.utils.StateMachine;this.initStates()}__extends(e,a);e.prototype.init=function(){var d=this;this._stateMachine.addListener(c.INIT,function(a){return d.onStateChange(a)});this._stateMachine.addListener(c.CHANGE,function(a){return d.onStateChange(a)});this._stateMachine.init();a.prototype.init.call(this)};e.prototype.initStates=function(){};e.prototype.getStateSpriteName=function(a){return this._stateMachine.getStateData(a,
...
(function(d){(function(g){var c=function(a){function b(){a.call(this,this)}__extends(b,a);b.prototype._generateArmature=function(){var a=new d.GameObject;a.init();return new dragonBones.Armature(a)};b.prototype._generateSlot=function(){return new g.WSlot};b.prototype._generateDisplay=function(a,b,c,g){var l=new d.GameObject,q=new d.component.SpriteRenderer;q.sprite=a.getSprite(b);q.spriteOffset={x:c/q.sprite.frame.width,y:g/q.sprite.frame.height};l.addComponent(q);l.init();return l};return b}(dragonBones.BaseFactory);
