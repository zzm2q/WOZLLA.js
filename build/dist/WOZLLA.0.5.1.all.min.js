...
b!==a&&((this._sprite=a)?(this.setTextureFrame(a.frame),b&&b.spriteAtlas===a.spriteAtlas||this.setTexture(a.spriteAtlas.glTexture)):(this.setTexture(null),this.setTextureFrame(null)))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"spriteOffset",{get:function(){return this._getTextureOffset()},set:function(a){this.setTextureOffset(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"spriteAtlasSrc",{get:function(){return this._spriteSrc},set:function(a){this._spriteSrc=
a;this._spriteProxy.setAssetSrc(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"spriteName",{get:function(){return this._spriteName},set:function(a){this._spriteName=a;this.sprite=this._spriteProxy.getSprite(a)},enumerable:!0,configurable:!0});b.prototype.onAssetLoaded=function(a){this.sprite=a?a.getSprite(this._spriteName):null};b.prototype.loadAssets=function(a){this._spriteProxy.loadAsset(a)};return b}(g.QuadRenderer);g.SpriteRenderer=c;d.Component.register(c,{name:"SpriteRenderer",
properties:[{name:"color",type:"int"},{name:"spriteAtlasSrc",type:"string"},{name:"spriteName",type:"string"}]})})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
