(function(d,g){function c(){b.READY||(r.determineEventTypes(),t.each(b.gestures,function(a){w.register(a)}),r.onTouch(b.DOCUMENT,l,w.detect),r.onTouch(b.DOCUMENT,p,w.detect),b.READY=!0)}var b=function y(a,e){return new y.Instance(a,e||{})};b.VERSION="1.1.3";b.defaults={behavior:{userSelect:"none",touchAction:"pan-y",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};b.DOCUMENT=document;b.HAS_POINTEREVENTS=navigator.pointerEnabled||navigator.msPointerEnabled;
b.HAS_TOUCHEVENTS="ontouchstart"in d;b.IS_MOBILE=/mobile|tablet|ip(ad|hone|od)|android|silk/i.test(navigator.userAgent);b.NO_MOUSEEVENTS=b.HAS_TOUCHEVENTS&&b.IS_MOBILE||b.HAS_POINTEREVENTS;b.CALCULATE_INTERVAL=25;var a={},e=b.DIRECTION_DOWN="down",f=b.DIRECTION_LEFT="left",h=b.DIRECTION_UP="up",s=b.DIRECTION_RIGHT="right",m=b.POINTER_MOUSE="mouse",q=b.POINTER_TOUCH="touch",k=b.POINTER_PEN="pen",n=b.EVENT_START="start",l=b.EVENT_MOVE="move",p=b.EVENT_END="end",u=b.EVENT_RELEASE="release",v=b.EVENT_TOUCH=
"touch";b.READY=!1;b.plugins=b.plugins||{};b.gestures=b.gestures||{};var t=b.utils={extend:function(a,e,b){for(var f in e)!e.hasOwnProperty(f)||a[f]!==g&&b||(a[f]=e[f]);return a},on:function(a,e,b){a.addEventListener(e,b,!1)},off:function(a,e,b){a.removeEventListener(e,b,!1)},each:function(a,e,b){var f,h;if("forEach"in a)a.forEach(e,b);else if(a.length!==g)for(f=0,h=a.length;f<h&&!1!==e.call(b,a[f],f,a);f++);else for(f in a)if(a.hasOwnProperty(f)&&!1===e.call(b,a[f],f,a))break},inStr:function(a,e){return-1<
a.indexOf(e)},inArray:function(a,e){if(a.indexOf){var b=a.indexOf(e);return-1===b?!1:b}for(var b=0,f=a.length;b<f;b++)if(a[b]===e)return b;return!1},toArray:function(a){return Array.prototype.slice.call(a,0)},hasParent:function(a,e){for(;a;){if(a==e)return!0;a=a.parentNode}return!1},getCenter:function(a){var e=[],b=[],f=[],h=[],c=Math.min,d=Math.max;if(1===a.length)return{pageX:a[0].pageX,pageY:a[0].pageY,clientX:a[0].clientX,clientY:a[0].clientY};t.each(a,function(a){e.push(a.pageX);b.push(a.pageY);
f.push(a.clientX);h.push(a.clientY)});return{pageX:(c.apply(Math,e)+d.apply(Math,e))/2,pageY:(c.apply(Math,b)+d.apply(Math,b))/2,clientX:(c.apply(Math,f)+d.apply(Math,f))/2,clientY:(c.apply(Math,h)+d.apply(Math,h))/2}},getVelocity:function(a,e,b){return{x:Math.abs(e/a)||0,y:Math.abs(b/a)||0}},getAngle:function(a,e){return 180*Math.atan2(e.clientY-a.clientY,e.clientX-a.clientX)/Math.PI},getDirection:function(a,b){var c=Math.abs(a.clientX-b.clientX),d=Math.abs(a.clientY-b.clientY);return c>=d?0<a.clientX-
b.clientX?f:s:0<a.clientY-b.clientY?h:e},getDistance:function(a,e){var b=e.clientX-a.clientX,f=e.clientY-a.clientY;return Math.sqrt(b*b+f*f)},getScale:function(a,e){return 2<=a.length&&2<=e.length?this.getDistance(e[0],e[1])/this.getDistance(a[0],a[1]):1},getRotation:function(a,e){return 2<=a.length&&2<=e.length?this.getAngle(e[1],e[0])-this.getAngle(a[1],a[0]):0},isVertical:function(a){return a==h||a==e},setPrefixedCss:function(a,e,b,f){var h=["","Webkit","Moz","O","ms"];e=t.toCamelCase(e);for(var c=
0;c<h.length;c++){var d=e;h[c]&&(d=h[c]+d.slice(0,1).toUpperCase()+d.slice(1));if(d in a.style){a.style[d]=(null==f||f)&&b||"";break}}},toggleBehavior:function(a,e,b){if(e&&a&&a.style){t.each(e,function(e,f){t.setPrefixedCss(a,f,e,b)});var f=b&&function(){return!1};"none"==e.userSelect&&(a.onselectstart=f);"none"==e.userDrag&&(a.ondragstart=f)}},toCamelCase:function(a){return a.replace(/[_-]([a-z])/g,function(a){return a[1].toUpperCase()})}},r=b.event={preventMouseEvents:!1,started:!1,shouldDetect:!1,
on:function(a,e,b,f){e=e.split(" ");t.each(e,function(e){t.on(a,e,b);f&&f(e)})},off:function(a,e,b,f){e=e.split(" ");t.each(e,function(e){t.off(a,e,b);f&&f(e)})},onTouch:function(e,f,h){var c=this,d=function(a){var d=a.type.toLowerCase(),s=b.HAS_POINTEREVENTS,d=t.inStr(d,"mouse"),m;d&&c.preventMouseEvents||(d&&f==n&&0===a.button?(c.preventMouseEvents=!1,c.shouldDetect=!0):s&&f==n?c.shouldDetect=1===a.buttons||x.matchType(q,a):d||f!=n||(c.preventMouseEvents=!0,c.shouldDetect=!0),s&&f!=p&&x.updatePointer(f,
a),c.shouldDetect&&(m=c.doDetect.call(c,a,f,e,h)),m==p&&(c.preventMouseEvents=!1,c.shouldDetect=!1,x.reset()),s&&f==p&&x.updatePointer(f,a))};this.on(e,a[f],d);return d},doDetect:function(a,e,b,f){var h=this.getTouchList(a,e),c=e,d=h.trigger,s=h.length;e==n?d=v:e==p&&(d=u,s=h.length-(a.changedTouches?a.changedTouches.length:1));0<s&&this.started&&(c=l);this.started=!0;a=this.collectEventData(b,c,h,a);e!=p&&f.call(w,a);d&&(a.changedLength=s,a.eventType=d,f.call(w,a),a.eventType=c,delete a.changedLength);
c==p&&(f.call(w,a),this.started=!1);return c},determineEventTypes:function(){var e;e=b.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:b.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];a[n]=e[0];a[l]=e[1];a[p]=e[2];return a},getTouchList:function(a,e){if(b.HAS_POINTEREVENTS)return x.getTouchList();
if(a.touches){if(e==l)return a.touches;var f=[],h=[].concat(t.toArray(a.touches),t.toArray(a.changedTouches)),c=[];t.each(h,function(a){!1===t.inArray(f,a.identifier)&&c.push(a);f.push(a.identifier)});return c}a.identifier=1;return[a]},collectEventData:function(a,e,b,f){a=q;t.inStr(f.type,"mouse")||x.matchType(m,f)?a=m:x.matchType(k,f)&&(a=k);return{center:t.getCenter(b),timeStamp:Date.now(),target:f.target,touches:b,eventType:e,pointerType:a,srcEvent:f,preventDefault:function(){var a=this.srcEvent;
a.preventManipulation&&a.preventManipulation();a.preventDefault&&a.preventDefault()},stopPropagation:function(){this.srcEvent.stopPropagation()},stopDetect:function(){return w.stopDetect()}}}},x=b.PointerEvent={pointers:{},getTouchList:function(){var a=[];t.each(this.pointers,function(e){a.push(e)});return a},updatePointer:function(a,e){a==p?delete this.pointers[e.pointerId]:(e.identifier=e.pointerId,this.pointers[e.pointerId]=e)},matchType:function(a,e){if(!e.pointerType)return!1;var b=e.pointerType,
f={};f[m]=b===(e.MSPOINTER_TYPE_MOUSE||m);f[q]=b===(e.MSPOINTER_TYPE_TOUCH||q);f[k]=b===(e.MSPOINTER_TYPE_PEN||k);return f[a]},reset:function(){this.pointers={}}},w=b.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(a,e){this.current||(this.stopped=!1,this.current={inst:a,startEvent:t.extend({},e),lastEvent:!1,lastCalcEvent:!1,futureCalcEvent:!1,lastCalcData:{},name:""},this.detect(e))},detect:function(a){if(this.current&&!this.stopped){a=this.extendEventData(a);var e=
this.current.inst,b=e.options;t.each(this.gestures,function(f){!this.stopped&&e.enabled&&b[f.name]&&f.handler.call(f,a,e)},this);this.current&&(this.current.lastEvent=a);a.eventType==p&&this.stopDetect();return a}},stopDetect:function(){this.previous=t.extend({},this.current);this.current=null;this.stopped=!0},getCalculatedData:function(a,e,f,h,c){var d=this.current,s=!1,m=d.lastCalcEvent,q=d.lastCalcData;m&&a.timeStamp-m.timeStamp>b.CALCULATE_INTERVAL&&(e=m.center,f=a.timeStamp-m.timeStamp,h=a.center.clientX-
m.center.clientX,c=a.center.clientY-m.center.clientY,s=!0);if(a.eventType==v||a.eventType==u)d.futureCalcEvent=a;if(!d.lastCalcEvent||s)q.velocity=t.getVelocity(f,h,c),q.angle=t.getAngle(e,a.center),q.direction=t.getDirection(e,a.center),d.lastCalcEvent=d.futureCalcEvent||a,d.futureCalcEvent=a;a.velocityX=q.velocity.x;a.velocityY=q.velocity.y;a.interimAngle=q.angle;a.interimDirection=q.direction},extendEventData:function(a){var e=this.current,b=e.startEvent,e=e.lastEvent||b;if(a.eventType==v||a.eventType==
u)b.touches=[],t.each(a.touches,function(a){b.touches.push({clientX:a.clientX,clientY:a.clientY})});var f=a.timeStamp-b.timeStamp,h=a.center.clientX-b.center.clientX,c=a.center.clientY-b.center.clientY;this.getCalculatedData(a,e.center,f,h,c);t.extend(a,{startEvent:b,deltaTime:f,deltaX:h,deltaY:c,distance:t.getDistance(b.center,a.center),angle:t.getAngle(b.center,a.center),direction:t.getDirection(b.center,a.center),scale:t.getScale(b.touches,a.touches),rotation:t.getRotation(b.touches,a.touches)});
return a},register:function(a){var e=a.defaults||{};e[a.name]===g&&(e[a.name]=!0);t.extend(b.defaults,e,!0);a.index=a.index||1E3;this.gestures.push(a);this.gestures.sort(function(a,e){return a.index<e.index?-1:a.index>e.index?1:0});return this.gestures}};b.Instance=function(a,e){var f=this;c();this.element=a;this.enabled=!0;t.each(e,function(a,b){delete e[b];e[t.toCamelCase(b)]=a});this.options=t.extend(t.extend({},b.defaults),e||{});this.options.behavior&&t.toggleBehavior(this.element,this.options.behavior,
!0);this.eventStartHandler=r.onTouch(a,n,function(a){f.enabled&&a.eventType==n?w.startDetect(f,a):a.eventType==v&&w.detect(a)});this.eventHandlers=[]};b.Instance.prototype={on:function(a,e){var b=this;r.on(b.element,a,e,function(a){b.eventHandlers.push({gesture:a,handler:e})});return b},off:function(a,e){var b=this;r.off(b.element,a,e,function(a){a=t.inArray({gesture:a,handler:e});!1!==a&&b.eventHandlers.splice(a,1)});return b},trigger:function(a,e){e||(e={});var f=b.DOCUMENT.createEvent("Event");
f.initEvent(a,!0,!0);f.gesture=e;var h=this.element;t.hasParent(e.target,h)&&(h=e.target);navigator.isCocoonJS?this.eventHandlers.forEach(function(e){a===e.gesture&&e.handler(f)}):h.dispatchEvent(f);return this},enable:function(a){this.enabled=a;return this},dispose:function(){var e,b;t.toggleBehavior(this.element,this.options.behavior,!1);for(e=-1;b=this.eventHandlers[++e];)t.off(this.element,b.gesture,b.handler);this.eventHandlers=[];r.off(this.element,a[n],this.eventStartHandler);return null}};
(function(a){var c=!1;b.gestures.Drag={name:a,index:50,handler:function(b,d){var m=w.current;if(!(0<d.options.dragMaxTouches&&b.touches.length>d.options.dragMaxTouches))switch(b.eventType){case n:c=!1;break;case l:if(b.distance<d.options.dragMinDistance&&m.name!=a)break;var q=m.startEvent.center;if(m.name!=a&&(m.name=a,d.options.dragDistanceCorrection&&0<b.distance)){var g=Math.abs(d.options.dragMinDistance/b.distance);q.pageX+=b.deltaX*g;q.pageY+=b.deltaY*g;q.clientX+=b.deltaX*g;q.clientY+=b.deltaY*
g;b=w.extendEventData(b)}if(m.lastEvent.dragLockToAxis||d.options.dragLockToAxis&&d.options.dragLockMinDistance<=b.distance)b.dragLockToAxis=!0;m=m.lastEvent.direction;b.dragLockToAxis&&m!==b.direction&&(t.isVertical(m)?b.direction=0>b.deltaY?h:e:b.direction=0>b.deltaX?f:s);c||(d.trigger(a+"start",b),c=!0);d.trigger(a,b);d.trigger(a+b.direction,b);m=t.isVertical(b.direction);(d.options.dragBlockVertical&&m||d.options.dragBlockHorizontal&&!m)&&b.preventDefault();break;case u:c&&b.changedLength<=d.options.dragMaxTouches&&
(d.trigger(a+"end",b),c=!1);break;case p:c=!1}},defaults:{dragMinDistance:10,dragDistanceCorrection:!0,dragMaxTouches:1,dragBlockHorizontal:!1,dragBlockVertical:!1,dragLockToAxis:!1,dragLockMinDistance:25}}})("drag");b.gestures.Gesture={name:"gesture",index:1337,handler:function(a,e){e.trigger(this.name,a)}};(function(a){var e;b.gestures.Hold={name:a,index:10,defaults:{holdTimeout:500,holdThreshold:2},handler:function(b,f){var h=f.options,c=w.current;switch(b.eventType){case n:clearTimeout(e);c.name=
a;e=setTimeout(function(){c&&c.name==a&&f.trigger(a,b)},h.holdTimeout);break;case l:b.distance>h.holdThreshold&&clearTimeout(e);break;case u:clearTimeout(e)}}}})("hold");b.gestures.Release={name:"release",index:Infinity,handler:function(a,e){a.eventType==u&&e.trigger(this.name,a)}};b.gestures.Swipe={name:"swipe",index:40,defaults:{swipeMinTouches:1,swipeMaxTouches:1,swipeVelocityX:.6,swipeVelocityY:.6},handler:function(a,e){if(a.eventType==u){var b=a.touches.length,f=e.options;b<f.swipeMinTouches||
b>f.swipeMaxTouches||!(a.velocityX>f.swipeVelocityX||a.velocityY>f.swipeVelocityY)||(e.trigger(this.name,a),e.trigger(this.name+a.direction,a))}}};(function(a){var e=!1;b.gestures.Tap={name:a,index:100,handler:function(b,f){var h=f.options,c=w.current,d=w.previous,s,m;switch(b.eventType){case n:e=!1;break;case l:e=e||b.distance>h.tapMaxDistance;break;case p:!t.inStr(b.srcEvent.type,"cancel")&&b.deltaTime<h.tapMaxTime&&!e&&(s=d&&d.lastEvent&&b.timeStamp-d.lastEvent.timeStamp,m=!1,d&&d.name==a&&s&&
s<h.doubleTapInterval&&b.distance<h.doubleTapDistance&&(f.trigger("doubletap",b),m=!0),!m||h.tapAlways)&&(c.name=a,f.trigger(c.name,b))}},defaults:{tapMaxTime:250,tapMaxDistance:10,tapAlways:!0,doubleTapDistance:20,doubleTapInterval:300}}})("tap");b.gestures.Touch={name:"touch",index:-Infinity,defaults:{preventDefault:!1,preventMouse:!1},handler:function(a,e){e.options.preventMouse&&a.pointerType==m?a.stopDetect():(e.options.preventDefault&&a.preventDefault(),a.eventType==v&&e.trigger("touch",a))}};
(function(a){var e=!1;b.gestures.Transform={name:a,index:45,defaults:{transformMinScale:.01,transformMinRotation:1},handler:function(b,f){switch(b.eventType){case n:e=!1;break;case l:if(2>b.touches.length)break;var h=Math.abs(1-b.scale),c=Math.abs(b.rotation);if(h<f.options.transformMinScale&&c<f.options.transformMinRotation)break;w.current.name=a;e||(f.trigger(a+"start",b),e=!0);f.trigger(a,b);c>f.options.transformMinRotation&&f.trigger("rotate",b);h>f.options.transformMinScale&&(f.trigger("pinch",
b),f.trigger("pinch"+(1>b.scale?"in":"out"),b));break;case u:e&&2>b.changedLength&&(f.trigger(a+"end",b),e=!1)}}}})("transform");"function"==typeof define&&define.amd?define(function(){return b}):"undefined"!==typeof module&&module.exports?module.exports=b:d.Hammer=b})(window);var dragonBones;
(function(d){var g=function(){function c(b){this._animationStateCount=0;this._armature=b;this._animationList=[];this._animationStateList=[];this._timeScale=1;this._isPlaying=!1;this.tweenEnabled=!0}c.prototype.dispose=function(){if(this._armature){for(var b=this._animationStateList.length;b--;)d.AnimationState._returnObject(this._animationStateList[b]);this._animationList.length=0;this._animationStateList.length=0;this._animationStateList=this._animationList=this._animationDataList=this._armature=
null}};c.prototype.gotoAndPlay=function(b,a,e,f,h,s,m,q,g){void 0===a&&(a=-1);void 0===e&&(e=-1);void 0===f&&(f=NaN);void 0===h&&(h=0);void 0===s&&(s=null);void 0===m&&(m=c.SAME_LAYER_AND_GROUP);void 0===q&&(q=!0);void 0===g&&(g=!0);if(!this._animationDataList)return null;for(var n=this._animationDataList.length,l;n--;)if(this._animationDataList[n].name==b){l=this._animationDataList[n];break}if(!l)return null;this._isFading=this._isPlaying=!0;a=0>a?0>l.fadeTime?.3:l.fadeTime:a;e=0>e?0>l.scale?1:l.scale:
1E3*e/l.duration;f=isNaN(f)?l.playTimes:f;switch(m){case c.NONE:break;case c.SAME_LAYER:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],m.layer==h&&m.fadeOut(a,q);break;case c.SAME_GROUP:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],m.group==s&&m.fadeOut(a,q);break;case c.ALL:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],m.fadeOut(a,q);break;default:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],
m.layer==h&&m.group==s&&m.fadeOut(a,q)}this._lastAnimationState=d.AnimationState._borrowObject();this._lastAnimationState._layer=h;this._lastAnimationState._group=s;this._lastAnimationState.autoTween=this.tweenEnabled;this._lastAnimationState._fadeIn(this._armature,l,a,1/e,f,g);this.addState(this._lastAnimationState);f=this._armature.getSlots(!1);for(n=f.length;n--;)h=f[n],h.childArmature&&h.childArmature.animation.gotoAndPlay(b,a);return this._lastAnimationState};c.prototype.gotoAndStop=function(b,
a,e,f,h,d,m,q){void 0===e&&(e=-1);void 0===f&&(f=0);void 0===h&&(h=-1);void 0===d&&(d=0);void 0===m&&(m=null);void 0===q&&(q=c.ALL);var g=this.getState(b,d);g||(g=this.gotoAndPlay(b,f,h,NaN,d,m,q));0<=e?g.setCurrentTime(g.totalTime*e):g.setCurrentTime(a);g.stop();return g};c.prototype.play=function(){this._animationDataList&&0!=this._animationDataList.length&&(this._lastAnimationState?this._isPlaying?this.gotoAndPlay(this._lastAnimationState.name):this._isPlaying=!0:this.gotoAndPlay(this._animationDataList[0].name))};
c.prototype.stop=function(){this._isPlaying=!1};c.prototype.getState=function(b,a){void 0===a&&(a=0);for(var e=this._animationStateList.length;e--;){var f=this._animationStateList[e];if(f.name==b&&f.layer==a)return f}return null};c.prototype.hasAnimation=function(b){for(var a=this._animationDataList.length;a--;)if(this._animationDataList[a].name==b)return!0;return!1};c.prototype._advanceTime=function(b){if(this._isPlaying){var a=!1;b*=this._timeScale;for(var e=this._animationStateList.length;e--;){var f=
this._animationStateList[e];f._advanceTime(b)?this.removeState(f):1!=f.fadeState&&(a=!0)}this._isFading=a}};c.prototype._updateAnimationStates=function(){for(var b=this._animationStateList.length;b--;)this._animationStateList[b]._updateTimelineStates()};c.prototype.addState=function(b){0>this._animationStateList.indexOf(b)&&(this._animationStateList.unshift(b),this._animationStateCount=this._animationStateList.length)};c.prototype.removeState=function(b){var a=this._animationStateList.indexOf(b);
...
(b=new d.AnimationEvent(d.AnimationEvent.FADE_IN_COMPLETE),b.animationState=this,this._armature._eventList.push(b)))};c.prototype.advanceTimelinesTime=function(b){this._isPlaying&&!this._pausePlayheadInFade&&(this._time+=b);var a=!1,e=b=!1,f=!1,h=0,c=1E3*this._time;0==this._playTimes?(f=!1,h=Math.ceil(Math.abs(c)/this._totalTime)||1,c=0<=c?c-Math.floor(c/this._totalTime)*this._totalTime:c-Math.ceil(c/this._totalTime)*this._totalTime,0>c&&(c+=this._totalTime)):(h=this._playTimes*this._totalTime,c>=
h?(c=h,f=!0):c<=-h?(c=-h,f=!0):f=!1,0>c&&(c+=h),h=Math.ceil(c/this._totalTime)||1,c=0<=c?c-Math.floor(c/this._totalTime)*this._totalTime:c-Math.ceil(c/this._totalTime)*this._totalTime,f&&(c=this._totalTime));this._isComplete=f;var m=1E3*this._time/this._totalTime,q;for(q in this._timelineStateList){var g=this._timelineStateList[q];g._update(m);this._isComplete=g._isComplete&&this._isComplete}this._currentTime!=c&&(this._currentPlayTimes!=h&&(0<this._currentPlayTimes&&1<h&&(e=!0),this._currentPlayTimes=
h),0>this._currentTime&&(a=!0),this._isComplete&&(b=!0),this._currentTime=c,this.updateMainTimeline(f));a&&this._armature.hasEventListener(d.AnimationEvent.START)&&(q=new d.AnimationEvent(d.AnimationEvent.START),q.animationState=this,this._armature._eventList.push(q));b?(this._armature.hasEventListener(d.AnimationEvent.COMPLETE)&&(q=new d.AnimationEvent(d.AnimationEvent.COMPLETE),q.animationState=this,this._armature._eventList.push(q)),this.autoFadeOut&&this.fadeOut(this.fadeOutTime,!0)):e&&this._armature.hasEventListener(d.AnimationEvent.LOOP_COMPLETE)&&
(q=new d.AnimationEvent(d.AnimationEvent.LOOP_COMPLETE),q.animationState=this,this._armature._eventList.push(q))};c.prototype.updateMainTimeline=function(b){var a=this._clip.frameList;if(0<a.length){for(var e,f,h=0,c=this._clip.frameList.length;h<c;++h){if(0>this._currentFrameIndex)this._currentFrameIndex=0;else if(this._currentTime<this._currentFramePosition||this._currentTime>=this._currentFramePosition+this._currentFrameDuration){if(this._currentFrameIndex++,this._currentFrameIndex>=a.length)if(b){this._currentFrameIndex--;
...
(function(d){var g=function(){function c(){this.a=1;this.c=this.b=0;this.d=1;this.ty=this.tx=0}c.prototype.invert=function(){var b=this.a,a=this.b,e=this.c,f=this.d,h=this.tx,c=b*f-a*e;this.a=f/c;this.b=-a/c;this.c=-e/c;this.d=b/c;this.tx=(e*this.ty-f*h)/c;this.ty=-(b*this.ty-a*h)/c};c.prototype.concat=function(b){var a=b.a,e=b.b,f=b.c,h=b.d,c=this.tx,d=this.ty;if(1!=a||0!=e||0!=f||1!=h){var q=this.a,g=this.b,n=this.c,l=this.d;this.a=q*a+g*f;this.b=q*e+g*h;this.c=n*a+l*f;this.d=n*e+l*h}this.tx=c*
a+d*f+b.tx;this.ty=c*e+d*h+b.ty};return c}();d.Matrix=g})(dragonBones||(dragonBones={}));
...
null))};b.prototype._changeDisplay=function(a){void 0===a&&(a=0);if(0>a)this._isShowDisplay&&(this._isShowDisplay=!1,this._removeDisplayFromContainer(),this.updateChildArmatureAnimation());else if(0<this._displayList.length){var b=this._displayList.length;a>=b&&(a=b-1);this._currentDisplayIndex!=a?(this._isShowDisplay=!0,this._currentDisplayIndex=a,this._updateSlotDisplay(),this.updateChildArmatureAnimation(),this._displayDataList&&0<this._displayDataList.length&&this._currentDisplayIndex<this._displayDataList.length&&
this._origin.copy(this._displayDataList[this._currentDisplayIndex].transform)):this._isShowDisplay||(this._isShowDisplay=!0,this._armature&&(this._armature._slotsZOrderChanged=!0,this._addDisplayToContainer(this._armature.display)),this.updateChildArmatureAnimation())}};b.prototype._updateSlotDisplay=function(){var a=-1;this._currentDisplay&&(a=this._getDisplayIndex(),this._removeDisplayFromContainer());var b=this._displayList[this._currentDisplayIndex];this._currentDisplay=b?b instanceof d.Armature?
b.display:b:null;this._updateDisplay(this._currentDisplay);this._currentDisplay&&(this._armature&&this._isShowDisplay&&(0>a?(this._armature._slotsZOrderChanged=!0,this._addDisplayToContainer(this._armature.display)):this._addDisplayToContainer(this._armature.display,a)),this._updateDisplayBlendMode(this._blendMode),this._updateDisplayColor(this._colorTransform.alphaOffset,this._colorTransform.redOffset,this._colorTransform.greenOffset,this._colorTransform.blueOffset,this._colorTransform.alphaMultiplier,
...
};b.prototype._getDisplayIndex=function(){throw Error("Abstract method needs to be implemented in subclass!");};b.prototype._addDisplayToContainer=function(a,b){throw Error("Abstract method needs to be implemented in subclass!");};b.prototype._removeDisplayFromContainer=function(){throw Error("Abstract method needs to be implemented in subclass!");};b.prototype._updateTransform=function(){throw Error("Abstract method needs to be implemented in subclass!");};b.prototype._updateDisplayVisible=function(a){throw Error("Abstract method needs to be implemented in subclass!");
};b.prototype._updateDisplayColor=function(a,b,f,h,c,d,g,k){this._colorTransform.alphaOffset=a;this._colorTransform.redOffset=b;this._colorTransform.greenOffset=f;this._colorTransform.blueOffset=h;this._colorTransform.alphaMultiplier=c;this._colorTransform.redMultiplier=d;this._colorTransform.greenMultiplier=g;this._colorTransform.blueMultiplier=k};b.prototype._updateDisplayBlendMode=function(a){throw Error("Abstract method needs to be implemented in subclass!");};return b}(d.DBObject);d.Slot=g})(dragonBones||
...
(function(d){var g=function(c){function b(a,b){c.call(this,a)}__extends(b,c);Object.defineProperty(b,"MOVEMENT_CHANGE",{get:function(){return b.FADE_IN},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"movementID",{get:function(){return this.animationName},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"armature",{get:function(){return this.target},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"animationName",{get:function(){return this.animationState.name},
enumerable:!0,configurable:!0});b.FADE_IN="fadeIn";b.FADE_OUT="fadeOut";b.START="start";b.COMPLETE="complete";b.LOOP_COMPLETE="loopComplete";b.FADE_IN_COMPLETE="fadeInComplete";b.FADE_OUT_COMPLETE="fadeOutComplete";return b}(d.Event);d.AnimationEvent=g})(dragonBones||(dragonBones={}));(function(d){var g=function(c){function b(a){c.call(this,a)}__extends(b,c);b.Z_ORDER_UPDATED="zOrderUpdated";return b}(d.Event);d.ArmatureEvent=g})(dragonBones||(dragonBones={}));
(function(d){var g=function(c){function b(a,b){c.call(this,a)}__extends(b,c);Object.defineProperty(b,"MOVEMENT_FRAME_EVENT",{get:function(){return b.ANIMATION_FRAME_EVENT},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"armature",{get:function(){return this.target},enumerable:!0,configurable:!0});b.ANIMATION_FRAME_EVENT="animationFrameEvent";b.BONE_FRAME_EVENT="boneFrameEvent";return b}(d.Event);d.FrameEvent=g})(dragonBones||(dragonBones={}));
(function(d){var g=function(c){function b(a){c.call(this);this.dragonBonesDataDic={};this.textureAtlasDic={};if(a!=this)throw Error("Abstract class can not be instantiated!");}__extends(b,c);b.prototype.dispose=function(a){void 0===a&&(a=!0);if(a){for(var b in this.dragonBonesDataDic)this.dragonBonesDataDic[b].dispose(),delete this.dragonBonesDataDic[b];for(var f in this.textureAtlasDic)this.textureAtlasDic[f].dispose(),delete this.textureAtlasDic[f]}this.textureAtlasDic=this.dragonBonesDataDic=null};
b.prototype.getDragonBonesData=function(a){return this.dragonBonesDataDic[a]};b.prototype.getSkeletonData=function(a){return this.getDragonBonesData(a)};b.prototype.addDragonBonesData=function(a,b){void 0===b&&(b=null);if(!a)throw Error();b=b||a.name;if(!b)throw Error("Unnamed data!");if(this.dragonBonesDataDic[b])throw Error();this.dragonBonesDataDic[b]=a};b.prototype.addSkeletonData=function(a,b){void 0===b&&(b=null);this.addDragonBonesData(a,b)};b.prototype.removeDragonBonesData=function(a){delete this.dragonBonesDataDic[a]};
b.prototype.removeSkeletonData=function(a){delete this.dragonBonesDataDic[a]};b.prototype.getTextureAtlas=function(a){return this.textureAtlasDic[a]};b.prototype.addTextureAtlas=function(a,b){void 0===b&&(b=null);if(!a)throw Error();!b&&a.hasOwnProperty("name")&&(b=a.name);if(!b)throw Error("Unnamed data!");if(this.textureAtlasDic[b])throw Error();this.textureAtlasDic[b]=a};b.prototype.removeTextureAtlas=function(a){delete this.textureAtlasDic[a]};b.prototype.getTextureDisplay=function(a,b,f,h){void 0===
b&&(b=null);void 0===f&&(f=NaN);void 0===h&&(h=NaN);var c;if(b)c=this.textureAtlasDic[b];else for(b in this.textureAtlasDic){c=this.textureAtlasDic[b];if(c.getRegion(a))break;c=null}if(!c)return null;if(isNaN(f)||isNaN(h))if(b=(b=this.dragonBonesDataDic[b])?b:this.findFirstDragonBonesData())if(b=b.getDisplayDataByName(a))f=b.pivot.x,h=b.pivot.y;return this._generateDisplay(c,a,f,h)};b.prototype.buildArmature=function(a,b,f,h){void 0===b&&(b=null);void 0===f&&(f=null);void 0===h&&(h=null);var c={};
this.fillBuildArmatureDataPackageArmatureInfo(a,b,c)&&this.fillBuildArmatureDataPackageTextureInfo(f,c);a=c.armatureData;b=c.textureAtlas;return a&&b?this.buildArmatureUsingArmatureDataFromTextureAtlas(c.dragonBonesData,a,b,h):null};b.prototype.buildArmatureUsingArmatureDataFromTextureAtlas=function(a,b,f,h){void 0===h&&(h=null);var c=this._generateArmature();c.name=b.name;c.__dragonBonesData=a;c._armatureData=b;c.animation.animationDataList=b.animationDataList;this._buildBones(c);this._buildSlots(c,
h,f);c.advanceTime(0);return c};b.prototype.copyAnimationsToArmature=function(a,b,f,h){void 0===f&&(f=null);void 0===h&&(h=!0);var c={};if(!this.fillBuildArmatureDataPackageArmatureInfo(b,f,c))return!1;b=c.armatureData;a.animation.animationDataList=b.animationDataList;b=b.getSkinData("");var m;a=a.getSlots(!1);for(var g,k=0,n,l=a.length,p=0;p<l;p++){f=a[p];g=f.displayList;for(var k=g.length,u=0;u<k;u++)n=g[u],n instanceof d.Armature&&(m=b.getSlotData(f.name),m=m.displayDataList[u],m.type==d.DisplayData.ARMATURE&&
this.copyAnimationsToArmature(n,m.name,c.dragonBonesDataName,h))}return!0};b.prototype.fillBuildArmatureDataPackageArmatureInfo=function(a,b,f){if(b)f.dragonBonesDataName=b,f.dragonBonesData=this.dragonBonesDataDic[b],f.armatureData=f.dragonBonesData.getArmatureDataByName(a);else for(b in this.dragonBonesDataDic)if(f.dragonBonesData=this.dragonBonesDataDic[b],f.armatureData=f.dragonBonesData.getArmatureDataByName(a),f.armatureData)return f.dragonBonesDataName=b,!0;return!1};b.prototype.fillBuildArmatureDataPackageTextureInfo=
function(a,b){b.textureAtlas=this.textureAtlasDic[a?a:b.dragonBonesDataName]};b.prototype.findFirstDragonBonesData=function(){for(var a in this.dragonBonesDataDic){var b=this.dragonBonesDataDic[a];if(b)return b}return null};b.prototype.findFirstTextureAtlas=function(){for(var a in this.textureAtlasDic){var b=this.textureAtlasDic[a];if(b)return b}return null};b.prototype._buildBones=function(a){for(var b=a.armatureData.boneDataList,f,h,c=0;c<b.length;c++)f=b[c],h=d.Bone.initWithBoneData(f),(f=f.parent)&&
null==a.armatureData.getBoneData(f)&&(f=null),a.addBone(h,f,!0);a._updateAnimationAfterBoneListChanged()};b.prototype._buildSlots=function(a,b,f){var h=a.armatureData.getSkinData(b);if(h)for(var c=[],h=h.slotDataList,m,g,k,n=0;n<h.length;n++)if(m=h[n],k=a.getBone(m.parent)){g=this._generateSlot();g.initWithSlotData(m);k.addSlot(g);for(k=m.displayDataList.length;k--;){var l=m.displayDataList[k];switch(l.type){case d.DisplayData.ARMATURE:l=this.buildArmatureUsingArmatureDataFromTextureAtlas(a.__dragonBonesData,
a.__dragonBonesData.getArmatureDataByName(l.name),f,b);c[k]=l;break;default:c[k]=this._generateDisplay(f,l.name,l.pivot.x,l.pivot.y)}}for(var p in c)if(m=c[p],m instanceof d.Armature&&(m=m.display),m.hasOwnProperty("name"))try{m.name=g.name}catch(u){}g.displayList=c;g._changeDisplay(0)}};b.prototype._generateArmature=function(){return null};b.prototype._generateSlot=function(){return null};b.prototype._generateDisplay=function(a,b,f,h){return null};b._helpMatrix=new d.Matrix;return b}(d.EventDispatcher);
d.BaseFactory=g})(dragonBones||(dragonBones={}));(function(d){var g=function(){function c(b,a){void 0===b&&(b=0);void 0===a&&(a=0);this.x=b;this.y=a}c.prototype.toString=function(){return"[Point (x="+this.x+" y="+this.y+")]"};return c}();d.Point=g})(dragonBones||(dragonBones={}));(function(d){var g=function(){return function(c,b,a,e){void 0===c&&(c=0);void 0===b&&(b=0);void 0===a&&(a=0);void 0===e&&(e=0);this.x=c;this.y=b;this.width=a;this.height=e}}();d.Rectangle=g})(dragonBones||(dragonBones={}));
...
(function(d){var g=function(c){function b(){c.call(this);this.playTimes=this.fadeTime=this.lastFrameDuration=this.playTimes=this.frameRate=0;this.autoTween=!0;this.tweenEasing=NaN;this.hideTimelineNameMap=[];this._timelineList=[]}__extends(b,c);Object.defineProperty(b.prototype,"timelineList",{get:function(){return this._timelineList},enumerable:!0,configurable:!0});b.prototype.dispose=function(){c.prototype.dispose.call(this);this.hideTimelineNameMap=null;for(var a in this._timelineList)this._timelineList[a].dispose();
this._timelineList=null};b.prototype.getTimeline=function(a){for(var b=this._timelineList.length;b--;)if(this._timelineList[b].name==a)return this._timelineList[b];return null};b.prototype.addTimeline=function(a){if(!a)throw Error();0>this._timelineList.indexOf(a)&&(this._timelineList[this._timelineList.length]=a)};return b}(d.Timeline);d.AnimationData=g})(dragonBones||(dragonBones={}));
(function(d){var g=function(){function c(){this._boneDataList=[];this._skinDataList=[];this._animationDataList=[]}c.sortBoneDataHelpArray=function(b,a){return b[0]>a[0]?1:-1};c.sortBoneDataHelpArrayDescending=function(b,a){return b[0]>a[0]?-1:1};c.prototype.dispose=function(){for(var b=this._boneDataList.length;b--;)this._boneDataList[b].dispose();for(b=this._skinDataList.length;b--;)this._skinDataList[b].dispose();for(b=this._animationDataList.length;b--;)this._animationDataList[b].dispose();this._animationDataList=
...
b)return this._displayDataList[a];return null};Object.defineProperty(c.prototype,"displayDataList",{get:function(){return this._displayDataList},enumerable:!0,configurable:!0});return c}();d.SlotData=g})(dragonBones||(dragonBones={}));
(function(d){var g=function(c){function b(){c.call(this);this.displayIndex=this.tweenRotate=0;this.tweenEasing=10;this.tweenRotate=0;this.tweenScale=!0;this.displayIndex=0;this.visible=!0;this.zOrder=NaN;this.global=new d.DBTransform;this.transform=new d.DBTransform;this.pivot=new d.Point;this.scaleOffset=new d.Point}__extends(b,c);b.prototype.dispose=function(){c.prototype.dispose.call(this);this.color=this.scaleOffset=this.pivot=this.transform=this.global=null};return b}(d.Frame);d.TransformFrame=
g})(dragonBones||(dragonBones={}));(function(d){var g=function(c){function b(){c.call(this);this.originTransform=new d.DBTransform;this.originTransform.scaleX=1;this.originTransform.scaleY=1;this.originPivot=new d.Point;this.offset=0}__extends(b,c);b.prototype.dispose=function(){c.prototype.dispose.call(this);this.originPivot=this.originTransform=null};return b}(d.Timeline);d.TransformTimeline=g})(dragonBones||(dragonBones={}));
(function(d){var g=function(){function c(){}c.parseTextureAtlasData=function(b,a){void 0===a&&(a=1);var e={},f,h=b[d.ConstValues.SUB_TEXTURE],s;for(s in h){var m=h[s],g=m[d.ConstValues.A_NAME],k=new d.Rectangle;k.x=c.getNumber(m,d.ConstValues.A_X,0)/a;k.y=c.getNumber(m,d.ConstValues.A_Y,0)/a;k.width=c.getNumber(m,d.ConstValues.A_WIDTH,0)/a;k.height=c.getNumber(m,d.ConstValues.A_HEIGHT,0)/a;var n="true"==m[d.ConstValues.A_ROTATED],l=c.getNumber(m,d.ConstValues.A_FRAME_WIDTH,0)/a,p=c.getNumber(m,d.ConstValues.A_FRAME_HEIGHT,
0)/a;0<l&&0<p?(f=new d.Rectangle,f.x=c.getNumber(m,d.ConstValues.A_FRAME_X,0)/a,f.y=c.getNumber(m,d.ConstValues.A_FRAME_Y,0)/a,f.width=l,f.height=p):f=null;e[g]=new d.TextureData(k,f,n)}return e};c.parseDragonBonesData=function(b){if(!b)throw Error();var a=b[d.ConstValues.A_VERSION],a=a.toString();if(a.toString()!=d.DragonBones.DATA_VERSION&&a.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var a=c.getNumber(b,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
e.name=b[d.ConstValues.A_NAME];e.isGlobal="0"==b[d.ConstValues.A_IS_GLOBAL]?!1:!0;c.tempDragonBonesData=e;var f=b[d.ConstValues.ARMATURE],h;for(h in f)e.addArmatureData(c.parseArmatureData(b[d.ConstValues.ARMATURE][h],a));c.tempDragonBonesData=null;return e};c.parseArmatureData=function(b,a){var e=new d.ArmatureData;e.name=b[d.ConstValues.A_NAME];var f=b[d.ConstValues.BONE],h;for(h in f)e.addBoneData(c.parseBoneData(f[h]));f=b[d.ConstValues.SKIN];for(h in f)e.addSkinData(c.parseSkinData(f[h]));c.tempDragonBonesData.isGlobal&&
d.DBDataUtil.transformArmatureData(e);e.sortBoneDataList();f=b[d.ConstValues.ANIMATION];for(h in f){var s=c.parseAnimationData(f[h],a);d.DBDataUtil.addHideTimeline(s,e);d.DBDataUtil.transformAnimationData(s,e,c.tempDragonBonesData.isGlobal);e.addAnimationData(s)}return e};c.parseBoneData=function(b){var a=new d.BoneData;a.name=b[d.ConstValues.A_NAME];a.parent=b[d.ConstValues.A_PARENT];a.length=Number(b[d.ConstValues.A_LENGTH])||0;a.inheritRotation=c.getBoolean(b,d.ConstValues.A_INHERIT_ROTATION,!0);
...
e.name=b[d.ConstValues.A_NAME];e.frameRate=a;e.duration=Math.round(1E3*(c.getNumber(b,d.ConstValues.A_DURATION,1)||1)/a);e.playTimes=c.getNumber(b,d.ConstValues.A_LOOP,1);e.playTimes=NaN!=e.playTimes?e.playTimes:1;e.fadeTime=c.getNumber(b,d.ConstValues.A_FADE_IN_TIME,0)||0;e.scale=c.getNumber(b,d.ConstValues.A_SCALE,1)||0;e.tweenEasing=c.getNumber(b,d.ConstValues.A_TWEEN_EASING,NaN);e.autoTween=c.getBoolean(b,d.ConstValues.A_AUTO_TWEEN,!0);var f=b[d.ConstValues.FRAME],h;for(h in f){var s=c.parseTransformFrame(f[h],
a);e.addFrame(s)}c.parseTimeline(b,e);f=e.duration;s=b[d.ConstValues.TIMELINE];for(h in s){var m=s[h],g=c.parseTransformTimeline(m,e.duration,a),g=c.parseTransformTimeline(m,e.duration,a),f=Math.min(f,g.frameList[g.frameList.length-1].duration);e.addTimeline(g)}0<e.frameList.length&&(f=Math.min(f,e.frameList[e.frameList.length-1].duration));e.lastFrameDuration=f;return e};c.parseTransformTimeline=function(b,a,e){var f=new d.TransformTimeline;f.name=b[d.ConstValues.A_NAME];f.scale=c.getNumber(b,d.ConstValues.A_SCALE,
1)||0;f.offset=c.getNumber(b,d.ConstValues.A_OFFSET,0)||0;f.originPivot.x=c.getNumber(b,d.ConstValues.A_PIVOT_X,0)||0;f.originPivot.y=c.getNumber(b,d.ConstValues.A_PIVOT_Y,0)||0;f.duration=a;a=b[d.ConstValues.FRAME];for(var h in a){var s=c.parseTransformFrame(a[h],e);f.addFrame(s)}c.parseTimeline(b,f);return f};c.parseTransformFrame=function(b,a){var e=new d.TransformFrame;c.parseFrame(b,e,a);e.visible=!c.getBoolean(b,d.ConstValues.A_HIDE,!1);e.tweenEasing=c.getNumber(b,d.ConstValues.A_TWEEN_EASING,
...
c.getNumber(b,d.ConstValues.A_SCALE_Y_OFFSET,0)||0;var f=b[d.ConstValues.COLOR_TRANSFORM];f&&(e.color=new d.ColorTransform,c.parseColorTransform(f,e.color));return e};c.parseTimeline=function(b,a){var e=0,f,h=a.frameList,c;for(c in h)f=h[c],f.position=e,e+=f.duration;f&&(f.duration=a.duration-f.position)};c.parseFrame=function(b,a,e){void 0===e&&(e=0);a.duration=Math.round(1E3*(b[d.ConstValues.A_DURATION]||1)/e);a.action=b[d.ConstValues.A_ACTION];a.event=b[d.ConstValues.A_EVENT];a.sound=b[d.ConstValues.A_SOUND]};
...
(function(d){var g=function(){return function(c,b,a){this.region=c;this.frame=b;this.rotated=a}}();d.TextureData=g})(dragonBones||(dragonBones={}));
...
(function(d){var g=function(){function c(){}c.transformArmatureData=function(b){for(var a=b.boneDataList,e=a.length;e--;){var f=a[e];if(f.parent){var h=b.getBoneData(f.parent);h&&(f.transform.copy(f.global),d.TransformUtil.globalToLocal(f.transform,h.global))}}};c.transformArmatureDataAnimations=function(b){for(var a=b.animationDataList,e=a.length;e--;)c.transformAnimationData(a[e],b,!1)};c.transformRelativeAnimationData=function(b,a){};c.transformAnimationData=function(b,a,e){if(e){var f=a.getSkinData(null);
e=a.boneDataList;var h;f&&(h=f.slotDataList);for(f=0;f<e.length;f++){var s=e[f],m=b.getTimeline(s.name);if(m){var g=null;if(h)for(var k in h)if(g=h[k],g.parent==s.name)break;for(var n=m.frameList,l=null,p=null,u=null,v=n.length,t=0;t<v;t++){var r=n[t];c.setFrameTransform(b,a,s,r);r.transform.x-=s.transform.x;r.transform.y-=s.transform.y;r.transform.skewX-=s.transform.skewX;r.transform.skewY-=s.transform.skewY;r.transform.scaleX/=s.transform.scaleX;r.transform.scaleY/=s.transform.scaleY;!m.transformed&&
g&&(r.zOrder-=g.zOrder);l||(l=m.originTransform,l.copy(r.transform),l.skewX=d.TransformUtil.formatRadian(l.skewX),l.skewY=d.TransformUtil.formatRadian(l.skewY),p=m.originPivot,p.x=r.pivot.x,p.y=r.pivot.y);r.transform.x-=l.x;r.transform.y-=l.y;r.transform.skewX=d.TransformUtil.formatRadian(r.transform.skewX-l.skewX);r.transform.skewY=d.TransformUtil.formatRadian(r.transform.skewY-l.skewY);r.transform.scaleX/=l.scaleX;r.transform.scaleY/=l.scaleY;m.transformed||(r.pivot.x-=p.x,r.pivot.y-=p.y);if(u){var x=
...
u.transform.skewX),r.transform.skewY=u.transform.skewY+d.TransformUtil.formatRadian(r.transform.skewY-u.transform.skewY))}u=r}m.transformed=!0}}}else c.transformRelativeAnimationData(b,a)};c.setFrameTransform=function(b,a,e,f){f.transform.copy(f.global);if(e=a.getBoneData(e.parent)){var h=b.getTimeline(e.name);if(h){for(var s=[],m=[];h;)s.push(h),m.push(e),h=(e=a.getBoneData(e.parent))?b.getTimeline(e.name):null;b=s.length;var g;a=new d.Matrix;for(var k=new d.DBTransform,n=new d.Matrix;b--;)h=s[b],
e=m[b],c.getTimelineTransform(h,f.position,k,!g),g?(k.x+=h.originTransform.x+e.transform.x,k.y+=h.originTransform.y+e.transform.y,k.skewX+=h.originTransform.skewX+e.transform.skewX,k.skewY+=h.originTransform.skewY+e.transform.skewY,k.scaleX=k.scaleX*h.originTransform.scaleX*e.transform.scaleX,k.scaleY=k.scaleY*h.originTransform.scaleY*e.transform.scaleY,d.TransformUtil.transformToMatrix(k,n,!0),n.concat(a),d.TransformUtil.matrixToTransform(n,g,0<=k.scaleX*g.scaleX,0<=k.scaleY*g.scaleY)):(g=new d.DBTransform,
g.copy(k)),d.TransformUtil.transformToMatrix(g,a,!0);d.TransformUtil.globalToLocal(f.transform,g)}}};c.getTimelineTransform=function(b,a,e,f){for(var h=b.frameList,c=h.length;c--;)if(b=h[c],b.position<=a&&b.position+b.duration>a){if(c==h.length-1||a==b.position)e.copy(f?b.global:b.transform);else{var m=b.tweenEasing;a=(a-b.position)/b.duration;m&&10!=m&&(a=d.MathUtil.getEaseValue(a,m));h=h[c+1];b=f?b.global:b.transform;f=f?h.global:h.transform;e.x=b.x+(f.x-b.x)*a;e.y=b.y+(f.y-b.y)*a;e.skewX=d.TransformUtil.formatRadian(b.skewX+
(f.skewX-b.skewX)*a);e.skewY=d.TransformUtil.formatRadian(b.skewY+(f.skewY-b.skewY)*a);e.scaleX=b.scaleX+(f.scaleX-b.scaleX)*a;e.scaleY=b.scaleY+(f.scaleY-b.scaleY)*a}break}};c.addHideTimeline=function(b,a){for(var e=a.boneDataList,f=e.length;f--;){var h=e[f].name;b.getTimeline(h)||0>b.hideTimelineNameMap.indexOf(h)&&b.hideTimelineNameMap.push(h)}};return c}();d.DBDataUtil=g})(dragonBones||(dragonBones={}));
(function(d){var g=function(){function c(){}c.getEaseValue=function(b,a){var e=1;1<a?(e=.5*(1-Math.cos(b*Math.PI)),a-=1):0<a?e=1-Math.pow(1-b,2):0>a&&(a*=-1,e=Math.pow(b,2));return(e-b)*a+b};return c}();d.MathUtil=g})(dragonBones||(dragonBones={}));
(function(d){var g=function(){function c(){}c.globalToLocal=function(b,a){c.transformToMatrix(b,c._helpTransformMatrix,!0);c.transformToMatrix(a,c._helpParentTransformMatrix,!0);c._helpParentTransformMatrix.invert();c._helpTransformMatrix.concat(c._helpParentTransformMatrix);c.matrixToTransform(c._helpTransformMatrix,b,0<=b.scaleX*a.scaleX,0<=b.scaleY*a.scaleY)};c.transformToMatrix=function(b,a,e){void 0===e&&(e=!1);e?(a.a=b.scaleX*Math.cos(b.skewY),a.b=b.scaleX*Math.sin(b.skewY),a.c=-b.scaleY*Math.sin(b.skewX),
a.d=b.scaleY*Math.cos(b.skewX)):(a.a=Math.cos(b.skewY),a.b=Math.sin(b.skewY),a.c=-Math.sin(b.skewX),a.d=Math.cos(b.skewX));a.tx=b.x;a.ty=b.y};c.matrixToTransform=function(b,a,e,f){a.x=b.tx;a.y=b.ty;a.scaleX=Math.sqrt(b.a*b.a+b.b*b.b)*(e?1:-1);a.scaleY=Math.sqrt(b.d*b.d+b.c*b.c)*(f?1:-1);e=[];e[0]=Math.acos(b.d/a.scaleY);e[1]=-e[0];e[2]=Math.asin(-b.c/a.scaleY);e[3]=0<=e[2]?Math.PI-e[2]:e[2]-Math.PI;Number(e[0]).toFixed(4)==Number(e[2]).toFixed(4)||Number(e[0]).toFixed(4)==Number(e[3]).toFixed(4)?
...
(function(d){(function(d){var c=function(){function a(){this._listeners=[]}a.prototype.add=function(a){this._listeners.push(a)};a.prototype.remove=function(a){var b,h=this._listeners.length;for(b=0;b<h;b++)if(this._listeners[b]===a)return this._listeners.splice(b,1),!0;return!1};a.prototype.removeAt=function(a){return this._listeners.splice(a,1)};a.prototype.get=function(a){return this._listeners[a]};a.prototype.length=function(){return this._listeners.length};a.prototype.clear=function(){this._listeners.length=
0};return a}(),b=function(){function a(){this._captureDict={};this._bubbleDict={}}a.prototype.setBubbleParent=function(a){this._bubbleParent=a};a.prototype.hasListener=function(a,b){void 0===b&&(b=!1);return 0<this._getListenerList(a,b).length()};a.prototype.getListenerCount=function(a,b){return this._getListenerList(a,b).length()};a.prototype.addListener=function(a,b,h){void 0===h&&(h=!1);this._getListenerList(a,h).add(b)};a.prototype.removeListener=function(a,b,h){void 0===h&&(h=!1);return this._getListenerList(a,
h).remove(b)};a.prototype.clearListeners=function(a,b){this._getListenerList(a,b).clear()};a.prototype.clearAllListeners=function(){this._captureDict={};this._bubbleDict={}};a.prototype.dispatchEvent=function(a){var b,h,c,d;a._target=this;if(a.bubbles){c=this._getAncients();h=c.length;for(b=h-1;0<=b;b--)if(d=c[b],d._dispatchEventInPhase(a,0))return;if(!this._dispatchEventInPhase(a,0)&&!this._dispatchEventInPhase(a,2))for(b=0;b<h&&(d=c[b],!d._dispatchEventInPhase(a,1));b++);}else this._dispatchEventInPhase(a,
2)};a.prototype._dispatchEventInPhase=function(a,b){var h,c,d;a._eventPhase=b;a._listenerRemove=!1;a._currentTarget=this;d=this._getListenerList(a.type,0===b);h=d.length();if(0<h){for(h-=1;0<=h;h--)if(c=d.get(h),c(a),a._listenerRemove&&(a._listenerRemove=!1,d.removeAt(h)),a.isStopImmediatePropagation())return!0;if(a.isStopPropagation())return!0}return!1};a.prototype._getAncients=function(){for(var a=[],b=this;b._bubbleParent;)b=b._bubbleParent,a.push(b);return a};a.prototype._getListenerList=function(a,
b){var h,d=b?this._captureDict:this._bubbleDict;h=d[a];h||(h=new c,d[a]=h);return h};return a}();d.EventDispatcher=b})(d.event||(d.event={}))})(WOZLLA||(WOZLLA={}));__extends=this.__extends||function(d,g){function c(){this.constructor=d}for(var b in g)g.hasOwnProperty(b)&&(d[b]=g[b]);c.prototype=g.prototype;d.prototype=new c};
(function(d){(function(g){var c=function(b){function a(a){b.call(this);this._refCount=0;this._src=a}__extends(a,b);Object.defineProperty(a.prototype,"src",{get:function(){return this._src},enumerable:!0,configurable:!0});a.prototype.retain=function(){this._refCount++};a.prototype.release=function(a){void 0===a&&(a=!0);a&&0<this._refCount&&this._refCount--;0===this._refCount&&this.unload()};a.prototype.load=function(a,b){a()};a.prototype.unload=function(){var b=new d.event.Event(a.EVENT_UNLOAD,!1);
b.target=b.currentTarget=this;this.dispatchEvent(b)};a.EVENT_UNLOAD="unload";return a}(d.event.EventDispatcher);g.Asset=c})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
...
h,c;h=0;for(c=a.length;h<c;h++)b=a[h],this.load(b.src,b.AssetClass,b.callback)};a.prototype.load=function(a,f,h){var c=this,d,g;(d=this._loadedAssets[a])?h&&h():(g=this._loadingUnits[a])?g.addCallback(h,h):(d=new f(a),g=new b(a),g.addCallback(h,h),this._loadingUnits[a]=g,d.load(function(){delete c._loadingUnits[a];c.addAsset(d);g.complete(null,d)},function(b){console.log(b);delete c._loadingUnits[a];g.complete(b)}))};return a}();d.AssetLoader=c;var b=function(){function a(a){this.callbacks=[];this.src=
...
(function(d){(function(d){var c=function(){function b(){this.values=new Float32Array(9);this.identity()}b.prototype.applyMatrix=function(a){this.values.set(a.values)};b.prototype.identity=function(){this.values[0]=1;this.values[1]=0;this.values[2]=0;this.values[3]=0;this.values[4]=1;this.values[5]=0;this.values[6]=0;this.values[7]=0;this.values[8]=1};b.prototype.invert=function(){var a=this.values[0],b=this.values[1],f=this.values[3],h=this.values[4],c=this.values[6],d=this.values[7],g=a*h-b*f;this.values[0]=
h/g;this.values[1]=-b/g;this.values[3]=-f/g;this.values[4]=a/g;this.values[6]=(f*d-h*c)/g;this.values[7]=-(a*d-b*c)/g};b.prototype.prepend=function(a,b,f,h,c,d){var g,k,n,l,p=this.values,u=p[6],v=p[7];if(1!=a||0!=b||0!=f||1!=h)g=p[0],k=p[1],n=p[3],l=p[4],p[0]=g*a+k*f,p[1]=g*b+k*h,p[3]=n*a+l*f,p[4]=n*b+l*h;p[6]=u*a+v*f+c;p[7]=u*b+v*h+d};b.prototype.append=function(a,b,f,h,c,d){var g,k,n,l,p=this.values;g=p[0];k=p[1];n=p[3];l=p[4];p[0]=a*g+b*n;p[1]=a*k+b*l;p[3]=f*g+h*n;p[4]=f*k+h*l;p[6]=c*g+d*n+p[6];
p[7]=c*k+d*l+p[7]};b.prototype.prependTransform=function(a,e,f,h,c,d,g,k,n){if(c%360){var l=c*b.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=1,l=0;if(k||n)this.values[6]-=k,this.values[7]-=n;d||g?(d*=b.DEG_TO_RAD,g*=b.DEG_TO_RAD,this.prepend(c*f,l*f,-l*h,c*h,0,0),this.prepend(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),a,e)):this.prepend(c*f,l*f,-l*h,c*h,a,e);return this};b.prototype.appendTransform=function(a,e,f,h,c,d,g,k,n){if(c%360){var l=c*b.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=
1,l=0;d||g?(d*=b.DEG_TO_RAD,g*=b.DEG_TO_RAD,this.append(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),a,e),this.append(c*f,l*f,-l*h,c*h,0,0)):this.append(c*f,l*f,-l*h,c*h,a,e);if(k||n)this.values[6]-=k*this.values[0]+n*this.values[3],this.values[7]-=k*this.values[1]+n*this.values[4];return this};b.DEG_TO_RAD=Math.PI/180;return b}();d.Matrix=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function b(a,b,f){this._target=null;this.loop=this.ignoreGlobalPause=this._useTicks=!1;this._actions=this._steps=this.pluginData=null;this.paused=!1;this.duration=0;this._prevPos=-1;this.position=null;this._stepPosition=this._prevPosition=0;this.passive=!1;this.initialize(a,b,f)}b.get=function(a,e,f,h){void 0===e&&(e=null);void 0===f&&(f=null);void 0===h&&(h=!1);h&&b.removeTweens(a);return new b(a,e,f)};b.removeTweens=function(a){if(a.tween_count){for(var e=
b._tweens,f=e.length-1;0<=f;f--)e[f]._target==a&&(e[f].paused=!0,e.splice(f,1));a.tween_count=0}};b.tick=function(a,e){void 0===e&&(e=!1);for(var f=b._tweens.concat(),h=f.length-1;0<=h;h--){var c=f[h];e&&!c.ignoreGlobalPause||c.paused||c.tick(c._useTicks?1:a)}};b._register=function(a,e){var f=a._target,h=b._tweens;if(e)f&&(f.tween_count=f.tween_count?f.tween_count+1:1),h.push(a);else for(f&&f.tween_count--,f=h.length;f--;)if(h[f]==a){h.splice(f,1);break}};b.removeAllTweens=function(){for(var a=b._tweens,
e=0,f=a.length;e<f;e++){var h=a[e];h.paused=!0;h._target.tweenjs_count=0}a.length=0};b.prototype.initialize=function(a,e,f){this._target=a;e&&(this._useTicks=e.useTicks,this.ignoreGlobalPause=e.ignoreGlobalPause,this.loop=e.loop,e.override&&b.removeTweens(a));this.pluginData=f||{};this._curQueueProps={};this._initQueueProps={};this._steps=[];this._actions=[];e&&e.paused?this.paused=!0:b._register(this,!0);e&&null!=e.position&&this.setPosition(e.position,b.NONE)};b.prototype.setPosition=function(a,
b){void 0===b&&(b=1);0>a&&(a=0);var f=a,h=!1;f>=this.duration&&(this.loop?f%=this.duration:(f=this.duration,h=!0));if(f==this._prevPos)return h;var c=this._prevPos;this.position=this._prevPos=f;this._prevPosition=a;if(this._target)if(h)this._updateTargetProps(null,1);else if(0<this._steps.length){for(var d=0,g=this._steps.length;d<g&&!(this._steps[d].t>f);d++);d=this._steps[d-1];this._updateTargetProps(d,(this._stepPosition=f-d.t)/d.d)}0!=b&&0<this._actions.length&&(this._useTicks?this._runActions(f,
f):1==b&&f<c?(c!=this.duration&&this._runActions(c,this.duration),this._runActions(0,f,!0)):this._runActions(c,f));h&&this.setPaused(!0);return h};b.prototype._runActions=function(a,b,f){void 0===f&&(f=!1);var h=a,c=b,d=-1,g=this._actions.length,k=1;a>b&&(h=b,c=a,d=g,g=k=-1);for(;(d+=k)!=g;){b=this._actions[d];var n=b.t;(n==c||n>h&&n<c||f&&n==a)&&b.f.apply(b.o,b.p)}};b.prototype._updateTargetProps=function(a,e){var f,h,c,d;if(a||1!=e){if(this.passive=!!a.v)return;a.e&&(e=a.e(e,0,1,1));f=a.p0;h=a.p1}else this.passive=
!1,f=h=this._curQueueProps;for(var g in this._initQueueProps){null==(c=f[g])&&(f[g]=c=this._initQueueProps[g]);null==(d=h[g])&&(h[g]=d=c);c=c==d||0==e||1==e||"number"!=typeof c?1==e?d:c:c+(d-c)*e;var k=!1;if(d=b._plugins[g])for(var n=0,l=d.length;n<l;n++){var p=d[n].tween(this,g,c,f,h,e,!!a&&f==h,!a);p==b.IGNORE?k=!0:c=p}k||(this._target[g]=c)}};b.prototype.setPaused=function(a){this.paused=a;b._register(this,!a);return this};b.prototype._cloneProps=function(a){var b={},f;for(f in a)b[f]=a[f];return b};
b.prototype._addStep=function(a){0<a.d&&(this._steps.push(a),a.t=this.duration,this.duration+=a.d);return this};b.prototype._appendQueueProps=function(a){var e,f,h,c,d,g;for(g in a)if(void 0===this._initQueueProps[g]){f=this._target[g];if(e=b._plugins[g])for(h=0,c=e.length;h<c;h++)f=e[h].init(this,g,f);this._initQueueProps[g]=this._curQueueProps[g]=void 0===f?null:f}for(g in a){f=this._curQueueProps[g];if(e=b._plugins[g])for(d=d||{},h=0,c=e.length;h<c;h++)e[h].step&&e[h].step(this,g,f,a[g],d);this._curQueueProps[g]=
a[g]}d&&this._appendQueueProps(d);return this._curQueueProps};b.prototype._addAction=function(a){a.t=this.duration;this._actions.push(a);return this};b.prototype._set=function(a,b){for(var f in a)b[f]=a[f]};b.prototype.wait=function(a,b){void 0===b&&(b=!1);if(null==a||0>=a)return this;var f=this._cloneProps(this._curQueueProps);return this._addStep({d:a,p0:f,p1:f,v:b})};b.prototype.to=function(a,b,f){void 0===f&&(f=void 0);if(isNaN(b)||0>b)b=0;return this._addStep({d:b||0,p0:this._cloneProps(this._curQueueProps),
e:f,p1:this._cloneProps(this._appendQueueProps(a))})};b.prototype.call=function(a,b,f){void 0===b&&(b=void 0);void 0===f&&(f=void 0);a||(a=function(){});return this._addAction({f:a,p:f?f:[this],o:b?b:this._target})};b.prototype.set=function(a,b){void 0===b&&(b=null);return this._addAction({f:this._set,o:this,p:[a,b?b:this._target]})};b.prototype.play=function(a){a||(a=this);return this.call(a.setPaused,[!1],a)};b.prototype.pause=function(a){a||(a=this);return this.call(a.setPaused,[!0],a)};b.prototype.tick=
...
typeof a.skewX&&(this._values[7]=a.skewX);"number"===typeof a.skewY&&(this._values[8]=a.skewY);"undefined"!==typeof a.relative&&(this._relative=a.relative);this._dirty=!0};b.prototype.transform=function(a){void 0===a&&(a=null);var e,f,h=this.worldMatrix;f=this._values[0];var c=this._values[1];e=this._values[4];var d=this._values[5],g=this._values[6],k=this._values[7],n=this._values[8];this.useGLCoords&&(k+=180);a&&this._relative?h.applyMatrix(a.worldMatrix):this===a?h.identity():h.applyMatrix(a.worldMatrix);
this.__local_matrix?(f=this.__local_matrix,h.append(f.a,f.b,f.c,f.d,f.tx,f.ty)):(e%360?(e*=b.DEG_TO_RAD,a=Math.cos(e),e=Math.sin(e)):(a=1,e=0),k||n?(k*=b.DEG_TO_RAD,n*=b.DEG_TO_RAD,h.append(Math.cos(n),Math.sin(n),-Math.sin(k),Math.cos(k),f,c),h.append(a*d,e*d,-e*g,a*g,0,0)):h.append(a*d,e*d,-e*g,a*g,f,c));this._dirty=!1};b.prototype.updateWorldMatrix=function(){if(this._dirty){var a=this.worldMatrix;a?a.identity():a=new d.math.Matrix;for(var b=this;null!=b;)a.prependTransform(b.x,b.y,b.scaleX,b.scaleY,
b.rotation,b.skewX,b.skewY,0,0),b=b.parent}};b.prototype.globalToLocal=function(a,b,f){void 0===f&&(f=!1);f&&this.updateWorldMatrix();g.applyMatrix(this.worldMatrix);g.invert();g.append(1,0,0,1,a,b);return{x:g.values[6],y:g.values[7]}};b.prototype.localToGlobal=function(a,b,f){void 0===f&&(f=!1);f&&this.updateWorldMatrix();g.applyMatrix(this.worldMatrix);g.append(1,0,0,1,a,b);return{x:g.values[6],y:g.values[7]}};b.prototype.tween=function(a){return d.utils.Tween.get(this,null,null,a)};b.prototype.clearTweens=
function(){return d.utils.Tween.removeTweens(this)};b.DEG_TO_RAD=Math.PI/180;return b}();d.Transform=c})(WOZLLA||(WOZLLA={}));
(function(d){var g=function(c){function b(){c.apply(this,arguments);this._py=this._px=this._bottom=this._right=this._left=this._top=this._height=this._width=0;this._anchorMode=b.ANCHOR_CENTER|b.ANCHOR_MIDDLE}__extends(b,c);Object.defineProperty(b.prototype,"width",{get:function(){return this._width},set:function(a){this._width!==a&&(this._width=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"height",{get:function(){return this._height},set:function(a){this._height!==
...
function(a){void 0===a&&(a=null);var e,f;f=a&&this._relative&&a instanceof b?a:d.Director.getInstance().viewRectTransform;e=this._anchorMode;(e&b.ANCHOR_LEFT)===b.ANCHOR_LEFT?this.x=this._px:(e&b.ANCHOR_RIGHT)===b.ANCHOR_RIGHT?this.x=f._width+this._px:(e&b.ANCHOR_HORIZONTAL_STRENGTH)===b.ANCHOR_HORIZONTAL_STRENGTH?(this.x=this._left,this._width=f._width-this._left-this._right):this.x=f._width/2+this._px;(e&b.ANCHOR_TOP)===b.ANCHOR_TOP?this.y=this._py:(e&b.ANCHOR_BOTTOM)===b.ANCHOR_BOTTOM?this.y=f._height+
this._py:(e&b.ANCHOR_VERTICAL_STRENGTH)===b.ANCHOR_VERTICAL_STRENGTH?(this.y=this._top,this._height=f._height-this._top-this._bottom):this.y=f._height/2+this._py;c.prototype.transform.call(this,a)};b.ANCHOR_TOP=1;b.ANCHOR_MIDDLE=16;b.ANCHOR_BOTTOM=256;b.ANCHOR_VERTICAL_STRENGTH=4096;b.ANCHOR_LEFT=65536;b.ANCHOR_CENTER=1048576;b.ANCHOR_RIGHT=16777216;b.ANCHOR_HORIZONTAL_STRENGTH=268435456;return b}(d.Transform);d.RectTransform=g})(WOZLLA||(WOZLLA={}));
(function(d){var g=function(){function c(){}c.isTrue=function(b,a){void 0===a&&(a=c.DEFAULT_MESSAGE);if(!0!==b)throw Error(a);};c.isFalse=function(b,a){void 0===a&&(a=c.DEFAULT_MESSAGE);if(!1!==b)throw Error(a);};c.isTypeof=function(b,a,e){void 0===e&&(e=c.DEFAULT_MESSAGE);if(typeof b!==a)throw Error(e);};c.isNotTypeof=function(b,a,e){void 0===e&&(e=c.DEFAULT_MESSAGE);if(typeof b===a)throw Error(e);};c.isString=function(b,a){void 0===a&&(a=c.DEFAULT_MESSAGE);c.isTypeof(b,"string",a)};c.isObject=function(b,
...
(function(d){var g=function(c){function b(){c.apply(this,arguments)}__extends(b,c);Object.defineProperty(b.prototype,"gameObject",{get:function(){return this._gameObject},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"transform",{get:function(){return this._gameObject.transform},enumerable:!0,configurable:!0});b.prototype.init=function(){};b.prototype.destroy=function(){};b.prototype.loadAssets=function(a){a&&a()};b.prototype.listRequiredComponents=function(){return[]};b.register=
function(a,e){d.Assert.isObject(e);d.Assert.isString(e.name);d.Assert.isUndefined(b.configMap[e.name]);b.ctorMap[e.name]=a;b.configMap[e.name]=e};b.unregister=function(a){d.Assert.isString(a);d.Assert.isNotUndefined(b.configMap[a]);delete b.ctorMap[a];delete b.configMap[a]};b.create=function(a){d.Assert.isString(a);a=b.ctorMap[a];d.Assert.isFunction(a);return new a};b.getConfig=function(a){d.Assert.isString(a);a=b.configMap[a];d.Assert.isNotUndefined(a);return a};b.ctorMap={};b.configMap={};return b}(d.event.EventDispatcher);
d.Component=g})(WOZLLA||(WOZLLA={}));(function(d){var g=function(c){function b(){c.apply(this,arguments)}__extends(b,c);b.prototype.collideXY=function(a,b){return!1};b.prototype.collide=function(a){return!1};return b}(d.Component);d.Collider=g})(WOZLLA||(WOZLLA={}));
(function(d){var g=function(a,b){return a.z-b.z},c={},b=function(a){function b(e){void 0===e&&(e=!1);a.call(this);this._visible=this._active=!0;this._loadingAssets=this._touchable=this._destroyed=this._initialized=!1;this._name="GameObject";this._children=[];this._components=[];this._transform=e?new d.RectTransform:new d.Transform;this._rectTransform=e?this._transform:null;this._z=0;this._behaviours=[]}__extends(b,a);b.getById=function(a){return c[a]};Object.defineProperty(b.prototype,"id",{get:function(){return this._id},
...
!a.paused?(a.time-=d.Time.delta,0>a.time&&(a.task.apply(a,a.args),a.time+=a.intervalTime)):a.isLoop&&!a.paused&&a.task.apply(a,a.args),this._runScheduleCount++};c.prototype.removeSchedule=function(b){delete this._schedules[b]};c.prototype.scheduleLoop=function(b,a){var e="Schedule_"+this._scheduleCount++;this._schedules[e]={task:b,args:a,isLoop:!0};return e};c.prototype.scheduleFrame=function(b,a,e){void 0===a&&(a=0);var f="Schedule_"+this._scheduleCount++;this._schedules[f]={task:b,frame:a,args:e,
isFrame:!0};return f};c.prototype.scheduleInterval=function(b,a,e){void 0===a&&(a=0);var f="Schedule_"+this._scheduleCount++;this._schedules[f]={task:b,intervalTime:a,time:a,args:e,isInterval:!0};return f};c.prototype.scheduleTime=function(b,a,e){void 0===a&&(a=0);var f="Schedule_"+this._scheduleCount++;this._schedules[f]={task:b,time:a||0,args:e,isTime:!0};return f};c.prototype.resumeSchedule=function(b){this._schedules[b].paused=!1};c.prototype.pauseSchedule=function(b){this._schedules[b].paused=
!0};return c}();d.Scheduler=g})(WOZLLA||(WOZLLA={}));
(function(d){function g(a){for(var b={x:a.offsetLeft,y:a.offsetTop};a=a.offsetParent;)b.x+=a.offsetLeft,b.y+=a.offsetTop;return b}var c=function(a){function b(e){a.call(this,e.type,e.bubbles,e.data);this.touchMoveDetection=!1;this.x=e.x;this.y=e.y;this.touch=e.touch;this.touchMoveDetection=e.touchMoveDetection;this.gesture=e.gesture;this.identifier=e.identifier}__extends(b,a);b.prototype.setTouchMoveDetection=function(a){this.touchMoveDetection=a};return b}(d.event.Event);d.GestureEvent=c;var b=function(){function a(b,
f){void 0===f&&(f=1);this.enabled=!0;this.canvasOffset=this.canvas=null;this.channelMap={};var c=this,s=window.navigator;c.canvas=b;c.canvasOffset=g(b);c.touchScale=f;Hammer(s.isCocoonJS?document:b,{transform:!1,doubletap:!1,hold:!1,rotate:!1,pinch:!1}).on(a.enabledGestures||"touch release tap swipe drag dragstart dragend",function(a){("release"===a.type||c.enabled)&&d.Scheduler.getInstance().scheduleFrame(function(){c.onGestureEvent(a)})})}a.setEanbledGestures=function(a){this.enabledGestures=a};
a.prototype.onGestureEvent=function(a){var b,c,g,m,q,k,n,l,p=a.type,u=d.Director.getInstance().stage,v=this.touchScale||1;if(n=a.gesture.srcEvent.changedTouches)for(m=n.length,g=0;g<m;g++)c=n[g],q=parseInt(c.identifier),b=c.pageX-this.canvasOffset.x,c=c.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&(l=u.getUnderPoint(b,c,!0))&&(this.channelMap[q]=this.createDispatchChanel(l),delete this.channelMap[q-10]),(k=this.channelMap[q])&&k.onGestureEvent(a,l,b,c,q);else q=1,b=a.gesture.srcEvent.pageX-this.canvasOffset.x,
c=a.gesture.srcEvent.pageY-this.canvasOffset.y,b*=v,c*=v,"touch"===p&&((l=u.getUnderPoint(b,c,!0))?this.channelMap[q]=this.createDispatchChanel(l):delete this.channelMap[q]),(k=this.channelMap[q])&&k.onGestureEvent(a,l,b,c,q)};a.prototype.createDispatchChanel=function(a){var b=!0;return{onGestureEvent:function(h,g,m,q,k){var n=h.type,l=d.Director.getInstance().stage;switch(n){case "drag":if(!b){g=a;break}case "tap":case "release":g=l.getUnderPoint(m,q,!0)}if("tap"!==n||a===g)h=new c({x:m,y:q,type:n,
bubbles:!0,touch:g,gesture:h.gesture,identifier:k,touchMoveDetection:!1}),a.dispatchEvent(h),b=h.touchMoveDetection}}};return a}();d.Touch=b})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function b(){}b.getGLContext=function(a,b){var c,h=b||{},d={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},g;for(g in d)"undefined"===typeof h[g]&&(h[g]=d[g]);b=h;try{c=a.getContext("experimental-webgl",b)}catch(q){try{c=a.getContext("webgl",b)}catch(k){}}return c};b.compileShader=function(a,b,c){b=a.createShader(b);a.shaderSource(b,c);a.compileShader(b);return a.getShaderParameter(b,a.COMPILE_STATUS)?b:(console.log(a.getShaderInfoLog(b)),null)};
...
b.FRAGMENT_SOURCE="precision mediump float;\nvarying vec2 vTextureCoord;\nvarying vec4 vColor;\nuniform sampler2D uSampler;\nvoid main(void) {\ngl_FragColor = texture2D(uSampler, vTextureCoord) * vColor ;\n}";return b}(d.renderer.ShaderProgram);c.V2T2C1A1=b})(g.shader||(g.shader={}))})(d.renderer||(d.renderer={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){function c(a){return 0===(a&a-1)}var b=function(){function a(a){this._gl=a;this._textureMap={}}a.prototype.getTexture=function(a){return this._textureMap[a]};a.prototype.generateTexture=function(a,b){var h,s;h=this._gl;var m=b||h.createTexture();h.bindTexture(h.TEXTURE_2D,m);h.pixelStorei(h.UNPACK_PREMULTIPLY_ALPHA_WEBGL,1);h.texParameteri(h.TEXTURE_2D,h.TEXTURE_MAG_FILTER,h.LINEAR);h.texParameteri(h.TEXTURE_2D,h.TEXTURE_MIN_FILTER,h.LINEAR);c(a.width)&&c(a.height)?(h.texParameteri(h.TEXTURE_2D,
...
this._usingTexture&&this._usingTexture.bind(a),this._quadBatch.flush(a))};b.prototype._clearCommands=function(){var a=this._commandQueueMap,b;for(b in a)a[b].clear()};b.prototype._eachCommand=function(a){var b,e,c,f,d,g,p,u=this._commandQueueMap,v=this._layerManager._getSortedLayers();b=0;for(e=v.length;b<e;b++)if(c=v[b],d=u[c]){g=d.negativeZQueue;if(0<g.length)for(c=0,f=g.length;c<f;c++)p=g[c],a(p);g=d.zeroZQueue;if(0<g.length)for(c=0,f=g.length;c<f;c++)p=g[c],a(p);g=d.positiveZQueue;if(0<g.length)for(c=
0,f=g.length;c<f;c++)p=g[c],a(p)}};b.MAX_QUAD_SIZE=500;return b}();d.Renderer=b;var a=function(){function a(b){this._addIndex=0;this.negativeZQueue=[];this.zeroZQueue=[];this.positiveZQueue=[];this.layer=b}a.prototype.add=function(a){a._addIndex=this._addIndex++;0===a.globalZ?this.zeroZQueue.push(a):0<a.globalZ?this.positiveZQueue.push(a):this.negativeZQueue.push(a)};a.prototype.clear=function(){var a,b,e;a=0;for(b=this.negativeZQueue.length;a<b;a++)e=this.negativeZQueue[a],e.isPoolable&&e.release();
...
Object.defineProperty(a.prototype,"vertexBuffer",{get:function(){return this._vertexBuffer},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"indexBuffer",{get:function(){return this._indexBuffer},enumerable:!0,configurable:!0});a.prototype.canFill=function(a){return this._curVertexIndex<this._size};a.prototype.fillQuad=function(a){var b,e,c=this._vertices;b=this._curVertexIndex;if(a.count===a.renderCount)c.set(a.storage,b);else{var d=0,f=a.renderOffset*a.type.size,g=a.renderCount*
a.type.size;for(e=a.storage;d<g;f++,d++)c[b+d]=e[f]}this._curVertexIndex+=a.renderCount*a.type.size;this._curBatchSize+=a.renderCount};a.prototype.flush=function(a){0!==this._curBatchSize&&(a.bindBuffer(a.ARRAY_BUFFER,this._vertexBuffer),a.bufferData(a.ARRAY_BUFFER,this._vertices,a.DYNAMIC_DRAW),a.drawElements(a.TRIANGLES,6*this._curBatchSize,a.UNSIGNED_SHORT,0),this._curBatchSize=this._curVertexIndex=0)};a.prototype._initBuffers=function(){var a,b,e=this._gl,c=6*this._size;this._vertices=new Float32Array(24*
...
g(b);a.runStep()},g(b))};b.prototype.stop=function(){this._runing=!1};b.prototype.runStep=function(a){void 0===a&&(a=this._timeScale);d.Time.update(a);this._stage.update();this._stage.visitStage(this._renderer);this._renderer.render();this._scheduler.runSchedule();d.utils.Tween.tick(d.Time.delta)};return b}();d.Director=c})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){var c=function(a){function e(b){a.call(this,b)}__extends(e,a);Object.defineProperty(e.prototype,"glTexture",{get:function(){return this._glTexture},enumerable:!0,configurable:!0});e.prototype._generateTexture=function(a){var e=d.Director.getInstance().renderer;if(!e)throw Error("Director not initialized");this._glTexture=e.textureManager.generateTexture(new b(a))};e.prototype._generatePVRTexture=function(a){throw Error("Unsupported now");};return e}(g.Asset);g.GLTextureAsset=
...
function(){this.asset&&this.asset.release();this.asset=null};a.prototype.checkDirty=function(){return this.asset?this.newAssetSrc!==this.asset.src:!!this.newAssetSrc};a.prototype.doLoad=function(a){a(null)};return a}();c.AssetProxy=b})(d.proxy||(d.proxy={}))})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){(function(c){var b=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype.getSprite=function(a){return this.asset?this.asset.getSprite(a):null};b.prototype.doLoad=function(a){var b=this.newAssetSrc;b?d.AssetLoader.getInstance().load(b,d.SpriteAtlas,function(){a(d.AssetLoader.getInstance().getAsset(b))}):a(null)};return b}(c.AssetProxy);c.SpriteAtlasProxy=b})(d.proxy||(d.proxy={}))})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
...
(WOZLLA={}));
(function(d){(function(g){function c(a){var b=a.lastIndexOf("/");return-1!==b?a.substr(b+1,a.length):a}var b=/(\.png|\.jpg)$/i,a=function(a){function f(b){a.call(this,b);this._spriteCache={}}__extends(f,a);Object.defineProperty(f.prototype,"imageSrc",{get:function(){return this._imageSrc},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"metaSrc",{get:function(){return this._metaSrc},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"sourceImage",{get:function(){return this._sourceImage},enumerable:!0,
configurable:!0});Object.defineProperty(f.prototype,"spriteData",{get:function(){return this._spriteData},enumerable:!0,configurable:!0});f.prototype.getSprite=function(a){var b;return a?(b=this._spriteCache[a])?b:this._spriteData?(b=this._spriteData.frames[a])?("undefined"===typeof b.frame.width&&(b.frame.width=b.frame.w,b.frame.height=b.frame.h),b=new g.Sprite(this,{x:b.frame.x,y:b.frame.y,width:b.frame.width,height:b.frame.height},a),this._spriteCache[a]=b):null:null:this._entireSprite};f.prototype.load=
function(a,e){var c=this;b.test(this.src)?(this._imageSrc=this.src,this._loadImage(function(b,d){b?e&&e(b):(c._generateTexture(d),c._sourceImage=d,c._entireSprite=new g.Sprite(c,{x:0,y:0,width:d.width,height:d.height}),a&&a())})):(this._metaSrc=this.src,this._loadSpriteAtlas(function(b,d,f){b?e&&e(b):(c._sourceImage=d,c._generateTexture(d),c._entireSprite=new g.Sprite(c,{x:0,y:0,width:d.width,height:d.height}),c._spriteData=f,a&&a())}))};f.prototype._loadImage=function(a){var b=this,e=new Image;e.src=
this._imageSrc;e.onload=function(){a&&a(null,e)};e.onerror=function(){a("Fail to load image: "+b._imageSrc)}};f.prototype._loadSpriteAtlas=function(a){var b=this;d.utils.Ajax.request({url:b._metaSrc,contentType:"json",success:function(e){var d=e.meta.image,f=c(b._metaSrc);b._imageSrc=b._metaSrc.replace(new RegExp(f+"$"),d);b._loadImage(function(b,c){b?a&&a(b):a&&a(null,c,e)})},error:function(b){a("Fail to load sprite: "+this._metaSrc+", "+b.code+":"+b.message)}})};return f}(g.GLTextureAsset);g.SpriteAtlas=
a})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(g){var c=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.collideXY=function(a,b){return this.region&&this.region.containsXY(a,b)};a.prototype.collide=function(a){return!1};return a}(d.Collider);g.CircleCollider=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){var c=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.prototype.collideXY=function(a,b){return!0};a.prototype.collide=function(a){return!1};return a}(d.Collider);g.MaskCollider=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){var c=function(b){function a(){b.apply(this,arguments)}__extends(a,b);a.fromSpriteRenderer=function(a){var b=new d.component.RectCollider,c=a.sprite.frame;a=a.spriteOffset;b.region=new d.math.Rectangle(0-c.width*a.x,0-c.height*a.y,c.width,c.height);return b};a.prototype.collideXY=function(a,b){return this.region&&this.region.containsXY(a,b)};a.prototype.collide=function(a){return!1};return a}(d.Collider);g.RectCollider=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA=
...
(function(d){var g=function(c){function b(){c.apply(this,arguments)}__extends(b,c);b.prototype.render=function(a,b){};return b}(d.Component);d.Renderer=g})(WOZLLA||(WOZLLA={}));
...
function(a,b){this._renderOffset=a;this._renderCount=b};a.prototype.setVertices=function(a,b,c,d,g,q,k,n,l){void 0===l&&(l=0);var p=this._type.strade;l=this._type.size*l+this._type.vertexIndex;this._storage[0+l]=a;this._storage[1+l]=b;this._storage[0+l+1*p]=c;this._storage[1+l+1*p]=d;this._storage[0+l+2*p]=g;this._storage[1+l+2*p]=q;this._storage[0+l+3*p]=k;this._storage[1+l+3*p]=n};a.prototype.setTexCoords=function(a,b,c,d,g,q,k,n,l){void 0===l&&(l=0);var p=this._type.strade;l=this._type.size*l+
this._type.texCoordIndex;this._storage[0+l]=a;this._storage[1+l]=b;this._storage[0+l+1*p]=c;this._storage[1+l+1*p]=d;this._storage[0+l+2*p]=g;this._storage[1+l+2*p]=q;this._storage[0+l+3*p]=k;this._storage[1+l+3*p]=n};a.prototype.setAlpha=function(a,b){void 0===b&&(b=0);var c=this._type.strade,d=this._type.size*b+this._type.alphaIndex;this._storage[d]=a;this._storage[d+1*c]=a;this._storage[d+2*c]=a;this._storage[d+3*c]=a};a.prototype.setColor=function(a,b){void 0===b&&(b=0);var c=this._type.strade,
...
(function(d){(function(g){var c,b=function(a){function b(e,c){a.call(this,e,c);this.isPoolable=!0}__extends(b,a);b.init=function(a,b,e,d,g){var k=c.retain();k.initWith(a,b,e,d,g);return k};Object.defineProperty(b.prototype,"texture",{get:function(){return this._texture},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"materialId",{get:function(){return this._materialId},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"quad",{get:function(){return this._quad},enumerable:!0,
configurable:!0});b.prototype.initWith=function(a,b,e,c,d){this._globalZ=a;this._layer=b;this._texture=e;this._materialId=c;this._quad=d};b.prototype.release=function(){c.release(this)};return b}(g.RenderCommandBase);g.QuadCommand=b;c=new d.utils.ObjectPool(200,function(){return new b(0,g.ILayerManager.DEFAULT)})})(d.renderer||(d.renderer={}))})(WOZLLA||(WOZLLA={}));
...
this._maskQuadRenderer=new d.component.QuadRenderer;this._maskQuadRenderer.setTexture(a);this._helperGameObject.addComponent(this._maskQuadRenderer);this._helperGameObject.init()};return a}(d.Mask);g.RectMask=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));(function(d){(function(g){var c=function(){function b(){}b.array2rect=function(a){return new d.math.Rectangle(a[0],a[1],a[2],a[3])};return b}();g.PropertyConverter=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){var c=function(b){function a(){b.apply(this,arguments);this._canvasSize=new d.math.Size(0,0);this._sizeDirty=this._graphicsDirty=!0}__extends(a,b);Object.defineProperty(a.prototype,"canvasSize",{get:function(){return this._canvasSize},set:function(a){this._canvasSize=a;this._sizeDirty=!0},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"canvasWidth",{get:function(){return this._canvasSize.width},set:function(a){this._canvasSize.width=a;this._sizeDirty=!0},
...
(this.draw(this._context),this._graphicsDirty=!1,this.generateCanvasTexture(a)),this._glTexture&&b.prototype.render.call(this,a,c))};a.prototype.initCanvas=function(){0>=this._canvasSize.width||0>=this._canvasSize.height||(this._canvas=document.createElement("canvas"),this._canvas.width=this._canvasSize.width,this._canvas.height=this._canvasSize.height,this._context=this._canvas.getContext("2d"),this._sizeDirty=!1,this._graphicsDirty=!0)};a.prototype.updateCanvas=function(){if(0>=this._canvasSize.width||
0>=this._canvasSize.height)this.destroyCanvas(),this._graphicsDirty=!0;this._canvas.width=this._canvasSize.width;this._canvas.height=this._canvasSize.height;this._sizeDirty=!1;this._graphicsDirty=!0};a.prototype.destroyCanvas=function(){this._canvas&&this._canvas.dispose&&this._canvas.dispose();this._context&&this._context.dispose&&this._context.dispose();this._canvas=this._context=null};a.prototype.generateCanvasTexture=function(a){this._glTexture?a.textureManager.updateTexture(this._glTexture):
this._glTexture=a.textureManager.generateTexture(new d.assets.HTMLImageDescriptor(this._canvas));this.setTexture(this._glTexture)};return a}(g.QuadRenderer);g.CanvasRenderer=c})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){var c=function(b){function a(){b.call(this);this._spriteProxy=new d.assets.proxy.SpriteAtlasProxy(this)}__extends(a,b);Object.defineProperty(a.prototype,"color",{get:function(){return this._quadColor},set:function(a){this.setQuadColor(a)},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"alpha",{get:function(){return this._quadAlpha},set:function(a){this.setQuadAlpha(a)},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"materialId",{get:function(){return this._quadMaterialId},
...
b.prototype.destroy.call(this)};a.prototype.onAssetLoaded=function(a){this.sprite=a?a.getSprite(this._spriteName):null};a.prototype.loadAssets=function(a){this._spriteProxy.loadAsset(a)};return a}(g.QuadRenderer);g.SpriteRenderer=c;d.Component.register(c,{name:"SpriteRenderer",properties:[{name:"color",type:"int",defaultValue:16777215},{name:"alpha",type:"int",defaultValue:1},{name:"spriteAtlasSrc",type:"string"},{name:"spriteName",type:"string"}]})})(d.component||(d.component={}))})(WOZLLA||(WOZLLA=
{}));
(function(d){(function(g){var c=d.renderer.QuadCommand,b=function(a){function b(){a.apply(this,arguments)}__extends(b,a);Object.defineProperty(b.prototype,"renderRegion",{get:function(){return this._renderRegion},set:function(a){this._renderRegion=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"patch",{get:function(){return this._patch},set:function(a){this._patch=a;this._quadVertexDirty=!0},enumerable:!0,configurable:!0});b.prototype._initQuad=function(){this._quad=new d.renderer.Quad(9)};b.prototype._updateNinePatchQuads=
function(){this._updateNinePatchQuadVertices();this._updateNinePatchQuadAlpha();this._updateNinePatchQuadColor();this._textureUpdated=!1};b.prototype._updateNinePatchQuadVertices=function(){for(var a=new d.Transform,b=this._getTextureFrame(),e,c={x:0,y:0},g=this._patch||new d.math.Rectangle(0,0,b.width,b.height),k=this._renderRegion||g,b=[{frame:{x:b.x,y:b.y,width:g.left,height:g.top},pos:{x:k.x,y:k.y},size:{width:1,height:1}},{frame:{x:b.x+g.left,y:b.y,width:g.width,height:g.top},pos:{x:k.x+g.left,
y:k.y},size:{width:(k.width-(g.right-g.width))/g.width,height:1}},{frame:{x:b.x+g.right,y:b.y,width:b.width-g.right,height:g.top},pos:{x:k.right,y:k.y},size:{width:1,height:1}},{frame:{x:b.x,y:b.y+g.top,width:g.left,height:g.height},pos:{x:k.x,y:k.y+g.top},size:{width:1,height:(k.height-(g.bottom-g.height))/g.height}},{frame:{x:b.x+g.left,y:b.y+g.top,width:g.width,height:g.height},pos:{x:k.x+g.left,y:k.y+g.top},size:{width:(k.width-(g.right-g.width))/g.width,height:(k.height-(g.bottom-g.height))/
g.height}},{frame:{x:b.x+g.right,y:b.y+g.top,width:b.width-g.right,height:g.height},pos:{x:k.right,y:k.y+g.top},size:{width:1,height:(k.height-(g.bottom-g.height))/g.height}},{frame:{x:b.x,y:b.y+g.bottom,width:b.width-g.right,height:b.height-g.bottom},pos:{x:k.x,y:k.bottom},size:{width:1,height:1}},{frame:{x:b.x+g.left,y:b.y+g.bottom,width:g.width,height:b.height-g.bottom},pos:{x:k.x+g.left,y:k.bottom},size:{width:(k.width-(g.right-g.width))/g.width,height:1}},{frame:{x:b.x+g.right,y:b.y+g.bottom,
width:b.width-g.right,height:b.height-g.bottom},pos:{x:k.right,y:k.bottom},size:{width:1,height:1}}],g=0;9>g;g++)if(k=b[g],0<k.frame.width&&0<k.frame.height){e=k.frame;var n=this._texture,l=n.descriptor.width,n=n.descriptor.height,p={};p.x0=e.x/l;p.y0=e.y/n;p.x1=(e.x+e.width)/l;p.y1=e.y/n;p.x2=(e.x+e.width)/l;p.y2=(e.y+e.height)/n;p.x3=e.x/l;p.y3=(e.y+e.height)/n;e=p;a.set(this.gameObject.transform);a.x+=k.pos.x;a.y+=k.pos.y;a.setScale(k.size.width,k.size.height);a.updateWorldMatrix();this._updateQuadVerticesByArgs(e,
k.frame,c,a.worldMatrix,g)}else this._clearQuadVertices(g);this._quadVertexDirty=!1};b.prototype._updateNinePatchQuadAlpha=function(){for(var a=0;9>a;a++)this._updateQuadAlpha(a);this._quadAlphaDirty=!1};b.prototype._updateNinePatchQuadColor=function(){for(var a=0;9>a;a++)this._updateQuadColor(a);this._quadColorDirty=!1};b.prototype.render=function(a,b){this._texture&&((b&d.GameObject.MASK_TRANSFORM_DIRTY)===d.GameObject.MASK_TRANSFORM_DIRTY&&(this._quadVertexDirty=!0),this._textureUpdated&&this._updateNinePatchQuads(),
this._quadVertexDirty&&(this._updateNinePatchQuadVertices(),this._quadVertexDirty=!1),this._quadAlphaDirty&&this._updateNinePatchQuadAlpha(),this._quadColorDirty&&this._updateNinePatchQuadColor(),a.addCommand(c.init(this._quadGlobalZ,this._quadLayer,this._texture,this._quadMaterialId,this._quad)))};return b}(g.SpriteRenderer);g.NinePatchRenderer=b;d.Component.register(b,{name:"NinePatchRenderer",properties:[{name:"patch",type:"rect",defaultValue:[0,0,0,0],convert:g.PropertyConverter.array2rect},{name:"renderRegion",
type:"rect",defaultValue:[0,0,0,0],convert:g.PropertyConverter.array2rect},{group:"SpriteRenderer",properties:d.Component.getConfig("SpriteRenderer").properties}]})})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=document.createElement("canvas");c.width=1;c.height=1;var b=c.getContext("2d"),c=function(e){function c(){e.apply(this,arguments);this._textDirty=!0;this._textStyle=new a}__extends(c,e);c.measureText=function(a,e){var c,d,f;b.font=a.font;c=Math.ceil(b.measureText(e).width);d=Math.ceil(1.2*b.measureText("M").width);if(a.shadow||a.stroke)f=Math.max(a.strokeWidth,Math.abs(a.shadowOffsetX),Math.abs(a.shadowOffsetY)),c+=2*f,d+=2*f+4;c=Math.ceil(c);d=Math.ceil(d);0!==c%2&&
(c+=1);0!==d%2&&(d+=1);return{width:c,height:d}};Object.defineProperty(c.prototype,"text",{get:function(){return this._text},set:function(a){"string"!==typeof a&&(a+="");a!==this._text&&(this._text=a,this._textDirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(c.prototype,"style",{get:function(){return this._textStyle},set:function(a){this._textStyle=a;this._textDirty=!0},enumerable:!0,configurable:!0});Object.defineProperty(c.prototype,"textWidth",{get:function(){return this._canvasSize.width},
enumerable:!0,configurable:!0});Object.defineProperty(c.prototype,"textHeight",{get:function(){return this._canvasSize.height},enumerable:!0,configurable:!0});c.prototype.render=function(a,b){if(this._textDirty||this._textStyle.dirty)this.measureTextSize(),this._textDirty=this._textStyle.dirty=!1,this._graphicsDirty=!0;e.prototype.render.call(this,a,b)};c.prototype.draw=function(a){this.drawText(a,this._canvasSize.width,this._canvasSize.height)};c.prototype.drawText=function(a,b,e){a.save();a.font=
this._textStyle.font;a.textAlign="center";a.textBaseline="middle";this._textStyle.shadow&&(0<this._textStyle.shadowOffsetX||0<this._textStyle.shadowOffsetY)&&(a.fillStyle=this._textStyle.shadowColor,a.fillText(this._text,b/2+this._textStyle.shadowOffsetX,e/2+this._textStyle.shadowOffsetY));this._textStyle.stroke&&0<this._textStyle.strokeWidth&&(a.strokeStyle=this._textStyle.strokeColor,a.lineWidth=this._textStyle.strokeWidth,a.strokeText(this._text,b/2,e/2));a.fillStyle=this._textStyle.color;a.fillText(this._text,
b/2,e/2);a.restore()};c.prototype.measureTextSize=function(){var a;this._text?(a=c.measureText(this._textStyle,this._text),this.canvasWidth=a.width,this.canvasHeight=a.height):this.canvasWidth=this.canvasHeight=0};c.prototype.generateCanvasTexture=function(b){var c={x:0,y:0};e.prototype.generateCanvasTexture.call(this,b);this._textStyle.align===a.CENTER?c.x=.5:this._textStyle.align===a.END&&(c.x=1);this._textStyle.baseline===a.MIDDLE?c.y=.5:this._textStyle.baseline===a.BOTTOM&&(c.y=1);this.setTextureOffset(c)};
return c}(d.CanvasRenderer);d.TextRenderer=c;var a=function(){function a(){this.dirty=!0;this._font="normal 24px Arial";this._color="#000000";this._shadow=!1;this._shadowColor="#000000";this._shadowOffsetY=this._shadowOffsetX=0;this._stroke=!1;this._strokeColor="#000000";this._strokeWidth=0;this._align=a.START;this._baseline=a.TOP}Object.defineProperty(a.prototype,"font",{get:function(){return this._font},set:function(a){a!==this._font&&(this._font=a,this.dirty=!0)},enumerable:!0,configurable:!0});
...
"align",{get:function(){return this._align},set:function(a){a!==this._align&&(this._align=a,this.dirty=!0)},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"baseline",{get:function(){return this._baseline},set:function(a){a!==this._baseline&&(this._baseline=a,this.dirty=!0)},enumerable:!0,configurable:!0});a.START="start";a.CENTER="center";a.END="end";a.TOP="top";a.MIDDLE="middle";a.BOTTOM="bottom";return a}();d.TextStyle=a})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
(function(d){var g=function(c){function b(){c.apply(this,arguments);this.enabled=!0}__extends(b,c);b.prototype.update=function(){};return b}(d.Component);d.Behaviour=g})(WOZLLA||(WOZLLA={}));(function(d){var g=function(c){function b(a,b,d,h){void 0===b&&(b=!1);void 0===d&&(d=null);void 0===h&&(h=!0);c.call(this,a,b,d,h)}__extends(b,c);return b}(d.event.Event);d.CoreEvent=g})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){function c(a,b){b()}var b=function(){function a(){this.doInit=this.doLoad=!1}a.prototype.instantiateWithSrc=function(a,b){void 0===b&&(b=c);this.src=a;this.newCallback=b;return this};a.prototype.instantiateWithJSON=function(a,b){void 0===b&&(b=c);this.data=a;this.newCallback=b;return this};a.prototype.load=function(a){void 0===a&&(a=c);this.doLoad=!0;this.loadCallback=a;return this};a.prototype.init=function(){this.doLoad?this.doInit=!0:this.err="JSONXBuilder: init must after load";
...
success:function(c){b.data=c;a&&a()},error:function(c){b.err=c;a&&a()}}):a&&a()};a.prototype._newGameObjectTree=function(a){var b=this;this._newGameObject(this.data.root,function(c){b.root=c;a&&a()})};a.prototype._newGameObject=function(a,b){var c=this,g=new d.GameObject(a.rect);g.id=a.id;g.name=a.name;g.active=a.active;g.visible=a.visible;g.touchable=a.touchable;g.transform.set(a.transform);var m=a.components;m&&0<m.length&&m.forEach(function(a){g.addComponent(c._newComponent(a))});var q=0,k=a.children;
k&&0!==k.length?k.forEach(function(a){a.reference?c._newReferenceObject(a,function(a){a&&g.addChild(a);q++;q===k.length&&b(g)}):c._newGameObject(a,function(a){g.addChild(a);q++;q===k.length&&b(g)})}):b(g)};a.prototype._newReferenceObject=function(b,c){var d=this;(new a).instantiateWithSrc(b.reference).build(function(a,g){a?d.err=a:g&&(g.name=b.name,g.id=b.id,g.active=b.active,g.visible=b.visible,g.touchable=b.touchable,g.transform.set(b.transform));c(g)})};a.prototype._newComponent=function(a){var b=
d.Component.create(a.name);d.Component.getConfig(a.name).properties.forEach(function(c){var d=a.properties[c.name],d="undefined"===typeof d?c.defaultValue:d;c.convert&&(d=c.convert(d));b[c.name]=d});return b};a.prototype._loadAssets=function(a){this.root.loadAssets(a)};a.prototype._init=function(){this.root.init()};return a}();g.JSONXBuilder=b})(d.jsonx||(d.jsonx={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){(function(c){c.rectIntersect=function(b,a){return b.x<a.x+a.width&&a.x<b.x+b.width&&b.y<a.y+a.height&&a.y<b.y+b.height};c.rectIntersect2=function(b,a,c,d,h,g,m,q){return b<=h+m&&h<=b+c&&a<=g+q&&g<=a+d}})(d.MathUtils||(d.MathUtils={}))})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
'state "'+a+'" not defined');this._stateConfig[a].data[b]=c};f.prototype.defineTransition=function(a,b,c){d.Assert.isNotUndefined(this._stateConfig[a],'state "'+a+'" not defined');d.Assert.isNotUndefined(this._stateConfig[b],'state "'+b+'" not defined');this._stateConfig[a][b]=c};f.prototype.init=function(){this._currentState=this._defaultState;this.dispatchEvent(new d.event.Event(f.INIT,!1,new b(this._currentState)))};f.prototype.getCurrentState=function(){return this._currentState};f.prototype.changeState=
function(c){var e=this,g,q;d.Assert.isNotUndefined(this._stateConfig[c]);g=this._currentState;q=this._stateConfig[c][c]||a.getInstance();this._currentTransition&&this._currentTransition.cancel();q.reset();q.execute(g,c,function(){e._currentTransition=null;e._currentState=c;e.dispatchEvent(new d.event.Event(f.CHANGE,!1,new b(e._currentState)))});this._currentTransition=q};f.INIT="state.init";f.CHANGE="state.change";return f}(d.event.EventDispatcher);g.StateMachine=c;var b=function(){return function(a){this.state=
a}}();g.StateEventData=b;var a=function(){function a(){this._canceled=!1}a.getInstance=function(){a.instance||(a.instance=new a);return a.instance};a.prototype.reset=function(){this._canceled=!1};a.prototype.cancel=function(){this._canceled=!0};a.prototype.execute=function(a,b,c){this._canceled||c()};return a}();g.EmptyTransition=a})(d.utils||(d.utils={}))})(WOZLLA||(WOZLLA={}));
...
"spriteName")};b.prototype.setStateSpriteName=function(a,b){this._stateMachine.setStateData(a,"spriteName",b)};b.prototype.onStateChange=function(a){this.spriteName=this.getStateSpriteName(a.data.state)};return b}(d.component.SpriteRenderer);g.StateWidget=b})(d.ui||(d.ui={}))})(WOZLLA||(WOZLLA={}));
...
(a-=2)*a)+1)};b.bounceIn=function(a){return 1-b.bounceOut(1-a)};b.bounceOut=function(a){return a<1/2.75?7.5625*a*a:a<2/2.75?7.5625*(a-=1.5/2.75)*a+.75:a<2.5/2.75?7.5625*(a-=2.25/2.75)*a+.9375:7.5625*(a-=2.625/2.75)*a+.984375};b.bounceInOut=function(a){return.5>a?.5*b.bounceIn(2*a):.5*b.bounceOut(2*a-1)+.5};b.getElasticIn=function(a,b){var c=2*Math.PI;return function(d){if(0==d||1==d)return d;var g=b/c*Math.asin(1/a);return-(a*Math.pow(2,10*(d-=1))*Math.sin((d-g)*c/b))}};b.getElasticOut=function(a,
b){var c=2*Math.PI;return function(d){if(0==d||1==d)return d;var g=b/c*Math.asin(1/a);return a*Math.pow(2,-10*d)*Math.sin((d-g)*c/b)+1}};b.getElasticInOut=function(a,b){var c=2*Math.PI;return function(d){var g=b/c*Math.asin(1/a);return 1>(d*=2)?-.5*a*Math.pow(2,10*(d-=1))*Math.sin((d-g)*c/b):a*Math.pow(2,-10*(d-=1))*Math.sin((d-g)*c/b)*.5+1}};b.linear=function(a){return a};b.expoIn=function(a){return 0==a?0:Math.pow(2,10*(a-1))-.001};b.expoOut=function(a){return 1==a?1:-Math.pow(2,-10*a)+1};b.expoInOut=
...
g.WTextureAtlas,function(){var g=c.getAsset(b._textureSrc);g?(g.retain(),b._skeletonJSONAsset=d,b._wTextureAtlas=g):d.release();a()})):a()})):a()};a.prototype.initArmature=function(){var a,b,c;this._skeletonJSONAsset&&this._wTextureAtlas&&this._armatureName&&(b=new g.WFactory,a=this._skeletonJSONAsset.cloneData(),b.addSkeletonData(dragonBones.DataParser.parseDragonBonesData(a),a.name),b.addTextureAtlas(this._wTextureAtlas,this._wTextureAtlas.name),a=b.buildArmature(this._armatureName),c=a.getDisplay(),
dragonBones.WorldClock.clock.add(a),g.setupWorldClock(),this._container=c,this._factory=b,this._armature=a)};return a}(d.Renderer);g.SkeletonRenderer=c})(d.DragonBones||(d.DragonBones={}))})(WOZLLA||(WOZLLA={}));
...
this._display.parent&&this._display.parent.removeChild(this._display)};a.prototype._updateTransform=function(){var a;this._display&&(a=this._display.transform,a.__local_matrix=this._globalTransformMatrix,a.dirty=!0)};a.prototype._updateDisplayVisible=function(a){this._display&&this._parent&&(this._display.visible=this._parent._visible&&this._visible&&a)};a.prototype._updateDisplayColor=function(a,c,d,g,m,q,k,n){b.prototype._updateDisplayColor.call(this,a,c,d,g,m,q,k,n);this._display&&(a=this._display.renderer)&&
(a.alpha=m)};a.prototype._updateDisplayBlendMode=function(a){};return a}(dragonBones.Slot);d.WSlot=c})(d.DragonBones||(d.DragonBones={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){function c(a){var b=a.lastIndexOf("/");return-1!==b?a.substr(b+1,a.length):a}var b=function(a){function b(){a.apply(this,arguments)}__extends(b,a);b.prototype.dispose=function(){};b.prototype.getRegion=function(a){a=this.getSprite(a).frame;return new dragonBones.Rectangle(a.x,a.y,a.width,a.height)};b.prototype._loadSpriteAtlas=function(a){var b=this;d.utils.Ajax.request({url:this._metaSrc,contentType:"json",success:function(d){var e=d.imagePath,g=c(b._metaSrc);b._imageSrc=
b._metaSrc.replace(new RegExp(g+"$"),e);b._loadImage(function(c,e){if(c)a&&a(c);else{var g=b._parseData(d);b.name=g.name;a&&a(null,e,g)}})},error:function(c){a("Fail to load sprite: "+b._metaSrc+", "+c.code+":"+c.message)}})};b.prototype._parseData=function(a){var b={name:a.name,frames:{}};a.SubTexture.forEach(function(a){b.frames[a.name]={frame:a}});return b};return b}(d.assets.SpriteAtlas);g.WTextureAtlas=b})(d.DragonBones||(d.DragonBones={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){var c=!1;g.setupWorldClock=function(){c||(c=!0,d.Director.getInstance().scheduler.scheduleLoop(function(){dragonBones.WorldClock.clock.advanceTime(1/60)}))};var b=function(a){function b(){a.call(this,this)}__extends(b,a);b.prototype._generateArmature=function(){var a=new d.GameObject;a.init();return new dragonBones.Armature(a)};b.prototype._generateSlot=function(){return new g.WSlot};b.prototype._generateDisplay=function(a,b,c,e){var g=new d.GameObject,k=new d.component.SpriteRenderer;
k.sprite=a.getSprite(b);k.spriteOffset={x:c/k.sprite.frame.width,y:e/k.sprite.frame.height};g.addComponent(k);g.init();return g};return b}(dragonBones.BaseFactory);g.WFactory=b})(d.DragonBones||(d.DragonBones={}))})(WOZLLA||(WOZLLA={}));
