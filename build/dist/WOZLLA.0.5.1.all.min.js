...
on:function(b,a,e,f){a=a.split(" ");t.each(a,function(a){t.on(b,a,e);f&&f(a)})},off:function(b,a,e,f){a=a.split(" ");t.each(a,function(a){t.off(b,a,e);f&&f(a)})},onTouch:function(e,f,h){var c=this,d=function(b){var d=b.type.toLowerCase(),s=a.HAS_POINTEREVENTS,d=t.inStr(d,"mouse"),m;d&&c.preventMouseEvents||(d&&f==n&&0===b.button?(c.preventMouseEvents=!1,c.shouldDetect=!0):s&&f==n?c.shouldDetect=1===b.buttons||x.matchType(q,b):d||f!=n||(c.preventMouseEvents=!0,c.shouldDetect=!0),s&&f!=p&&x.updatePointer(f,
b),c.shouldDetect&&(m=c.doDetect.call(c,b,f,e,h)),m==p&&(c.preventMouseEvents=!1,c.shouldDetect=!1,x.reset()),s&&f==p&&x.updatePointer(f,b))};this.on(e,b[f],d);return d},doDetect:function(b,a,e,f){var h=this.getTouchList(b,a),c=a,d=h.trigger,s=h.length;a==n?d=v:a==p&&(d=u,s=h.length-(b.changedTouches?b.changedTouches.length:1));0<s&&this.started&&(c=l);this.started=!0;b=this.collectEventData(e,c,h,b);a!=p&&f.call(w,b);d&&(b.changedLength=s,b.eventType=d,f.call(w,b),b.eventType=c,delete b.changedLength);
c==p&&(f.call(w,b),this.started=!1);return c},determineEventTypes:function(){var e;e=a.HAS_POINTEREVENTS?d.PointerEvent?["pointerdown","pointermove","pointerup pointercancel lostpointercapture"]:["MSPointerDown","MSPointerMove","MSPointerUp MSPointerCancel MSLostPointerCapture"]:a.NO_MOUSEEVENTS?["touchstart","touchmove","touchend touchcancel"]:["touchstart mousedown","touchmove mousemove","touchend touchcancel mouseup"];b[n]=e[0];b[l]=e[1];b[p]=e[2];return b},getTouchList:function(b,e){if(a.HAS_POINTEREVENTS)return x.getTouchList();
if(b.touches){if(e==l)return b.touches;var f=[],h=[].concat(t.toArray(b.touches),t.toArray(b.changedTouches)),c=[];t.each(h,function(b){!1===t.inArray(f,b.identifier)&&c.push(b);f.push(b.identifier)});return c}b.identifier=1;return[b]},collectEventData:function(b,a,e,f){b=q;t.inStr(f.type,"mouse")||x.matchType(m,f)?b=m:x.matchType(k,f)&&(b=k);return{center:t.getCenter(e),timeStamp:Date.now(),target:f.target,touches:e,eventType:a,pointerType:b,srcEvent:f,preventDefault:function(){var b=this.srcEvent;
b.preventManipulation&&b.preventManipulation();b.preventDefault&&b.preventDefault()},stopPropagation:function(){this.srcEvent.stopPropagation()},stopDetect:function(){return w.stopDetect()}}}},x=a.PointerEvent={pointers:{},getTouchList:function(){var b=[];t.each(this.pointers,function(a){b.push(a)});return b},updatePointer:function(b,a){b==p?delete this.pointers[a.pointerId]:(a.identifier=a.pointerId,this.pointers[a.pointerId]=a)},matchType:function(b,a){if(!a.pointerType)return!1;var e=a.pointerType,
f={};f[m]=e===(a.MSPOINTER_TYPE_MOUSE||m);f[q]=e===(a.MSPOINTER_TYPE_TOUCH||q);f[k]=e===(a.MSPOINTER_TYPE_PEN||k);return f[b]},reset:function(){this.pointers={}}},w=a.detection={gestures:[],current:null,previous:null,stopped:!1,startDetect:function(b,a){this.current||(this.stopped=!1,this.current={inst:b,startEvent:t.extend({},a),lastEvent:!1,lastCalcEvent:!1,futureCalcEvent:!1,lastCalcData:{},name:""},this.detect(a))},detect:function(b){if(this.current&&!this.stopped){b=this.extendEventData(b);var a=
this.current.inst,e=a.options;t.each(this.gestures,function(f){!this.stopped&&a.enabled&&e[f.name]&&f.handler.call(f,b,a)},this);this.current&&(this.current.lastEvent=b);b.eventType==p&&this.stopDetect();return b}},stopDetect:function(){this.previous=t.extend({},this.current);this.current=null;this.stopped=!0},getCalculatedData:function(b,e,f,h,c){var d=this.current,s=!1,m=d.lastCalcEvent,q=d.lastCalcData;m&&b.timeStamp-m.timeStamp>a.CALCULATE_INTERVAL&&(e=m.center,f=b.timeStamp-m.timeStamp,h=b.center.clientX-
m.center.clientX,c=b.center.clientY-m.center.clientY,s=!0);if(b.eventType==v||b.eventType==u)d.futureCalcEvent=b;if(!d.lastCalcEvent||s)q.velocity=t.getVelocity(f,h,c),q.angle=t.getAngle(e,b.center),q.direction=t.getDirection(e,b.center),d.lastCalcEvent=d.futureCalcEvent||b,d.futureCalcEvent=b;b.velocityX=q.velocity.x;b.velocityY=q.velocity.y;b.interimAngle=q.angle;b.interimDirection=q.direction},extendEventData:function(b){var a=this.current,e=a.startEvent,a=a.lastEvent||e;if(b.eventType==v||b.eventType==
...
(function(b){var c=!1;a.gestures.Drag={name:b,index:50,handler:function(a,d){var m=w.current;if(!(0<d.options.dragMaxTouches&&a.touches.length>d.options.dragMaxTouches))switch(a.eventType){case n:c=!1;break;case l:if(a.distance<d.options.dragMinDistance&&m.name!=b)break;var q=m.startEvent.center;if(m.name!=b&&(m.name=b,d.options.dragDistanceCorrection&&0<a.distance)){var g=Math.abs(d.options.dragMinDistance/a.distance);q.pageX+=a.deltaX*g;q.pageY+=a.deltaY*g;q.clientX+=a.deltaX*g;q.clientY+=a.deltaY*
g;a=w.extendEventData(a)}if(m.lastEvent.dragLockToAxis||d.options.dragLockToAxis&&d.options.dragLockMinDistance<=a.distance)a.dragLockToAxis=!0;m=m.lastEvent.direction;a.dragLockToAxis&&m!==a.direction&&(t.isVertical(m)?a.direction=0>a.deltaY?h:e:a.direction=0>a.deltaX?f:s);c||(d.trigger(b+"start",a),c=!0);d.trigger(b,a);d.trigger(b+a.direction,a);m=t.isVertical(a.direction);(d.options.dragBlockVertical&&m||d.options.dragBlockHorizontal&&!m)&&a.preventDefault();break;case u:c&&a.changedLength<=d.options.dragMaxTouches&&
(d.trigger(b+"end",a),c=!1);break;case p:c=!1}},defaults:{dragMinDistance:10,dragDistanceCorrection:!0,dragMaxTouches:1,dragBlockHorizontal:!1,dragBlockVertical:!1,dragLockToAxis:!1,dragLockMinDistance:25}}})("drag");a.gestures.Gesture={name:"gesture",index:1337,handler:function(b,a){a.trigger(this.name,b)}};(function(b){var e;a.gestures.Hold={name:b,index:10,defaults:{holdTimeout:500,holdThreshold:2},handler:function(a,f){var h=f.options,c=w.current;switch(a.eventType){case n:clearTimeout(e);c.name=
...
e>f.swipeMaxTouches||!(b.velocityX>f.swipeVelocityX||b.velocityY>f.swipeVelocityY)||(a.trigger(this.name,b),a.trigger(this.name+b.direction,b))}}};(function(b){var e=!1;a.gestures.Tap={name:b,index:100,handler:function(a,f){var h=f.options,c=w.current,d=w.previous,s,m;switch(a.eventType){case n:e=!1;break;case l:e=e||a.distance>h.tapMaxDistance;break;case p:!t.inStr(a.srcEvent.type,"cancel")&&a.deltaTime<h.tapMaxTime&&!e&&(s=d&&d.lastEvent&&a.timeStamp-d.lastEvent.timeStamp,m=!1,d&&d.name==b&&s&&
s<h.doubleTapInterval&&a.distance<h.doubleTapDistance&&(f.trigger("doubletap",a),m=!0),!m||h.tapAlways)&&(c.name=b,f.trigger(c.name,a))}},defaults:{tapMaxTime:250,tapMaxDistance:10,tapAlways:!0,doubleTapDistance:20,doubleTapInterval:300}}})("tap");a.gestures.Touch={name:"touch",index:-Infinity,defaults:{preventDefault:!1,preventMouse:!1},handler:function(b,a){a.options.preventMouse&&b.pointerType==m?b.stopDetect():(a.options.preventDefault&&b.preventDefault(),b.eventType==v&&a.trigger("touch",b))}};
...
null}};c.prototype.gotoAndPlay=function(a,b,e,f,h,s,m,q,g){void 0===b&&(b=-1);void 0===e&&(e=-1);void 0===f&&(f=NaN);void 0===h&&(h=0);void 0===s&&(s=null);void 0===m&&(m=c.SAME_LAYER_AND_GROUP);void 0===q&&(q=!0);void 0===g&&(g=!0);if(!this._animationDataList)return null;for(var n=this._animationDataList.length,l;n--;)if(this._animationDataList[n].name==a){l=this._animationDataList[n];break}if(!l)return null;this._isFading=this._isPlaying=!0;b=0>b?0>l.fadeTime?.3:l.fadeTime:b;e=0>e?0>l.scale?1:l.scale:
1E3*e/l.duration;f=isNaN(f)?l.playTimes:f;switch(m){case c.NONE:break;case c.SAME_LAYER:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],m.layer==h&&m.fadeOut(b,q);break;case c.SAME_GROUP:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],m.group==s&&m.fadeOut(b,q);break;case c.ALL:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],m.fadeOut(b,q);break;default:for(n=this._animationStateList.length;n--;)m=this._animationStateList[n],
m.layer==h&&m.group==s&&m.fadeOut(b,q)}this._lastAnimationState=d.AnimationState._borrowObject();this._lastAnimationState._layer=h;this._lastAnimationState._group=s;this._lastAnimationState.autoTween=this.tweenEnabled;this._lastAnimationState._fadeIn(this._armature,l,b,1/e,f,g);this.addState(this._lastAnimationState);f=this._armature.getSlots(!1);for(n=f.length;n--;)h=f[n],h.childArmature&&h.childArmature.animation.gotoAndPlay(a,b);return this._lastAnimationState};c.prototype.gotoAndStop=function(a,
b,e,f,h,d,m,q){void 0===e&&(e=-1);void 0===f&&(f=0);void 0===h&&(h=-1);void 0===d&&(d=0);void 0===m&&(m=null);void 0===q&&(q=c.ALL);var g=this.getState(a,d);g||(g=this.gotoAndPlay(a,f,h,NaN,d,m,q));0<=e?g.setCurrentTime(g.totalTime*e):g.setCurrentTime(b);g.stop();return g};c.prototype.play=function(){this._animationDataList&&0!=this._animationDataList.length&&(this._lastAnimationState?this._isPlaying?this.gotoAndPlay(this._lastAnimationState.name):this._isPlaying=!0:this.gotoAndPlay(this._animationDataList[0].name))};
...
h),0>this._currentTime&&(b=!0),this._isComplete&&(a=!0),this._currentTime=c,this.updateMainTimeline(f));b&&this._armature.hasEventListener(d.AnimationEvent.START)&&(q=new d.AnimationEvent(d.AnimationEvent.START),q.animationState=this,this._armature._eventList.push(q));a?(this._armature.hasEventListener(d.AnimationEvent.COMPLETE)&&(q=new d.AnimationEvent(d.AnimationEvent.COMPLETE),q.animationState=this,this._armature._eventList.push(q)),this.autoFadeOut&&this.fadeOut(this.fadeOutTime,!0)):e&&this._armature.hasEventListener(d.AnimationEvent.LOOP_COMPLETE)&&
...
function(){var b,a,f,h=this._timelineStateList.length;if(1==h)b=this._timelineStateList[0],f=b._animationState.weight*b._animationState.fadeWeight,b._weight=f,a=b._transform,b=b._pivot,this._tween.x=a.x*f,this._tween.y=a.y*f,this._tween.skewX=a.skewX*f,this._tween.skewY=a.skewY*f,this._tween.scaleX=1+(a.scaleX-1)*f,this._tween.scaleY=1+(a.scaleY-1)*f,this._tweenPivot.x=b.x*f,this._tweenPivot.y=b.y*f;else if(1<h){var c=0,d=0,g=0,k=0,n=0,l=0,p=0,u=0,v=1,t=0,r=this._timelineStateList[h-1]._animationState.layer;
for(a=0;h--;){b=this._timelineStateList[h];a=b._animationState.layer;if(r!=a)if(t>=v){b._weight=0;break}else v-=t;r=a;f=b._animationState.weight*b._animationState.fadeWeight*v;(b._weight=f)&&b._blendEnabled&&(a=b._transform,b=b._pivot,c+=a.x*f,d+=a.y*f,g+=a.skewX*f,k+=a.skewY*f,n+=(a.scaleX-1)*f,l+=(a.scaleY-1)*f,p+=b.x*f,u+=b.y*f,t+=f)}this._tween.x=c;this._tween.y=d;this._tween.skewX=g;this._tween.skewY=k;this._tween.scaleX=n;this._tween.scaleY=l;this._tweenPivot.x=p;this._tweenPivot.y=u}};a.prototype.sortState=
...
};a.prototype._updateDisplayColor=function(b,a,f,h,c,d,g,k){this._colorTransform.alphaOffset=b;this._colorTransform.redOffset=a;this._colorTransform.greenOffset=f;this._colorTransform.blueOffset=h;this._colorTransform.alphaMultiplier=c;this._colorTransform.redMultiplier=d;this._colorTransform.greenMultiplier=g;this._colorTransform.blueMultiplier=k};a.prototype._updateDisplayBlendMode=function(b){throw Error("Abstract method needs to be implemented in subclass!");};return a}(d.DBObject);d.Slot=g})(dragonBones||
...
h,f);c.advanceTime(0);return c};a.prototype.copyAnimationsToArmature=function(b,a,f,h){void 0===f&&(f=null);void 0===h&&(h=!0);var c={};if(!this.fillBuildArmatureDataPackageArmatureInfo(a,f,c))return!1;a=c.armatureData;b.animation.animationDataList=a.animationDataList;a=a.getSkinData("");var m;b=b.getSlots(!1);for(var g,k=0,n,l=b.length,p=0;p<l;p++){f=b[p];g=f.displayList;for(var k=g.length,u=0;u<k;u++)n=g[u],n instanceof d.Armature&&(m=a.getSlotData(f.name),m=m.displayDataList[u],m.type==d.DisplayData.ARMATURE&&
...
null==b.armatureData.getBoneData(f)&&(f=null),b.addBone(h,f,!0);b._updateAnimationAfterBoneListChanged()};a.prototype._buildSlots=function(b,a,f){var h=b.armatureData.getSkinData(a);if(h)for(var c=[],h=h.slotDataList,m,g,k,n=0;n<h.length;n++)if(m=h[n],k=b.getBone(m.parent)){g=this._generateSlot();g.initWithSlotData(m);k.addSlot(g);for(k=m.displayDataList.length;k--;){var l=m.displayDataList[k];switch(l.type){case d.DisplayData.ARMATURE:l=this.buildArmatureUsingArmatureDataFromTextureAtlas(b.__dragonBonesData,
b.__dragonBonesData.getArmatureDataByName(l.name),f,a);c[k]=l;break;default:c[k]=this._generateDisplay(f,l.name,l.pivot.x,l.pivot.y)}}for(var p in c)if(m=c[p],m instanceof d.Armature&&(m=m.display),m.hasOwnProperty("name"))try{m.name=g.name}catch(u){}g.displayList=c;g._changeDisplay(0)}};a.prototype._generateArmature=function(){return null};a.prototype._generateSlot=function(){return null};a.prototype._generateDisplay=function(b,a,f,h){return null};a._helpMatrix=new d.Matrix;return a}(d.EventDispatcher);
...
(function(d){var g=function(){function c(){}c.parseTextureAtlasData=function(a,b){void 0===b&&(b=1);var e={},f,h=a[d.ConstValues.SUB_TEXTURE],s;for(s in h){var m=h[s],g=m[d.ConstValues.A_NAME],k=new d.Rectangle;k.x=c.getNumber(m,d.ConstValues.A_X,0)/b;k.y=c.getNumber(m,d.ConstValues.A_Y,0)/b;k.width=c.getNumber(m,d.ConstValues.A_WIDTH,0)/b;k.height=c.getNumber(m,d.ConstValues.A_HEIGHT,0)/b;var n="true"==m[d.ConstValues.A_ROTATED],l=c.getNumber(m,d.ConstValues.A_FRAME_WIDTH,0)/b,p=c.getNumber(m,d.ConstValues.A_FRAME_HEIGHT,
0)/b;0<l&&0<p?(f=new d.Rectangle,f.x=c.getNumber(m,d.ConstValues.A_FRAME_X,0)/b,f.y=c.getNumber(m,d.ConstValues.A_FRAME_Y,0)/b,f.width=l,f.height=p):f=null;e[g]=new d.TextureData(k,f,n)}return e};c.parseDragonBonesData=function(a){if(!a)throw Error();var b=a[d.ConstValues.A_VERSION],b=b.toString();if(b.toString()!=d.DragonBones.DATA_VERSION&&b.toString()!=d.DragonBones.PARENT_COORDINATE_DATA_VERSION)throw Error("Nonsupport version!");var b=c.getNumber(a,d.ConstValues.A_FRAME_RATE,0)||0,e=new d.DragonBonesData;
...
e=b.boneDataList;var h;f&&(h=f.slotDataList);for(f=0;f<e.length;f++){var s=e[f],m=a.getTimeline(s.name);if(m){var g=null;if(h)for(var k in h)if(g=h[k],g.parent==s.name)break;for(var n=m.frameList,l=null,p=null,u=null,v=n.length,t=0;t<v;t++){var r=n[t];c.setFrameTransform(a,b,s,r);r.transform.x-=s.transform.x;r.transform.y-=s.transform.y;r.transform.skewX-=s.transform.skewX;r.transform.skewY-=s.transform.skewY;r.transform.scaleX/=s.transform.scaleX;r.transform.scaleY/=s.transform.scaleY;!m.transformed&&
...
u.transform.skewX),r.transform.skewY=u.transform.skewY+d.TransformUtil.formatRadian(r.transform.skewY-u.transform.skewY))}u=r}m.transformed=!0}}}else c.transformRelativeAnimationData(a,b)};c.setFrameTransform=function(a,b,e,f){f.transform.copy(f.global);if(e=b.getBoneData(e.parent)){var h=a.getTimeline(e.name);if(h){for(var s=[],m=[];h;)s.push(h),m.push(e),h=(e=b.getBoneData(e.parent))?a.getTimeline(e.name):null;a=s.length;var g;b=new d.Matrix;for(var k=new d.DBTransform,n=new d.Matrix;a--;)h=s[a],
e=m[a],c.getTimelineTransform(h,f.position,k,!g),g?(k.x+=h.originTransform.x+e.transform.x,k.y+=h.originTransform.y+e.transform.y,k.skewX+=h.originTransform.skewX+e.transform.skewX,k.skewY+=h.originTransform.skewY+e.transform.skewY,k.scaleX=k.scaleX*h.originTransform.scaleX*e.transform.scaleX,k.scaleY=k.scaleY*h.originTransform.scaleY*e.transform.scaleY,d.TransformUtil.transformToMatrix(k,n,!0),n.concat(b),d.TransformUtil.matrixToTransform(n,g,0<=k.scaleX*g.scaleX,0<=k.scaleY*g.scaleY)):(g=new d.DBTransform,
g.copy(k)),d.TransformUtil.transformToMatrix(g,b,!0);d.TransformUtil.globalToLocal(f.transform,g)}}};c.getTimelineTransform=function(a,b,e,f){for(var h=a.frameList,c=h.length;c--;)if(a=h[c],a.position<=b&&a.position+a.duration>b){if(c==h.length-1||b==a.position)e.copy(f?a.global:a.transform);else{var g=a.tweenEasing;b=(b-a.position)/a.duration;g&&10!=g&&(b=d.MathUtil.getEaseValue(b,g));h=h[c+1];a=f?a.global:a.transform;f=f?h.global:h.transform;e.x=a.x+(f.x-a.x)*b;e.y=a.y+(f.y-a.y)*b;e.skewX=d.TransformUtil.formatRadian(a.skewX+
...
h/g;this.values[1]=-a/g;this.values[3]=-f/g;this.values[4]=b/g;this.values[6]=(f*d-h*c)/g;this.values[7]=-(b*d-a*c)/g};a.prototype.prepend=function(b,a,f,h,c,d){var g,k,n,l,p=this.values,u=p[6],v=p[7];if(1!=b||0!=a||0!=f||1!=h)g=p[0],k=p[1],n=p[3],l=p[4],p[0]=g*b+k*f,p[1]=g*a+k*h,p[3]=n*b+l*f,p[4]=n*a+l*h;p[6]=u*b+v*f+c;p[7]=u*a+v*h+d};a.prototype.append=function(b,a,f,h,c,d){var g,k,n,l,p=this.values;g=p[0];k=p[1];n=p[3];l=p[4];p[0]=b*g+a*n;p[1]=b*k+a*l;p[3]=f*g+h*n;p[4]=f*k+h*l;p[6]=c*g+d*n+p[6];
p[7]=c*k+d*l+p[7]};a.prototype.prependTransform=function(b,e,f,h,c,d,g,k,n){if(c%360){var l=c*a.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=1,l=0;if(k||n)this.values[6]-=k,this.values[7]-=n;d||g?(d*=a.DEG_TO_RAD,g*=a.DEG_TO_RAD,this.prepend(c*f,l*f,-l*h,c*h,0,0),this.prepend(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),b,e)):this.prepend(c*f,l*f,-l*h,c*h,b,e);return this};a.prototype.appendTransform=function(b,e,f,h,c,d,g,k,n){if(c%360){var l=c*a.DEG_TO_RAD;c=Math.cos(l);l=Math.sin(l)}else c=
1,l=0;d||g?(d*=a.DEG_TO_RAD,g*=a.DEG_TO_RAD,this.append(Math.cos(g),Math.sin(g),-Math.sin(d),Math.cos(d),b,e),this.append(c*f,l*f,-l*h,c*h,0,0)):this.append(c*f,l*f,-l*h,c*h,b,e);if(k||n)this.values[6]-=k*this.values[0]+n*this.values[3],this.values[7]-=k*this.values[1]+n*this.values[4];return this};a.DEG_TO_RAD=Math.PI/180;return a}();d.Matrix=c})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
f):1==a&&f<c?(c!=this.duration&&this._runActions(c,this.duration),this._runActions(0,f,!0)):this._runActions(c,f));h&&this.setPaused(!0);return h};a.prototype._runActions=function(b,a,f){void 0===f&&(f=!1);var h=b,c=a,d=-1,g=this._actions.length,k=1;b>a&&(h=a,c=b,d=g,g=k=-1);for(;(d+=k)!=g;){a=this._actions[d];var n=a.t;(n==c||n>h&&n<c||f&&n==b)&&a.f.apply(a.o,a.p)}};a.prototype._updateTargetProps=function(b,e){var f,h,c,d;if(b||1!=e){if(this.passive=!!b.v)return;b.e&&(e=b.e(e,0,1,1));f=b.p0;h=b.p1}else this.passive=
!1,f=h=this._curQueueProps;for(var g in this._initQueueProps){null==(c=f[g])&&(f[g]=c=this._initQueueProps[g]);null==(d=h[g])&&(h[g]=d=c);c=c==d||0==e||1==e||"number"!=typeof c?1==e?d:c:c+(d-c)*e;var k=!1;if(d=a._plugins[g])for(var n=0,l=d.length;n<l;n++){var p=d[n].tween(this,g,c,f,h,e,!!b&&f==h,!b);p==a.IGNORE?k=!0:c=p}k||(this._target[g]=c)}};a.prototype.setPaused=function(b){this.paused=b;a._register(this,!b);return this};a.prototype._cloneProps=function(b){var a={},f;for(f in b)a[f]=b[f];return a};
a.prototype._addStep=function(b){0<b.d&&(this._steps.push(b),b.t=this.duration,this.duration+=b.d);return this};a.prototype._appendQueueProps=function(b){var e,f,h,c,d,g;for(g in b)if(void 0===this._initQueueProps[g]){f=this._target[g];if(e=a._plugins[g])for(h=0,c=e.length;h<c;h++)f=e[h].init(this,g,f);this._initQueueProps[g]=this._curQueueProps[g]=void 0===f?null:f}for(g in b){f=this._curQueueProps[g];if(e=a._plugins[g])for(d=d||{},h=0,c=e.length;h<c;h++)e[h].step&&e[h].step(this,g,f,b[g],d);this._curQueueProps[g]=
b[g]}d&&this._appendQueueProps(d);return this._curQueueProps};a.prototype._addAction=function(b){b.t=this.duration;this._actions.push(b);return this};a.prototype._set=function(b,a){for(var f in b)a[f]=b[f]};a.prototype.wait=function(b,a){void 0===a&&(a=!1);if(null==b||0>=b)return this;var f=this._cloneProps(this._curQueueProps);return this._addStep({d:b,p0:f,p1:f,v:a})};a.prototype.to=function(b,a,f){void 0===f&&(f=void 0);if(isNaN(a)||0>a)a=0;return this._addStep({d:a||0,p0:this._cloneProps(this._curQueueProps),
...
typeof b.skewX&&(this._values[7]=b.skewX);"number"===typeof b.skewY&&(this._values[8]=b.skewY);"undefined"!==typeof b.relative&&(this._relative=b.relative);this._dirty=!0};a.prototype.transform=function(b){void 0===b&&(b=null);var e,f,h=this.worldMatrix;f=this._values[0];var c=this._values[1];e=this._values[4];var d=this._values[5],g=this._values[6],k=this._values[7],n=this._values[8];this.useGLCoords&&(k+=180);b&&this._relative?h.applyMatrix(b.worldMatrix):this===b?h.identity():h.applyMatrix(b.worldMatrix);
this.__local_matrix?(f=this.__local_matrix,h.append(f.a,f.b,f.c,f.d,f.tx,f.ty)):(e%360?(e*=a.DEG_TO_RAD,b=Math.cos(e),e=Math.sin(e)):(b=1,e=0),k||n?(k*=a.DEG_TO_RAD,n*=a.DEG_TO_RAD,h.append(Math.cos(n),Math.sin(n),-Math.sin(k),Math.cos(k),f,c),h.append(b*d,e*d,-e*g,b*g,0,0)):h.append(b*d,e*d,-e*g,b*g,f,c));this._dirty=!1};a.prototype.updateWorldMatrix=function(){if(this._dirty){var b=this.worldMatrix;b?b.identity():b=new d.math.Matrix;for(var a=this;null!=a;)b.prependTransform(a.x,a.y,a.scaleX,a.scaleY,
...
function(b,e){d.Assert.isObject(e);d.Assert.isString(e.name);d.Assert.isUndefined(a.configMap[e.name]);a.ctorMap[e.name]=b;a.configMap[e.name]=e};a.unregister=function(b){d.Assert.isString(b);d.Assert.isNotUndefined(a.configMap[b]);delete a.ctorMap[b];delete a.configMap[b]};a.create=function(b){d.Assert.isString(b);b=a.ctorMap[b];d.Assert.isFunction(b);return new b};a.getConfig=function(b){d.Assert.isString(b);b=a.configMap[b];d.Assert.isNotUndefined(b);return b};a.ctorMap={};a.configMap={};return a}(d.event.EventDispatcher);
d.Component=g})(WOZLLA||(WOZLLA={}));(function(d){var g=function(c){function a(){c.apply(this,arguments)}__extends(a,c);a.prototype.collideXY=function(b,a){return!1};a.prototype.collide=function(b){return!1};return a}(d.Component);d.Collider=g})(WOZLLA||(WOZLLA={}));
...
!b.paused?(b.time-=d.Time.delta,0>b.time&&(b.task.apply(b,b.args),b.time+=b.intervalTime)):b.isLoop&&!b.paused&&b.task.apply(b,b.args),this._runScheduleCount++};c.prototype.removeSchedule=function(a){delete this._schedules[a]};c.prototype.scheduleLoop=function(a,b){var e="Schedule_"+this._scheduleCount++;this._schedules[e]={task:a,args:b,isLoop:!0};return e};c.prototype.scheduleFrame=function(a,b,e){void 0===b&&(b=0);var f="Schedule_"+this._scheduleCount++;this._schedules[f]={task:a,frame:b,args:e,
isFrame:!0};return f};c.prototype.scheduleInterval=function(a,b,e){void 0===b&&(b=0);var f="Schedule_"+this._scheduleCount++;this._schedules[f]={task:a,intervalTime:b,time:b,args:e,isInterval:!0};return f};c.prototype.scheduleTime=function(a,b,e){void 0===b&&(b=0);var f="Schedule_"+this._scheduleCount++;this._schedules[f]={task:a,time:b||0,args:e,isTime:!0};return f};c.prototype.resumeSchedule=function(a){this._schedules[a].paused=!1};c.prototype.pauseSchedule=function(a){this._schedules[a].paused=
...
bubbles:!0,touch:g,gesture:h.gesture,identifier:k,touchMoveDetection:!1}),a.dispatchEvent(h),b=h.touchMoveDetection}}};return a}();d.Touch=a})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function a(){}a.getGLContext=function(a,e){var f,c=e||{},d={alpha:!0,antialias:!0,premultipliedAlpha:!1,stencil:!0},g;for(g in d)"undefined"===typeof c[g]&&(c[g]=d[g]);e=c;try{f=a.getContext("experimental-webgl",e)}catch(q){try{f=a.getContext("webgl",e)}catch(k){}}return f};a.compileShader=function(a,e,f){e=a.createShader(e);a.shaderSource(e,f);a.compileShader(e);return a.getShaderParameter(e,a.COMPILE_STATUS)?e:(console.log(a.getShaderInfoLog(e)),null)};
a.compileProgram=function(b,e,f){e=a.compileShader(b,b.VERTEX_SHADER,e);f=a.compileShader(b,b.FRAGMENT_SHADER,f);var c=b.createProgram();b.attachShader(c,e);b.attachShader(c,f);b.linkProgram(c);b.getProgramParameter(c,b.LINK_STATUS)||console.log("Could not initialise program");return{program:c,vertexShader:e,fragmentShader:f}};return a}();d.WebGLUtils=c})(d.renderer||(d.renderer={}))})(WOZLLA||(WOZLLA={}));
(function(d){d=d.renderer||(d.renderer={});(d.ILayerManager||(d.ILayerManager={})).DEFAULT="default"})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function a(){this._layerIndexMap={};this._sortedLayers=[];this.define(d.ILayerManager.DEFAULT,0)}a.prototype.define=function(a,e){var f=this;if(this._layerIndexMap[a])throw Error("Layer has been defined: "+a);this._layerIndexMap[a]=e;this._sortedLayers.push(a);this._sortedLayers.sort(function(a,b){return f.getZIndex(a)-f.getZIndex(b)})};a.prototype.undefine=function(a){this._sortedLayers.splice(this._sortedLayers.indexOf(a),1);delete this._layerIndexMap[a]};
...
{}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function a(a,e,f){this._id=a;this._shaderProgramId=e;this._blendType=f}Object.defineProperty(a.prototype,"id",{get:function(){return this._id},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"shaderProgramId",{get:function(){return this._shaderProgramId},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"blendType",{get:function(){return this._blendType},enumerable:!0,configurable:!0});a.prototype.equals=function(a){return a.blendType===
...
(function(d){(function(d){var c=function(){function a(){this._materialMap={};this._materialMap[d.IMaterial.DEFAULT]=this.createMaterial(d.IMaterial.DEFAULT,d.IShaderProgram.V2T2C1A1,d.BlendType.NORMAL)}a.prototype.createMaterial=function(a,e,f){e=new d.Material(a,e,f);return this._materialMap[a]=e};a.prototype.getMaterial=function(a){return this._materialMap[a]};a.prototype.deleteMaterial=function(a){delete this._materialMap[a.id]};a.prototype.clear=function(){this._materialMap={}};return a}();d.MaterialManager=
c})(d.renderer||(d.renderer={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(){function a(a,e,f){this._id=a;this._vertexShader=e;this._fragmentShader=f}Object.defineProperty(a.prototype,"id",{get:function(){return this._id},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"vertexShader",{get:function(){return this._vertexShader},enumerable:!0,configurable:!0});Object.defineProperty(a.prototype,"fragmentShader",{get:function(){return this._fragmentShader},enumerable:!0,configurable:!0});a.prototype.useProgram=function(a){a.useProgram(this._id)};
...
4===g.readyState&&(g.onreadystatechange=b,clearTimeout(m),e=a[d.contentType]||function(){return g.responseText},d.success(e(g)))};g.open(d.method,d.url,d.async);m=setTimeout(function(){g.onreadystatechange=b;g.abort();d.error({code:e.ERROR_TIMEOUT,message:"request timeout"})},d.timeout);g.send()};e.ERROR_TIMEOUT=1;e.ERROR_SERVER=2;return e}();d.Ajax=e})(d.utils||(d.utils={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){function c(a){var e=a,f;if(a&&"object"===typeof a)for(f in e="[object Array]"===Object.prototype.toString.call(a)?[]:{},a)e[f]=c(a[f]);return e}var a=function(a){function e(){a.apply(this,arguments)}__extends(e,a);e.prototype.cloneData=function(){return this._data?c(this._data):this._data};e.prototype.load=function(a,b){var e=this;d.utils.Ajax.request({url:this.src,contentType:"json",success:function(b){e._data=b;a()},error:function(a){b(a)}})};e.prototype.unload=function(){this._data=
null;a.prototype.unload.call(this)};return e}(g.Asset);g.JSONAsset=a})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){(function(c){var a=function(){function a(b){this.loading=!1;this.proxyTarget=b}a.prototype.setAssetSrc=function(a){this.newAssetSrc=a};a.prototype.loadAsset=function(a){var b=this;this.checkDirty()&&!this.loading&&(this.loading=!0,this.asset&&this.asset.release(),this.asset=null,this.doLoad(function(c){c?c.src!==b.newAssetSrc?(c.retain(),c.release(),b.asset=null):(b.asset=c,b.asset.retain()):(b.asset=null,a&&a());b.loading=!1;b.proxyTarget.onAssetLoaded(c);a&&a()}))};a.prototype.onDestroy=
function(){this.asset&&this.asset.release();this.asset=null};a.prototype.checkDirty=function(){return this.asset?this.newAssetSrc!==this.asset.src:!!this.newAssetSrc};a.prototype.doLoad=function(a){a(null)};return a}();c.AssetProxy=a})(d.proxy||(d.proxy={}))})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){(function(c){var a=function(a){function e(){a.apply(this,arguments)}__extends(e,a);e.prototype.getSprite=function(a){return this.asset?this.asset.getSprite(a):null};e.prototype.doLoad=function(a){var b=this.newAssetSrc;b?d.AssetLoader.getInstance().load(b,d.SpriteAtlas,function(){a(d.AssetLoader.getInstance().getAsset(b))}):a(null)};return e}(c.AssetProxy);c.SpriteAtlasProxy=a})(d.proxy||(d.proxy={}))})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
...
(WOZLLA={}));
(function(d){(function(g){function c(a){var b=a.lastIndexOf("/");return-1!==b?a.substr(b+1,a.length):a}var a=/(\.png|\.jpg)$/i,b=function(b){function f(a){b.call(this,a);this._spriteCache={}}__extends(f,b);Object.defineProperty(f.prototype,"imageSrc",{get:function(){return this._imageSrc},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"metaSrc",{get:function(){return this._metaSrc},enumerable:!0,configurable:!0});Object.defineProperty(f.prototype,"sourceImage",{get:function(){return this._sourceImage},enumerable:!0,
...
b})(d.assets||(d.assets={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){var c=function(){function a(a,e){this._minCount=a;this._factory=e;this._pool=[];for(var c=0;c<this._minCount;c++)this._pool.push(this._factory())}a.prototype.retain=function(){var a=this._pool.shift();return a?a:this._factory()};a.prototype.release=function(a){-1===this._pool.indexOf(a)&&this._pool.push(a)};return a}();d.ObjectPool=c})(d.utils||(d.utils={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(g){var c,a=function(a){function e(e,c){a.call(this,e,c);this.isPoolable=!0}__extends(e,a);e.init=function(a,b,e,d,g){var k=c.retain();k.initWith(a,b,e,d,g);return k};Object.defineProperty(e.prototype,"texture",{get:function(){return this._texture},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"materialId",{get:function(){return this._materialId},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"quad",{get:function(){return this._quad},enumerable:!0,
configurable:!0});e.prototype.initWith=function(a,b,e,c,d){this._globalZ=a;this._layer=b;this._texture=e;this._materialId=c;this._quad=d};e.prototype.release=function(){c.release(this)};return e}(g.RenderCommandBase);g.QuadCommand=a;c=new d.utils.ObjectPool(200,function(){return new a(0,g.ILayerManager.DEFAULT)})})(d.renderer||(d.renderer={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(g){var c=function(a){function b(){a.call(this);this._spriteProxy=new d.assets.proxy.SpriteAtlasProxy(this)}__extends(b,a);Object.defineProperty(b.prototype,"color",{get:function(){return this._quadColor},set:function(a){this.setQuadColor(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"alpha",{get:function(){return this._quadAlpha},set:function(a){this.setQuadAlpha(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"materialId",{get:function(){return this._quadMaterialId},
set:function(a){this.setQuadMaterialId(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"renderLayer",{get:function(){return this._quadLayer},set:function(a){this.setQuadLayer(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"renderOrder",{get:function(){return this._quadGlobalZ},set:function(a){this.setQuadGlobalZ(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"sprite",{get:function(){return this._sprite},set:function(a){var b=this._sprite;
b!==a&&((this._sprite=a)?(this.setTextureFrame(a.frame),b&&b.spriteAtlas===a.spriteAtlas||this.setTexture(a.spriteAtlas.glTexture)):(this.setTexture(null),this.setTextureFrame(null)))},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"spriteOffset",{get:function(){return this._getTextureOffset()},set:function(a){this.setTextureOffset(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"imageSrc",{get:function(){return this._spriteAtlasSrc},set:function(a){this.spriteAtlasSrc=
a;this.spriteName=null},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"spriteAtlasSrc",{get:function(){return this._spriteAtlasSrc},set:function(a){this._spriteAtlasSrc=a;this._spriteProxy.setAssetSrc(a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"spriteName",{get:function(){return this._spriteName},set:function(a){this._spriteName=a;this.sprite=this._spriteProxy.getSprite(a)},enumerable:!0,configurable:!0});b.prototype.destroy=function(){this._spriteProxy.onDestroy();
a.prototype.destroy.call(this)};b.prototype.onAssetLoaded=function(a){this.sprite=a?a.getSprite(this._spriteName):null};b.prototype.loadAssets=function(a){this._spriteProxy.loadAsset(a)};return b}(g.QuadRenderer);g.SpriteRenderer=c;d.Component.register(c,{name:"SpriteRenderer",properties:[{name:"color",type:"int",defaultValue:16777215},{name:"alpha",type:"int",defaultValue:1},{name:"spriteAtlasSrc",type:"string"},{name:"spriteName",type:"string"}]})})(d.component||(d.component={}))})(WOZLLA||(WOZLLA=
{}));
(function(d){(function(g){var c=d.renderer.QuadCommand,a=function(a){function e(){a.apply(this,arguments)}__extends(e,a);Object.defineProperty(e.prototype,"renderRegion",{get:function(){return this._renderRegion},set:function(a){this._renderRegion=a},enumerable:!0,configurable:!0});Object.defineProperty(e.prototype,"patch",{get:function(){return this._patch},set:function(a){this._patch=a;this._quadVertexDirty=!0},enumerable:!0,configurable:!0});e.prototype._initQuad=function(){this._quad=new d.renderer.Quad(9)};e.prototype._updateNinePatchQuads=
...
width:b.width-g.right,height:b.height-g.bottom},pos:{x:k.right,y:k.bottom},size:{width:1,height:1}}],g=0;9>g;g++)if(k=b[g],0<k.frame.width&&0<k.frame.height){c=k.frame;var n=this._texture,l=n.descriptor.width,n=n.descriptor.height,p={};p.x0=c.x/l;p.y0=c.y/n;p.x1=(c.x+c.width)/l;p.y1=c.y/n;p.x2=(c.x+c.width)/l;p.y2=(c.y+c.height)/n;p.x3=c.x/l;p.y3=(c.y+c.height)/n;c=p;a.set(this.gameObject.transform);a.x+=k.pos.x;a.y+=k.pos.y;a.setScale(k.size.width,k.size.height);a.updateWorldMatrix();this._updateQuadVerticesByArgs(c,
k.frame,e,a.worldMatrix,g)}else this._clearQuadVertices(g);this._quadVertexDirty=!1};e.prototype._updateNinePatchQuadAlpha=function(){for(var a=0;9>a;a++)this._updateQuadAlpha(a);this._quadAlphaDirty=!1};e.prototype._updateNinePatchQuadColor=function(){for(var a=0;9>a;a++)this._updateQuadColor(a);this._quadColorDirty=!1};e.prototype.render=function(a,b){this._texture&&((b&d.GameObject.MASK_TRANSFORM_DIRTY)===d.GameObject.MASK_TRANSFORM_DIRTY&&(this._quadVertexDirty=!0),this._textureUpdated&&this._updateNinePatchQuads(),
this._quadVertexDirty&&(this._updateNinePatchQuadVertices(),this._quadVertexDirty=!1),this._quadAlphaDirty&&this._updateNinePatchQuadAlpha(),this._quadColorDirty&&this._updateNinePatchQuadColor(),a.addCommand(c.init(this._quadGlobalZ,this._quadLayer,this._texture,this._quadMaterialId,this._quad)))};return e}(g.SpriteRenderer);g.NinePatchRenderer=a;d.Component.register(a,{name:"NinePatchRenderer",properties:[]})})(d.component||(d.component={}))})(WOZLLA||(WOZLLA={}));
(function(d){var g=function(c){function a(){c.apply(this,arguments);this.enabled=!0}__extends(a,c);a.prototype.update=function(){};return a}(d.Component);d.Behaviour=g})(WOZLLA||(WOZLLA={}));(function(d){var g=function(c){function a(a,e,d,h){void 0===e&&(e=!1);void 0===d&&(d=null);void 0===h&&(h=!0);c.call(this,a,e,d,h)}__extends(a,c);return a}(d.event.Event);d.CoreEvent=g})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(d){(function(c){c.rectIntersect=function(a,b){return a.x<b.x+b.width&&b.x<a.x+a.width&&a.y<b.y+b.height&&b.y<a.y+a.height};c.rectIntersect2=function(a,b,c,d,h,g,m,q){return a<=h+m&&h<=a+c&&b<=g+q&&g<=b+d}})(d.MathUtils||(d.MathUtils={}))})(d.math||(d.math={}))})(WOZLLA||(WOZLLA={}));
...
function(c){var e=this,g,q;d.Assert.isNotUndefined(this._stateConfig[c]);g=this._currentState;q=this._stateConfig[c][c]||b.getInstance();this._currentTransition&&this._currentTransition.cancel();q.reset();q.execute(g,c,function(){e._currentTransition=null;e._currentState=c;e.dispatchEvent(new d.event.Event(f.CHANGE,!1,new a(e._currentState)))});this._currentTransition=q};f.INIT="state.init";f.CHANGE="state.change";return f}(d.event.EventDispatcher);g.StateMachine=c;var a=function(){return function(a){this.state=
...
(function(d){(function(g){var c=d.utils.StateMachine,a=function(a){function e(){a.call(this);this._stateMachine=new d.utils.StateMachine;this.initStates()}__extends(e,a);e.prototype.init=function(){var e=this;this._stateMachine.addListener(c.INIT,function(a){return e.onStateChange(a)});this._stateMachine.addListener(c.CHANGE,function(a){return e.onStateChange(a)});this._stateMachine.init();a.prototype.init.call(this)};e.prototype.initStates=function(){};e.prototype.getStateSpriteName=function(a){return this._stateMachine.getStateData(a,
"spriteName")};e.prototype.setStateSpriteName=function(a,b){this._stateMachine.setStateData(a,"spriteName",b)};e.prototype.onStateChange=function(a){this.spriteName=this.getStateSpriteName(a.data.state)};return e}(d.component.SpriteRenderer);g.StateWidget=a})(d.ui||(d.ui={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(a){function b(){a.apply(this,arguments)}__extends(b,a);Object.defineProperty(b.prototype,"normalSpriteName",{get:function(){return this.getStateSpriteName(b.STATE_NORMAL)},set:function(a){this.setStateSpriteName(b.STATE_NORMAL,a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"disabledSpriteName",{get:function(){return this.getStateSpriteName(b.STATE_DISABLED)},set:function(a){this.setStateSpriteName(b.STATE_DISABLED,a)},enumerable:!0,configurable:!0});
Object.defineProperty(b.prototype,"pressedSpriteName",{get:function(){return this.getStateSpriteName(b.STATE_PRESSED)},set:function(a){this.setStateSpriteName(b.STATE_PRESSED,a)},enumerable:!0,configurable:!0});b.prototype.init=function(){var b=this;this.gameObject.addListener("touch",function(a){return b.onTouch(a)});this.gameObject.addListener("release",function(a){return b.onRelease(a)});this.gameObject.addListener("tap",function(a){return b.onTap(a)});a.prototype.init.call(this)};b.prototype.destroy=
function(){this._stateMachine.clearAllListeners();a.prototype.destroy.call(this)};b.prototype.isEnabled=function(){return this._stateMachine.getCurrentState()!==b.STATE_DISABLED};b.prototype.setEnabled=function(a){void 0===a&&(a=!0);this._stateMachine.changeState(a?b.STATE_NORMAL:b.STATE_DISABLED);this._gameObject.touchable=a};b.prototype.initStates=function(){this._stateMachine.defineState(b.STATE_NORMAL,!0);this._stateMachine.defineState(b.STATE_DISABLED);this._stateMachine.defineState(b.STATE_PRESSED)};
b.prototype.onTouch=function(a){this._stateMachine.changeState(b.STATE_PRESSED)};b.prototype.onRelease=function(a){this._stateMachine.changeState(b.STATE_NORMAL)};b.prototype.onTap=function(a){};b.STATE_NORMAL="normal";b.STATE_DISABLED="disabled";b.STATE_PRESSED="pressed";return b}(d.StateWidget);d.Button=c})(d.ui||(d.ui={}))})(WOZLLA||(WOZLLA={}));
(function(d){(function(d){var c=function(a){function b(){a.apply(this,arguments)}__extends(b,a);Object.defineProperty(b.prototype,"uncheckedSpriteName",{get:function(){return this.getStateSpriteName(b.STATE_UNCHECKED)},set:function(a){this.setStateSpriteName(b.STATE_UNCHECKED,a)},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"disabledSpriteName",{get:function(){return this.getStateSpriteName(b.STATE_DISABLED)},set:function(a){this.setStateSpriteName(b.STATE_DISABLED,a)},enumerable:!0,
configurable:!0});Object.defineProperty(b.prototype,"checkedSpriteName",{get:function(){return this.getStateSpriteName(b.STATE_CHECKED)},set:function(a){this.setStateSpriteName(b.STATE_CHECKED,a)},enumerable:!0,configurable:!0});b.prototype.init=function(){var b=this;this._gameObject.addListener("tap",function(a){return b.onTap(a)});a.prototype.init.call(this)};b.prototype.destroy=function(){this._stateMachine.clearAllListeners();a.prototype.destroy.call(this)};b.prototype.isEnabled=function(){return this._stateMachine.getCurrentState()!==
b.STATE_DISABLED};b.prototype.setEnabled=function(a){void 0===a&&(a=!0);this._stateMachine.changeState(a?b.STATE_UNCHECKED:b.STATE_DISABLED);this._gameObject.touchable=a};b.prototype.initStates=function(){this._stateMachine.defineState(b.STATE_UNCHECKED,!0);this._stateMachine.defineState(b.STATE_DISABLED);this._stateMachine.defineState(b.STATE_CHECKED)};b.prototype.onTap=function(a){this._stateMachine.getCurrentState()===b.STATE_CHECKED?this._stateMachine.changeState(b.STATE_UNCHECKED):this._stateMachine.changeState(b.STATE_CHECKED)};
b.STATE_UNCHECKED="unchecked";b.STATE_CHECKED="checked";b.STATE_DISABLED="disabled";return b}(d.StateWidget);d.CheckBox=c})(d.ui||(d.ui={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(g){var c=function(a){function b(){a.apply(this,arguments)}__extends(b,a);Object.defineProperty(b.prototype,"skeletonSrc",{get:function(){return this._skeletonSrc},set:function(a){this._skeletonSrc=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"textureSrc",{get:function(){return this._textureSrc},set:function(a){this._textureSrc=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"armatureName",{get:function(){return this._armatureName},
set:function(a){this._armatureName=a},enumerable:!0,configurable:!0});Object.defineProperty(b.prototype,"armature",{get:function(){return this._armature},enumerable:!0,configurable:!0});b.prototype.init=function(){this.initArmature();a.prototype.init.call(this)};b.prototype.destroy=function(){this._skeletonJSONAsset&&this._skeletonJSONAsset.release();this._skeletonJSONAsset=null;this._wTextureAtlas&&this._wTextureAtlas.release();this._wTextureAtlas=null;this._armature&&this._armature.dispose();this._armature=
null;this._factory&&this._factory.dispose();this._container&&(this._container.destroy(),this._container.removeMe(),this._container=null);a.prototype.destroy.call(this)};b.prototype.render=function(a,b){console.log("render",b);this._container.visit(a,this.transform,b)};b.prototype.loadAssets=function(a){var b=this,c;this._skeletonSrc&&this._textureSrc&&this._armatureName?(c=d.Director.getInstance().assetLoader,c.load(this._skeletonSrc,d.assets.JSONAsset,function(){var d=c.getAsset(b._skeletonSrc);
d?(d.retain(),c.load(b._textureSrc,g.WTextureAtlas,function(){var g=c.getAsset(b._textureSrc);g?(g.retain(),b._skeletonJSONAsset=d,b._wTextureAtlas=g):d.release();a()})):a()})):a()};b.prototype.initArmature=function(){var a,b,c;this._skeletonJSONAsset&&this._wTextureAtlas&&this._armatureName&&(b=new g.WFactory,a=this._skeletonJSONAsset.cloneData(),b.addSkeletonData(dragonBones.DataParser.parseDragonBonesData(a),a.name),b.addTextureAtlas(this._wTextureAtlas,this._wTextureAtlas.name),a=b.buildArmature(this._armatureName),
c=a.getDisplay(),dragonBones.WorldClock.clock.add(a),g.setupWorldClock(),this._container=c,this._factory=b,this._armature=a)};return b}(d.Renderer);g.SkeletonRenderer=c})(d.DragonBones||(d.DragonBones={}))})(WOZLLA||(WOZLLA={}));
...
(function(d){(function(g){var c=!1;g.setupWorldClock=function(){c||(c=!0,d.Director.getInstance().scheduler.scheduleLoop(function(){dragonBones.WorldClock.clock.advanceTime(1/60)}))};var a=function(a){function c(){a.call(this,this)}__extends(c,a);c.prototype._generateArmature=function(){var a=new d.GameObject;a.init();return new dragonBones.Armature(a)};c.prototype._generateSlot=function(){return new g.WSlot};c.prototype._generateDisplay=function(a,b,c,e){var g=new d.GameObject,k=new d.component.SpriteRenderer;
k.sprite=a.getSprite(b);k.spriteOffset={x:c/k.sprite.frame.width,y:e/k.sprite.frame.height};g.addComponent(k);g.init();return g};return c}(dragonBones.BaseFactory);g.WFactory=a})(d.DragonBones||(d.DragonBones={}))})(WOZLLA||(WOZLLA={}));
